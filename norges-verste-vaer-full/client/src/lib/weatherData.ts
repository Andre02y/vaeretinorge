 ...
 *
 * Sist oppdatert: 18.07.2026 kl. 03:17
...
export const META = {
  ...
  datoOppdatert: "18.07.2026 kl. 03:17",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [20.8, 24.0, 26.0, 24.0, 23.3, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [19.2, 26.2, 20.7, 23.7, 23.2, 19.5], trend: "Noe bedring (-3.7) - roligere forhold" },
  ...
  { navn: "Oslo", dager: [15.3, 14.9, 14.7, 14.6, 15.9, 7.9], trend: "Markant bedring (-8.0) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [12.9, 12.7, 12.6, 12.2, 13.0, 14.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [10.3, 9.7, 8.7, 8.7, 10.2, 12.6], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [8.7, 8.9, 8.0, 7.3, 10.6, 13.4], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [9.2, 7.7, 6.8, 6.5, 8.0, 15.5], trend: "Kraftig forverring (+7.5) - okt vind og/eller nedbor" },
  { navn: "Buskerud", dager: [8.9, 7.8, 7.7, 7.2, 9.3, 8.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [9.0, 7.8, 7.3, 7.2, 8.1, 6.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [7.5, 7.3, 7.0, 6.4, 7.1, 8.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [7.1, 6.7, 6.0, 5.6, 6.2, 6.6], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 140.1, iDag: 22.0, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 132.5, iDag: 19.5, endringFraIGar: -3.7, plasseringEndring: 0 },
  { navn: "Troms", total: 131.5, iDag: 22.3, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 84.4, iDag: 18.0, endringFraIGar: 2.6, plasseringEndring: 1 },
  { navn: "Oslo", total: 83.3, iDag: 7.9, endringFraIGar: -8.0, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 78.2, iDag: 14.8, endringFraIGar: 1.8, plasseringEndring: 0 },
  { navn: "Vestland", total: 60.2, iDag: 12.6, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 56.9, iDag: 13.4, endringFraIGar: 2.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 53.7, iDag: 15.5, endringFraIGar: 7.5, plasseringEndring: 2 },
  { navn: "Buskerud", total: 49.4, iDag: 8.5, endringFraIGar: -0.8, plasseringEndring: -1 },
  { navn: "Telemark", total: 46.1, iDag: 6.7, endringFraIGar: -1.4, plasseringEndring: -1 },
  { navn: "Agder", total: 43.6, iDag: 8.3, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 38.2, iDag: 6.6, endringFraIGar: 0.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 55.6, vindkast: 23.8, nedbor: 0, temp: 12.0, farevarsel: "gul" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 55.4, vindkast: 19.5, nedbor: 0, temp: 3.0, farevarsel: "gul" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 51.4, vindkast: 18.1, nedbor: 0, temp: 5.1, farevarsel: "gul" },
  { navn: "ARNØYA - TROLLTINDEN", kommune: "SKJERVØY", fylke: "Troms", ei: 46.5, vindkast: 18.2, nedbor: 0, temp: 2.6, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 45.1, vindkast: 17.4, nedbor: 0, temp: 6.0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [58.2, 64.5, 63.7, 63.9, 60.6, 42.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 1.2,
    dager: [54.0, 48.5, 50.7, 59.2, 48.1, 44.0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 6.0,
    dager: [48.3, 58.7, 42.6, 56.9, 51.3, 45.1, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 4.8,
    dager: [46.5, 47.8, 52.3, 59.2, 52.1, 43.1, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [43.2, 59.0, 43.1, 54.6, 52.8, 38.2, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 48 EI per dag. Toppdag Tir med 59.0 EI. Kraftige vindkast opp til 26.8 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 140.1 poeng - 7.6 poeng foran Finnmark (132.5).",
