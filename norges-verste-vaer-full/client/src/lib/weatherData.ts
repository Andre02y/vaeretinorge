 ...
 *
 * Sist oppdatert: 21.03.2026 kl. 07:30
...
export const META = {
  ...
  datoOppdatert: "21.03.2026 kl. 07:30",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.6, 33.8, 41.5, 42.4, 41.3, 38.2], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Finnmark", dager: [31.1, 33.6, 37.6, 38.9, 37.4, 30.5], trend: "Markant bedring (-6.9) - lavtrykket har passert" },
  { navn: "Troms", dager: [28.1, 28.9, 33.1, 39.5, 35.9, 30.9], trend: "Markant bedring (-5.0) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [22.5, 24.8, 25.9, 32.5, 30.7, 25.0], trend: "Markant bedring (-5.7) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [32.1, 28.8, 26.2, 22.9, 21.3, 23.9], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [24.5, 25.2, 29.2, 25.9, 25.2, 25.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [34.0, 30.8, 25.5, 23.2, 19.4, 20.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [29.9, 27.3, 25.1, 24.1, 23.4, 22.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [33.5, 28.2, 24.4, 21.7, 20.3, 21.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [30.1, 29.7, 25.0, 19.9, 19.4, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [28.9, 26.6, 26.6, 19.8, 20.3, 22.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [28.6, 26.8, 22.5, 19.1, 19.0, 20.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [28.6, 24.9, 21.7, 19.1, 19.0, 20.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 226.8, iDag: 38.2, endringFraIGar: -3.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 209.1, iDag: 30.5, endringFraIGar: -6.9, plasseringEndring: 0 },
  { navn: "Troms", total: 196.4, iDag: 30.9, endringFraIGar: -5.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 161.4, iDag: 25.0, endringFraIGar: -5.7, plasseringEndring: 0 },
  { navn: "Innlandet", total: 155.2, iDag: 23.9, endringFraIGar: 2.6, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 155.1, iDag: 25.1, endringFraIGar: -0.1, plasseringEndring: 1 },
  { navn: "Oslo", total: 153.1, iDag: 20.2, endringFraIGar: 0.8, plasseringEndring: -2 },
  { navn: "Vestland", total: 152.3, iDag: 22.5, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Agder", total: 149.8, iDag: 21.7, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Telemark", total: 144.7, iDag: 20.6, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 144.4, iDag: 22.2, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Rogaland", total: 136.3, iDag: 20.3, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 134.2, iDag: 20.9, endringFraIGar: 1.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 295.2, vindkast: 0, nedbor: 504.0, temp: 1.3, farevarsel: "oransje" },
  { navn: "KONGSMARKA", kommune: "VÅGAN", fylke: "Nordland", ei: 89.6, vindkast: 0, nedbor: 109.2, temp: 0, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 74.8, vindkast: 38.8, nedbor: 0, temp: -1.8, farevarsel: "oransje" },
  { navn: "ANDØYA", kommune: "ANDØY", fylke: "Nordland", ei: 74.6, vindkast: 22.6, nedbor: 66.3, temp: 5.1, farevarsel: "oransje" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 72.8, vindkast: 29.7, nedbor: 0, temp: 4.8, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3353.9,
    tempMin: -1.8,
    dager: [33.8, 35.4, 32.8, 675.7, 833.2, 295.2, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 318 EI per dag. Toppdag Fre med 833.2 EI. Mye nedbor med totalt 3353.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.4,
    dager: [53.3, 64.1, 79.2, 79.7, 85.5, 71.2, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -8.0,
    dager: [55.1, 71.9, 82.6, 62.8, 50.6, 74.8, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [52.2, 61.9, 78.2, 68.5, 68.5, 67.5, 0],
  ...
  },
  {
    ...
    precipTotal: 151.3,
    tempMin: -2.2,
    dager: [38.8, 59.0, 96.8, 68.1, 71.2, 57.2, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Ons med 96.8 EI. Mye nedbor med totalt 151.3 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 226.8 poeng - 17.7 poeng foran Finnmark (209.1).",
