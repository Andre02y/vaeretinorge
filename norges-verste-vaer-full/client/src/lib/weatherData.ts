 ...
 *
 * Sist oppdatert: 09.08.2026 kl. 06:09
...
export const META = {
  ...
  datoOppdatert: "09.08.2026 kl. 06:09",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Oslo", dager: [16.7, 16.4, 31.9, 33.7, 25.4, 16.9, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [22.1, 23.0, 19.0, 17.7, 21.7, 21.9, 21.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [21.8, 17.1, 18.5, 24.0, 18.5, 24.4, 19.0], trend: "Markant bedring (-5.4) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [24.2, 18.4, 16.3, 22.0, 18.8, 20.5, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.7, 18.2, 16.1, 17.0, 20.8, 17.1, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [16.8, 20.6, 20.4, 17.2, 16.3, 18.1, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [15.4, 15.9, 20.3, 20.0, 17.1, 16.0, 14.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.9, 14.1, 18.0, 18.2, 17.3, 17.5, 14.6], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Rogaland", dager: [15.9, 14.4, 15.5, 18.3, 16.7, 17.5, 14.7], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Buskerud", dager: [12.9, 13.8, 20.4, 21.1, 15.7, 14.2, 13.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [12.7, 13.8, 22.2, 22.2, 12.8, 13.7, 13.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Oslo", total: 158.0, iDag: 17.0, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Nordland", total: 146.4, iDag: 21.0, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 143.3, iDag: 19.0, endringFraIGar: -5.4, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 139.5, iDag: 19.3, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 127.5, iDag: 15.6, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Troms", total: 126.7, iDag: 17.3, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Agder", total: 119.3, iDag: 14.6, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 116.6, iDag: 14.6, endringFraIGar: -2.9, plasseringEndring: 0 },
  { navn: "Rogaland", total: 113.0, iDag: 14.7, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 111.7, iDag: 13.6, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 110.8, iDag: 13.4, endringFraIGar: -0.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 75.0, vindkast: 0, nedbor: 2.0, temp: -33.6, farevarsel: "oransje" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 63.1, vindkast: 29.3, nedbor: 0, temp: 13.5, farevarsel: "oransje" },
  { navn: "E6 LANGFJORDBOTN", kommune: "ALTA", fylke: "Finnmark", ei: 62.8, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "oransje" },
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 65.6,
    tempMin: 0,
    dager: [54.5, 26.3, 46.5, 55.6, 47.2, 55.0, 49.2],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 48 EI per dag. Toppdag Tor med 55.6 EI. Mye nedbor med totalt 65.6 mm."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.8, 58.0, 62.1, 47.0, 32.6, 34.7, 36.7],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.1, 51.9, 60.6, 41.5, 29.6, 34.9, 37.2],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 163.2 poeng - 5.2 poeng foran Oslo (158.0).",
