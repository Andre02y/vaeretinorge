 ...
 *
 * Sist oppdatert: 04.05.2026 kl. 15:19
...
export const META = {
  ...
  datoOppdatert: "04.05.2026 kl. 15:19",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Trøndelag", dager: [36.8], trend: "Kraftig forverring (+36.8) - okt vind og/eller nedbor" },
  ...
  { navn: "Troms", dager: [28.5], trend: "Kraftig forverring (+28.5) - okt vind og/eller nedbor" },
  ...
  { navn: "Rogaland", dager: [19.2], trend: "Kraftig forverring (+19.2) - okt vind og/eller nedbor" },
  ...
  { navn: "Buskerud", dager: [17.7], trend: "Kraftig forverring (+17.7) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [17.3], trend: "Kraftig forverring (+17.3) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Trøndelag", total: 36.8, iDag: 36.8, endringFraIGar: 36.8, plasseringEndring: 0 },
  ...
  { navn: "Troms", total: 28.5, iDag: 28.5, endringFraIGar: 28.5, plasseringEndring: 0 },
  ...
  { navn: "Rogaland", total: 19.2, iDag: 19.2, endringFraIGar: 19.2, plasseringEndring: 0 },
  ...
  { navn: "Buskerud", total: 17.7, iDag: 17.7, endringFraIGar: 17.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 17.3, iDag: 17.3, endringFraIGar: 17.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 963.3, vindkast: 0, nedbor: 1845.8, temp: 0.3, farevarsel: "oransje" },
  { navn: "GJEMNES - REINSFJELLET", kommune: "GJEMNES", fylke: "Møre og Romsdal", ei: 65.0, vindkast: 26.7, nedbor: 0, temp: -3.1, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 64.6, vindkast: 26.3, nedbor: 0, temp: -4.7, farevarsel: "oransje" },
  { navn: "KAPPFJELLET", kommune: "GRANE", fylke: "Nordland", ei: 62.0, vindkast: 22.2, nedbor: 0, temp: -3.8, farevarsel: "oransje" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 57.7, vindkast: 21.1, nedbor: 0, temp: -2.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1845.8,
    tempMin: 0.3,
    dager: [963.3, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 963 EI per dag. Toppdag Man med 963.3 EI. Mye nedbor med totalt 1845.8 mm."
  },
  {
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Man med 65.0 EI. Kraftige vindkast opp til 26.7 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Man med 64.6 EI. Kraftige vindkast opp til 26.3 m/s."
  },
  {
    navn: "KAPPFJELLET",
    kommune: "GRANE",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.7,
    dager: [57.7, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Man med 57.7 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Trøndelag leder sammenlagt med 36.8 poeng - 4.0 poeng foran Nordland (32.8).",
