 ...
 *
 * Sist oppdatert: 11.04.2026 kl. 20:28
 * Periode sammenlagt: 06.04 - 11.04.2026 (6 dager)
...
export const META = {
  ...
  dagLabel: "Lørdag 11.04.2026",
  sammenlagtLabel: "06.04 - 11.04.2026 (6 dager)",
  datoOppdatert: "11.04.2026 kl. 20:28",
  rapportVersjon: "v2.2 (norsk tid, live uke, ryddig arkiv, fikset uke/arkiv-logikk)",
  dagLabels: ["Man 06", "Tir 07", "Ons 08", "Tor 09", "Fre 10", "Lør 11"],
};

// ---- DAG-FOR-DAG EI PER FYLKE ----

export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 28.7, 23.5], trend: "Markant bedring (-5.2) - lavtrykket har passert" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 30.8, 31.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 24.8, 24.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.0, 24.6], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.0, 23.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.4, 23.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 20.6, 20.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 25.2, 26.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.9, 21.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.7, 25.7], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 20.9, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.8, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 20.9, 19.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 184.1, iDag: 23.5, endringFraIGar: -5.2, plasseringEndring: 0 },
  { navn: "Agder", total: 159.3, iDag: 31.6, endringFraIGar: 0.8, plasseringEndring: 3 },
  { navn: "Innlandet", total: 155.8, iDag: 24.8, endringFraIGar: 0.0, plasseringEndring: -1 },
  { navn: "Vestland", total: 154.7, iDag: 24.6, endringFraIGar: -2.4, plasseringEndring: -1 },
  { navn: "Nordland", total: 152.1, iDag: 23.6, endringFraIGar: -0.4, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 150.5, iDag: 23.8, endringFraIGar: 0.4, plasseringEndring: 1 },
  { navn: "Troms", total: 148.0, iDag: 20.4, endringFraIGar: -0.2, plasseringEndring: -1 },
  { navn: "Rogaland", total: 143.7, iDag: 26.2, endringFraIGar: 1.0, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 143.6, iDag: 21.2, endringFraIGar: -1.7, plasseringEndring: -1 },
  { navn: "Telemark", total: 128.8, iDag: 25.7, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 121.8, iDag: 20.5, endringFraIGar: -0.4, plasseringEndring: 1 },
  { navn: "Oslo", total: 121.5, iDag: 19.8, endringFraIGar: 0.0, plasseringEndring: -1 },
  { navn: "Østfold", total: 119.7, iDag: 19.7, endringFraIGar: -1.2, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER LØRDAG 11.04.2026 ----

export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 86.0, vindkast: 38.6, nedbor: 0, temp: -6.1, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 81.3, vindkast: 34.3, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 70.4, vindkast: 26.5, nedbor: 0.1, temp: -4.0, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 67.6, vindkast: 30.7, nedbor: 0, temp: -4.2, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 67.5, vindkast: 28.7, nedbor: 0, temp: -5.9, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.1,
    dager: [80.1, 39.5, 44.2, 66.7, 82.6, 86.0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 67 EI per dag. Toppdag Lør med 86.0 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -6.1 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 88.2, 81.3, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Fre med 88.2 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 225.0,
    tempMin: -3.9,
    dager: [77.7, 25.9, 44.8, 92.4, 83.9, 57.8, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 225.0 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 71.8, 67.5, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Man med 81.3 EI. Kraftige vindkast opp til 33.8 m/s. Bitende kulde ned til -7.5 grader C."
  },
  {
    navn: "MIDTSTOVA",
    kommune: "ULVIK",
    ...
    precipTotal: 3.0,
    tempMin: -5.5,
    dager: [63.5, 42.4, 48.3, 72.8, 63.0, 70.4, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Tor med 72.8 EI. Kraftige vindkast opp til 29.9 m/s. Bitende kulde ned til -5.5 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 184.1 poeng - 24.8 poeng foran Agder (159.3).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-04-06",
  tilDato: "2026-04-11",
  periode: "06.04 - 11.04.2026 (6 dager)",
  dagerRegistrert: 6,
