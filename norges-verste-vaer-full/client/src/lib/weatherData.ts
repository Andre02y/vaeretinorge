 ...
 *
 * Sist oppdatert: 06.06.2026 kl. 15:04
...
export const META = {
  ...
  datoOppdatert: "06.06.2026 kl. 15:04",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Agder", dager: [19.4, 18.4, 21.7, 26.3, 23.7, 17.9], trend: "Markant bedring (-5.8) - lavtrykket har passert" },
  { navn: "Telemark", dager: [20.8, 18.7, 18.5, 23.2, 22.7, 18.8], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Buskerud", dager: [18.8, 17.7, 17.9, 23.0, 22.6, 17.7], trend: "Noe bedring (-4.9) - roligere forhold" },
  { navn: "Vestland", dager: [19.6, 18.1, 19.5, 19.3, 19.7, 17.6], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Innlandet", dager: [16.8, 17.1, 16.9, 23.3, 22.0, 16.9], trend: "Markant bedring (-5.1) - lavtrykket har passert" },
  { navn: "Rogaland", dager: [19.0, 18.5, 17.7, 21.3, 19.4, 16.9], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Finnmark", dager: [20.5, 18.8, 19.9, 17.6, 16.6, 15.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [18.4, 17.5, 18.4, 16.9, 17.3, 20.4], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [17.7, 16.2, 14.9, 21.1, 22.4, 14.9], trend: "Markant bedring (-7.5) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [17.6, 17.5, 17.3, 14.7, 16.7, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [18.8, 17.3, 15.9, 12.5, 13.9, 15.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Agder", total: 127.4, iDag: 17.9, endringFraIGar: -5.8, plasseringEndring: 0 },
  { navn: "Telemark", total: 122.7, iDag: 18.8, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 117.7, iDag: 17.7, endringFraIGar: -4.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 113.8, iDag: 17.6, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 113.0, iDag: 16.9, endringFraIGar: -5.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 112.8, iDag: 16.9, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Finnmark", total: 109.2, iDag: 15.8, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Nordland", total: 108.9, iDag: 20.4, endringFraIGar: 3.1, plasseringEndring: 1 },
  { navn: "Østfold", total: 107.2, iDag: 14.9, endringFraIGar: -7.5, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 101.1, iDag: 17.3, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Troms", total: 93.7, iDag: 15.3, endringFraIGar: 1.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 60.9, vindkast: 28.4, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 48.0, vindkast: 28.3, nedbor: 0, temp: 13.5, farevarsel: "gul" },
  { navn: "SKIEN - JØNNEVALL", kommune: "SKIEN", fylke: "Telemark", ei: 46.0, vindkast: 0, nedbor: 21.9, temp: 0, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 45.4, vindkast: 10.5, nedbor: 3.3, temp: 0, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 2.9,
    dager: [28.2, 46.6, 66.5, 62.2, 47.2, 26.4, 0],
  ...
  },
  {
    ...
    precipTotal: 15.0,
    tempMin: 0,
    dager: [44.9, 42.9, 49.8, 47.5, 45.4, 45.4, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [33.6, 37.6, 36.0, 40.3, 63.9, 60.9, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Fre med 63.9 EI. Kraftige vindkast opp til 28.4 m/s."
  },
  {
    navn: "TOVDAL",
    kommune: "ÅMLI",
  ...
  },
  {
    ...
    precipTotal: 51.0,
    tempMin: 0,
    dager: [41.2, 36.1, 39.8, 44.6, 47.4, 43.4, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Fre med 47.4 EI. Mye nedbor med totalt 51.0 mm."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 184.1 poeng - 56.7 poeng foran Agder (127.4).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
