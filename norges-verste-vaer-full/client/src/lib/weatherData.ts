 ...
 *
 * Sist oppdatert: 18.08.2026 kl. 05:35
...
export const META = {
  ...
  datoOppdatert: "18.08.2026 kl. 05:35",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [21.1, 24.8], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [22.4, 22.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.1, 24.6], trend: "Noe forverring (+4.5) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [21.7, 17.9], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Trøndelag", dager: [20.8, 18.7], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [18.8, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [17.3, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 15.0], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Buskerud", dager: [15.7, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.6, 15.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [14.4, 14.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 14.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 45.9, iDag: 24.8, endringFraIGar: 3.7, plasseringEndring: 2 },
  { navn: "Nordland", total: 45.1, iDag: 22.7, endringFraIGar: 0.3, plasseringEndring: -1 },
  { navn: "Troms", total: 44.7, iDag: 24.6, endringFraIGar: 4.5, plasseringEndring: 2 },
  { navn: "Oslo", total: 39.6, iDag: 17.9, endringFraIGar: -3.8, plasseringEndring: -2 },
  { navn: "Trøndelag", total: 39.5, iDag: 18.7, endringFraIGar: -2.1, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 36.5, iDag: 17.7, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 34.3, iDag: 17.0, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 33.9, iDag: 17.3, endringFraIGar: 0.7, plasseringEndring: 1 },
  { navn: "Rogaland", total: 32.2, iDag: 15.0, endringFraIGar: -2.2, plasseringEndring: -1 },
  { navn: "Buskerud", total: 31.6, iDag: 15.9, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Agder", total: 30.4, iDag: 15.8, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 29.0, iDag: 14.6, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Telemark", total: 28.0, iDag: 14.7, endringFraIGar: 1.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 80.4, vindkast: 0, nedbor: 0, temp: -44.0, farevarsel: "oransje" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 66.3, vindkast: 0, nedbor: 0, temp: -36.1, farevarsel: "oransje" },
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 61.6, vindkast: 0, nedbor: 0, temp: -36.5, farevarsel: "oransje" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 60.8, vindkast: 0, nedbor: 0, temp: -36.6, farevarsel: "oransje" },
  { navn: "E39 NORDHORDLANDSBRUA", kommune: "BERGEN", fylke: "Vestland", ei: 58.3, vindkast: 0, nedbor: 0, temp: -36.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -45.9,
    dager: [73.4, 80.4, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 77 EI per dag. Toppdag Tir med 80.4 EI. Bitende kulde ned til -45.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -37.1,
    dager: [48.5, 57.1, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 53 EI per dag. Toppdag Tir med 57.1 EI. Bitende kulde ned til -37.1 grader C."
  },
  {
    navn: "ANDA FYR II",
    kommune: "ØKSNES",
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.7, 49.9, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 49.9 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -36.1,
    dager: [31.7, 66.3, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 66.3 EI. Bitende kulde ned til -36.1 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [43.6, 51.0, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Tir med 51.0 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 45.9 poeng, foran Nordland (45.1).",
