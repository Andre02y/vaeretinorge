 ...
 *
 * Sist oppdatert: 07.04.2026 kl. 07:03
...
export const META = {
  ...
  datoOppdatert: "07.04.2026 kl. 07:03",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Innlandet", dager: [34.6, 28.2], trend: "Markant bedring (-6.4) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [34.0, 27.9], trend: "Markant bedring (-6.1) - lavtrykket har passert" },
  { navn: "Finnmark", dager: [28.8, 30.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 25.7], trend: "Markant bedring (-6.9) - lavtrykket har passert" },
  { navn: "Agder", dager: [32.3, 24.2], trend: "Markant bedring (-8.1) - lavtrykket har passert" },
  { navn: "Vestland", dager: [31.7, 24.4], trend: "Markant bedring (-7.3) - lavtrykket har passert" },
  { navn: "Troms", dager: [24.5, 26.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.6, 25.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 21.7], trend: "Markant bedring (-5.5) - lavtrykket har passert" },
  { navn: "Østfold", dager: [24.2, 22.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 22.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.7, 20.8], trend: "Noe bedring (-3.9) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Innlandet", total: 62.8, iDag: 28.2, endringFraIGar: -6.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 61.9, iDag: 27.9, endringFraIGar: -6.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 59.5, iDag: 30.7, endringFraIGar: 1.9, plasseringEndring: 3 },
  { navn: "Møre og Romsdal", total: 58.3, iDag: 25.7, endringFraIGar: -6.9, plasseringEndring: -1 },
  { navn: "Agder", total: 56.5, iDag: 24.2, endringFraIGar: -8.1, plasseringEndring: -1 },
  { navn: "Vestland", total: 56.1, iDag: 24.4, endringFraIGar: -7.3, plasseringEndring: -1 },
  { navn: "Troms", total: 50.5, iDag: 26.0, endringFraIGar: 1.5, plasseringEndring: 3 },
  { navn: "Nordland", total: 49.7, iDag: 25.1, endringFraIGar: 0.5, plasseringEndring: 1 },
  { navn: "Rogaland", total: 48.9, iDag: 21.7, endringFraIGar: -5.5, plasseringEndring: -2 },
  { navn: "Østfold", total: 46.5, iDag: 22.3, endringFraIGar: -1.9, plasseringEndring: 1 },
  { navn: "Buskerud", total: 46.1, iDag: 22.9, endringFraIGar: -0.3, plasseringEndring: 2 },
  { navn: "Telemark", total: 45.9, iDag: 22.1, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Oslo", total: 45.5, iDag: 20.8, endringFraIGar: -3.9, plasseringEndring: -5 },
...
export const STASJONER_PERIODE = [
  { navn: "TRYSIL - NORDRE KANKEN", kommune: "TRYSIL", fylke: "Innlandet", ei: 69.0, vindkast: 27.6, nedbor: 0, temp: -4.8, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 62.7, vindkast: 23.8, nedbor: 0, temp: -7.2, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 61.5, vindkast: 23.2, nedbor: 0, temp: -11.1, farevarsel: "oransje" },
  { navn: "GJEMNES - REINSFJELLET", kommune: "GJEMNES", fylke: "Møre og Romsdal", ei: 57.6, vindkast: 21.9, nedbor: 0, temp: -3.5, farevarsel: "gul" },
  { navn: "SNØHEIM", kommune: "DOVRE", fylke: "Innlandet", ei: 57.3, vindkast: 27.0, nedbor: 0, temp: -5.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -4.8,
    dager: [81.5, 69.0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 75 EI per dag. Toppdag Man med 81.5 EI. Kraftige vindkast opp til 33.4 m/s."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -11.1,
    dager: [80.7, 61.5, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 71 EI per dag. Toppdag Man med 80.7 EI. Kraftige vindkast opp til 34.4 m/s. Bitende kulde ned til -11.1 grader C."
  },
  {
    navn: "SNØHEIM",
    kommune: "DOVRE",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.8,
    dager: [72.7, 57.2, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Man med 72.7 EI. Kraftige vindkast opp til 33.7 m/s. Bitende kulde ned til -7.8 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Innlandet leder sammenlagt med 62.8 poeng - 0.9 poeng foran Trøndelag (61.9).",
