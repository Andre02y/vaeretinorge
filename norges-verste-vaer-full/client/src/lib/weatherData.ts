 ...
 *
 * Sist oppdatert: 26.09.2026 kl. 10:04
...
export const META = {
  ...
  datoOppdatert: "26.09.2026 kl. 10:04",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [24.9, 23.4, 26.2, 19.7, 25.3, 23.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.4, 25.2, 24.8, 20.2, 23.2, 23.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [26.2, 20.4, 27.6, 21.7, 20.6, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [17.6, 17.3, 21.3, 28.3, 22.2, 24.8], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [23.7, 22.4, 23.2, 16.9, 21.9, 19.5], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Vestland", dager: [24.4, 18.5, 22.7, 22.0, 19.3, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [28.2, 20.5, 20.8, 20.4, 19.0, 18.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [22.5, 14.6, 19.3, 24.7, 16.5, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [21.6, 17.9, 17.3, 20.0, 17.8, 18.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [20.2, 14.9, 17.3, 21.2, 18.5, 17.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.0, 14.6, 15.4, 19.1, 16.0, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.4, 14.2, 14.3, 20.1, 15.3, 14.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.5, 14.1, 13.4, 16.1, 14.5, 12.4], trend: "Noe bedring (-2.1) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 143.3, iDag: 23.8, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Nordland", total: 141.2, iDag: 23.4, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 136.3, iDag: 19.8, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Oslo", total: 131.5, iDag: 24.8, endringFraIGar: 2.6, plasseringEndring: 3 },
  { navn: "Troms", total: 127.6, iDag: 19.5, endringFraIGar: -2.4, plasseringEndring: 0 },
  { navn: "Vestland", total: 127.5, iDag: 20.6, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 127.4, iDag: 18.5, endringFraIGar: -0.5, plasseringEndring: -3 },
  { navn: "Rogaland", total: 114.2, iDag: 16.6, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 113.0, iDag: 18.4, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Agder", total: 110.0, iDag: 17.9, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Buskerud", total: 96.7, iDag: 16.6, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 93.9, iDag: 14.6, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Østfold", total: 87.0, iDag: 12.4, endringFraIGar: -2.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV82 KJØLHÅGEN", kommune: "ANDØY", fylke: "Nordland", ei: 67.8, vindkast: 0, nedbor: 0, temp: -38.3, farevarsel: "oransje" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 64.8, vindkast: 0, nedbor: 0, temp: -39.7, farevarsel: "oransje" },
  { navn: "FV65 BYE", kommune: "ORKLAND", fylke: "Trøndelag", ei: 61.3, vindkast: 0, nedbor: 0, temp: -39.7, farevarsel: "oransje" },
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 60.0, vindkast: 0, nedbor: 0, temp: -39.7, farevarsel: "gul" },
  { navn: "FV614 GRYTADALEN", kommune: "BREMANGER", fylke: "Vestland", ei: 52.7, vindkast: 0, nedbor: 0.5, temp: -29.5, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 2051.5,
    tempMin: -39.7,
    dager: [29.5, 34.0, 1041.4, 54.3, 43.6, 64.8, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 211 EI per dag. Toppdag Ons med 1041.4 EI. Mye nedbor med totalt 2051.5 mm. Bitende kulde ned til -39.7 grader C."
  },
  {
    ...
    precipTotal: 23.5,
    tempMin: -30.0,
    dager: [53.6, 60.8, 53.6, 53.0, 58.1, 52.7, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 55 EI per dag. Toppdag Tir med 60.8 EI. Mye nedbor med totalt 23.5 mm. Bitende kulde ned til -30.0 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [49.3, 50.2, 61.7, 36.5, 48.6, 35.5, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.7,
    dager: [37.9, 59.5, 49.8, 35.8, 38.2, 60.0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Lør med 60.0 EI. Bitende kulde ned til -39.7 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 143.3 poeng - 2.1 poeng foran Nordland (141.2).",
