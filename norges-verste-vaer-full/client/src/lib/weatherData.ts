 ...
 *
 * Sist oppdatert: 11.07.2026 kl. 20:43
...
export const META = {
  ...
  datoOppdatert: "11.07.2026 kl. 20:43",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [21.3, 24.8, 20.7, 20.0, 19.5, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [24.2, 26.4, 17.6, 20.1, 15.5, 16.8], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Oslo", dager: [17.5, 17.6, 16.9, 15.3, 15.0, 24.6], trend: "Kraftig forverring (+9.6) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [13.5, 17.7, 15.4, 15.9, 15.6, 16.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [19.1, 19.6, 15.4, 12.5, 10.6, 12.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [17.8, 18.8, 19.5, 12.0, 8.8, 11.7], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [13.9, 16.2, 15.4, 11.6, 9.6, 10.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [14.8, 14.7, 12.9, 10.0, 8.6, 10.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.6, 17.0, 13.3, 9.5, 8.5, 7.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.4, 14.4, 12.6, 9.9, 9.0, 7.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [12.1, 13.5, 11.0, 8.4, 6.5, 5.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 126.8, iDag: 20.5, endringFraIGar: 1.0, plasseringEndring: 0 },
  { navn: "Finnmark", total: 120.6, iDag: 16.8, endringFraIGar: 1.3, plasseringEndring: 0 },
  ...
  { navn: "Oslo", total: 106.9, iDag: 24.6, endringFraIGar: 9.6, plasseringEndring: 0 },
  { navn: "Troms", total: 94.5, iDag: 16.4, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Vestland", total: 89.2, iDag: 12.0, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 88.6, iDag: 11.7, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Rogaland", total: 77.5, iDag: 10.8, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 71.5, iDag: 10.5, endringFraIGar: 1.9, plasseringEndring: 1 },
  { navn: "Agder", total: 70.3, iDag: 7.4, endringFraIGar: -1.1, plasseringEndring: -1 },
  { navn: "Telemark", total: 67.0, iDag: 7.7, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Østfold", total: 57.0, iDag: 5.5, endringFraIGar: -1.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 52.3, vindkast: 0, nedbor: 0, temp: -25.1, farevarsel: "gul" },
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 48.3, vindkast: 17.7, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "E10 BJØRNFJELL", kommune: "NARVIK", fylke: "Nordland", ei: 48.2, vindkast: 0, nedbor: 2.1, temp: -17.3, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.3, 38.9, 40.7, 46.3, 40.5, 48.3, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Lør med 48.3 EI."
  },
  {
    navn: "LEIRFJORD",
    kommune: "LEIRFJORD",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [55.4, 47.0, 33.0, 30.0, 37.1, 43.4, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [44.2, 47.6, 34.0, 46.6, 29.6, 37.1, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 126.8 poeng - 6.2 poeng foran Finnmark (120.6).",
