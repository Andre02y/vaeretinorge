 ...
 *
 * Sist oppdatert: 13.08.2026 kl. 09:08
...
export const META = {
  ...
  datoOppdatert: "13.08.2026 kl. 09:08",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [24.9, 24.9, 27.2, 24.3], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Troms", dager: [21.1, 21.9, 24.4, 21.5], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Nordland", dager: [21.5, 24.6, 23.3, 19.4], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [25.0, 25.0, 18.1, 15.8], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Trøndelag", dager: [19.6, 24.8, 19.0, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [26.9, 21.0, 17.1, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [28.3, 17.1, 16.4, 16.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [20.0, 19.5, 15.2, 14.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [22.7, 18.3, 14.3, 13.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [22.8, 16.7, 14.7, 13.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.6, 13.4, 12.4, 12.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [19.0, 13.1, 12.4, 11.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.4, 11.3, 11.3, 9.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 101.3, iDag: 24.3, endringFraIGar: -2.9, plasseringEndring: 0 },
  { navn: "Troms", total: 88.9, iDag: 21.5, endringFraIGar: -2.9, plasseringEndring: 2 },
  { navn: "Nordland", total: 88.8, iDag: 19.4, endringFraIGar: -3.9, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 83.9, iDag: 15.8, endringFraIGar: -2.3, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 80.9, iDag: 17.5, endringFraIGar: -1.5, plasseringEndring: 1 },
  { navn: "Vestland", total: 80.6, iDag: 15.6, endringFraIGar: -1.5, plasseringEndring: -1 },
  { navn: "Oslo", total: 77.8, iDag: 16.0, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 69.0, iDag: 14.3, endringFraIGar: -0.9, plasseringEndring: 1 },
  { navn: "Rogaland", total: 68.8, iDag: 13.5, endringFraIGar: -0.8, plasseringEndring: -1 },
  { navn: "Agder", total: 67.6, iDag: 13.4, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 56.7, iDag: 12.3, endringFraIGar: -0.1, plasseringEndring: 1 },
  { navn: "Telemark", total: 56.2, iDag: 11.7, endringFraIGar: -0.7, plasseringEndring: -1 },
  { navn: "Østfold", total: 48.5, iDag: 9.5, endringFraIGar: -1.8, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 LANGFJORDBOTN", kommune: "ALTA", fylke: "Finnmark", ei: 64.4, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 54.9, vindkast: 19.9, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 54.7, vindkast: 0, nedbor: 0, temp: -33.4, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 49.9, vindkast: 22.3, nedbor: 0, temp: 5.2, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.9,
    dager: [68.2, 63.6, 66.7, 64.4, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.8,
    dager: [74.9, 35.1, 65.1, 54.7, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Man med 74.9 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.2,
    dager: [59.3, 46.2, 39.9, 49.3, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 101.3 poeng - 12.4 poeng foran Troms (88.9).",
