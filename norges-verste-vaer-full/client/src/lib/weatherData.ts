 ...
 *
 * Sist oppdatert: 18.08.2026 kl. 02:32
...
export const META = {
  ...
  datoOppdatert: "18.08.2026 kl. 02:32",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [21.1, 23.9], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [20.1, 23.6], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [22.4, 20.2], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Trøndelag", dager: [20.8, 17.0], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Oslo", dager: [21.7, 13.7], trend: "Markant bedring (-8.0) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [18.8, 15.0], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Vestland", dager: [17.3, 16.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 15.2], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Agder", dager: [14.6, 15.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.7, 13.6], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Østfold", dager: [14.4, 13.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 12.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 45.0, iDag: 23.9, endringFraIGar: 2.8, plasseringEndring: 2 },
  { navn: "Troms", total: 43.7, iDag: 23.6, endringFraIGar: 3.5, plasseringEndring: 3 },
  { navn: "Nordland", total: 42.6, iDag: 20.2, endringFraIGar: -2.2, plasseringEndring: -2 },
  { navn: "Trøndelag", total: 37.8, iDag: 17.0, endringFraIGar: -3.8, plasseringEndring: 0 },
  { navn: "Oslo", total: 35.4, iDag: 13.7, endringFraIGar: -8.0, plasseringEndring: -3 },
  { navn: "Møre og Romsdal", total: 33.8, iDag: 15.0, endringFraIGar: -3.8, plasseringEndring: 0 },
  { navn: "Vestland", total: 33.5, iDag: 16.2, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 32.5, iDag: 15.9, endringFraIGar: -0.7, plasseringEndring: 1 },
  { navn: "Rogaland", total: 32.4, iDag: 15.2, endringFraIGar: -2.0, plasseringEndring: -1 },
  { navn: "Agder", total: 29.8, iDag: 15.2, endringFraIGar: 0.6, plasseringEndring: 1 },
  { navn: "Buskerud", total: 29.3, iDag: 13.6, endringFraIGar: -2.1, plasseringEndring: -1 },
  { navn: "Østfold", total: 28.2, iDag: 13.8, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 26.0, iDag: 12.7, endringFraIGar: -0.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 83.1, vindkast: 0, nedbor: 0, temp: -46.8, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 60.0, vindkast: 0, nedbor: 0, temp: -40.0, farevarsel: "gul" },
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV560 KROSSLEITET", kommune: "ØYGARDEN", fylke: "Vestland", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 59.8, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -46.8,
    dager: [73.4, 83.1, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 78 EI per dag. Toppdag Tir med 83.1 EI. Bitende kulde ned til -46.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -40.0,
    dager: [48.5, 60.0, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Tir med 60.0 EI. Bitende kulde ned til -40.0 grader C."
  },
  {
    navn: "ANDA FYR II",
    kommune: "ØKSNES",
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.7, 49.5, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 49.5 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [43.6, 50.2, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Tir med 50.2 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.6,
    dager: [31.7, 59.6, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 46 EI per dag. Toppdag Tir med 59.6 EI. Bitende kulde ned til -39.6 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 45.0 poeng, foran Troms (43.7).",
