 ...
 *
 * Sist oppdatert: 09.04.2026 kl. 23:38
...
export const META = {
  ...
  datoOppdatert: "09.04.2026 kl. 23:38",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1], trend: "Markant bedring (-5.3) - lavtrykket har passert" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1], trend: "Markant bedring (-6.7) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5], trend: "Noe bedring (-4.7) - roligere forhold" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 131.9, iDag: 34.1, endringFraIGar: -5.3, plasseringEndring: 0 },
  { navn: "Troms", total: 107.0, iDag: 25.1, endringFraIGar: -6.7, plasseringEndring: 2 },
  { navn: "Innlandet", total: 106.2, iDag: 24.1, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Nordland", total: 104.5, iDag: 25.5, endringFraIGar: -4.7, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 103.3, iDag: 21.0, endringFraIGar: -1.7, plasseringEndring: -3 },
  { navn: "Vestland", total: 103.1, iDag: 24.9, endringFraIGar: 1.3, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 99.5, iDag: 20.9, endringFraIGar: -0.4, plasseringEndring: -1 },
  { navn: "Agder", total: 96.9, iDag: 22.9, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 92.3, iDag: 23.5, endringFraIGar: 2.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 81.9, iDag: 18.7, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Telemark", total: 81.4, iDag: 19.3, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 80.4, iDag: 18.8, endringFraIGar: -0.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E134 MIDTLÆGER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 92.4, vindkast: 0, nedbor: 73.4, temp: 0.0, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 82.8, vindkast: 37.7, nedbor: 0, temp: 0.2, farevarsel: "oransje" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 72.8, vindkast: 22.3, nedbor: 1.3, temp: -0.5, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 66.7, vindkast: 31.8, nedbor: 0, temp: -3.3, farevarsel: "oransje" },
  { navn: "KLEVAVATNET", kommune: "AURLAND", fylke: "Vestland", ei: 66.3, vindkast: 23.2, nedbor: 1.8, temp: 1.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 141.9,
    tempMin: -2.7,
    dager: [77.7, 25.9, 44.8, 92.4, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 141.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.8,
    dager: [80.1, 39.5, 44.2, 66.7, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Man med 80.1 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -5.8 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 2.4,
    tempMin: -5.5,
    dager: [63.5, 42.4, 48.3, 72.8, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Tor med 72.8 EI. Kraftige vindkast opp til 29.9 m/s. Bitende kulde ned til -5.5 grader C."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 131.9 poeng - 24.9 poeng foran Troms (107.0).",
