 ...
 *
 * Sist oppdatert: 26.07.2026 kl. 10:04
...
export const META = {
  ...
  datoOppdatert: "26.07.2026 kl. 10:04",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [19.7, 28.1, 23.5, 21.2, 26.1, 19.9, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [20.9, 22.8, 21.6, 21.8, 22.5, 18.3, 17.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [14.4, 17.0, 19.9, 17.7, 21.7, 21.0, 24.9], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [17.8, 16.2, 16.4, 16.6, 16.3, 29.0, 18.0], trend: "Markant bedring (-11.0) - lavtrykket har passert" },
  { navn: "Troms", dager: [17.8, 19.5, 20.3, 18.6, 18.6, 15.4, 16.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [12.2, 13.3, 16.0, 13.8, 19.7, 25.5, 24.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [14.1, 17.9, 20.1, 17.0, 19.4, 17.3, 18.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [12.9, 13.8, 18.1, 13.9, 17.1, 21.8, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [12.1, 12.3, 11.5, 12.7, 14.6, 19.3, 21.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [12.7, 11.6, 15.3, 13.8, 13.7, 17.8, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.1, 11.2, 11.3, 11.1, 11.9, 18.1, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [12.0, 11.0, 10.9, 11.8, 12.3, 18.3, 16.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [13.0, 11.2, 12.7, 9.7, 10.1, 13.0, 16.4], trend: "Noe forverring (+3.4) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 157.7, iDag: 19.2, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Finnmark", total: 145.8, iDag: 17.9, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 136.6, iDag: 24.9, endringFraIGar: 3.9, plasseringEndring: 1 },
  { navn: "Oslo", total: 130.3, iDag: 18.0, endringFraIGar: -11.0, plasseringEndring: -1 },
  { navn: "Troms", total: 127.1, iDag: 16.9, endringFraIGar: 1.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 125.1, iDag: 24.6, endringFraIGar: -0.9, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 124.2, iDag: 18.4, endringFraIGar: 1.1, plasseringEndring: -1 },
  { navn: "Rogaland", total: 119.2, iDag: 21.6, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Agder", total: 103.7, iDag: 21.2, endringFraIGar: 1.9, plasseringEndring: 1 },
  { navn: "Innlandet", total: 103.7, iDag: 18.8, endringFraIGar: 1.0, plasseringEndring: -1 },
  { navn: "Telemark", total: 94.0, iDag: 17.3, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 92.8, iDag: 16.5, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Østfold", total: 86.1, iDag: 16.4, endringFraIGar: 3.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 78.3, vindkast: 0, nedbor: 1.1, temp: -39.8, farevarsel: "oransje" },
  { navn: "BREKKE I SOGN", kommune: "GULEN", fylke: "Vestland", ei: 69.4, vindkast: 0, nedbor: 68.8, temp: 0, farevarsel: "oransje" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 61.5, vindkast: 13.6, nedbor: 15.4, temp: 0, farevarsel: "oransje" },
  { navn: "EIKEMO", kommune: "ETNE", fylke: "Vestland", ei: 57.0, vindkast: 0, nedbor: 44.0, temp: 0, farevarsel: "gul" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 56.9, vindkast: 27.5, nedbor: 0, temp: 11.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 10.9,
    dager: [32.1, 37.9, 33.3, 36.3, 55.6, 58.3, 56.9],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [32.1, 35.1, 36.6, 36.2, 51.5, 57.4, 54.1],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 157.7 poeng - 11.9 poeng foran Finnmark (145.8).",
