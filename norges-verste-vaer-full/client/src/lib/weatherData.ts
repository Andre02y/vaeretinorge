 ...
 *
 * Sist oppdatert: 15.08.2026 kl. 20:12
...
export const META = {
  ...
  datoOppdatert: "15.08.2026 kl. 20:12",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Nordland", dager: [21.5, 24.6, 23.3, 21.7, 21.0, 19.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [25.0, 25.0, 18.1, 16.3, 18.5, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [28.3, 17.1, 16.4, 15.9, 22.3, 21.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [21.1, 21.9, 24.4, 19.0, 16.6, 16.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [26.9, 21.0, 17.1, 16.2, 18.3, 17.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.6, 24.8, 19.0, 18.2, 16.5, 18.7], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [22.7, 18.3, 14.3, 12.9, 14.5, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [22.8, 16.7, 14.7, 12.8, 13.1, 16.7], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [20.0, 19.5, 15.2, 13.2, 14.0, 14.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [19.0, 13.1, 12.4, 11.5, 12.9, 15.1], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [18.6, 13.4, 12.4, 11.2, 12.4, 14.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.4, 11.3, 11.3, 10.9, 9.4, 8.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Nordland", total: 131.5, iDag: 19.4, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 122.7, iDag: 19.8, endringFraIGar: 1.3, plasseringEndring: 1 },
  { navn: "Oslo", total: 121.0, iDag: 21.0, endringFraIGar: -1.3, plasseringEndring: 1 },
  { navn: "Troms", total: 119.2, iDag: 16.2, endringFraIGar: -0.4, plasseringEndring: -2 },
  { navn: "Vestland", total: 116.9, iDag: 17.4, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 116.8, iDag: 18.7, endringFraIGar: 2.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 98.3, iDag: 15.6, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Agder", total: 96.8, iDag: 16.7, endringFraIGar: 3.6, plasseringEndring: 1 },
  { navn: "Innlandet", total: 96.0, iDag: 14.1, endringFraIGar: 0.1, plasseringEndring: -1 },
  { navn: "Telemark", total: 84.0, iDag: 15.1, endringFraIGar: 2.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 82.2, iDag: 14.2, endringFraIGar: 1.8, plasseringEndring: 0 },
  { navn: "Østfold", total: 68.0, iDag: 8.7, endringFraIGar: -0.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV848 FORNES", kommune: "NARVIK", fylke: "Nordland", ei: 65.0, vindkast: 0, nedbor: 1.2, temp: -39.3, farevarsel: "oransje" },
  { navn: "E6 LANGFJORDBOTN", kommune: "ALTA", fylke: "Finnmark", ei: 62.2, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "oransje" },
  { navn: "BIRTAVARRE - HOLMEN", kommune: "KÅFJORD", fylke: "Troms", ei: 60.0, vindkast: 89.9, nedbor: 0, temp: 12.3, farevarsel: "gul" },
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 55.3, vindkast: 0, nedbor: 0, temp: -30.2, farevarsel: "gul" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 53.8, vindkast: 0, nedbor: 0, temp: -33.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 3.0,
    tempMin: -39.9,
    dager: [60.1, 59.4, 59.9, 44.9, 60.3, 53.8, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Fre med 60.3 EI. Bitende kulde ned til -39.9 grader C."
  },
  {
    ...
    precipTotal: 0.4,
    tempMin: -39.8,
    dager: [74.9, 35.1, 65.1, 61.0, 57.7, 21.9, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 53 EI per dag. Toppdag Man med 74.9 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
    ...
    precipTotal: 29.7,
    tempMin: 0,
    dager: [59.2, 47.8, 24.9, 40.6, 50.1, 46.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.0, 38.1, 44.5, 53.8, 46.0, 37.7, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 138.0 poeng - 6.5 poeng foran Nordland (131.5).",
