 ...
 *
 * Sist oppdatert: 10.04.2026 kl. 03:16
...
export const META = {
  ...
  datoOppdatert: "10.04.2026 kl. 03:16",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 29.3], trend: "Noe bedring (-4.8) - roligere forhold" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 27.2], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 26.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 22.1], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 22.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 21.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 26.5], trend: "Noe forverring (+3.0) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.8], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 20.8], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 22.1], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 161.2, iDag: 29.3, endringFraIGar: -4.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 133.4, iDag: 27.2, endringFraIGar: 3.1, plasseringEndring: 1 },
  { navn: "Vestland", total: 129.4, iDag: 26.3, endringFraIGar: 1.4, plasseringEndring: 3 },
  { navn: "Nordland", total: 129.2, iDag: 24.7, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Troms", total: 129.1, iDag: 22.1, endringFraIGar: -3.0, plasseringEndring: -3 },
  { navn: "Trøndelag", total: 126.1, iDag: 22.8, endringFraIGar: 1.8, plasseringEndring: -1 },
  { navn: "Agder", total: 121.8, iDag: 24.9, endringFraIGar: 2.0, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 121.4, iDag: 21.9, endringFraIGar: 1.0, plasseringEndring: -1 },
  { navn: "Rogaland", total: 118.8, iDag: 26.5, endringFraIGar: 3.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 103.2, iDag: 21.8, endringFraIGar: 2.5, plasseringEndring: 1 },
  { navn: "Oslo", total: 102.7, iDag: 20.8, endringFraIGar: 2.1, plasseringEndring: -1 },
  { navn: "Buskerud", total: 102.5, iDag: 22.1, endringFraIGar: 3.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 113.4, vindkast: 48.4, nedbor: 0, temp: -4.2, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 93.8, vindkast: 38.5, nedbor: 0, temp: -4.5, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 83.2, vindkast: 28.7, nedbor: 0, temp: -6.1, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 82.1, vindkast: 34.3, nedbor: 0, temp: -2.8, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 81.5, vindkast: 26.4, nedbor: 0, temp: -4.8, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 113.4, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 68 EI per dag. Toppdag Fre med 113.4 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.8,
    dager: [80.1, 39.5, 44.2, 66.7, 93.8, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Fre med 93.8 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -5.8 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 141.9,
    tempMin: -2.7,
    dager: [77.7, 25.9, 44.8, 92.4, 57.4, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 74.7, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Man med 81.3 EI. Kraftige vindkast opp til 33.8 m/s. Bitende kulde ned til -7.5 grader C."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -10.0,
    dager: [80.7, 50.0, 35.1, 48.7, 83.2, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Fre med 83.2 EI. Kraftige vindkast opp til 34.4 m/s. Bitende kulde ned til -10.0 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 161.2 poeng - 27.8 poeng foran Innlandet (133.4).",
