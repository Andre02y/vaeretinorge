 ...
 *
 * Sist oppdatert: 27.07.2026 kl. 08:16
...
export const META = {
  ...
  datoOppdatert: "27.07.2026 kl. 08:16",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Møre og Romsdal", dager: [23.5], trend: "Kraftig forverring (+23.5) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [21.5], trend: "Kraftig forverring (+21.5) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [19.8], trend: "Kraftig forverring (+19.8) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [19.4], trend: "Kraftig forverring (+19.4) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [18.9], trend: "Kraftig forverring (+18.9) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [18.2], trend: "Kraftig forverring (+18.2) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [18.0], trend: "Kraftig forverring (+18.0) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [17.5], trend: "Kraftig forverring (+17.5) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [16.7], trend: "Kraftig forverring (+16.7) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [16.3], trend: "Kraftig forverring (+16.3) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Møre og Romsdal", total: 23.5, iDag: 23.5, endringFraIGar: 23.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 21.5, iDag: 21.5, endringFraIGar: 21.5, plasseringEndring: 0 },
  { navn: "Rogaland", total: 19.8, iDag: 19.8, endringFraIGar: 19.8, plasseringEndring: 0 },
  { navn: "Finnmark", total: 19.4, iDag: 19.4, endringFraIGar: 19.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 18.9, iDag: 18.9, endringFraIGar: 18.9, plasseringEndring: 0 },
  { navn: "Agder", total: 18.2, iDag: 18.2, endringFraIGar: 18.2, plasseringEndring: 0 },
  { navn: "Oslo", total: 18.0, iDag: 18.0, endringFraIGar: 18.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 17.5, iDag: 17.5, endringFraIGar: 17.5, plasseringEndring: 0 },
  { navn: "Innlandet", total: 16.7, iDag: 16.7, endringFraIGar: 16.7, plasseringEndring: 0 },
  { navn: "Troms", total: 16.3, iDag: 16.3, endringFraIGar: 16.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 75.2, vindkast: 0, nedbor: 3.7, temp: -36.0, farevarsel: "oransje" },
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 61.0, vindkast: 0, nedbor: 0, temp: -31.6, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV65 BYE", kommune: "ORKLAND", fylke: "Trøndelag", ei: 57.9, vindkast: 0, nedbor: 0, temp: -35.6, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 54.1, vindkast: 12.1, nedbor: 8.5, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3.7,
    tempMin: -36.0,
    dager: [75.2, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 75 EI per dag. Toppdag Man med 75.2 EI. Bitende kulde ned til -36.0 grader C."
  },
  {
    navn: "RV13 VIKAFJELL",
    kommune: "VIK",
    ...
    precipTotal: 0,
    tempMin: -31.6,
    dager: [61.0, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Man med 61.0 EI. Bitende kulde ned til -31.6 grader C."
  },
  {
  ...
  },
  {
    ...
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Man med 57.9 EI. Bitende kulde ned til -35.6 grader C."
  },
  {
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Møre og Romsdal leder sammenlagt med 23.5 poeng - 2.0 poeng foran Vestland (21.5).",
