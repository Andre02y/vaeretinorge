 ...
 *
 * Sist oppdatert: 21.06.2026 kl. 18:25
 * Periode sammenlagt: 15.06 - 21.06.2026 (7 dager)
...
export const META = {
  ...
  dagLabel: "Søndag 21.06.2026",
  sammenlagtLabel: "15.06 - 21.06.2026 (7 dager)",
  datoOppdatert: "21.06.2026 kl. 18:25",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [32.1, 22.7, 27.4, 28.7, 20.0, 20.4, 24.6], trend: "Noe forverring (+4.2) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [26.6, 16.8, 23.6, 23.3, 26.6, 17.3, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [16.7, 17.4, 18.9, 18.9, 18.3, 24.0, 26.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [20.1, 17.7, 15.6, 19.0, 18.0, 22.1, 25.6], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [20.5, 18.2, 20.6, 20.5, 16.8, 19.3, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [15.5, 14.3, 14.1, 18.2, 18.9, 22.7, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.2, 17.7, 15.1, 15.8, 15.2, 14.8, 21.9], trend: "Kraftig forverring (+7.1) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [16.0, 16.1, 14.7, 16.2, 17.1, 15.4, 15.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [18.9, 16.0, 13.9, 13.3, 14.6, 15.1, 17.1], trend: "Noe forverring (+2.0) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [15.4, 14.2, 15.9, 17.2, 12.6, 11.9, 14.8], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [15.0, 12.5, 14.9, 14.7, 15.5, 14.0, 14.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.7, 12.8, 15.6, 17.0, 15.7, 11.7, 12.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [18.0, 11.9, 13.5, 15.5, 13.7, 12.1, 11.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 175.9, iDag: 24.6, endringFraIGar: 4.2, plasseringEndring: 0 },
  { navn: "Oslo", total: 151.9, iDag: 17.7, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 140.2, iDag: 26.0, endringFraIGar: 2.0, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 138.1, iDag: 25.6, endringFraIGar: 3.5, plasseringEndring: 1 },
  { navn: "Troms", total: 135.1, iDag: 19.2, endringFraIGar: -0.1, plasseringEndring: -2 },
  { navn: "Vestland", total: 124.5, iDag: 20.8, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 119.7, iDag: 21.9, endringFraIGar: 7.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 111.2, iDag: 15.7, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 108.9, iDag: 17.1, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Agder", total: 102.0, iDag: 14.8, endringFraIGar: 2.9, plasseringEndring: 1 },
  { navn: "Buskerud", total: 101.5, iDag: 14.9, endringFraIGar: 0.9, plasseringEndring: 1 },
  { navn: "Telemark", total: 100.8, iDag: 12.3, endringFraIGar: 0.6, plasseringEndring: -2 },
  { navn: "Østfold", total: 96.0, iDag: 11.3, endringFraIGar: -0.8, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER SØNDAG 21.06.2026 ----

export const STASJONER_PERIODE = [
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 63.8, vindkast: 32.4, nedbor: 0, temp: 9.5, farevarsel: "oransje" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 58.8, vindkast: 25.8, nedbor: 0, temp: 11.7, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 57.0, vindkast: 16.6, nedbor: 4.9, temp: 0, farevarsel: "gul" },
  { navn: "SOGNDAL LH - STOREHAUGFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 56.9, vindkast: 24.7, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "GJEMNES - REINSFJELLET", kommune: "GJEMNES", fylke: "Møre og Romsdal", ei: 55.5, vindkast: 29.8, nedbor: 0, temp: 6.3, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 253.0,
    tempMin: -0.9,
    dager: [50.4, 28.1, 72.0, 85.6, 49.5, 51.4, 50.7],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 55 EI per dag. Toppdag Tor med 85.6 EI. Mye nedbor med totalt 253.0 mm."
  },
  {
    navn: "KRÅKENES",
    kommune: "KINN",
    ...
    precipTotal: 0,
    tempMin: 9.9,
    dager: [47.9, 43.1, 25.1, 42.3, 42.4, 39.9, 58.8],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 43 EI per dag. Toppdag Søn med 58.8 EI. Kraftige vindkast opp til 28.9 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [46.0, 31.8, 49.6, 49.9, 34.6, 41.9, 45.3],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 43 EI per dag. Toppdag Tor med 49.9 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [38.5, 33.6, 35.1, 38.6, 41.1, 52.5, 56.9],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 42 EI per dag. Toppdag Søn med 56.9 EI."
  },
  {
    ...
    precipTotal: 30.2,
    tempMin: 0,
    dager: [30.2, 30.2, 26.7, 48.2, 45.4, 58.3, 57.0],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 42 EI per dag. Toppdag Lør med 58.3 EI. Mye nedbor med totalt 30.2 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 175.9 poeng - 24.0 poeng foran Oslo (151.9).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-06-15",
  tilDato: "2026-06-21",
  periode: "15.06 - 21.06.2026 (7 dager)",
  dagerRegistrert: 7,
