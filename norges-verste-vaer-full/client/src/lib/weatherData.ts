 ...
 *
 * Sist oppdatert: 29.03.2026 kl. 07:05
...
export const META = {
  ...
  datoOppdatert: "29.03.2026 kl. 07:05",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [46.8, 39.3, 33.4, 31.6, 34.1, 31.2, 30.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [37.0, 32.9, 29.8, 35.6, 38.4, 36.3, 31.8], trend: "Noe bedring (-4.5) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [35.7, 35.1, 32.8, 38.6, 29.1, 28.7, 28.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [36.5, 33.8, 29.0, 30.1, 36.3, 31.2, 28.1], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Vestland", dager: [32.1, 34.6, 32.3, 32.1, 29.5, 31.5, 24.5], trend: "Markant bedring (-7.0) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [40.7, 31.0, 22.9, 33.1, 28.8, 23.7, 28.3], trend: "Noe forverring (+4.6) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [27.7, 29.7, 26.2, 30.6, 28.8, 28.7, 27.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [25.2, 30.5, 31.5, 26.7, 29.8, 30.3, 25.0], trend: "Markant bedring (-5.3) - lavtrykket har passert" },
  { navn: "Rogaland", dager: [24.8, 27.6, 30.0, 31.7, 28.0, 27.1, 22.6], trend: "Noe bedring (-4.5) - roligere forhold" },
  { navn: "Oslo", dager: [20.5, 27.4, 35.8, 21.2, 30.9, 33.6, 21.1], trend: "Markant bedring (-12.5) - lavtrykket har passert" },
  { navn: "Østfold", dager: [21.4, 27.1, 30.4, 24.3, 23.8, 24.8, 21.6], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Telemark", dager: [22.2, 25.8, 28.0, 21.4, 25.0, 26.6, 23.1], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Buskerud", dager: [21.9, 23.4, 26.0, 21.2, 26.3, 25.7, 23.4], trend: "Noe bedring (-2.3) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 246.9, iDag: 30.5, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Finnmark", total: 241.8, iDag: 31.8, endringFraIGar: -4.5, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 228.7, iDag: 28.7, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Troms", total: 225.0, iDag: 28.1, endringFraIGar: -3.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 216.6, iDag: 24.5, endringFraIGar: -7.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 208.5, iDag: 28.3, endringFraIGar: 4.6, plasseringEndring: 0 },
  { navn: "Innlandet", total: 199.5, iDag: 27.8, endringFraIGar: -0.9, plasseringEndring: 1 },
  { navn: "Agder", total: 199.0, iDag: 25.0, endringFraIGar: -5.3, plasseringEndring: -1 },
  { navn: "Rogaland", total: 191.8, iDag: 22.6, endringFraIGar: -4.5, plasseringEndring: 1 },
  { navn: "Oslo", total: 190.5, iDag: 21.1, endringFraIGar: -12.5, plasseringEndring: -1 },
  { navn: "Østfold", total: 173.4, iDag: 21.6, endringFraIGar: -3.2, plasseringEndring: 0 },
  { navn: "Telemark", total: 172.1, iDag: 23.1, endringFraIGar: -3.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 167.9, iDag: 23.4, endringFraIGar: -2.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 62.1, vindkast: 27.9, nedbor: 0, temp: -9.7, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 60.8, vindkast: 23.2, nedbor: 0, temp: -3.2, farevarsel: "oransje" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 59.8, vindkast: 18.2, nedbor: 0, temp: -3.5, farevarsel: "gul" },
  { navn: "SKLINNA FYR", kommune: "LEKA", fylke: "Trøndelag", ei: 58.3, vindkast: 26.7, nedbor: 0, temp: 5.5, farevarsel: "gul" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 57.7, vindkast: 17.2, nedbor: 0, temp: -7.9, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1020.7,
    tempMin: -5.7,
    dager: [543.8, 35.4, 26.4, 32.9, 32.6, 31.0, 31.4],
    beskrivelse: "Ekstremt vaer hele uken med snitt 105 EI per dag. Toppdag Man med 543.8 EI. Mye nedbor med totalt 1020.7 mm. Bitende kulde ned til -5.7 grader C."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -9.9,
    dager: [72.9, 81.5, 62.8, 67.2, 55.9, 56.1, 62.1],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -4.3,
    dager: [69.7, 72.3, 62.7, 61.0, 68.9, 59.7, 59.8],
    beskrivelse: "Ekstremt vaer hele uken med snitt 65 EI per dag. Toppdag Tir med 72.3 EI. Kraftige vindkast opp til 38.0 m/s."
  },
  {
    navn: "KRÅKENES",
    kommune: "KINN",
    ...
    precipTotal: 0,
    tempMin: 4.2,
    dager: [66.0, 86.9, 62.5, 46.8, 63.7, 60.5, 51.4],
  ...
  },
  {
    ...
    precipTotal: 104.1,
    tempMin: -2.1,
    dager: [62.8, 61.6, 76.7, 76.3, 45.2, 62.4, 36.3],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 246.9 poeng - 5.1 poeng foran Finnmark (241.8).",
