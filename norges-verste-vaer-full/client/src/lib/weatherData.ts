 ...
 *
 * Sist oppdatert: 23.08.2026 kl. 14:16
 * Periode sammenlagt: 17.08 - 23.08.2026 (7 dager)
...
export const META = {
  ...
  dagLabel: "Søndag 23.08.2026",
  sammenlagtLabel: "17.08 - 23.08.2026 (7 dager)",
  datoOppdatert: "23.08.2026 kl. 14:16",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [21.7, 25.3, 23.4, 28.9, 27.3, 29.8, 27.7], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Finnmark", dager: [21.1, 23.7, 22.1, 20.0, 16.7, 17.0, 17.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [18.8, 19.1, 16.6, 20.4, 25.1, 19.3, 17.3], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Nordland", dager: [22.4, 22.4, 19.2, 17.4, 17.2, 16.1, 16.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [20.8, 20.0, 17.6, 21.3, 16.7, 16.7, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 16.1, 15.8, 16.3, 18.4, 21.0, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.1, 23.7, 17.7, 14.3, 13.0, 14.7, 15.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.7, 16.4, 14.7, 18.4, 16.5, 17.8, 17.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [17.3, 14.8, 14.0, 14.6, 20.0, 19.0, 16.0], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Agder", dager: [14.6, 15.7, 16.1, 16.2, 15.3, 14.8, 15.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 14.4, 12.9, 12.5, 16.0, 17.9, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 13.9, 13.7, 14.1, 14.9, 13.7, 16.7], trend: "Noe forverring (+3.0) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [14.4, 13.6, 11.3, 14.0, 12.3, 12.5, 12.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 184.1, iDag: 27.7, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 138.5, iDag: 17.9, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 136.6, iDag: 17.3, endringFraIGar: -2.0, plasseringEndring: 0 },
  { navn: "Nordland", total: 130.8, iDag: 16.1, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 130.6, iDag: 17.5, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 123.5, iDag: 19.3, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Troms", total: 118.9, iDag: 15.4, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 116.9, iDag: 17.4, endringFraIGar: -0.4, plasseringEndring: 1 },
  { navn: "Vestland", total: 115.7, iDag: 16.0, endringFraIGar: -3.0, plasseringEndring: -1 },
  { navn: "Agder", total: 107.7, iDag: 15.0, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 107.2, iDag: 16.3, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 100.3, iDag: 16.7, endringFraIGar: 3.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 90.2, iDag: 12.1, endringFraIGar: -0.4, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER SØNDAG 23.08.2026 ----

export const STASJONER_PERIODE = [
  { navn: "RV3 EBRU", kommune: "LØTEN", fylke: "Innlandet", ei: 87.7, vindkast: 0, nedbor: 162.5, temp: 13.5, farevarsel: "oransje" },
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 69.4, vindkast: 0, nedbor: 0, temp: -45.2, farevarsel: "oransje" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 62.2, vindkast: 0, nedbor: 0, temp: -35.4, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 58.3, vindkast: 0, nedbor: 0, temp: -30.2, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -39.9,
    dager: [48.5, 58.4, 59.4, 59.4, 58.9, 59.9, 59.9],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 58 EI per dag. Toppdag Lør med 59.9 EI. Bitende kulde ned til -39.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -45.9,
    dager: [73.4, 75.4, 16.3, 15.8, 28.1, 67.1, 69.4],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 49 EI per dag. Toppdag Tir med 75.4 EI. Bitende kulde ned til -45.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.2,
    dager: [24.9, 63.7, 65.1, 67.0, 16.7, 22.8, 62.2],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 46 EI per dag. Toppdag Tor med 67.0 EI. Bitende kulde ned til -39.2 grader C."
  },
  {
    navn: "ERESFJORD",
    kommune: "MOLDE",
    ...
    precipTotal: 75.0,
    tempMin: 0,
    dager: [37.5, 38.5, 36.0, 35.5, 54.0, 42.0, 39.0],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 40 EI per dag. Toppdag Fre med 54.0 EI. Mye nedbor med totalt 75.0 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 43.9, 37.6, 38.4, 45.8, 39.4, 35.4],
    beskrivelse: "Varierende forhold hele uken med snitt 39 EI per dag. Toppdag Fre med 45.8 EI."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 184.1 poeng - 45.6 poeng foran Finnmark (138.5).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-08-17",
  tilDato: "2026-08-23",
  periode: "17.08 - 23.08.2026 (7 dager)",
  dagerRegistrert: 7,
  versteFylke: "Oslo",
  versteFylkeScore: 184.1,
};
