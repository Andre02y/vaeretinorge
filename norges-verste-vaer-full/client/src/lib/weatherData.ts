 ...
 *
 * Sist oppdatert: 14.07.2026 kl. 12:28
...
export const META = {
  ...
  datoOppdatert: "14.07.2026 kl. 12:28",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [19.2, 25.9], trend: "Kraftig forverring (+6.7) - okt vind og/eller nedbor" },
  ...
  { navn: "Møre og Romsdal", dager: [13.5, 12.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [12.9, 13.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [10.3, 10.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [8.7, 9.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [9.2, 9.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [8.9, 9.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [9.0, 8.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [7.1, 8.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [7.5, 7.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 45.1, iDag: 25.9, endringFraIGar: 6.7, plasseringEndring: 2 },
  { navn: "Nordland", total: 44.6, iDag: 23.8, endringFraIGar: 3.0, plasseringEndring: -1 },
  { navn: "Troms", total: 44.0, iDag: 23.4, endringFraIGar: 2.8, plasseringEndring: -1 },
  { navn: "Oslo", total: 30.3, iDag: 15.0, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 26.4, iDag: 12.9, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 26.3, iDag: 13.4, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 20.7, iDag: 10.4, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 18.2, iDag: 9.5, endringFraIGar: 0.8, plasseringEndring: 3 },
  { navn: "Innlandet", total: 18.2, iDag: 9.0, endringFraIGar: -0.2, plasseringEndring: -1 },
  { navn: "Buskerud", total: 18.0, iDag: 9.1, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Telemark", total: 17.2, iDag: 8.2, endringFraIGar: -0.8, plasseringEndring: -2 },
  { navn: "Østfold", total: 15.3, iDag: 8.2, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Agder", total: 14.6, iDag: 7.1, endringFraIGar: -0.4, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 66.2, vindkast: 29.2, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 62.7, vindkast: 30.1, nedbor: 0, temp: 9.4, farevarsel: "oransje" },
  { navn: "HAMMERFEST LH - BOAZOVARRI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 61.3, vindkast: 22.0, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 57.6, vindkast: 24.1, nedbor: 0, temp: 5.9, farevarsel: "gul" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 56.1, vindkast: 25.6, nedbor: 0, temp: 9.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [58.2, 66.2, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Tir med 66.2 EI. Kraftige vindkast opp til 29.2 m/s."
  },
  {
    navn: "E10 BJØRNFJELL",
    kommune: "NARVIK",
    ...
    precipTotal: 1.2,
    tempMin: -31.5,
    dager: [60.8, 54.7, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Man med 60.8 EI. Bitende kulde ned til -31.5 grader C."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
    ...
    precipTotal: 0,
    tempMin: 4.7,
    dager: [54.0, 57.6, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Tir med 57.6 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 8.8,
    dager: [48.3, 62.7, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Tir med 62.7 EI. Kraftige vindkast opp til 30.1 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [50.8, 54.8, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 53 EI per dag. Toppdag Tir med 54.8 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 45.1 poeng, foran Nordland (44.6).",
