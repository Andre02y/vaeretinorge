 ...
 *
 * Sist oppdatert: 01.08.2026 kl. 17:51
...
export const META = {
  ...
  datoOppdatert: "01.08.2026 kl. 17:51",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Nordland", dager: [18.6, 18.4, 23.0, 20.2, 23.2, 19.9], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Oslo", dager: [19.2, 17.1, 15.9, 25.2, 27.5, 18.0], trend: "Markant bedring (-9.5) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [19.4, 21.5, 14.8, 16.4, 20.4, 17.7], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Finnmark", dager: [17.7, 14.2, 17.4, 17.8, 15.5, 23.7], trend: "Kraftig forverring (+8.2) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [15.0, 16.0, 21.4, 16.2, 16.5, 18.9], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [21.9, 15.9, 16.0, 15.6, 16.8, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [19.5, 18.2, 16.7, 13.8, 16.5, 16.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.9, 15.5, 13.7, 16.5, 17.5, 15.4], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Buskerud", dager: [15.4, 12.3, 11.8, 15.6, 16.5, 13.9], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Telemark", dager: [15.4, 13.1, 13.5, 14.5, 14.2, 13.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [12.3, 11.9, 12.4, 9.5, 14.8, 12.4], trend: "Noe bedring (-2.4) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Nordland", total: 123.3, iDag: 19.9, endringFraIGar: -3.3, plasseringEndring: 1 },
  { navn: "Oslo", total: 122.9, iDag: 18.0, endringFraIGar: -9.5, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 110.2, iDag: 17.7, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Finnmark", total: 106.3, iDag: 23.7, endringFraIGar: 8.2, plasseringEndring: 3 },
  { navn: "Troms", total: 104.0, iDag: 18.9, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 102.8, iDag: 16.6, endringFraIGar: -0.2, plasseringEndring: -2 },
  { navn: "Agder", total: 101.1, iDag: 16.4, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Innlandet", total: 95.5, iDag: 15.4, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 85.5, iDag: 13.9, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 84.5, iDag: 13.8, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 73.3, iDag: 12.4, endringFraIGar: -2.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 60.8, vindkast: 0, nedbor: 4.3, temp: -38.7, farevarsel: "oransje" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 52.7, vindkast: 25.0, nedbor: 0, temp: 11.8, farevarsel: "gul" },
  { navn: "BOTNEN I FØRDE", kommune: "SUNNFJORD", fylke: "Vestland", ei: 51.5, vindkast: 0, nedbor: 33.0, temp: 0, farevarsel: "gul" },
  { navn: "HAMMERFEST LH - BOAZOVARRI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 50.4, vindkast: 18.4, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 50.0, vindkast: 11.4, nedbor: 7.6, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 5.0,
    tempMin: -39.4,
    dager: [58.9, 58.8, 51.2, 56.3, 59.4, 60.8, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Lør med 60.8 EI. Bitende kulde ned til -39.4 grader C."
  },
  {
    ...
    precipTotal: 50.3,
    tempMin: 0,
    dager: [57.3, 51.8, 45.7, 56.9, 55.7, 50.0, 0],
