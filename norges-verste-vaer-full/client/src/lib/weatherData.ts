 ...
 *
 * Sist oppdatert: 23.04.2026 kl. 09:20
...
export const META = {
  ...
  datoOppdatert: "23.04.2026 kl. 09:20",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Troms", dager: [23.4, 31.2, 30.4, 28.0], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 25.4], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 25.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 22.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [25.2, 18.5, 18.1, 18.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 23.8], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [19.7, 18.2, 19.3, 20.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [19.0, 17.6, 19.3, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [25.0, 17.7, 16.4, 16.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 16.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Troms", total: 113.0, iDag: 28.0, endringFraIGar: -2.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 102.5, iDag: 25.4, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 87.7, iDag: 25.8, endringFraIGar: 0.8, plasseringEndring: 2 },
  { navn: "Innlandet", total: 86.2, iDag: 22.6, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 85.4, iDag: 17.7, endringFraIGar: -0.4, plasseringEndring: -2 },
  { navn: "Agder", total: 80.2, iDag: 18.4, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 79.7, iDag: 23.8, endringFraIGar: 2.8, plasseringEndring: 3 },
  { navn: "Vestland", total: 77.3, iDag: 20.1, endringFraIGar: 0.8, plasseringEndring: 1 },
  { navn: "Rogaland", total: 76.4, iDag: 20.5, endringFraIGar: 1.2, plasseringEndring: 2 },
  { navn: "Buskerud", total: 75.4, iDag: 17.7, endringFraIGar: 1.1, plasseringEndring: -2 },
  { navn: "Telemark", total: 75.1, iDag: 16.0, endringFraIGar: -0.4, plasseringEndring: -4 },
  { navn: "Østfold", total: 71.6, iDag: 16.5, endringFraIGar: 1.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 72.1, vindkast: 0, nedbor: 17.2, temp: 1.5, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 67.7, vindkast: 26.3, nedbor: 0, temp: -1.3, farevarsel: "oransje" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 64.0, vindkast: 22.7, nedbor: 0, temp: -3.7, farevarsel: "oransje" },
  { navn: "MEHAMN LUFTHAVN", kommune: "GAMVIK", fylke: "Finnmark", ei: 62.5, vindkast: 17.6, nedbor: 0.3, temp: 1.6, farevarsel: "oransje" },
  { navn: "TRYSIL - NORDRE KANKEN", kommune: "TRYSIL", fylke: "Innlandet", ei: 60.6, vindkast: 28.2, nedbor: 0, temp: 1.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -1.3,
    dager: [54.3, 85.8, 56.7, 67.7, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Tir med 85.8 EI. Kraftige vindkast opp til 40.9 m/s."
  },
  {
    navn: "REINHAUGEN",
    kommune: "NESSEBY",
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [40.4, 63.8, 70.8, 64.0, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -4.0,
    dager: [48.2, 74.4, 56.5, 52.9, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Tir med 74.4 EI. Kraftige vindkast opp til 29.6 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.8,
    dager: [53.6, 65.4, 56.0, 56.8, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Tir med 65.4 EI. Kraftige vindkast opp til 28.3 m/s."
  },
  {
    navn: "E69 NORDKAPP",
    kommune: "NORDKAPP",
    ...
    precipTotal: 20.6,
    tempMin: -1.9,
    dager: [44.3, 59.5, 50.0, 72.1, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Tor med 72.1 EI. Mye nedbor med totalt 20.6 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 151.4 poeng - 38.4 poeng foran Troms (113.0).",
