 ...
 *
 * Sist oppdatert: 15.07.2026 kl. 09:47
...
export const META = {
  ...
  datoOppdatert: "15.07.2026 kl. 09:47",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [20.8, 24.0, 25.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [19.2, 26.2, 22.0], trend: "Noe bedring (-4.2) - roligere forhold" },
  { navn: "Troms", dager: [20.6, 21.9, 19.3], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Oslo", dager: [15.3, 14.9, 14.9], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Vestland", dager: [10.3, 9.7, 9.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [8.7, 8.9, 9.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [8.9, 7.8, 9.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [9.0, 7.8, 7.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [9.2, 7.7, 7.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [7.5, 7.3, 7.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [7.1, 6.7, 7.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 70.5, iDag: 25.7, endringFraIGar: 1.7, plasseringEndring: 1 },
  { navn: "Finnmark", total: 67.4, iDag: 22.0, endringFraIGar: -4.2, plasseringEndring: -1 },
  { navn: "Troms", total: 61.8, iDag: 19.3, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Oslo", total: 45.1, iDag: 14.9, endringFraIGar: 0.0, plasseringEndring: 0 },
  ...
  { navn: "Vestland", total: 29.8, iDag: 9.8, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 27.2, iDag: 9.6, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 25.8, iDag: 9.1, endringFraIGar: 1.3, plasseringEndring: 2 },
  { navn: "Telemark", total: 24.6, iDag: 7.8, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Innlandet", total: 24.6, iDag: 7.7, endringFraIGar: 0.0, plasseringEndring: -2 },
  { navn: "Agder", total: 22.6, iDag: 7.8, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 21.5, iDag: 7.7, endringFraIGar: 1.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SØRE ANGSTAURSUNDET", kommune: "TROMSØ", fylke: "Troms", ei: 66.7, vindkast: 0, nedbor: 0, temp: -36.6, farevarsel: "oransje" },
  { navn: "SANDHORNØYA - VÅTVIKFJELLET", kommune: "GILDESKÅL", fylke: "Nordland", ei: 63.0, vindkast: 28.3, nedbor: 0, temp: 7.4, farevarsel: "oransje" },
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 61.7, vindkast: 0, nedbor: 0, temp: -39.7, farevarsel: "oransje" },
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 58.4, vindkast: 23.2, nedbor: 0, temp: 0, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 11.9,
    tempMin: -31.5,
    dager: [60.8, 64.3, 33.3, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 53 EI per dag. Toppdag Tir med 64.3 EI. Bitende kulde ned til -31.5 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [42.7, 57.5, 46.4, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 57.5 EI. Kraftige vindkast opp til 27.0 m/s."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 4.1,
    dager: [54.0, 48.5, 43.0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 48 EI per dag. Toppdag Man med 54.0 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 70.5 poeng, foran Finnmark (67.4).",
