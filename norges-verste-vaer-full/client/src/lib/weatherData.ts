 ...
 *
 * Sist oppdatert: 24.06.2026 kl. 18:59
...
export const META = {
  ...
  datoOppdatert: "24.06.2026 kl. 18:59",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.0, 24.8, 20.9], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [22.9, 21.2, 23.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [20.3, 21.2, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [23.4, 18.0, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.5, 20.3, 17.3], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Vestland", dager: [18.0, 18.7, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [16.2, 16.1, 17.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [15.3, 14.5, 17.3], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [14.2, 13.4, 14.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [12.4, 12.0, 14.1], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [13.6, 12.6, 11.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [11.9, 12.3, 13.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [9.9, 11.9, 13.2], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 78.7, iDag: 20.9, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 67.1, iDag: 23.0, endringFraIGar: 1.8, plasseringEndring: 0 },
  { navn: "Finnmark", total: 62.3, iDag: 20.8, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 58.7, iDag: 17.3, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Troms", total: 58.1, iDag: 17.3, endringFraIGar: -3.0, plasseringEndring: 0 },
  { navn: "Vestland", total: 57.3, iDag: 20.6, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 49.9, iDag: 17.6, endringFraIGar: 1.5, plasseringEndring: 0 },
  { navn: "Innlandet", total: 47.1, iDag: 17.3, endringFraIGar: 2.8, plasseringEndring: 0 },
  { navn: "Rogaland", total: 42.3, iDag: 14.7, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 38.5, iDag: 14.1, endringFraIGar: 2.1, plasseringEndring: 1 },
  { navn: "Agder", total: 37.6, iDag: 11.4, endringFraIGar: -1.2, plasseringEndring: -1 },
  { navn: "Telemark", total: 37.2, iDag: 13.0, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Østfold", total: 35.0, iDag: 13.2, endringFraIGar: 1.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 53.4, vindkast: 11.9, nedbor: 15.6, temp: 0, farevarsel: "gul" },
  { navn: "LAVIK", kommune: "HØYANGER", fylke: "Vestland", ei: 49.8, vindkast: 0, nedbor: 29.6, temp: 0, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 48.3, vindkast: 20.6, nedbor: 0, temp: 3.5, farevarsel: "gul" },
  { navn: "FRØYSET", kommune: "MASFJORDEN", fylke: "Vestland", ei: 48.3, vindkast: 0, nedbor: 26.6, temp: 0, farevarsel: "gul" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 47.8, vindkast: 23.6, nedbor: 0, temp: 12.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 75.4,
    tempMin: 0,
    dager: [47.9, 52.4, 42.5, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 48 EI per dag. Toppdag Tir med 52.4 EI. Mye nedbor med totalt 75.4 mm."
  },
  {
    ...
    precipTotal: 22.3,
    tempMin: 0,
    dager: [46.7, 42.6, 53.4, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 48 EI per dag. Toppdag Ons med 53.4 EI. Mye nedbor med totalt 22.3 mm."
  },
  {
    navn: "BJERKA - VALLA",
    kommune: "HEMNES",
    ...
    precipTotal: 66.1,
    tempMin: 0,
    dager: [60.4, 38.5, 39.2, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 46 EI per dag. Toppdag Man med 60.4 EI. Mye nedbor med totalt 66.1 mm."
  },
  {
    navn: "BARDAL",
    kommune: "LEIRFJORD",
    ...
    precipTotal: 57.6,
    tempMin: 0,
    dager: [49.0, 44.5, 40.2, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Man med 49.0 EI. Mye nedbor med totalt 57.6 mm."
  },
  {
    ...
    precipTotal: 51.7,
    tempMin: 0,
    dager: [41.5, 51.9, 37.4, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Tir med 51.9 EI. Mye nedbor med totalt 51.7 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 78.7 poeng - 11.6 poeng foran Møre og Romsdal (67.1).",
