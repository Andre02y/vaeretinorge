 ...
 *
 * Sist oppdatert: 10.04.2026 kl. 07:17
...
export const META = {
  ...
  datoOppdatert: "10.04.2026 kl. 07:17",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 29.5], trend: "Noe bedring (-4.6) - roligere forhold" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 27.5], trend: "Noe forverring (+3.4) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.2], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 22.4], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 24.6], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 27.6], trend: "Noe forverring (+4.7) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 23.3], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 27.5], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 22.2], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 22.4], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 22.8], trend: "Noe forverring (+5.0) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 161.4, iDag: 29.5, endringFraIGar: -4.6, plasseringEndring: 0 },
  { navn: "Innlandet", total: 133.7, iDag: 27.5, endringFraIGar: 3.4, plasseringEndring: 1 },
  { navn: "Vestland", total: 130.3, iDag: 27.2, endringFraIGar: 2.3, plasseringEndring: 3 },
  { navn: "Troms", total: 129.4, iDag: 22.4, endringFraIGar: -2.7, plasseringEndring: -2 },
  { navn: "Nordland", total: 128.9, iDag: 24.4, endringFraIGar: -1.1, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 127.9, iDag: 24.6, endringFraIGar: 3.6, plasseringEndring: -1 },
  { navn: "Agder", total: 124.5, iDag: 27.6, endringFraIGar: 4.7, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 122.8, iDag: 23.3, endringFraIGar: 2.4, plasseringEndring: -1 },
  { navn: "Rogaland", total: 119.8, iDag: 27.5, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 103.6, iDag: 22.2, endringFraIGar: 2.9, plasseringEndring: 1 },
  { navn: "Buskerud", total: 102.8, iDag: 22.4, endringFraIGar: 3.6, plasseringEndring: 1 },
  { navn: "Oslo", total: 102.5, iDag: 20.6, endringFraIGar: 1.9, plasseringEndring: -2 },
  { navn: "Østfold", total: 101.9, iDag: 22.8, endringFraIGar: 5.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 107.3, vindkast: 48.4, nedbor: 0, temp: -4.6, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 91.4, vindkast: 38.5, nedbor: 0, temp: -5.3, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 81.0, vindkast: 29.7, nedbor: 0, temp: -5.5, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 80.3, vindkast: 28.7, nedbor: 0, temp: -7.0, farevarsel: "oransje" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 80.0, vindkast: 30.5, nedbor: 0, temp: -5.3, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 107.3, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Fre med 107.3 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.8,
    dager: [80.1, 39.5, 44.2, 66.7, 91.4, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Fre med 91.4 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -5.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 76.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [59.4, 38.1, 71.3, 56.2, 73.0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Fre med 73.0 EI. Kraftige vindkast opp til 37.1 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 161.4 poeng - 27.7 poeng foran Innlandet (133.7).",
