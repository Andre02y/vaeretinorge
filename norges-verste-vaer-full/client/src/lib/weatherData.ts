 ...
 *
 * Sist oppdatert: 01.04.2026 kl. 14:52
...
export const META = {
  ...
  datoOppdatert: "01.04.2026 kl. 14:52",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [30.4, 31.1, 42.8], trend: "Kraftig forverring (+11.7) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [32.4, 31.2, 37.4], trend: "Kraftig forverring (+6.2) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [27.6, 28.6, 35.8], trend: "Kraftig forverring (+7.2) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [31.4, 28.2, 26.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [25.2, 27.3, 28.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [29.0, 25.5, 23.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [35.4, 21.5, 20.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [29.5, 24.6, 22.3], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Agder", dager: [32.3, 23.7, 20.1], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Trøndelag", dager: [21.9, 23.9, 25.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [27.7, 22.4, 20.3], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Buskerud", dager: [27.1, 20.8, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [26.9, 20.4, 18.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 104.3, iDag: 42.8, endringFraIGar: 11.7, plasseringEndring: 1 },
  { navn: "Finnmark", total: 101.0, iDag: 37.4, endringFraIGar: 6.2, plasseringEndring: -1 },
  { navn: "Troms", total: 92.0, iDag: 35.8, endringFraIGar: 7.2, plasseringEndring: 2 },
  { navn: "Vestland", total: 86.5, iDag: 26.9, endringFraIGar: -1.3, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 81.1, iDag: 28.6, endringFraIGar: 1.3, plasseringEndring: 4 },
  { navn: "Innlandet", total: 78.1, iDag: 23.6, endringFraIGar: -1.9, plasseringEndring: 1 },
  { navn: "Oslo", total: 77.0, iDag: 20.1, endringFraIGar: -1.4, plasseringEndring: -3 },
  { navn: "Rogaland", total: 76.4, iDag: 22.3, endringFraIGar: -2.3, plasseringEndring: 0 },
  { navn: "Agder", total: 76.1, iDag: 20.1, endringFraIGar: -3.6, plasseringEndring: -3 },
  { navn: "Trøndelag", total: 71.1, iDag: 25.3, endringFraIGar: 1.4, plasseringEndring: 3 },
  { navn: "Østfold", total: 70.4, iDag: 20.3, endringFraIGar: -2.1, plasseringEndring: -1 },
  { navn: "Buskerud", total: 67.2, iDag: 19.3, endringFraIGar: -1.5, plasseringEndring: -1 },
  { navn: "Telemark", total: 66.0, iDag: 18.7, endringFraIGar: -1.7, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 STØDI BRU", kommune: "SALTDAL", fylke: "Nordland", ei: 123.1, vindkast: 0, nedbor: 125.5, temp: -0.7, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 88.0, vindkast: 40.4, nedbor: 0, temp: -2.0, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 79.8, vindkast: 36.4, nedbor: 0, temp: -3.8, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 79.1, vindkast: 36.8, nedbor: 0, temp: 0.7, farevarsel: "oransje" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 77.3, vindkast: 32.8, nedbor: 0, temp: 0, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 147.2,
    tempMin: -2.0,
    dager: [46.2, 53.0, 123.1, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 74 EI per dag. Toppdag Ons med 123.1 EI. Mye nedbor med totalt 147.2 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.2,
    dager: [55.0, 56.6, 88.0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 67 EI per dag. Toppdag Ons med 88.0 EI. Kraftige vindkast opp til 40.4 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -8.5,
    dager: [48.1, 55.8, 79.8, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Ons med 79.8 EI. Kraftige vindkast opp til 36.4 m/s. Bitende kulde ned til -8.5 grader C."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [52.6, 62.9, 64.8, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Ons med 64.8 EI. Kraftige vindkast opp til 28.8 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.4, 50.5, 77.3, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Ons med 77.3 EI. Kraftige vindkast opp til 32.8 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 104.3 poeng, foran Finnmark (101.0).",
