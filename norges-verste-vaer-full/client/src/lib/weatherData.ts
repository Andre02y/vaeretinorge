 ...
 *
 * Sist oppdatert: 19.04.2026 kl. 17:29
...
export const META = {
  ...
  datoOppdatert: "19.04.2026 kl. 17:29",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [24.6, 34.2, 28.1, 23.3, 21.2, 25.6, 25.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.1, 27.5, 27.0, 28.8, 25.8], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Telemark", dager: [22.8, 27.6, 26.5, 19.6, 18.1, 22.6, 28.9], trend: "Kraftig forverring (+6.3) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.2, 23.4, 20.0, 20.2, 24.2], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.1, 19.4, 18.1, 18.0, 32.7], trend: "Kraftig forverring (+14.7) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [24.3, 23.1, 22.3, 21.8, 20.6, 23.6, 22.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [22.2, 24.5, 22.4, 21.8, 20.7, 21.8, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 23.7, 23.8, 18.7, 17.1, 19.8, 27.8], trend: "Kraftig forverring (+8.0) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [21.8, 21.5, 23.5, 24.2, 19.6, 21.5, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [22.0, 20.6, 22.4, 22.1, 22.2, 23.2, 19.5], trend: "Noe bedring (-3.7) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.7, 21.3, 17.1, 18.5, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [21.8, 19.8, 21.5, 18.2, 16.6, 14.0, 24.9], trend: "Kraftig forverring (+10.9) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [20.5, 19.6, 19.1, 19.1, 16.8, 16.8, 17.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 182.4, iDag: 25.4, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Finnmark", total: 181.4, iDag: 25.8, endringFraIGar: -3.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 166.1, iDag: 28.9, endringFraIGar: 6.3, plasseringEndring: 1 },
  { navn: "Innlandet", total: 165.5, iDag: 24.2, endringFraIGar: 4.0, plasseringEndring: -1 },
  { navn: "Oslo", total: 162.1, iDag: 32.7, endringFraIGar: 14.7, plasseringEndring: 4 },
  { navn: "Nordland", total: 158.3, iDag: 22.6, endringFraIGar: -1.0, plasseringEndring: -1 },
  { navn: "Vestland", total: 155.5, iDag: 22.1, endringFraIGar: 0.3, plasseringEndring: -1 },
  { navn: "Buskerud", total: 154.1, iDag: 27.8, endringFraIGar: 8.0, plasseringEndring: 2 },
  { navn: "Rogaland", total: 152.9, iDag: 20.8, endringFraIGar: -0.7, plasseringEndring: -1 },
  { navn: "Troms", total: 152.0, iDag: 19.5, endringFraIGar: -3.7, plasseringEndring: -3 },
  { navn: "Trøndelag", total: 141.1, iDag: 19.8, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Østfold", total: 136.8, iDag: 24.9, endringFraIGar: 10.9, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 129.3, iDag: 17.4, endringFraIGar: 0.6, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "FV51 VALDRESFLYE", kommune: "ØYSTRE SLIDRE", fylke: "Innlandet", ei: 105.8, vindkast: 0, nedbor: 120.0, temp: -0.3, farevarsel: "oransje" },
  { navn: "FV55 HERVAVATN", kommune: "LUSTER", fylke: "Vestland", ei: 67.5, vindkast: 0, nedbor: 14.3, temp: 0.4, farevarsel: "oransje" },
  { navn: "RV7 DYRANUT", kommune: "EIDFJORD", fylke: "Vestland", ei: 59.0, vindkast: 0, nedbor: 12.2, temp: -0.2, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 56.9, vindkast: 23.5, nedbor: 0, temp: -2.1, farevarsel: "gul" },
  { navn: "HAUKELISETER TESTFELT", kommune: "VINJE", fylke: "Telemark", ei: 55.9, vindkast: 6.3, nedbor: 31.0, temp: 0.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 426.9,
    tempMin: -1.1,
    dager: [60.2, 231.3, 53.5, 71.3, 46.2, 39.9, 45.0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [74.4, 75.5, 52.8, 71.9, 57.1, 59.9, 30.5],
    beskrivelse: "Ekstremt vaer hele uken med snitt 60 EI per dag. Toppdag Tir med 75.5 EI. Kraftige vindkast opp til 36.7 m/s."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 70.9, 66.5, 70.3, 45.2, 42.9, 35.7],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 57 EI per dag. Toppdag Tir med 70.9 EI. Kraftige vindkast opp til 31.7 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -7.3,
    dager: [62.1, 60.3, 53.4, 69.2, 39.9, 49.5, 56.9],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 182.4 poeng - 1.0 poeng foran Finnmark (181.4).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
