 ...
 *
 * Sist oppdatert: 13.05.2026 kl. 16:03
...
export const META = {
  ...
  datoOppdatert: "13.05.2026 kl. 16:03",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [22.7, 24.7, 33.7], trend: "Kraftig forverring (+9.0) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [24.1, 28.7, 23.8], trend: "Noe bedring (-4.9) - roligere forhold" },
  { navn: "Oslo", dager: [20.0, 29.5, 22.5], trend: "Markant bedring (-7.0) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [26.4, 22.0, 20.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [21.7, 21.5, 24.8], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [25.4, 20.2, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [24.6, 19.9, 21.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.5, 21.3, 18.5], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Agder", dager: [21.6, 20.8, 19.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [23.5, 20.2, 18.0], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Buskerud", dager: [20.5, 21.1, 19.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 81.1, iDag: 33.7, endringFraIGar: 9.0, plasseringEndring: 3 },
  { navn: "Nordland", total: 76.6, iDag: 23.8, endringFraIGar: -4.9, plasseringEndring: -1 },
  { navn: "Oslo", total: 72.0, iDag: 22.5, endringFraIGar: -7.0, plasseringEndring: -1 },
  { navn: "Innlandet", total: 68.6, iDag: 20.2, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Troms", total: 68.0, iDag: 24.8, endringFraIGar: 3.3, plasseringEndring: 4 },
  { navn: "Vestland", total: 66.2, iDag: 20.6, endringFraIGar: 0.4, plasseringEndring: -1 },
  { navn: "Rogaland", total: 65.7, iDag: 21.2, endringFraIGar: 1.3, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 62.3, iDag: 18.5, endringFraIGar: -2.8, plasseringEndring: -1 },
  { navn: "Agder", total: 61.9, iDag: 19.5, endringFraIGar: -1.3, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 61.7, iDag: 18.0, endringFraIGar: -2.2, plasseringEndring: -2 },
  { navn: "Buskerud", total: 61.0, iDag: 19.4, endringFraIGar: -1.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 69.9, vindkast: 0, nedbor: 16.3, temp: 1.7, farevarsel: "oransje" },
  { navn: "BÅTSFJORD - STRAUMSNESAKSLA", kommune: "BÅTSFJORD", fylke: "Finnmark", ei: 59.2, vindkast: 27.5, nedbor: 0, temp: 4.1, farevarsel: "gul" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 58.2, vindkast: 23.7, nedbor: 0, temp: 1.1, farevarsel: "gul" },
  { navn: "MEHAMN LUFTHAVN", kommune: "GAMVIK", fylke: "Finnmark", ei: 57.8, vindkast: 24.0, nedbor: 17.1, temp: 6.1, farevarsel: "gul" },
  { navn: "GLOMFJORD - SKIHYTTA", kommune: "MELØY", fylke: "Nordland", ei: 57.7, vindkast: 5.4, nedbor: 67.2, temp: 3.3, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 5.2,
    dager: [37.9, 35.0, 52.2, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Ons med 52.2 EI."
  },
  {
    navn: "RV77 GRADDIS",
    kommune: "SALTDAL",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.6,
    dager: [40.3, 38.8, 43.9, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 41 EI per dag. Toppdag Ons med 43.9 EI. Bitende kulde ned til -5.6 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 81.1 poeng, foran Nordland (76.6).",
