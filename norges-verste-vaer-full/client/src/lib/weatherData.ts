 ...
 *
 * Sist oppdatert: 08.04.2026 kl. 09:05
...
export const META = {
  ...
  datoOppdatert: "08.04.2026 kl. 09:05",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 36.6], trend: "Kraftig forverring (+7.0) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 24.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [24.5, 25.6, 32.5], trend: "Kraftig forverring (+6.9) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 22.0], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.0], trend: "Kraftig forverring (+5.8) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [32.3, 20.8, 22.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 19.3, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 95.0, iDag: 36.6, endringFraIGar: 7.0, plasseringEndring: 2 },
  { navn: "Trøndelag", total: 84.2, iDag: 24.6, endringFraIGar: -1.0, plasseringEndring: -1 },
  { navn: "Troms", total: 82.6, iDag: 32.5, endringFraIGar: 6.9, plasseringEndring: 4 },
  { navn: "Innlandet", total: 82.2, iDag: 23.5, endringFraIGar: -0.6, plasseringEndring: -2 },
  { navn: "Møre og Romsdal", total: 79.3, iDag: 22.0, endringFraIGar: -2.7, plasseringEndring: -1 },
  { navn: "Nordland", total: 78.8, iDag: 30.0, endringFraIGar: 5.8, plasseringEndring: 2 },
  { navn: "Vestland", total: 77.6, iDag: 23.0, endringFraIGar: 0.1, plasseringEndring: -2 },
  { navn: "Agder", total: 75.7, iDag: 22.6, endringFraIGar: 1.8, plasseringEndring: -2 },
  { navn: "Rogaland", total: 68.7, iDag: 21.1, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Oslo", total: 63.7, iDag: 19.6, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 63.4, iDag: 20.6, endringFraIGar: 2.0, plasseringEndring: 1 },
  { navn: "Buskerud", total: 63.3, iDag: 20.8, endringFraIGar: 1.5, plasseringEndring: 1 },
  { navn: "Telemark", total: 62.9, iDag: 19.9, endringFraIGar: 0.7, plasseringEndring: -2 },
...
export const STASJONER_PERIODE = [
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 75.8, vindkast: 37.1, nedbor: 0, temp: -1.8, farevarsel: "oransje" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 67.7, vindkast: 24.0, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "ARNØYA - TROLLTINDEN", kommune: "SKJERVØY", fylke: "Troms", ei: 66.6, vindkast: 23.8, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 66.0, vindkast: 22.9, nedbor: 0, temp: -2.1, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 60.9, vindkast: 21.3, nedbor: 0, temp: -3.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [59.4, 38.1, 75.8, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Ons med 75.8 EI. Kraftige vindkast opp til 37.1 m/s."
  },
  {
    navn: "SNØHEIM",
    kommune: "DOVRE",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.2,
    dager: [52.8, 42.1, 66.0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Ons med 66.0 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 95.0 poeng, foran Trøndelag (84.2).",
