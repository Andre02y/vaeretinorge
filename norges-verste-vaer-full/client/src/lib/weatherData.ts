 ...
 *
 * Sist oppdatert: 24.04.2026 kl. 17:58
...
export const META = {
  ...
  datoOppdatert: "24.04.2026 kl. 17:58",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.3, 36.3, 46.8, 47.9, 45.2], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Troms", dager: [23.4, 31.2, 30.4, 33.8, 37.4], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 29.6, 30.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 27.4, 27.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 25.3, 26.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 22.4, 21.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 18.6, 18.4], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Telemark", dager: [25.0, 17.7, 16.4, 16.5, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 16.7, 16.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 15.9, 15.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 204.5, iDag: 45.2, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Troms", total: 156.2, iDag: 37.4, endringFraIGar: 3.6, plasseringEndring: 0 },
  { navn: "Nordland", total: 136.9, iDag: 30.2, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 116.6, iDag: 27.3, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 107.4, iDag: 26.2, endringFraIGar: 0.9, plasseringEndring: 2 },
  { navn: "Innlandet", total: 107.3, iDag: 21.3, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Oslo", total: 104.7, iDag: 18.4, endringFraIGar: -0.2, plasseringEndring: -2 },
  ...
  { navn: "Telemark", total: 91.2, iDag: 15.6, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 91.2, iDag: 16.8, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Østfold", total: 86.5, iDag: 15.5, endringFraIGar: -0.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "VARDØ RADIO", kommune: "VARDØ", fylke: "Finnmark", ei: 77.0, vindkast: 29.5, nedbor: 0.8, temp: 0.9, farevarsel: "oransje" },
  { navn: "E75 DOMEN", kommune: "VARDØ", fylke: "Finnmark", ei: 74.4, vindkast: 0, nedbor: 31.2, temp: -1.4, farevarsel: "oransje" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 71.4, vindkast: 27.3, nedbor: 0, temp: -4.7, farevarsel: "oransje" },
  { navn: "MEHAMN LUFTHAVN", kommune: "GAMVIK", fylke: "Finnmark", ei: 68.9, vindkast: 22.9, nedbor: 2.8, temp: 0.0, farevarsel: "oransje" },
  { navn: "FARKOLLEN", kommune: "SØR-VARANGER", fylke: "Finnmark", ei: 67.2, vindkast: 27.7, nedbor: 0, temp: -3.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -2.6,
    dager: [54.3, 85.8, 56.7, 69.2, 50.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -4.7,
    dager: [40.4, 63.8, 70.8, 69.7, 71.4, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 63 EI per dag. Toppdag Fre med 71.4 EI. Kraftige vindkast opp til 27.3 m/s."
  },
  {
    navn: "FINNESVATNET",
    kommune: "VARDØ",
    ...
    precipTotal: 1.9,
    tempMin: -1.3,
    dager: [39.6, 54.0, 78.0, 68.6, 65.6, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.1,
    dager: [53.6, 65.4, 56.0, 60.9, 63.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [41.3, 67.1, 62.7, 62.9, 61.0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 204.5 poeng - 48.3 poeng foran Troms (156.2).",
