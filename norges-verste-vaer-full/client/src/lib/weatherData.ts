 ...
 *
 * Sist oppdatert: 01.07.2026 kl. 09:02
...
export const META = {
  ...
  datoOppdatert: "01.07.2026 kl. 09:02",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [18.6, 27.6, 28.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [14.2, 24.3, 24.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [19.3, 18.9, 13.0], trend: "Markant bedring (-5.9) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [15.7, 19.4, 14.4], trend: "Noe bedring (-5.0) - roligere forhold" },
  { navn: "Oslo", dager: [15.4, 15.7, 15.9], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Agder", dager: [11.9, 12.8, 11.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [10.2, 11.1, 11.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [10.4, 11.4, 11.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [10.6, 11.0, 10.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [9.8, 10.1, 8.8], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 74.4, iDag: 25.3, endringFraIGar: -2.4, plasseringEndring: 0 },
  { navn: "Finnmark", total: 74.2, iDag: 28.0, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Troms", total: 62.9, iDag: 24.4, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 51.2, iDag: 13.0, endringFraIGar: -5.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 49.5, iDag: 14.4, endringFraIGar: -5.0, plasseringEndring: 0 },
  { navn: "Oslo", total: 47.0, iDag: 15.9, endringFraIGar: 0.2, plasseringEndring: 1 },
  ...
  { navn: "Agder", total: 35.7, iDag: 11.0, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Buskerud", total: 33.2, iDag: 11.9, endringFraIGar: 0.8, plasseringEndring: 2 },
  { navn: "Telemark", total: 33.1, iDag: 11.3, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Rogaland", total: 31.8, iDag: 10.2, endringFraIGar: -0.8, plasseringEndring: -1 },
  { navn: "Østfold", total: 28.7, iDag: 8.8, endringFraIGar: -1.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 67.6, vindkast: 29.6, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "HAMMERFEST LH - BOAZOVARRI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 62.7, vindkast: 22.9, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 60.8, vindkast: 26.1, nedbor: 0, temp: 7.3, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 60.0, vindkast: 23.3, nedbor: 0, temp: 4.3, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 57.5, vindkast: 25.8, nedbor: 0, temp: 7.4, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 67.3, 67.6, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Ons med 67.6 EI. Kraftige vindkast opp til 32.1 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 7.3,
    dager: [35.3, 51.6, 60.8, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Ons med 60.8 EI. Kraftige vindkast opp til 27.1 m/s."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.3, 48.2, 62.7, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Ons med 62.7 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 74.4 poeng - 0.2 poeng foran Finnmark (74.2).",
