 ...
 *
 * Sist oppdatert: 20.06.2026 kl. 18:11
...
export const META = {
  ...
  datoOppdatert: "20.06.2026 kl. 18:11",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [32.1, 22.7, 27.4, 28.7, 20.0, 19.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [26.6, 16.8, 23.6, 23.3, 26.6, 16.8], trend: "Markant bedring (-9.8) - lavtrykket har passert" },
  { navn: "Troms", dager: [20.5, 18.2, 20.6, 20.5, 16.8, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [16.7, 17.4, 18.9, 18.9, 18.3, 23.9], trend: "Kraftig forverring (+5.6) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [20.1, 17.7, 15.6, 19.0, 18.0, 20.3], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [15.5, 14.3, 14.1, 18.2, 18.9, 22.2], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [19.2, 17.7, 15.1, 15.8, 15.2, 13.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [16.0, 16.1, 14.7, 16.2, 17.1, 14.3], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Innlandet", dager: [18.9, 16.0, 13.9, 13.3, 14.6, 13.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.7, 12.8, 15.6, 17.0, 15.7, 11.0], trend: "Noe bedring (-4.7) - roligere forhold" },
  { navn: "Agder", dager: [15.4, 14.2, 15.9, 17.2, 12.6, 11.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.0, 12.5, 14.9, 14.7, 15.5, 11.9], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Østfold", dager: [18.0, 11.9, 13.5, 15.5, 13.7, 11.6], trend: "Noe bedring (-2.1) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 150.3, iDag: 19.4, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Oslo", total: 133.7, iDag: 16.8, endringFraIGar: -9.8, plasseringEndring: 0 },
  { navn: "Troms", total: 115.4, iDag: 18.8, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Nordland", total: 114.1, iDag: 23.9, endringFraIGar: 5.6, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 110.7, iDag: 20.3, endringFraIGar: 2.3, plasseringEndring: -1 },
  { navn: "Vestland", total: 103.2, iDag: 22.2, endringFraIGar: 3.3, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 96.8, iDag: 13.8, endringFraIGar: -1.4, plasseringEndring: -1 },
  { navn: "Rogaland", total: 94.4, iDag: 14.3, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 90.6, iDag: 13.9, endringFraIGar: -0.7, plasseringEndring: 1 },
  { navn: "Telemark", total: 87.8, iDag: 11.0, endringFraIGar: -4.7, plasseringEndring: -1 },
  { navn: "Agder", total: 86.7, iDag: 11.4, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 84.5, iDag: 11.9, endringFraIGar: -3.6, plasseringEndring: 0 },
  { navn: "Østfold", total: 84.2, iDag: 11.6, endringFraIGar: -2.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV848 FORNES", kommune: "NARVIK", fylke: "Nordland", ei: 67.8, vindkast: 0, nedbor: 5.4, temp: -38.6, farevarsel: "oransje" },
  { navn: "HOVLANDSDAL", kommune: "FJALER", fylke: "Vestland", ei: 58.0, vindkast: 0, nedbor: 46.0, temp: 0, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 57.6, vindkast: 13.8, nedbor: 15.7, temp: 0, farevarsel: "gul" },
  { navn: "BOTNEN I FØRDE", kommune: "SUNNFJORD", fylke: "Vestland", ei: 57.6, vindkast: 0, nedbor: 45.3, temp: 0, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 57.4, vindkast: 31.9, nedbor: 0, temp: 7.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 211.2,
    tempMin: -0.9,
    dager: [50.4, 28.1, 72.0, 85.6, 49.5, 52.8, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [46.0, 31.8, 49.6, 49.9, 34.6, 38.0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [52.8, 33.0, 46.0, 46.6, 30.2, 38.7, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [38.5, 33.6, 35.1, 38.6, 41.1, 51.9, 0],
    beskrivelse: "Varierende forhold sa langt denne uka med snitt 40 EI per dag. Toppdag Lør med 51.9 EI."
  },
  {
    ...
    precipTotal: 24.8,
    tempMin: 0,
    dager: [30.2, 30.2, 26.7, 48.2, 45.4, 57.6, 0],
    beskrivelse: "Varierende forhold sa langt denne uka med snitt 40 EI per dag. Toppdag Lør med 57.6 EI. Mye nedbor med totalt 24.8 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 150.3 poeng - 16.6 poeng foran Oslo (133.7).",
