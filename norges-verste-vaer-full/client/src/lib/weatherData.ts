 ...
 *
 * Sist oppdatert: 29.03.2026 kl. 14:30
...
export const META = {
  ...
  datoOppdatert: "29.03.2026 kl. 14:30",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [46.8, 39.3, 33.4, 31.6, 34.1, 31.2, 33.8], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Finnmark", dager: [37.0, 32.9, 29.8, 35.6, 38.4, 36.3, 33.7], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [35.7, 35.1, 32.8, 38.6, 29.1, 28.7, 27.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [36.5, 33.8, 29.0, 30.1, 36.3, 31.2, 28.5], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Vestland", dager: [32.1, 34.6, 32.3, 32.1, 29.5, 31.5, 28.0], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Trøndelag", dager: [40.7, 31.0, 22.9, 33.1, 28.8, 23.7, 27.0], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [25.2, 30.5, 31.5, 26.7, 29.8, 30.3, 26.5], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Innlandet", dager: [27.7, 29.7, 26.2, 30.6, 28.8, 28.7, 25.9], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Rogaland", dager: [24.8, 27.6, 30.0, 31.7, 28.0, 27.1, 25.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [20.5, 27.4, 35.8, 21.2, 30.9, 33.6, 21.9], trend: "Markant bedring (-11.7) - lavtrykket har passert" },
  { navn: "Østfold", dager: [21.4, 27.1, 30.4, 24.3, 23.8, 24.8, 21.9], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Telemark", dager: [22.2, 25.8, 28.0, 21.4, 25.0, 26.6, 22.2], trend: "Noe bedring (-4.4) - roligere forhold" },
  { navn: "Buskerud", dager: [21.9, 23.4, 26.0, 21.2, 26.3, 25.7, 22.0], trend: "Noe bedring (-3.7) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 250.2, iDag: 33.8, endringFraIGar: 2.6, plasseringEndring: 0 },
  { navn: "Finnmark", total: 243.7, iDag: 33.7, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 227.3, iDag: 27.3, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Troms", total: 225.4, iDag: 28.5, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Vestland", total: 220.1, iDag: 28.0, endringFraIGar: -3.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 207.2, iDag: 27.0, endringFraIGar: 3.3, plasseringEndring: 0 },
  { navn: "Agder", total: 200.5, iDag: 26.5, endringFraIGar: -3.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 197.6, iDag: 25.9, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Rogaland", total: 194.8, iDag: 25.6, endringFraIGar: -1.5, plasseringEndring: 1 },
  { navn: "Oslo", total: 191.3, iDag: 21.9, endringFraIGar: -11.7, plasseringEndring: -1 },
  { navn: "Østfold", total: 173.7, iDag: 21.9, endringFraIGar: -2.9, plasseringEndring: 0 },
  { navn: "Telemark", total: 171.2, iDag: 22.2, endringFraIGar: -4.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 166.5, iDag: 22.0, endringFraIGar: -3.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 STØDI BRU", kommune: "SALTDAL", fylke: "Nordland", ei: 87.0, vindkast: 0, nedbor: 97.6, temp: -2.8, farevarsel: "oransje" },
  { navn: "KAPPFJELLET", kommune: "GRANE", fylke: "Nordland", ei: 63.0, vindkast: 24.7, nedbor: 0, temp: -3.2, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 62.3, vindkast: 23.2, nedbor: 0, temp: -2.8, farevarsel: "oransje" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 60.3, vindkast: 22.6, nedbor: 0, temp: -3.1, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 56.3, vindkast: 24.6, nedbor: 0, temp: 0.0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1020.7,
    tempMin: -5.2,
    dager: [543.8, 35.4, 26.4, 32.9, 32.6, 31.0, 32.6],
    beskrivelse: "Ekstremt vaer hele uken med snitt 105 EI per dag. Toppdag Man med 543.8 EI. Mye nedbor med totalt 1020.7 mm. Bitende kulde ned til -5.2 grader C."
  },
  {
    navn: "E6 STØDI BRU",
    kommune: "SALTDAL",
    ...
    precipTotal: 370.8,
    tempMin: -5.0,
    dager: [166.8, 48.1, 56.1, 38.7, 42.5, 32.6, 87.0],
    beskrivelse: "Ekstremt vaer hele uken med snitt 67 EI per dag. Toppdag Man med 166.8 EI. Mye nedbor med totalt 370.8 mm."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
    ...
    precipTotal: 0,
    tempMin: -4.3,
    dager: [69.7, 72.3, 62.7, 61.0, 68.9, 59.7, 60.3],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -9.9,
    dager: [72.9, 81.5, 62.8, 67.2, 55.9, 56.1, 53.5],
    beskrivelse: "Ekstremt vaer hele uken med snitt 64 EI per dag. Toppdag Tir med 81.5 EI. Kraftige vindkast opp til 43.3 m/s. Bitende kulde ned til -9.9 grader C."
  },
  {
    ...
    precipTotal: 106.7,
    tempMin: -2.1,
    dager: [62.8, 61.6, 76.7, 76.3, 45.2, 62.4, 55.6],
    beskrivelse: "Ekstremt vaer hele uken med snitt 63 EI per dag. Toppdag Ons med 76.7 EI. Kraftige vindkast opp til 26.9 m/s. Mye nedbor med totalt 106.7 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 250.2 poeng - 6.5 poeng foran Finnmark (243.7).",
