 ...
 *
 * Sist oppdatert: 04.09.2026 kl. 19:54
...
export const META = {
  ...
  datoOppdatert: "04.09.2026 kl. 19:54",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [19.1, 17.6, 20.8, 20.6, 26.5], trend: "Kraftig forverring (+5.9) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [18.7, 21.7, 19.2, 21.6, 19.1], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Vestland", dager: [15.8, 15.1, 22.8, 20.8, 18.8], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [17.6, 15.1, 20.9, 22.8, 16.2], trend: "Markant bedring (-6.6) - lavtrykket har passert" },
  { navn: "Agder", dager: [16.5, 14.9, 19.4, 19.1, 22.2], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [16.6, 15.8, 17.6, 20.1, 21.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.6, 16.1, 16.7, 16.9, 17.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [18.2, 17.7, 15.7, 20.0, 18.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [17.1, 15.4, 16.4, 16.6, 16.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [12.9, 12.6, 19.8, 16.8, 19.0], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [16.1, 12.5, 14.0, 14.3, 20.1], trend: "Kraftig forverring (+5.8) - okt vind og/eller nedbor" },
  { navn: "Buskerud", dager: [15.0, 12.9, 14.1, 13.6, 18.1], trend: "Noe forverring (+4.5) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [12.3, 11.9, 13.3, 13.3, 15.9], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 104.6, iDag: 26.5, endringFraIGar: 5.9, plasseringEndring: 1 },
  { navn: "Nordland", total: 100.3, iDag: 19.1, endringFraIGar: -2.5, plasseringEndring: -1 },
  { navn: "Vestland", total: 93.3, iDag: 18.8, endringFraIGar: -2.0, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 92.6, iDag: 16.2, endringFraIGar: -6.6, plasseringEndring: -1 },
  { navn: "Agder", total: 92.1, iDag: 22.2, endringFraIGar: 3.1, plasseringEndring: 3 },
  { navn: "Troms", total: 91.9, iDag: 21.8, endringFraIGar: 1.7, plasseringEndring: 1 },
  { navn: "Oslo", total: 91.9, iDag: 17.6, endringFraIGar: 0.7, plasseringEndring: -2 },
  { navn: "Trøndelag", total: 89.8, iDag: 18.2, endringFraIGar: -1.8, plasseringEndring: -2 },
  { navn: "Innlandet", total: 81.7, iDag: 16.2, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 81.1, iDag: 19.0, endringFraIGar: 2.2, plasseringEndring: 0 },
  { navn: "Telemark", total: 77.0, iDag: 20.1, endringFraIGar: 5.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 73.7, iDag: 18.1, endringFraIGar: 4.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 66.7, iDag: 15.9, endringFraIGar: 2.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 55.8, vindkast: 21.3, nedbor: 0, temp: 6.1, farevarsel: "gul" },
  { navn: "VARDØ LUFTHAVN - DOMEN", kommune: "VARDØ", fylke: "Finnmark", ei: 53.4, vindkast: 18.8, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 50.9, vindkast: 0, nedbor: 1.3, temp: -30.3, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 14.6,
    tempMin: -39.9,
    dager: [59.9, 59.9, 59.9, 59.9, 50.9, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 11.7,
    tempMin: -31.9,
    dager: [55.7, 57.5, 46.7, 45.8, 44.3, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Tir med 57.5 EI. Bitende kulde ned til -31.9 grader C."
  },
  {
    navn: "FV289 HURUM",
    kommune: "ASKER",
    ...
    precipTotal: 0.1,
    tempMin: -39.8,
    dager: [18.0, 59.3, 67.0, 48.0, 40.1, 0, 0],
  ...
  },
  {
    ...
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 46 EI per dag. Toppdag Ons med 60.5 EI. Mye nedbor med totalt 25.8 mm."
  },
  {
    navn: "BOTNEN I FØRDE",
    kommune: "SUNNFJORD",
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 104.6 poeng, foran Nordland (100.3).",
