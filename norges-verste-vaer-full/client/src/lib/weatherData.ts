 ...
 *
 * Sist oppdatert: 17.04.2026 kl. 17:49
...
export const META = {
  ...
  datoOppdatert: "17.04.2026 kl. 17:49",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [24.6, 34.2, 28.1, 23.3, 22.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.1, 27.5, 27.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.2, 23.4, 20.3], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Telemark", dager: [22.8, 27.6, 26.5, 19.6, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.3, 23.1, 22.3, 21.8, 21.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [22.2, 24.5, 22.4, 21.8, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.1, 19.4, 18.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [21.8, 21.5, 23.5, 24.2, 19.3], trend: "Noe bedring (-4.9) - roligere forhold" },
  { navn: "Troms", dager: [22.0, 20.6, 22.4, 22.1, 22.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 23.7, 23.8, 18.7, 17.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.7, 21.3, 17.0], trend: "Noe bedring (-4.3) - roligere forhold" },
  { navn: "Østfold", dager: [21.8, 19.8, 21.5, 18.2, 16.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [20.5, 19.6, 19.1, 19.1, 17.1], trend: "Noe bedring (-2.0) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 132.4, iDag: 22.2, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 127.0, iDag: 27.2, endringFraIGar: -0.3, plasseringEndring: 1 },
  { navn: "Innlandet", total: 121.4, iDag: 20.3, endringFraIGar: -3.1, plasseringEndring: -1 },
  { navn: "Telemark", total: 114.6, iDag: 18.1, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Nordland", total: 112.6, iDag: 21.1, endringFraIGar: -0.7, plasseringEndring: 1 },
  { navn: "Vestland", total: 111.7, iDag: 20.8, endringFraIGar: -1.0, plasseringEndring: 2 },
  { navn: "Oslo", total: 111.5, iDag: 18.2, endringFraIGar: -1.2, plasseringEndring: -2 },
  { navn: "Rogaland", total: 110.3, iDag: 19.3, endringFraIGar: -4.9, plasseringEndring: -1 },
  { navn: "Troms", total: 109.4, iDag: 22.3, endringFraIGar: 0.2, plasseringEndring: 1 },
  { navn: "Buskerud", total: 106.6, iDag: 17.2, endringFraIGar: -1.5, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 102.7, iDag: 17.0, endringFraIGar: -4.3, plasseringEndring: 0 },
  { navn: "Østfold", total: 98.1, iDag: 16.8, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 95.4, iDag: 17.1, endringFraIGar: -2.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "KLEVAVATNET", kommune: "AURLAND", fylke: "Vestland", ei: 54.4, vindkast: 14.5, nedbor: 0.3, temp: 1.8, farevarsel: "gul" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 53.3, vindkast: 24.7, nedbor: 0, temp: -0.7, farevarsel: "gul" },
  { navn: "HAUKELISETER TESTFELT", kommune: "VINJE", fylke: "Telemark", ei: 47.7, vindkast: 7.7, nedbor: 3.7, temp: 0.6, farevarsel: "gul" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 47.7, vindkast: 16.0, nedbor: 0, temp: -0.5, farevarsel: "gul" },
  { navn: "FOLGEFONNA SKISENTER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 46.5, vindkast: 17.2, nedbor: 0, temp: 0.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 408.6,
    tempMin: -1.1,
    dager: [60.2, 231.3, 53.5, 71.3, 30.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 599.9,
    tempMin: 2.5,
    dager: [111.7, 222.6, 16.0, 14.3, 14.3, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [74.4, 75.5, 52.8, 71.9, 53.3, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 70.9, 66.5, 70.3, 43.7, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 63 EI per dag. Toppdag Tir med 70.9 EI. Kraftige vindkast opp til 31.7 m/s."
  },
  {
    navn: "KLEVAVATNET",
    kommune: "AURLAND",
    ...
    precipTotal: 2.3,
    tempMin: -0.4,
    dager: [48.9, 59.2, 60.8, 69.4, 54.4, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Tor med 69.4 EI."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 132.4 poeng - 5.4 poeng foran Finnmark (127.0).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
