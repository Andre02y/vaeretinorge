 ...
 *
 * Sist oppdatert: 14.08.2026 kl. 17:40
...
export const META = {
  ...
  datoOppdatert: "14.08.2026 kl. 17:40",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Agder", dager: [22.8, 16.7, 14.7, 12.8, 12.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.6, 13.4, 12.4, 11.2, 12.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [19.0, 13.1, 12.4, 11.5, 11.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.4, 11.3, 11.3, 10.9, 9.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Agder", total: 79.5, iDag: 12.5, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 67.9, iDag: 12.3, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Telemark", total: 67.4, iDag: 11.4, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Østfold", total: 59.6, iDag: 9.7, endringFraIGar: -1.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 53.7, vindkast: 0, nedbor: 0.3, temp: -29.9, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.9,
    dager: [68.2, 63.6, 66.7, 64.1, 62.0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0.4,
    tempMin: -39.8,
    dager: [74.9, 35.1, 65.1, 61.0, 53.7, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Man med 74.9 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.2,
    dager: [59.3, 46.2, 39.9, 41.6, 42.5, 0, 0],
