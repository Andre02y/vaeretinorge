 ...
 *
 * Sist oppdatert: 30.05.2026 kl. 20:57
...
export const META = {
  ...
  datoOppdatert: "30.05.2026 kl. 20:57",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [25.2, 25.2, 27.3, 29.3, 26.3, 25.0], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Møre og Romsdal", dager: [23.8, 29.9, 25.8, 21.7, 16.9, 15.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [25.3, 25.3, 22.1, 18.1, 16.0, 17.8], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Agder", dager: [14.9, 17.0, 16.9, 15.4, 14.5, 14.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.2, 14.3, 14.8, 14.2, 14.0, 14.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [13.2, 14.9, 14.9, 14.1, 13.5, 12.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [10.9, 13.5, 14.2, 13.5, 13.4, 10.1], trend: "Noe bedring (-3.3) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Finnmark", total: 158.3, iDag: 25.0, endringFraIGar: -1.3, plasseringEndring: 0 },
  ...
  { navn: "Møre og Romsdal", total: 133.3, iDag: 15.2, endringFraIGar: -1.7, plasseringEndring: -1 },
  { navn: "Vestland", total: 124.6, iDag: 17.8, endringFraIGar: 1.8, plasseringEndring: 0 },
  ...
  { navn: "Agder", total: 93.6, iDag: 14.9, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Telemark", total: 84.8, iDag: 14.3, endringFraIGar: 0.3, plasseringEndring: 1 },
  { navn: "Buskerud", total: 83.2, iDag: 12.6, endringFraIGar: -0.9, plasseringEndring: -1 },
  { navn: "Østfold", total: 75.6, iDag: 10.1, endringFraIGar: -3.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 59.0, vindkast: 0, nedbor: 0, temp: -31.5, farevarsel: "gul" },
  { navn: "NORDNESFJELLET - JETTANII", kommune: "KÅFJORD", fylke: "Troms", ei: 45.2, vindkast: 10.9, nedbor: 1.1, temp: 1.2, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 45.0, vindkast: 9.5, nedbor: 2.5, temp: 0, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 44.4, vindkast: 19.6, nedbor: 0, temp: 0.7, farevarsel: "gul" },
  { navn: "MYKEN", kommune: "RØDØY", fylke: "Nordland", ei: 44.1, vindkast: 16.1, nedbor: 0.8, temp: 7.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [62.3, 64.9, 67.3, 51.5, 39.6, 29.0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [53.2, 68.2, 54.6, 36.4, 37.9, 33.7, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [55.2, 56.1, 58.8, 47.2, 37.1, 27.5, 0],
  ...
  },
  {
    ...
    precipTotal: 33.9,
    tempMin: 0,
    dager: [61.9, 62.1, 48.6, 29.4, 28.1, 45.0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 1.0,
    dager: [55.7, 63.5, 53.8, 36.4, 33.2, 32.4, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 158.9 poeng - 0.6 poeng foran Finnmark (158.3).",
