 ...
 *
 * Sist oppdatert: 07.08.2026 kl. 01:47
...
export const META = {
  ...
  datoOppdatert: "07.08.2026 kl. 01:47",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [20.3, 29.6, 32.1, 23.3, 22.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [16.7, 16.4, 31.9, 33.7, 24.6], trend: "Markant bedring (-9.1) - lavtrykket har passert" },
  { navn: "Vestland", dager: [21.8, 17.1, 18.5, 24.0, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [22.1, 23.0, 19.0, 17.7, 23.5], trend: "Kraftig forverring (+5.8) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [24.2, 18.4, 16.3, 22.0, 24.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.7, 18.2, 16.1, 17.0, 25.5], trend: "Kraftig forverring (+8.5) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [16.8, 20.6, 20.4, 17.2, 22.7], trend: "Kraftig forverring (+5.5) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [15.4, 15.9, 20.3, 20.0, 26.0], trend: "Kraftig forverring (+6.0) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [12.7, 13.8, 22.2, 22.2, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [12.9, 13.8, 20.4, 21.1, 23.6], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [16.9, 14.1, 18.0, 18.2, 24.3], trend: "Kraftig forverring (+6.1) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [15.9, 14.4, 15.5, 18.3, 26.3], trend: "Kraftig forverring (+8.0) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [11.1, 9.6, 21.0, 22.3, 24.0], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 128.0, iDag: 22.7, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Oslo", total: 123.3, iDag: 24.6, endringFraIGar: -9.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 106.3, iDag: 24.9, endringFraIGar: 0.9, plasseringEndring: 1 },
  { navn: "Nordland", total: 105.3, iDag: 23.5, endringFraIGar: 5.8, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 104.9, iDag: 24.0, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 99.5, iDag: 25.5, endringFraIGar: 8.5, plasseringEndring: 1 },
  { navn: "Troms", total: 97.7, iDag: 22.7, endringFraIGar: 5.5, plasseringEndring: -1 },
  { navn: "Agder", total: 97.6, iDag: 26.0, endringFraIGar: 6.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 92.9, iDag: 22.0, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 91.8, iDag: 23.6, endringFraIGar: 2.5, plasseringEndring: 0 },
  { navn: "Innlandet", total: 91.5, iDag: 24.3, endringFraIGar: 6.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 90.4, iDag: 26.3, endringFraIGar: 8.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 88.0, iDag: 24.0, endringFraIGar: 1.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "VALLDAL - MURI", kommune: "FJORD", fylke: "Møre og Romsdal", ei: 35.1, vindkast: 0, nedbor: 0.2, temp: 0, farevarsel: "ingen" },
  { navn: "SVERRESBORG", kommune: "TRONDHEIM", fylke: "Trøndelag", ei: 35.0, vindkast: 0, nedbor: 0.1, temp: 0, farevarsel: "ingen" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 31.3, vindkast: 22.6, nedbor: 0, temp: 0, farevarsel: "ingen" },
  { navn: "LINDESNES FYR", kommune: "LINDESNES", fylke: "Agder", ei: 29.9, vindkast: 19.8, nedbor: 0, temp: 0, farevarsel: "ingen" },
  { navn: "TRYSIL - NORDRE KANKEN", kommune: "TRYSIL", fylke: "Innlandet", ei: 29.8, vindkast: 19.5, nedbor: 0, temp: 0, farevarsel: "ingen" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.8,
    dager: [44.3, 64.1, 65.8, 63.0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Ons med 65.8 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.1, 51.9, 60.6, 41.5, 24.1, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Ons med 60.6 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.8, 58.0, 62.1, 47.0, 23.2, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Ons med 62.1 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [36.2, 54.3, 60.4, 44.1, 22.4, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Ons med 60.4 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 128.0 poeng - 4.7 poeng foran Oslo (123.3).",
