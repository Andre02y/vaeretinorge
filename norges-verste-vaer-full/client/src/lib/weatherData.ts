 ...
 *
 * Sist oppdatert: 09.05.2026 kl. 14:49
...
export const META = {
  ...
  datoOppdatert: "09.05.2026 kl. 14:49",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Trøndelag", dager: [42.9, 32.3, 29.2, 24.6, 20.9, 17.0], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Finnmark", dager: [29.1, 29.8, 28.5, 25.9, 24.7, 27.0], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [33.7, 34.3, 28.4, 24.4, 20.2, 22.7], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [28.0, 25.4, 25.0, 24.5, 24.4, 25.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [27.4, 29.4, 26.8, 22.6, 20.7, 23.2], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [23.8, 26.7, 24.8, 22.3, 21.4, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.3, 27.1, 19.8, 18.7, 18.9, 18.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [21.4, 22.4, 21.0, 18.2, 18.6, 16.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [21.3, 21.5, 20.6, 19.2, 18.7, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.4, 21.8, 19.6, 19.1, 17.6, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [18.4, 19.3, 19.9, 18.4, 18.2, 16.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Trøndelag", total: 166.9, iDag: 17.0, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Finnmark", total: 165.0, iDag: 27.0, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 163.7, iDag: 22.7, endringFraIGar: 2.5, plasseringEndring: -1 },
  { navn: "Troms", total: 153.1, iDag: 25.8, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Vestland", total: 150.1, iDag: 23.2, endringFraIGar: 2.5, plasseringEndring: 0 },
  { navn: "Innlandet", total: 138.8, iDag: 19.8, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Oslo", total: 122.0, iDag: 18.2, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Rogaland", total: 118.3, iDag: 16.7, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Agder", total: 118.3, iDag: 17.0, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 112.8, iDag: 16.3, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 110.9, iDag: 16.7, endringFraIGar: -1.5, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 61.7, vindkast: 0, nedbor: 4.2, temp: -25.5, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 57.9, vindkast: 23.7, nedbor: 0, temp: -3.1, farevarsel: "gul" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 57.5, vindkast: 26.2, nedbor: 0, temp: 8.4, farevarsel: "gul" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 56.3, vindkast: 23.0, nedbor: 0, temp: 1.3, farevarsel: "gul" },
  { navn: "NORDNESFJELLET - JETTANII", kommune: "KÅFJORD", fylke: "Troms", ei: 55.5, vindkast: 12.5, nedbor: 2.9, temp: 0.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3110.3,
    tempMin: -2.9,
    dager: [1597.7, 31.1, 25.5, 24.2, 25.6, 24.9, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.8,
    dager: [61.9, 55.8, 48.8, 42.3, 51.3, 57.9, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.7,
    dager: [54.9, 47.3, 49.0, 43.4, 48.3, 56.3, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Lør med 56.3 EI. Bitende kulde ned til -5.7 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.0,
    dager: [50.3, 46.0, 37.5, 36.8, 57.4, 55.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.5,
    dager: [54.9, 51.8, 44.8, 39.9, 43.3, 47.7, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 175.2 poeng - 8.3 poeng foran Trøndelag (166.9).",
