 ...
 *
 * Sist oppdatert: 10.05.2026 kl. 17:42
...
export const META = {
  ...
  datoOppdatert: "10.05.2026 kl. 17:42",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.3, 33.1, 30.4, 29.3, 26.7, 23.8, 28.6], trend: "Noe forverring (+4.8) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [42.9, 32.3, 29.2, 24.6, 20.9, 18.9, 25.0], trend: "Kraftig forverring (+6.1) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [33.7, 34.3, 28.4, 24.4, 20.2, 24.5, 28.3], trend: "Noe forverring (+3.8) - ustabilt vaer fortsetter" },
  { navn: "Finnmark", dager: [29.1, 29.8, 28.5, 25.9, 24.7, 28.3, 26.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [27.4, 29.4, 26.8, 22.6, 20.7, 24.4, 26.6], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [28.0, 25.4, 25.0, 24.5, 24.4, 24.1, 20.6], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Innlandet", dager: [23.8, 26.7, 24.8, 22.3, 21.4, 20.1, 24.0], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [19.3, 27.1, 19.8, 18.7, 18.9, 19.3, 30.3], trend: "Kraftig forverring (+11.0) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [21.4, 22.4, 21.0, 18.2, 18.6, 19.0, 23.4], trend: "Noe forverring (+4.4) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [21.3, 21.5, 20.6, 19.2, 18.7, 17.1, 22.6], trend: "Kraftig forverring (+5.5) - okt vind og/eller nedbor" },
  { navn: "Buskerud", dager: [18.4, 21.8, 19.6, 19.1, 17.6, 18.2, 22.4], trend: "Noe forverring (+4.2) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [18.4, 19.3, 19.9, 18.4, 18.2, 17.3, 22.7], trend: "Kraftig forverring (+5.4) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [19.0, 18.8, 18.7, 17.3, 16.6, 16.1, 18.3], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 205.2, iDag: 28.6, endringFraIGar: 4.8, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 193.8, iDag: 25.0, endringFraIGar: 6.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 193.8, iDag: 28.3, endringFraIGar: 3.8, plasseringEndring: 1 },
  { navn: "Finnmark", total: 192.7, iDag: 26.4, endringFraIGar: -1.9, plasseringEndring: -1 },
  { navn: "Vestland", total: 177.9, iDag: 26.6, endringFraIGar: 2.2, plasseringEndring: 1 },
  { navn: "Troms", total: 172.0, iDag: 20.6, endringFraIGar: -3.5, plasseringEndring: -1 },
  { navn: "Innlandet", total: 163.1, iDag: 24.0, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 153.4, iDag: 30.3, endringFraIGar: 11.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 144.0, iDag: 23.4, endringFraIGar: 4.4, plasseringEndring: 0 },
  { navn: "Agder", total: 141.0, iDag: 22.6, endringFraIGar: 5.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 137.1, iDag: 22.4, endringFraIGar: 4.2, plasseringEndring: 0 },
  { navn: "Telemark", total: 134.2, iDag: 22.7, endringFraIGar: 5.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 124.8, iDag: 18.3, endringFraIGar: 2.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "MYKEN", kommune: "RØDØY", fylke: "Nordland", ei: 58.9, vindkast: 24.1, nedbor: 7.9, temp: 6.7, farevarsel: "gul" },
  { navn: "SKLINNA FYR", kommune: "LEKA", fylke: "Trøndelag", ei: 56.2, vindkast: 24.0, nedbor: 0, temp: 7.0, farevarsel: "gul" },
  { navn: "NORDØYAN FYR", kommune: "NÆRØYSUND", fylke: "Trøndelag", ei: 54.5, vindkast: 23.3, nedbor: 0, temp: 7.1, farevarsel: "gul" },
  { navn: "BUHOLMRÅSA FYR", kommune: "OSEN", fylke: "Trøndelag", ei: 53.1, vindkast: 23.4, nedbor: 0, temp: 7.4, farevarsel: "gul" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 52.8, vindkast: 21.8, nedbor: 0, temp: 4.9, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3110.3,
    tempMin: -2.9,
    dager: [1597.7, 31.1, 25.5, 24.2, 25.6, 25.2, 22.3],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.8,
    dager: [61.9, 55.8, 48.8, 42.3, 51.3, 56.3, 48.1],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.7,
    dager: [54.9, 47.3, 49.0, 43.4, 48.3, 53.5, 49.4],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.2,
    dager: [62.2, 52.5, 45.5, 41.8, 39.5, 39.5, 50.5],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.5,
    dager: [54.9, 51.8, 44.8, 39.9, 43.3, 48.4, 45.5],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 205.2 poeng - 11.4 poeng foran Trøndelag (193.8).",
