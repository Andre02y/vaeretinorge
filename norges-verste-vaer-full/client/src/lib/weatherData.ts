 ...
 *
 * Sist oppdatert: 16.07.2026 kl. 20:53
...
export const META = {
  ...
  datoOppdatert: "16.07.2026 kl. 20:53",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [20.8, 24.0, 26.0, 24.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [19.2, 26.2, 20.7, 23.0], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [20.6, 21.9, 20.6, 24.4], trend: "Noe forverring (+3.8) - ustabilt vaer fortsetter" },
  ...
  { navn: "Trøndelag", dager: [12.9, 12.7, 12.6, 12.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [10.3, 9.7, 8.7, 8.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [8.7, 8.9, 8.0, 7.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [8.9, 7.8, 7.7, 7.1], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Agder", dager: [7.5, 7.3, 7.0, 5.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [7.1, 6.7, 6.0, 5.2], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 95.0, iDag: 24.2, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Finnmark", total: 89.1, iDag: 23.0, endringFraIGar: 2.3, plasseringEndring: 0 },
  { navn: "Troms", total: 87.5, iDag: 24.4, endringFraIGar: 3.8, plasseringEndring: 0 },
  ...
  { navn: "Trøndelag", total: 50.2, iDag: 12.0, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Vestland", total: 37.3, iDag: 8.6, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 32.8, iDag: 7.2, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 31.5, iDag: 7.1, endringFraIGar: -0.6, plasseringEndring: 0 },
  ...
  { navn: "Agder", total: 27.4, iDag: 5.6, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 25.0, iDag: 5.2, endringFraIGar: -0.8, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 63.4, vindkast: 27.7, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 58.7, vindkast: 31.0, nedbor: 0, temp: 8.3, farevarsel: "gul" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 58.5, vindkast: 29.1, nedbor: 0, temp: 9.0, farevarsel: "gul" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 58.3, vindkast: 25.8, nedbor: 0, temp: 5.9, farevarsel: "gul" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 55.6, vindkast: 22.0, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [58.2, 64.5, 63.7, 63.4, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 4.1,
    dager: [54.0, 48.5, 50.7, 58.3, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 53 EI per dag. Toppdag Tor med 58.3 EI. Kraftige vindkast opp til 25.8 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 7.1,
    dager: [46.5, 47.8, 52.3, 58.5, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Tor med 58.5 EI. Kraftige vindkast opp til 29.1 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 6.4,
    dager: [48.3, 58.7, 42.6, 54.8, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [43.2, 59.0, 43.1, 52.5, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 95.0 poeng - 5.9 poeng foran Finnmark (89.1).",
