 ...
 *
 * Sist oppdatert: 19.03.2026 kl. 07:44
...
export const META = {
  ...
  datoOppdatert: "19.03.2026 kl. 07:44",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.6, 33.8, 41.5, 45.4], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Finnmark", dager: [31.1, 33.6, 37.6, 31.7], trend: "Markant bedring (-5.9) - lavtrykket har passert" },
  { navn: "Troms", dager: [28.1, 28.9, 33.1, 35.4], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [34.0, 30.8, 25.5, 22.4], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Innlandet", dager: [32.1, 28.8, 26.2, 24.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [33.5, 28.2, 24.4, 19.7], trend: "Noe bedring (-4.7) - roligere forhold" },
  { navn: "Vestland", dager: [29.9, 27.3, 25.1, 22.7], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Telemark", dager: [30.1, 29.7, 25.0, 19.9], trend: "Markant bedring (-5.1) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [24.5, 25.2, 29.2, 25.7], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Østfold", dager: [28.9, 26.6, 26.6, 20.1], trend: "Markant bedring (-6.5) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [22.5, 24.8, 25.9, 28.8], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [28.6, 26.8, 22.5, 17.9], trend: "Noe bedring (-4.6) - roligere forhold" },
  { navn: "Buskerud", dager: [28.6, 24.9, 21.7, 19.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 150.3, iDag: 45.4, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Finnmark", total: 134.0, iDag: 31.7, endringFraIGar: -5.9, plasseringEndring: 0 },
  { navn: "Troms", total: 125.5, iDag: 35.4, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Oslo", total: 112.7, iDag: 22.4, endringFraIGar: -3.1, plasseringEndring: -1 },
  { navn: "Innlandet", total: 111.6, iDag: 24.5, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Agder", total: 105.8, iDag: 19.7, endringFraIGar: -4.7, plasseringEndring: 0 },
  { navn: "Vestland", total: 105.0, iDag: 22.7, endringFraIGar: -2.4, plasseringEndring: 1 },
  { navn: "Telemark", total: 104.7, iDag: 19.9, endringFraIGar: -5.1, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 104.6, iDag: 25.7, endringFraIGar: -3.5, plasseringEndring: 1 },
  { navn: "Østfold", total: 102.2, iDag: 20.1, endringFraIGar: -6.5, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 102.0, iDag: 28.8, endringFraIGar: 2.9, plasseringEndring: 2 },
  { navn: "Rogaland", total: 95.8, iDag: 17.9, endringFraIGar: -4.6, plasseringEndring: -1 },
  { navn: "Buskerud", total: 95.1, iDag: 19.9, endringFraIGar: -1.8, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 148.6, vindkast: 0, nedbor: 208.6, temp: -0.4, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 88.0, vindkast: 37.5, nedbor: 0, temp: -1.3, farevarsel: "oransje" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 79.6, vindkast: 40.4, nedbor: 0, temp: 4.3, farevarsel: "oransje" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 75.7, vindkast: 34.9, nedbor: 0, temp: 1.7, farevarsel: "oransje" },
  { navn: "E6 SEMSKA", kommune: "SALTDAL", fylke: "Nordland", ei: 75.5, vindkast: 0, nedbor: 33.7, temp: -0.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -2.6,
    dager: [53.3, 64.1, 79.2, 88.0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 71 EI per dag. Toppdag Tor med 88.0 EI. Kraftige vindkast opp til 38.4 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -8.0,
    dager: [55.1, 71.9, 82.6, 65.5, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 69 EI per dag. Toppdag Ons med 82.6 EI. Kraftige vindkast opp til 41.5 m/s. Bitende kulde ned til -8.0 grader C."
  },
  {
    navn: "KAPPFJELLET",
    kommune: "GRANE",
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [52.2, 61.9, 78.2, 75.2, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 67 EI per dag. Toppdag Ons med 78.2 EI. Kraftige vindkast opp til 35.2 m/s."
  },
  {
    navn: "E6 STØDI BRU",
    kommune: "SALTDAL",
    ...
    precipTotal: 119.5,
    tempMin: -2.2,
    dager: [38.8, 59.0, 96.8, 71.3, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Ons med 96.8 EI. Mye nedbor med totalt 119.5 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 3.5,
    dager: [43.6, 51.2, 84.7, 79.6, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 150.3 poeng - 16.3 poeng foran Finnmark (134.0).",
