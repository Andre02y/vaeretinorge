 ...
 *
 * Sist oppdatert: 04.07.2026 kl. 17:53
...
export const META = {
  ...
  datoOppdatert: "04.07.2026 kl. 17:53",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [18.6, 27.6, 27.6, 22.5, 17.4, 17.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [21.4, 27.7, 24.9, 17.5, 17.3, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [14.2, 24.3, 24.3, 18.7, 14.9, 14.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [19.3, 18.9, 13.2, 15.8, 19.7, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [16.7, 16.3, 13.1, 16.7, 21.7, 19.3], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Trøndelag", dager: [15.7, 19.4, 14.6, 13.9, 16.8, 17.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [11.7, 12.8, 13.3, 17.5, 19.3, 15.9], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Buskerud", dager: [10.2, 11.1, 11.2, 21.6, 19.1, 15.5], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Rogaland", dager: [10.6, 11.0, 10.7, 19.1, 23.3, 13.1], trend: "Markant bedring (-10.2) - lavtrykket har passert" },
  { navn: "Agder", dager: [11.9, 12.8, 11.1, 17.5, 20.4, 13.5], trend: "Markant bedring (-6.9) - lavtrykket har passert" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Finnmark", total: 131.5, iDag: 17.8, endringFraIGar: 0.4, plasseringEndring: -1 },
  { navn: "Nordland", total: 128.1, iDag: 19.3, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Troms", total: 111.2, iDag: 14.8, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 107.5, iDag: 20.6, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 103.8, iDag: 19.3, endringFraIGar: -2.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 97.8, iDag: 17.4, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Innlandet", total: 90.5, iDag: 15.9, endringFraIGar: -3.4, plasseringEndring: 1 },
  { navn: "Buskerud", total: 88.7, iDag: 15.5, endringFraIGar: -3.6, plasseringEndring: 2 },
  { navn: "Rogaland", total: 87.8, iDag: 13.1, endringFraIGar: -10.2, plasseringEndring: -2 },
  { navn: "Agder", total: 87.2, iDag: 13.5, endringFraIGar: -6.9, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 53.9, vindkast: 24.0, nedbor: 0, temp: 12.0, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 47.2, vindkast: 11.2, nedbor: 1.8, temp: 0, farevarsel: "gul" },
  { navn: "E10 BJØRNFJELL", kommune: "NARVIK", fylke: "Nordland", ei: 47.0, vindkast: 0, nedbor: 4.3, temp: -17.7, farevarsel: "gul" },
  { navn: "SVINØY FYR", kommune: "HERØY", fylke: "Møre og Romsdal", ei: 46.8, vindkast: 22.7, nedbor: 0, temp: 12.3, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 45.6, vindkast: 16.8, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 67.3, 64.6, 38.5, 34.5, 40.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [32.2, 57.2, 59.0, 47.3, 38.0, 43.2, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.3, 48.2, 61.0, 47.5, 30.9, 30.7, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 6.5,
    dager: [35.3, 51.6, 64.1, 37.3, 36.6, 22.2, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Oslo har overtatt forsteplassen i sammenlagt-ligaen med 137.4 poeng, foran Finnmark (131.5).",
