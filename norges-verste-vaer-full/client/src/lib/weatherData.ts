 ...
 *
 * Sist oppdatert: 21.05.2026 kl. 17:30
...
export const META = {
  ...
  datoOppdatert: "21.05.2026 kl. 17:30",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [26.7, 22.2, 20.9, 22.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [22.4, 21.7, 21.0, 23.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.0, 19.1, 17.1, 29.0], trend: "Kraftig forverring (+11.9) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [21.3, 23.1, 18.0, 18.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [21.1, 19.7, 18.4, 19.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.6, 19.7, 16.8, 18.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [22.1, 19.8, 16.0, 16.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [21.0, 17.0, 14.9, 20.9], trend: "Kraftig forverring (+6.0) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [19.6, 16.7, 15.4, 16.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [16.4, 14.7, 13.7, 19.4], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [17.4, 15.4, 14.1, 14.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.3, 12.1, 12.3, 18.6], trend: "Kraftig forverring (+6.3) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [17.9, 14.2, 12.7, 13.0], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 92.0, iDag: 22.2, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 88.1, iDag: 23.0, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Oslo", total: 84.2, iDag: 29.0, endringFraIGar: 11.9, plasseringEndring: 4 },
  { navn: "Rogaland", total: 81.1, iDag: 18.7, endringFraIGar: 0.7, plasseringEndring: -1 },
  { navn: "Vestland", total: 78.3, iDag: 19.1, endringFraIGar: 0.7, plasseringEndring: -1 },
  { navn: "Troms", total: 75.1, iDag: 18.0, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Nordland", total: 74.1, iDag: 16.2, endringFraIGar: 0.2, plasseringEndring: -2 },
  { navn: "Telemark", total: 73.8, iDag: 20.9, endringFraIGar: 6.0, plasseringEndring: 0 },
  { navn: "Innlandet", total: 68.5, iDag: 16.8, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 64.2, iDag: 19.4, endringFraIGar: 5.7, plasseringEndring: 2 },
  { navn: "Møre og Romsdal", total: 61.5, iDag: 14.6, endringFraIGar: 0.5, plasseringEndring: -1 },
  { navn: "Østfold", total: 59.3, iDag: 18.6, endringFraIGar: 6.3, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 57.8, iDag: 13.0, endringFraIGar: 0.3, plasseringEndring: -2 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 43.8, vindkast: 8.5, nedbor: 2.3, temp: 0, farevarsel: "gul" },
  { navn: "FV889 SELVIKHØYDEN", kommune: "MÅSØY", fylke: "Finnmark", ei: 43.6, vindkast: 0, nedbor: 0, temp: -12.4, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0.5,
    dager: [57.8, 66.1, 63.0, 36.7, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.4,
    dager: [56.2, 57.1, 60.3, 36.7, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0.4,
    dager: [50.7, 48.7, 43.7, 33.7, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.2, 46.6, 45.8, 35.8, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.3,
    dager: [50.6, 53.0, 43.0, 29.3, 0, 0, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 92.0 poeng - 3.9 poeng foran Finnmark (88.1).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
