 ...
 *
 * Sist oppdatert: 31.05.2026 kl. 08:46
...
export const META = {
  ...
  datoOppdatert: "31.05.2026 kl. 08:46",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [25.2, 25.2, 27.3, 29.3, 26.3, 24.8, 21.5], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Nordland", dager: [29.5, 26.9, 25.6, 26.8, 25.7, 24.4, 20.4], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Troms", dager: [24.4, 20.0, 20.5, 23.0, 24.4, 23.3, 20.1], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.4, 28.2, 28.3, 23.1, 19.4, 17.6, 14.5], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [23.8, 29.9, 25.8, 21.7, 16.9, 15.3, 14.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [25.3, 25.3, 22.1, 18.1, 16.0, 18.1, 14.2], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Innlandet", dager: [17.2, 21.6, 21.4, 18.5, 14.5, 13.7, 14.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [16.6, 17.4, 17.5, 17.5, 17.5, 18.0, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [15.1, 17.7, 18.6, 14.9, 15.3, 17.3, 14.6], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Agder", dager: [14.9, 17.0, 16.9, 15.4, 14.5, 15.0, 12.9], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Telemark", dager: [13.2, 14.3, 14.8, 14.2, 14.0, 14.3, 11.5], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Buskerud", dager: [13.2, 14.9, 14.9, 14.1, 13.5, 12.8, 12.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [10.9, 13.5, 14.2, 13.5, 13.4, 10.0, 10.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 179.6, iDag: 21.5, endringFraIGar: -3.3, plasseringEndring: 1 },
  { navn: "Nordland", total: 179.3, iDag: 20.4, endringFraIGar: -4.0, plasseringEndring: -1 },
  { navn: "Troms", total: 155.7, iDag: 20.1, endringFraIGar: -3.2, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 153.5, iDag: 14.5, endringFraIGar: -3.1, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 147.9, iDag: 14.5, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Vestland", total: 139.1, iDag: 14.2, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Innlandet", total: 121.4, iDag: 14.5, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Oslo", total: 121.1, iDag: 16.6, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 113.5, iDag: 14.6, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Agder", total: 106.6, iDag: 12.9, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Telemark", total: 96.3, iDag: 11.5, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 96.0, iDag: 12.6, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 86.4, iDag: 10.9, endringFraIGar: 0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 45.0, vindkast: 13.9, nedbor: 0, temp: 2.9, farevarsel: "gul" },
  { navn: "MYKEN", kommune: "RØDØY", fylke: "Nordland", ei: 44.1, vindkast: 16.1, nedbor: 0, temp: 7.9, farevarsel: "gul" },
  { navn: "EIMHJELLEN", kommune: "GLOPPEN", fylke: "Vestland", ei: 41.5, vindkast: 0, nedbor: 13.0, temp: 0, farevarsel: "gul" },
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 40.9, vindkast: 0, nedbor: 0, temp: -18.6, farevarsel: "gul" },
  { navn: "ANDA FYR II", kommune: "ØKSNES", fylke: "Nordland", ei: 40.4, vindkast: 0, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [62.3, 64.9, 67.3, 51.5, 39.6, 28.5, 26.6],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [53.2, 68.2, 54.6, 36.4, 37.9, 33.2, 34.3],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [55.2, 56.1, 58.8, 47.2, 37.1, 26.9, 22.7],
  ...
  },
  {
    ...
    precipTotal: 33.9,
    tempMin: 0,
    dager: [61.9, 62.1, 48.6, 29.4, 28.1, 45.3, 25.7],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.4,
    dager: [55.2, 57.9, 57.8, 35.3, 32.2, 31.3, 31.3],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 43 EI per dag. Toppdag Tir med 57.9 EI. Kraftige vindkast opp til 26.3 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 179.6 poeng, foran Nordland (179.3).",
