 ...
 *
 * Sist oppdatert: 31.07.2026 kl. 07:54
...
export const META = {
  ...
  datoOppdatert: "31.07.2026 kl. 07:54",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Møre og Romsdal", dager: [27.6, 25.9, 17.5, 17.7, 20.0], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [25.0, 21.1, 18.7, 21.5, 18.8], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Nordland", dager: [18.6, 18.4, 23.0, 20.2, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.2, 17.1, 15.9, 25.2, 18.1], trend: "Markant bedring (-7.1) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [19.4, 21.5, 14.8, 16.4, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [19.5, 18.2, 16.7, 13.8, 17.1], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [21.9, 15.9, 16.0, 15.6, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [15.0, 16.0, 21.4, 16.2, 14.2], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Finnmark", dager: [17.7, 14.2, 17.4, 17.8, 14.4], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Innlandet", dager: [16.9, 15.5, 13.7, 16.5, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.4, 13.1, 13.5, 14.5, 14.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.4, 12.3, 11.8, 15.6, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [12.3, 11.9, 12.4, 9.5, 11.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Møre og Romsdal", total: 108.7, iDag: 20.0, endringFraIGar: 2.3, plasseringEndring: 0 },
  { navn: "Vestland", total: 105.1, iDag: 18.8, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Nordland", total: 99.5, iDag: 19.3, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 95.5, iDag: 18.1, endringFraIGar: -7.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 89.8, iDag: 17.7, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Agder", total: 85.3, iDag: 17.1, endringFraIGar: 3.3, plasseringEndring: 2 },
  { navn: "Rogaland", total: 84.5, iDag: 15.1, endringFraIGar: -0.5, plasseringEndring: -1 },
  { navn: "Troms", total: 82.8, iDag: 14.2, endringFraIGar: -2.0, plasseringEndring: -1 },
  { navn: "Finnmark", total: 81.5, iDag: 14.4, endringFraIGar: -3.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 78.5, iDag: 15.9, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 71.2, iDag: 14.7, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 70.2, iDag: 15.1, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 57.4, iDag: 11.3, endringFraIGar: 1.8, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 64.4, vindkast: 0, nedbor: 0.1, temp: -33.6, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -30.0, farevarsel: "gul" },
  { navn: "FV65 BYE", kommune: "ORKLAND", fylke: "Trøndelag", ei: 57.5, vindkast: 0, nedbor: 0, temp: -35.6, farevarsel: "gul" },
  { navn: "RV13 SVELGANE", kommune: "VOSS", fylke: "Vestland", ei: 53.5, vindkast: 0, nedbor: 1.1, temp: -32.9, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 12.8,
    tempMin: -39.8,
    dager: [38.7, 56.4, 55.0, 69.2, 59.9, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 41.1,
    tempMin: 0,
    dager: [57.3, 51.8, 45.7, 56.9, 52.7, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [59.3, 47.5, 37.2, 38.3, 46.2, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 46 EI per dag. Toppdag Man med 59.3 EI."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: 0.4,
    dager: [49.6, 49.1, 42.9, 41.2, 41.8, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Man med 49.6 EI. Kraftige vindkast opp til 26.6 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Møre og Romsdal leder sammenlagt med 108.7 poeng - 3.6 poeng foran Vestland (105.1).",
