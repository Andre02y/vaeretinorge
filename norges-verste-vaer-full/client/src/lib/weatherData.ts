 ...
 *
 * Sist oppdatert: 26.08.2026 kl. 05:43
 * Periode sammenlagt: 24.08 - 26.08.2026 (3 dager)
...
export const META = {
  ...
  dagLabel: "Onsdag 26.08.2026",
  sammenlagtLabel: "24.08 - 26.08.2026 (3 dager)",
  datoOppdatert: "26.08.2026 kl. 05:43",
  rapportVersjon: "v2.2 (norsk tid, live uke, ryddig arkiv, fikset uke/arkiv-logikk)",
  dagLabels: ["Man 24", "Tir 25", "Ons 26"],
};

// ---- DAG-FOR-DAG EI PER FYLKE ----

export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [18.1, 23.0, 31.1], trend: "Kraftig forverring (+8.1) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [21.8, 21.9, 17.1], trend: "Noe bedring (-4.8) - roligere forhold" },
  { navn: "Troms", dager: [17.6, 20.2, 21.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [16.3, 15.7, 16.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [16.5, 14.2, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [13.6, 13.7, 16.0], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [14.8, 13.0, 13.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [14.8, 12.1, 13.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [14.1, 12.8, 12.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [14.0, 11.5, 12.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [11.8, 11.3, 13.6], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [11.7, 10.9, 14.0], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [11.1, 9.8, 11.9], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 72.2, iDag: 31.1, endringFraIGar: 8.1, plasseringEndring: 1 },
  { navn: "Nordland", total: 60.8, iDag: 17.1, endringFraIGar: -4.8, plasseringEndring: -1 },
  { navn: "Troms", total: 58.9, iDag: 21.1, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 48.8, iDag: 16.8, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 45.8, iDag: 15.1, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Agder", total: 43.3, iDag: 16.0, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 41.7, iDag: 13.9, endringFraIGar: 0.9, plasseringEndring: -1 },
  { navn: "Innlandet", total: 40.4, iDag: 13.5, endringFraIGar: 1.4, plasseringEndring: 1 },
  { navn: "Vestland", total: 39.6, iDag: 12.7, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Rogaland", total: 37.6, iDag: 12.1, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 36.7, iDag: 13.6, endringFraIGar: 2.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 36.6, iDag: 14.0, endringFraIGar: 3.1, plasseringEndring: 0 },
  { navn: "Østfold", total: 32.8, iDag: 11.9, endringFraIGar: 2.1, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER ONSDAG 26.08.2026 ----

export const STASJONER_PERIODE = [
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 74.2, vindkast: 0, nedbor: 0, temp: -46.8, farevarsel: "oransje" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 66.3, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "oransje" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 60.7, vindkast: 0, nedbor: 0, temp: -39.6, farevarsel: "oransje" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 339.0,
    tempMin: 7.2,
    dager: [144.9, 36.2, 12.8, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Man med 144.9 EI. Mye nedbor med totalt 339.0 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.8,
    dager: [63.5, 63.7, 66.3, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Ons med 66.3 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.9,
    dager: [45.3, 59.3, 59.9, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 55 EI per dag. Toppdag Ons med 59.9 EI. Bitende kulde ned til -39.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -46.8,
    dager: [46.0, 27.8, 74.2, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Ons med 74.2 EI. Bitende kulde ned til -46.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [36.1, 46.8, 52.9, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Ons med 52.9 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 72.2 poeng, foran Nordland (60.8).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-08-24",
  tilDato: "2026-08-26",
  periode: "24.08 - 26.08.2026 (3 dager)",
  dagerRegistrert: 3,
  versteFylke: "Finnmark",
  versteFylkeScore: 72.2,
};
