 ...
 *
 * Sist oppdatert: 18.03.2026 kl. 22:25
...
export const META = {
  ...
  datoOppdatert: "18.03.2026 kl. 22:25",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.6, 33.8, 41.5], trend: "Kraftig forverring (+7.7) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [31.1, 33.6, 37.6], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [34.0, 30.8, 25.5], trend: "Markant bedring (-5.3) - lavtrykket har passert" },
  { navn: "Troms", dager: [28.1, 28.9, 33.1], trend: "Noe forverring (+4.2) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [32.1, 28.8, 26.2], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Agder", dager: [33.5, 28.2, 24.4], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Telemark", dager: [30.1, 29.7, 25.0], trend: "Noe bedring (-4.7) - roligere forhold" },
  { navn: "Vestland", dager: [29.9, 27.3, 25.1], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Østfold", dager: [28.9, 26.6, 26.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [24.5, 25.2, 29.2], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [28.6, 26.8, 22.5], trend: "Noe bedring (-4.3) - roligere forhold" },
  { navn: "Buskerud", dager: [28.6, 24.9, 21.7], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.5, 24.8, 25.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 104.9, iDag: 41.5, endringFraIGar: 7.7, plasseringEndring: 2 },
  { navn: "Finnmark", total: 102.3, iDag: 37.6, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Oslo", total: 90.3, iDag: 25.5, endringFraIGar: -5.3, plasseringEndring: -2 },
  { navn: "Troms", total: 90.1, iDag: 33.1, endringFraIGar: 4.2, plasseringEndring: 4 },
  { navn: "Innlandet", total: 87.1, iDag: 26.2, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Agder", total: 86.1, iDag: 24.4, endringFraIGar: -3.8, plasseringEndring: -2 },
  { navn: "Telemark", total: 84.8, iDag: 25.0, endringFraIGar: -4.7, plasseringEndring: -1 },
  { navn: "Vestland", total: 82.3, iDag: 25.1, endringFraIGar: -2.2, plasseringEndring: -1 },
  { navn: "Østfold", total: 82.1, iDag: 26.6, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 78.9, iDag: 29.2, endringFraIGar: 4.0, plasseringEndring: 2 },
  { navn: "Rogaland", total: 77.9, iDag: 22.5, endringFraIGar: -4.3, plasseringEndring: -1 },
  { navn: "Buskerud", total: 75.2, iDag: 21.7, endringFraIGar: -3.2, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 73.2, iDag: 25.9, endringFraIGar: 1.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 STØDI BRU", kommune: "SALTDAL", fylke: "Nordland", ei: 96.8, vindkast: 0, nedbor: 80.6, temp: 1.1, farevarsel: "oransje" },
  { navn: "KVITFOSSEN I VÅGAN", kommune: "VÅGAN", fylke: "Nordland", ei: 89.5, vindkast: 0, nedbor: 109.1, temp: 0, farevarsel: "oransje" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 84.7, vindkast: 45.7, nedbor: 0, temp: 5.5, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 82.6, vindkast: 41.5, nedbor: 0, temp: -1.1, farevarsel: "oransje" },
  { navn: "ROALDSHORNET", kommune: "STRANDA", fylke: "Møre og Romsdal", ei: 81.0, vindkast: 46.1, nedbor: 0, temp: 4.3, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 5.2,
    dager: [60.7, 74.0, 74.3, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 70 EI per dag. Toppdag Ons med 74.3 EI. Kraftige vindkast opp til 36.2 m/s."
  },
  {
    navn: "ROALDSHORNET",
    kommune: "STRANDA",
    ...
    precipTotal: 0,
    tempMin: -1.6,
    dager: [56.5, 71.2, 81.0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 70 EI per dag. Toppdag Ons med 81.0 EI. Kraftige vindkast opp til 46.1 m/s."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 104.9 poeng, foran Finnmark (102.3).",
  gammelLeder: "Oslo",
  nyLeder: "Nordland",
};
