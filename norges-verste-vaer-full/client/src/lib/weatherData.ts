 ...
 *
 * Sist oppdatert: 13.07.2026 kl. 13:49
...
export const META = {
  ...
  datoOppdatert: "13.07.2026 kl. 13:49",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Oslo", dager: [15.5], trend: "Kraftig forverring (+15.5) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [13.4], trend: "Kraftig forverring (+13.4) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [12.9], trend: "Kraftig forverring (+12.9) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [10.7], trend: "Kraftig forverring (+10.7) - okt vind og/eller nedbor" },
  { navn: "Buskerud", dager: [10.4], trend: "Kraftig forverring (+10.4) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [10.1], trend: "Kraftig forverring (+10.1) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [9.4], trend: "Kraftig forverring (+9.4) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [9.1], trend: "Kraftig forverring (+9.1) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [8.4], trend: "Kraftig forverring (+8.4) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [7.7], trend: "Kraftig forverring (+7.7) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Oslo", total: 15.5, iDag: 15.5, endringFraIGar: 15.5, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 13.4, iDag: 13.4, endringFraIGar: 13.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 12.9, iDag: 12.9, endringFraIGar: 12.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 10.7, iDag: 10.7, endringFraIGar: 10.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 10.4, iDag: 10.4, endringFraIGar: 10.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 10.1, iDag: 10.1, endringFraIGar: 10.1, plasseringEndring: 0 },
  { navn: "Telemark", total: 9.4, iDag: 9.4, endringFraIGar: 9.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 9.1, iDag: 9.1, endringFraIGar: 9.1, plasseringEndring: 0 },
  { navn: "Østfold", total: 8.4, iDag: 8.4, endringFraIGar: 8.4, plasseringEndring: 0 },
  { navn: "Agder", total: 7.7, iDag: 7.7, endringFraIGar: 7.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 57.5, vindkast: 22.0, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "E10 BJØRNFJELL", kommune: "NARVIK", fylke: "Nordland", ei: 56.5, vindkast: 0, nedbor: 0, temp: -28.9, farevarsel: "gul" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 51.4, vindkast: 21.8, nedbor: 0, temp: 4.7, farevarsel: "gul" },
  { navn: "MANNDALEN - VADDJA", kommune: "KÅFJORD", fylke: "Troms", ei: 50.6, vindkast: 61.4, nedbor: 0, temp: 14.6, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 49.3, vindkast: 22.3, nedbor: 0, temp: 8.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Man med 56.5 EI. Bitende kulde ned til -28.9 grader C."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
  ...
  },
  {
    ...
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Man med 50.6 EI. Kraftige vindkast opp til 61.4 m/s."
  },
  {
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "TROMS LEDER!",
  beskrivelse: "Troms leder sammenlagt med 20.1 poeng - 0.5 poeng foran Nordland (19.6).",
  gammelLeder: "Troms",
  nyLeder: "Troms",
};
