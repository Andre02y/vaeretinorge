 ...
 *
 * Sist oppdatert: 10.05.2026 kl. 09:54
...
export const META = {
  ...
  datoOppdatert: "10.05.2026 kl. 09:54",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.3, 33.1, 30.4, 29.3, 26.7, 23.8, 27.7], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [33.7, 34.3, 28.4, 24.4, 20.2, 24.5, 28.2], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [42.9, 32.3, 29.2, 24.6, 20.9, 18.9, 24.6], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [29.1, 29.8, 28.5, 25.9, 24.7, 28.3, 26.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [27.4, 29.4, 26.8, 22.6, 20.7, 24.4, 25.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [28.0, 25.4, 25.0, 24.5, 24.4, 24.1, 20.1], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Innlandet", dager: [23.8, 26.7, 24.8, 22.3, 21.4, 20.1, 23.5], trend: "Noe forverring (+3.4) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [19.3, 27.1, 19.8, 18.7, 18.9, 19.3, 30.2], trend: "Kraftig forverring (+10.9) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [21.4, 22.4, 21.0, 18.2, 18.6, 19.0, 21.9], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [21.3, 21.5, 20.6, 19.2, 18.7, 17.1, 21.0], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [18.4, 21.8, 19.6, 19.1, 17.6, 18.2, 21.8], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [18.4, 19.3, 19.9, 18.4, 18.2, 17.3, 21.3], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [19.0, 18.8, 18.7, 17.3, 16.6, 16.1, 17.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 204.3, iDag: 27.7, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 193.7, iDag: 28.2, endringFraIGar: 3.7, plasseringEndring: 2 },
  { navn: "Trøndelag", total: 193.4, iDag: 24.6, endringFraIGar: 5.7, plasseringEndring: -1 },
  { navn: "Finnmark", total: 193.0, iDag: 26.7, endringFraIGar: -1.6, plasseringEndring: -1 },
  { navn: "Vestland", total: 177.0, iDag: 25.7, endringFraIGar: 1.3, plasseringEndring: 1 },
  { navn: "Troms", total: 171.5, iDag: 20.1, endringFraIGar: -4.0, plasseringEndring: -1 },
  { navn: "Innlandet", total: 162.6, iDag: 23.5, endringFraIGar: 3.4, plasseringEndring: 0 },
  { navn: "Oslo", total: 153.3, iDag: 30.2, endringFraIGar: 10.9, plasseringEndring: 0 },
  { navn: "Rogaland", total: 142.5, iDag: 21.9, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Agder", total: 139.4, iDag: 21.0, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 136.5, iDag: 21.8, endringFraIGar: 3.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 132.8, iDag: 21.3, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 124.2, iDag: 17.7, endringFraIGar: 1.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SKLINNA FYR", kommune: "LEKA", fylke: "Trøndelag", ei: 58.7, vindkast: 24.0, nedbor: 0, temp: 7.0, farevarsel: "gul" },
  { navn: "MYKEN", kommune: "RØDØY", fylke: "Nordland", ei: 57.7, vindkast: 23.5, nedbor: 7.9, temp: 6.7, farevarsel: "gul" },
  { navn: "NORDØYAN FYR", kommune: "NÆRØYSUND", fylke: "Trøndelag", ei: 56.8, vindkast: 23.3, nedbor: 0, temp: 7.1, farevarsel: "gul" },
  { navn: "BUHOLMRÅSA FYR", kommune: "OSEN", fylke: "Trøndelag", ei: 55.8, vindkast: 23.4, nedbor: 0, temp: 7.4, farevarsel: "gul" },
  { navn: "KAPPFJELLET", kommune: "GRANE", fylke: "Nordland", ei: 54.1, vindkast: 17.6, nedbor: 0, temp: 0.0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3110.3,
    tempMin: -2.9,
    dager: [1597.7, 31.1, 25.5, 24.2, 25.6, 25.2, 21.4],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.8,
    dager: [61.9, 55.8, 48.8, 42.3, 51.3, 56.3, 49.3],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.7,
    dager: [54.9, 47.3, 49.0, 43.4, 48.3, 53.5, 49.8],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.2,
    dager: [62.2, 52.5, 45.5, 41.8, 39.5, 39.5, 50.9],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.5,
    dager: [54.9, 51.8, 44.8, 39.9, 43.3, 48.4, 47.0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 204.3 poeng - 10.6 poeng foran Møre og Romsdal (193.7).",
