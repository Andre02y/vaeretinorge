 ...
 *
 * Sist oppdatert: 05.06.2026 kl. 13:56
...
export const META = {
  ...
  datoOppdatert: "05.06.2026 kl. 13:56",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [29.2, 29.3, 28.8, 32.7, 36.5], trend: "Noe forverring (+3.8) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [19.4, 18.4, 21.7, 26.3, 23.6], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Telemark", dager: [20.8, 18.7, 18.5, 23.2, 22.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.8, 17.7, 17.9, 23.0, 22.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [19.0, 18.5, 17.7, 21.3, 19.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.8, 17.1, 16.9, 23.3, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [19.6, 18.1, 19.5, 19.3, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [20.5, 18.8, 19.9, 17.6, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [17.7, 16.2, 14.9, 21.1, 23.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [18.4, 17.5, 18.4, 16.9, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [17.6, 17.5, 17.3, 14.7, 14.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [18.8, 17.3, 15.9, 12.5, 14.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [13.8, 15.4, 12.7, 14.2, 14.8], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 156.5, iDag: 36.5, endringFraIGar: 3.8, plasseringEndring: 0 },
  { navn: "Agder", total: 109.4, iDag: 23.6, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 104.1, iDag: 22.9, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 100.3, iDag: 22.9, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 96.4, iDag: 19.9, endringFraIGar: -1.4, plasseringEndring: 2 },
  { navn: "Innlandet", total: 96.2, iDag: 22.1, endringFraIGar: -1.2, plasseringEndring: 2 },
  { navn: "Vestland", total: 95.3, iDag: 18.8, endringFraIGar: -0.5, plasseringEndring: -1 },
  { navn: "Finnmark", total: 93.1, iDag: 16.3, endringFraIGar: -1.3, plasseringEndring: -3 },
  { navn: "Østfold", total: 93.0, iDag: 23.1, endringFraIGar: 2.0, plasseringEndring: 1 },
  { navn: "Nordland", total: 88.2, iDag: 17.0, endringFraIGar: 0.1, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 81.9, iDag: 14.8, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Troms", total: 78.5, iDag: 14.0, endringFraIGar: 1.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 70.9, iDag: 14.8, endringFraIGar: 0.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 62.0, vindkast: 27.8, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "EIMHJELLEN", kommune: "GLOPPEN", fylke: "Vestland", ei: 58.2, vindkast: 0, nedbor: 46.5, temp: 0, farevarsel: "gul" },
  { navn: "GLITRE", kommune: "MODUM", fylke: "Buskerud", ei: 54.5, vindkast: 0, nedbor: 39.0, temp: 0, farevarsel: "gul" },
  { navn: "TESSUNGDALEN - BAKKHUS", kommune: "TINN", fylke: "Telemark", ei: 52.4, vindkast: 0, nedbor: 34.8, temp: 0, farevarsel: "gul" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 51.0, vindkast: 25.0, nedbor: 0, temp: 4.5, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 4.2,
    dager: [28.2, 46.6, 66.5, 62.2, 51.0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 9.5,
    tempMin: 0,
    dager: [44.9, 42.9, 49.8, 47.5, 43.5, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 2.9,
    dager: [31.8, 36.7, 56.2, 58.8, 40.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [33.4, 33.2, 56.9, 56.0, 41.9, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Ons med 56.9 EI. Kraftige vindkast opp til 30.6 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 3.9,
    dager: [26.7, 35.9, 59.1, 53.0, 40.1, 0, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 156.5 poeng - 47.1 poeng foran Agder (109.4).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
