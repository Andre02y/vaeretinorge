 ...
 *
 * Sist oppdatert: 29.05.2026 kl. 22:07
...
export const META = {
  ...
  datoOppdatert: "29.05.2026 kl. 22:07",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.5, 26.9, 25.6, 26.8, 25.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [25.2, 25.2, 27.3, 29.3, 26.3], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.4, 28.2, 28.3, 23.1, 19.4], trend: "Noe bedring (-3.7) - roligere forhold" },
  ...
  { navn: "Innlandet", dager: [17.2, 21.6, 21.4, 18.5, 14.5], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Oslo", dager: [16.6, 17.4, 17.5, 17.5, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [15.1, 17.7, 18.6, 14.9, 15.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.9, 17.0, 16.9, 15.4, 14.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 134.5, iDag: 25.7, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 133.3, iDag: 26.3, endringFraIGar: -3.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 121.4, iDag: 19.4, endringFraIGar: -3.7, plasseringEndring: 0 },
  ...
  { navn: "Innlandet", total: 93.2, iDag: 14.5, endringFraIGar: -4.0, plasseringEndring: 0 },
  { navn: "Oslo", total: 86.5, iDag: 17.5, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 81.6, iDag: 15.3, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Agder", total: 78.7, iDag: 14.5, endringFraIGar: -0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "TORVHAUGDALEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 47.3, vindkast: 8.4, nedbor: 1.8, temp: 1.5, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 44.9, vindkast: 15.9, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "SISOVATNET", kommune: "SØRFOLD", fylke: "Nordland", ei: 44.7, vindkast: 6.0, nedbor: 4.9, temp: 1.9, farevarsel: "gul" },
  { navn: "E10 SKITDALSHØGDA", kommune: "NARVIK", fylke: "Nordland", ei: 44.6, vindkast: 0, nedbor: 11.7, temp: 1.8, farevarsel: "gul" },
  { navn: "E10 BJØRNFJELL", kommune: "NARVIK", fylke: "Nordland", ei: 44.1, vindkast: 0, nedbor: 10.3, temp: 1.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [62.3, 64.9, 67.3, 51.5, 39.6, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [55.2, 56.1, 58.8, 47.2, 37.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [53.2, 68.2, 54.6, 36.4, 37.9, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0.1,
    dager: [46.7, 66.8, 60.0, 43.1, 32.0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 1.0,
    dager: [55.7, 63.5, 53.8, 36.4, 33.2, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 63.5 EI. Kraftige vindkast opp til 28.2 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 134.5 poeng - 1.2 poeng foran Finnmark (133.3).",
