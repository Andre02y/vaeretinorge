 ...
 *
 * Sist oppdatert: 25.07.2026 kl. 20:47
...
export const META = {
  ...
  datoOppdatert: "25.07.2026 kl. 20:47",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [19.7, 28.1, 23.5, 21.2, 26.1, 19.8], trend: "Markant bedring (-6.3) - lavtrykket har passert" },
  { navn: "Finnmark", dager: [20.9, 22.8, 21.6, 21.8, 22.5, 18.1], trend: "Noe bedring (-4.4) - roligere forhold" },
  { navn: "Oslo", dager: [17.8, 16.2, 16.4, 16.6, 16.3, 28.8], trend: "Kraftig forverring (+12.5) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [14.4, 17.0, 19.9, 17.7, 21.7, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [17.8, 19.5, 20.3, 18.6, 18.6, 15.3], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Trøndelag", dager: [14.1, 17.9, 20.1, 17.0, 19.4, 17.1], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Vestland", dager: [12.2, 13.3, 16.0, 13.8, 19.7, 25.3], trend: "Kraftig forverring (+5.6) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [12.9, 13.8, 18.1, 13.9, 17.1, 21.3], trend: "Noe forverring (+4.2) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [12.7, 11.6, 15.3, 13.8, 13.7, 17.7], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [12.1, 12.3, 11.5, 12.7, 14.6, 17.6], trend: "Noe forverring (+3.0) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [12.0, 11.0, 10.9, 11.8, 12.3, 16.9], trend: "Noe forverring (+4.6) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [13.1, 11.2, 11.3, 11.1, 11.9, 15.2], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [13.0, 11.2, 12.7, 9.7, 10.1, 12.7], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 138.4, iDag: 19.8, endringFraIGar: -6.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 127.7, iDag: 18.1, endringFraIGar: -4.4, plasseringEndring: 0 },
  { navn: "Oslo", total: 112.1, iDag: 28.8, endringFraIGar: 12.5, plasseringEndring: 3 },
  { navn: "Møre og Romsdal", total: 111.2, iDag: 20.5, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Troms", total: 110.1, iDag: 15.3, endringFraIGar: -3.3, plasseringEndring: -2 },
  { navn: "Trøndelag", total: 105.6, iDag: 17.1, endringFraIGar: -2.3, plasseringEndring: -1 },
  { navn: "Vestland", total: 100.3, iDag: 25.3, endringFraIGar: 5.6, plasseringEndring: 1 },
  { navn: "Rogaland", total: 97.1, iDag: 21.3, endringFraIGar: 4.2, plasseringEndring: -1 },
  { navn: "Innlandet", total: 84.8, iDag: 17.7, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Agder", total: 80.8, iDag: 17.6, endringFraIGar: 3.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 74.9, iDag: 16.9, endringFraIGar: 4.6, plasseringEndring: 1 },
  { navn: "Telemark", total: 73.8, iDag: 15.2, endringFraIGar: 3.3, plasseringEndring: -1 },
  { navn: "Østfold", total: 69.4, iDag: 12.7, endringFraIGar: 2.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "GULLFJELLET", kommune: "BERGEN", fylke: "Vestland", ei: 64.7, vindkast: 12.8, nedbor: 87.1, temp: 11.2, farevarsel: "oransje" },
  ...
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 57.0, vindkast: 28.6, nedbor: 0, temp: 11.8, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 56.8, vindkast: 15.3, nedbor: 14.5, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 10.9,
    dager: [32.1, 37.9, 33.3, 36.3, 55.6, 57.0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Lør med 57.0 EI. Kraftige vindkast opp til 28.6 m/s."
  },
  {
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 138.4 poeng - 10.7 poeng foran Finnmark (127.7).",
