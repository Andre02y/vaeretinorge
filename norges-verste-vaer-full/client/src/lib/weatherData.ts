 ...
 *
 * Sist oppdatert: 03.04.2026 kl. 11:44
...
export const META = {
  ...
  datoOppdatert: "03.04.2026 kl. 11:44",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Nordland", dager: [30.4, 31.1, 44.3, 40.1, 31.5], trend: "Markant bedring (-8.6) - lavtrykket har passert" },
  { navn: "Troms", dager: [27.6, 28.6, 39.0, 39.1, 31.4], trend: "Markant bedring (-7.7) - lavtrykket har passert" },
  { navn: "Oslo", dager: [35.4, 21.5, 19.4, 34.4, 38.8], trend: "Noe forverring (+4.4) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [25.2, 27.3, 31.6, 32.3, 29.8], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Vestland", dager: [31.4, 28.2, 28.0, 29.0, 25.7], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Innlandet", dager: [29.0, 25.5, 23.6, 28.0, 29.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [21.9, 23.9, 26.0, 31.0, 28.9], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Østfold", dager: [27.7, 22.4, 20.5, 25.7, 33.2], trend: "Kraftig forverring (+7.5) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [29.5, 24.6, 23.3, 27.6, 24.0], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Agder", dager: [32.3, 23.7, 20.3, 26.2, 26.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [27.1, 20.8, 19.0, 27.4, 33.1], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [26.9, 20.4, 19.0, 27.4, 31.3], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Nordland", total: 177.4, iDag: 31.5, endringFraIGar: -8.6, plasseringEndring: -1 },
  { navn: "Troms", total: 165.7, iDag: 31.4, endringFraIGar: -7.7, plasseringEndring: 0 },
  { navn: "Oslo", total: 149.5, iDag: 38.8, endringFraIGar: 4.4, plasseringEndring: 2 },
  { navn: "Møre og Romsdal", total: 146.2, iDag: 29.8, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 142.3, iDag: 25.7, endringFraIGar: -3.3, plasseringEndring: -2 },
  { navn: "Innlandet", total: 136.0, iDag: 29.9, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 131.7, iDag: 28.9, endringFraIGar: -2.1, plasseringEndring: 1 },
  { navn: "Østfold", total: 129.5, iDag: 33.2, endringFraIGar: 7.5, plasseringEndring: 2 },
  { navn: "Rogaland", total: 129.0, iDag: 24.0, endringFraIGar: -3.6, plasseringEndring: -2 },
  { navn: "Agder", total: 128.5, iDag: 26.0, endringFraIGar: -0.2, plasseringEndring: -1 },
  { navn: "Buskerud", total: 127.4, iDag: 33.1, endringFraIGar: 5.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 125.0, iDag: 31.3, endringFraIGar: 3.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 73.1, vindkast: 0, nedbor: 28.7, temp: -0.6, farevarsel: "oransje" },
  { navn: "TRYVANNSHØGDA", kommune: "OSLO", fylke: "Oslo", ei: 61.1, vindkast: 18.1, nedbor: 8.7, temp: -1.0, farevarsel: "oransje" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 58.1, vindkast: 18.4, nedbor: 0, temp: -2.4, farevarsel: "gul" },
  { navn: "BÅTSFJORD - STRAUMSNESAKSLA", kommune: "BÅTSFJORD", fylke: "Finnmark", ei: 58.1, vindkast: 22.0, nedbor: 0, temp: 0.6, farevarsel: "gul" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 54.4, vindkast: 17.4, nedbor: 0.4, temp: -5.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -5.1,
    dager: [55.0, 56.6, 97.1, 85.8, 42.2, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 83.2,
    tempMin: -0.6,
    dager: [35.8, 49.3, 60.4, 91.8, 73.1, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Tor med 91.8 EI. Mye nedbor med totalt 83.2 mm."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
    ...
    precipTotal: 0,
    tempMin: -3.9,
    dager: [39.4, 58.3, 83.2, 79.3, 44.0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -1.0,
    dager: [36.8, 57.6, 81.7, 74.4, 44.5, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 178.3 poeng, foran Nordland (177.4).",
