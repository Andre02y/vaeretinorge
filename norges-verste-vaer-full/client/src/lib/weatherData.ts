 ...
 *
 * Sist oppdatert: 16.04.2026 kl. 20:57
...
export const META = {
  ...
  datoOppdatert: "16.04.2026 kl. 20:57",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [24.6, 34.2, 28.1, 22.7], trend: "Markant bedring (-5.4) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.2, 23.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.1, 27.6], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [22.8, 27.6, 26.5, 19.8], trend: "Markant bedring (-6.7) - lavtrykket har passert" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.1, 19.8], trend: "Markant bedring (-9.3) - lavtrykket har passert" },
  { navn: "Nordland", dager: [24.3, 23.1, 22.3, 21.7], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Buskerud", dager: [23.2, 23.7, 23.8, 19.7], trend: "Noe bedring (-4.1) - roligere forhold" },
  { navn: "Troms", dager: [22.0, 20.6, 22.4, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.7, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [21.8, 19.8, 21.5, 18.2], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [20.5, 19.6, 19.1, 19.0], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 109.6, iDag: 22.7, endringFraIGar: -5.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 101.2, iDag: 23.5, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Finnmark", total: 99.9, iDag: 27.6, endringFraIGar: 3.5, plasseringEndring: 2 },
  { navn: "Telemark", total: 96.7, iDag: 19.8, endringFraIGar: -6.7, plasseringEndring: -1 },
  { navn: "Oslo", total: 93.7, iDag: 19.8, endringFraIGar: -9.3, plasseringEndring: -1 },
  { navn: "Nordland", total: 91.4, iDag: 21.7, endringFraIGar: -0.6, plasseringEndring: 1 },
  { navn: "Rogaland", total: 91.2, iDag: 24.4, endringFraIGar: 0.9, plasseringEndring: 2 },
  { navn: "Vestland", total: 91.0, iDag: 21.9, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 90.4, iDag: 19.7, endringFraIGar: -4.1, plasseringEndring: -3 },
  { navn: "Troms", total: 87.1, iDag: 22.1, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 86.0, iDag: 21.6, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Østfold", total: 81.3, iDag: 18.2, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 78.2, iDag: 19.0, endringFraIGar: -0.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 73.6, vindkast: 31.7, nedbor: 0, temp: -2.5, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 72.6, vindkast: 33.0, nedbor: 0, temp: -0.3, farevarsel: "oransje" },
  { navn: "E134 MIDTLÆGER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 71.0, vindkast: 0, nedbor: 29.5, temp: 0.7, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 70.8, vindkast: 28.5, nedbor: 0, temp: -5.6, farevarsel: "oransje" },
  { navn: "KLEVAVATNET", kommune: "AURLAND", fylke: "Vestland", ei: 70.7, vindkast: 24.2, nedbor: 0.7, temp: 1.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 406.1,
    tempMin: -1.1,
    dager: [60.2, 231.3, 53.5, 71.0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 104 EI per dag. Toppdag Tir med 231.3 EI. Mye nedbor med totalt 406.1 mm."
  },
  {
    ...
    precipTotal: 599.9,
    tempMin: 2.5,
    dager: [111.7, 222.6, 16.0, 14.2, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 70.9, 66.5, 73.6, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 69 EI per dag. Toppdag Tor med 73.6 EI. Kraftige vindkast opp til 31.7 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [74.4, 75.5, 52.8, 72.6, 0, 0, 0],
  ...
  },
  {
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Tor med 70.8 EI. Kraftige vindkast opp til 28.5 m/s. Bitende kulde ned til -7.3 grader C."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 109.6 poeng - 8.4 poeng foran Innlandet (101.2).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
