 ...
 *
 * Sist oppdatert: 09.07.2026 kl. 19:11
...
export const META = {
  ...
  datoOppdatert: "09.07.2026 kl. 19:11",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [24.2, 26.4, 17.6, 20.6], trend: "Noe forverring (+3.0) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [21.3, 24.8, 20.7, 19.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [20.4, 21.8, 24.9, 17.3], trend: "Markant bedring (-7.6) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [24.6, 20.2, 19.2, 16.7], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Innlandet", dager: [17.8, 18.8, 19.5, 12.2], trend: "Markant bedring (-7.3) - lavtrykket har passert" },
  { navn: "Oslo", dager: [17.5, 17.6, 16.9, 15.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [19.1, 19.6, 15.4, 12.6], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Troms", dager: [13.5, 17.7, 15.4, 16.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [13.9, 16.2, 15.4, 11.7], trend: "Noe bedring (-3.7) - roligere forhold" },
  { navn: "Agder", dager: [14.6, 17.0, 13.3, 9.5], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Buskerud", dager: [14.8, 14.7, 12.9, 10.2], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Telemark", dager: [13.4, 14.4, 12.6, 9.9], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Østfold", dager: [12.1, 13.5, 11.0, 8.6], trend: "Noe bedring (-2.4) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 88.8, iDag: 20.6, endringFraIGar: 3.0, plasseringEndring: 0 },
  { navn: "Nordland", total: 86.7, iDag: 19.9, endringFraIGar: -0.8, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 84.4, iDag: 17.3, endringFraIGar: -7.6, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 80.7, iDag: 16.7, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Innlandet", total: 68.3, iDag: 12.2, endringFraIGar: -7.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 67.4, iDag: 15.4, endringFraIGar: -1.5, plasseringEndring: 1 },
  { navn: "Vestland", total: 66.7, iDag: 12.6, endringFraIGar: -2.8, plasseringEndring: -1 },
  { navn: "Troms", total: 62.7, iDag: 16.1, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Rogaland", total: 57.2, iDag: 11.7, endringFraIGar: -3.7, plasseringEndring: 0 },
  { navn: "Agder", total: 54.4, iDag: 9.5, endringFraIGar: -3.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 52.6, iDag: 10.2, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 50.3, iDag: 9.9, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Østfold", total: 45.2, iDag: 8.6, endringFraIGar: -2.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 47.2, vindkast: 16.6, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "HAMMERFEST LH - BOAZOVARRI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 47.0, vindkast: 18.2, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "CUOVDDATMOHKKI", kommune: "KARASJOK", fylke: "Finnmark", ei: 42.0, vindkast: 0, nedbor: 14.1, temp: 0, farevarsel: "gul" },
  { navn: "SKOGFOSS", kommune: "SØR-VARANGER", fylke: "Finnmark", ei: 41.4, vindkast: 0, nedbor: 12.7, temp: 0, farevarsel: "gul" },
  { navn: "BØRSELV II", kommune: "PORSANGER", fylke: "Finnmark", ei: 40.0, vindkast: 0, nedbor: 9.9, temp: 0, farevarsel: "ingen" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -2.0,
    dager: [45.3, 44.1, 56.0, 29.7, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [44.2, 47.6, 34.0, 47.0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Tir med 47.6 EI."
  },
  {
    navn: "LEIRFJORD",
    kommune: "LEIRFJORD",
    ...
    precipTotal: 64.8,
    tempMin: 0,
    dager: [43.0, 41.2, 51.5, 36.6, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Ons med 51.5 EI. Mye nedbor med totalt 64.8 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -1.5,
    dager: [29.0, 45.8, 61.4, 29.7, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 41 EI per dag. Toppdag Ons med 61.4 EI. Kraftige vindkast opp til 26.9 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [55.4, 47.0, 33.0, 29.7, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 88.8 poeng - 2.1 poeng foran Nordland (86.7).",
