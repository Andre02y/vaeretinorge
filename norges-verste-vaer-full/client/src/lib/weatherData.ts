 ...
 *
 * Sist oppdatert: 15.08.2026 kl. 23:11
...
export const META = {
  ...
  datoOppdatert: "15.08.2026 kl. 23:11",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [24.9, 24.9, 27.2, 22.3, 20.1, 18.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [21.5, 24.6, 23.3, 21.7, 21.0, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [25.0, 25.0, 18.1, 16.3, 18.5, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [28.3, 17.1, 16.4, 15.9, 22.3, 21.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [21.1, 21.9, 24.4, 19.0, 16.6, 16.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.6, 24.8, 19.0, 18.2, 16.5, 19.2], trend: "Noe forverring (+2.7) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [26.9, 21.0, 17.1, 16.2, 18.3, 17.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [22.7, 18.3, 14.3, 12.9, 14.5, 15.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [22.8, 16.7, 14.7, 12.8, 13.1, 16.6], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [20.0, 19.5, 15.2, 13.2, 14.0, 14.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [19.0, 13.1, 12.4, 11.5, 12.9, 15.3], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [18.6, 13.4, 12.4, 11.2, 12.4, 14.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.4, 11.3, 11.3, 10.9, 9.4, 9.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 138.0, iDag: 18.6, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Nordland", total: 131.4, iDag: 19.3, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 122.7, iDag: 19.8, endringFraIGar: 1.3, plasseringEndring: 1 },
  { navn: "Oslo", total: 121.7, iDag: 21.7, endringFraIGar: -0.6, plasseringEndring: 1 },
  { navn: "Troms", total: 119.0, iDag: 16.0, endringFraIGar: -0.6, plasseringEndring: -2 },
  { navn: "Trøndelag", total: 117.3, iDag: 19.2, endringFraIGar: 2.7, plasseringEndring: 1 },
  { navn: "Vestland", total: 117.1, iDag: 17.6, endringFraIGar: -0.7, plasseringEndring: -1 },
  { navn: "Rogaland", total: 97.7, iDag: 15.0, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Agder", total: 96.7, iDag: 16.6, endringFraIGar: 3.5, plasseringEndring: 1 },
  { navn: "Innlandet", total: 96.1, iDag: 14.2, endringFraIGar: 0.2, plasseringEndring: -1 },
  { navn: "Telemark", total: 84.2, iDag: 15.3, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 82.3, iDag: 14.3, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Østfold", total: 68.8, iDag: 9.5, endringFraIGar: 0.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV848 FORNES", kommune: "NARVIK", fylke: "Nordland", ei: 64.9, vindkast: 0, nedbor: 1.2, temp: -39.4, farevarsel: "oransje" },
  { navn: "BIRTAVARRE - HOLMEN", kommune: "KÅFJORD", fylke: "Troms", ei: 62.7, vindkast: 89.9, nedbor: 0, temp: 12.3, farevarsel: "oransje" },
  { navn: "E6 LANGFJORDBOTN", kommune: "ALTA", fylke: "Finnmark", ei: 62.2, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "oransje" },
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 56.3, vindkast: 0, nedbor: 0, temp: -31.5, farevarsel: "gul" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 55.8, vindkast: 0, nedbor: 0, temp: -35.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.9,
    dager: [68.2, 63.6, 66.7, 64.1, 61.4, 62.2, 0],
  ...
  },
  {
    ...
    precipTotal: 3.0,
    tempMin: -39.9,
    dager: [60.1, 59.4, 59.9, 44.9, 60.3, 55.8, 0],
  ...
  },
  {
    ...
    precipTotal: 0.4,
    tempMin: -39.8,
    dager: [74.9, 35.1, 65.1, 61.0, 57.7, 28.9, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Man med 74.9 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
    ...
    precipTotal: 29.7,
    tempMin: 0,
    dager: [59.2, 47.8, 24.9, 40.6, 50.1, 46.5, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Man med 59.2 EI. Mye nedbor med totalt 29.7 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.0, 38.1, 44.5, 53.8, 46.0, 37.8, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Tor med 53.8 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 138.0 poeng - 6.6 poeng foran Nordland (131.4).",
