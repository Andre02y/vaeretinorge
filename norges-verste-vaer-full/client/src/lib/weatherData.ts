 ...
 *
 * Sist oppdatert: 17.06.2026 kl. 21:57
...
export const META = {
  ...
  datoOppdatert: "17.06.2026 kl. 21:57",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [32.1, 22.7, 27.4], trend: "Noe forverring (+4.7) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [26.6, 16.8, 23.6], trend: "Kraftig forverring (+6.8) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [20.5, 18.2, 20.6], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [20.1, 17.7, 15.6], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Nordland", dager: [16.7, 17.4, 18.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.2, 17.7, 15.1], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Innlandet", dager: [18.9, 16.0, 13.9], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Rogaland", dager: [16.0, 16.1, 14.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [15.4, 14.2, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.7, 12.8, 15.6], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [15.5, 14.3, 14.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [18.0, 11.9, 13.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.0, 12.5, 14.9], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 82.2, iDag: 27.4, endringFraIGar: 4.7, plasseringEndring: 0 },
  { navn: "Oslo", total: 67.0, iDag: 23.6, endringFraIGar: 6.8, plasseringEndring: 0 },
  { navn: "Troms", total: 59.3, iDag: 20.6, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 53.4, iDag: 15.6, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Nordland", total: 53.0, iDag: 18.9, endringFraIGar: 1.5, plasseringEndring: 2 },
  { navn: "Trøndelag", total: 52.0, iDag: 15.1, endringFraIGar: -2.6, plasseringEndring: -1 },
  { navn: "Innlandet", total: 48.8, iDag: 13.9, endringFraIGar: -2.1, plasseringEndring: -1 },
  { navn: "Rogaland", total: 46.8, iDag: 14.7, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Agder", total: 45.5, iDag: 15.9, endringFraIGar: 1.7, plasseringEndring: 2 },
  { navn: "Telemark", total: 44.1, iDag: 15.6, endringFraIGar: 2.8, plasseringEndring: 2 },
  { navn: "Vestland", total: 43.9, iDag: 14.1, endringFraIGar: -0.2, plasseringEndring: -1 },
  { navn: "Østfold", total: 43.4, iDag: 13.5, endringFraIGar: 1.6, plasseringEndring: -3 },
  { navn: "Buskerud", total: 42.4, iDag: 14.9, endringFraIGar: 2.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "GAMANJUNNI", kommune: "KÅFJORD", fylke: "Troms", ei: 72.0, vindkast: 9.0, nedbor: 88.8, temp: 3.6, farevarsel: "oransje" },
  { navn: "LAKSELV LH - NJEAIDDAN", kommune: "PORSANGER", fylke: "Finnmark", ei: 49.6, vindkast: 16.1, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "HAMMERFEST LH - BOAZOVARRI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 46.0, vindkast: 14.9, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "ISKORAS II", kommune: "KARASJOK", fylke: "Finnmark", ei: 45.1, vindkast: 16.5, nedbor: 0, temp: 6.4, farevarsel: "gul" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 41.5, vindkast: 14.9, nedbor: 0, temp: 5.4, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 89.7,
    tempMin: 0.7,
    dager: [50.4, 28.1, 72.0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Ons med 72.0 EI. Mye nedbor med totalt 89.7 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [52.8, 33.0, 46.0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Man med 52.8 EI."
  },
  {
    navn: "REINHAUGEN",
    kommune: "NESSEBY",
    ...
    precipTotal: 0,
    tempMin: 2.2,
    dager: [51.4, 34.6, 41.5, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Man med 51.4 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [46.0, 31.8, 49.6, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Ons med 49.6 EI."
  },
  {
    navn: "KORGÅSEN",
    kommune: "NESSEBY",
    ...
    precipTotal: 0,
    tempMin: 2.9,
    dager: [54.1, 31.4, 39.4, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Man med 54.1 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 82.2 poeng - 15.2 poeng foran Oslo (67.0).",
