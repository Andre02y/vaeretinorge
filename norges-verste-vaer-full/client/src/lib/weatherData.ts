 ...
 *
 * Sist oppdatert: 23.08.2026 kl. 17:11
...
export const META = {
  ...
  datoOppdatert: "23.08.2026 kl. 17:11",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [21.7, 25.3, 23.4, 28.9, 27.3, 29.8, 27.6], trend: "Noe bedring (-2.2) - roligere forhold" },
  ...
  { navn: "Nordland", dager: [22.4, 22.4, 19.2, 17.4, 17.2, 16.1, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [20.8, 20.0, 17.6, 21.3, 16.7, 16.7, 17.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 16.1, 15.8, 16.3, 18.4, 21.0, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.1, 23.7, 17.7, 14.3, 13.0, 14.7, 15.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.7, 16.4, 14.7, 18.4, 16.5, 17.8, 17.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [17.3, 14.8, 14.0, 14.6, 20.0, 19.0, 15.8], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Agder", dager: [14.6, 15.7, 16.1, 16.2, 15.3, 14.8, 14.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 14.4, 12.9, 12.5, 16.0, 17.9, 16.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 13.9, 13.7, 14.1, 14.9, 13.7, 16.6], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [14.4, 13.6, 11.3, 14.0, 12.3, 12.5, 11.6], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 184.0, iDag: 27.6, endringFraIGar: -2.2, plasseringEndring: 0 },
  ...
  { navn: "Nordland", total: 131.3, iDag: 16.6, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 130.7, iDag: 17.6, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Innlandet", total: 123.4, iDag: 19.2, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Troms", total: 118.9, iDag: 15.4, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 116.6, iDag: 17.1, endringFraIGar: -0.7, plasseringEndring: 1 },
  { navn: "Vestland", total: 115.5, iDag: 15.8, endringFraIGar: -3.2, plasseringEndring: -1 },
  { navn: "Agder", total: 107.6, iDag: 14.9, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 107.1, iDag: 16.2, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 100.2, iDag: 16.6, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Østfold", total: 89.7, iDag: 11.6, endringFraIGar: -0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RV3 EBRU", kommune: "LØTEN", fylke: "Innlandet", ei: 97.4, vindkast: 0, nedbor: 183.5, temp: 14.4, farevarsel: "oransje" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 63.7, vindkast: 0, nedbor: 0, temp: -36.4, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 57.0, vindkast: 0, nedbor: 0, temp: -31.9, farevarsel: "gul" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 50.8, vindkast: 0, nedbor: 0, temp: -22.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -45.9,
    dager: [73.4, 75.4, 16.3, 15.8, 28.1, 67.1, 57.0],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 48 EI per dag. Toppdag Tir med 75.4 EI. Bitende kulde ned til -45.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.2,
    dager: [24.9, 63.7, 65.1, 67.0, 16.7, 22.8, 63.7],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 43.9, 37.6, 38.4, 45.8, 39.4, 36.3],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 184.0 poeng - 45.5 poeng foran Finnmark (138.5).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
