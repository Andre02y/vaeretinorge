 ...
 *
 * Sist oppdatert: 21.06.2026 kl. 15:44
...
export const META = {
  ...
  datoOppdatert: "21.06.2026 kl. 15:44",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Nordland", dager: [16.7, 17.4, 18.9, 18.9, 18.3, 24.0, 25.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [20.1, 17.7, 15.6, 19.0, 18.0, 22.1, 25.4], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [20.5, 18.2, 20.6, 20.5, 16.8, 19.3, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [15.5, 14.3, 14.1, 18.2, 18.9, 22.7, 20.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.2, 17.7, 15.1, 15.8, 15.2, 14.8, 21.3], trend: "Kraftig forverring (+6.5) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [16.0, 16.1, 14.7, 16.2, 17.1, 15.4, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [18.9, 16.0, 13.9, 13.3, 14.6, 15.1, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [15.4, 14.2, 15.9, 17.2, 12.6, 11.9, 14.8], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [15.0, 12.5, 14.9, 14.7, 15.5, 14.0, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.7, 12.8, 15.6, 17.0, 15.7, 11.7, 12.2], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Nordland", total: 139.6, iDag: 25.4, endringFraIGar: 1.4, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 137.9, iDag: 25.4, endringFraIGar: 3.3, plasseringEndring: 1 },
  { navn: "Troms", total: 134.7, iDag: 18.8, endringFraIGar: -0.5, plasseringEndring: -2 },
  { navn: "Vestland", total: 124.6, iDag: 20.9, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 119.1, iDag: 21.3, endringFraIGar: 6.5, plasseringEndring: 0 },
  { navn: "Rogaland", total: 111.1, iDag: 15.6, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Innlandet", total: 108.8, iDag: 17.0, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Agder", total: 102.0, iDag: 14.8, endringFraIGar: 2.9, plasseringEndring: 1 },
  { navn: "Buskerud", total: 101.7, iDag: 15.1, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Telemark", total: 100.7, iDag: 12.2, endringFraIGar: 0.5, plasseringEndring: -2 },
...
export const STASJONER_PERIODE = [
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 61.7, vindkast: 32.4, nedbor: 0, temp: 9.5, farevarsel: "oransje" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 60.2, vindkast: 25.8, nedbor: 0, temp: 11.7, farevarsel: "oransje" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 57.2, vindkast: 16.6, nedbor: 4.9, temp: 0, farevarsel: "gul" },
  { navn: "SOGNDAL LH - STOREHAUGFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 57.0, vindkast: 24.7, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 55.4, vindkast: 33.7, nedbor: 0, temp: 3.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 253.0,
    tempMin: -0.9,
    dager: [50.4, 28.1, 72.0, 85.6, 49.5, 51.4, 50.4],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 9.9,
    dager: [47.9, 43.1, 25.1, 42.3, 42.4, 39.9, 60.2],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 43 EI per dag. Toppdag Søn med 60.2 EI. Kraftige vindkast opp til 28.9 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [46.0, 31.8, 49.6, 49.9, 34.6, 41.9, 45.1],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [38.5, 33.6, 35.1, 38.6, 41.1, 52.5, 57.0],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 42 EI per dag. Toppdag Søn med 57.0 EI."
  },
  {
    ...
    precipTotal: 30.2,
    tempMin: 0,
    dager: [30.2, 30.2, 26.7, 48.2, 45.4, 58.3, 57.2],
