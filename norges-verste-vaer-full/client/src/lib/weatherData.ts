 ...
 *
 * Sist oppdatert: 26.03.2026 kl. 17:02
...
export const META = {
  ...
  datoOppdatert: "26.03.2026 kl. 17:02",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [46.8, 39.3, 33.4, 29.1], trend: "Noe bedring (-4.3) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [35.7, 35.1, 32.8, 39.1], trend: "Kraftig forverring (+6.3) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [37.0, 32.9, 29.8, 34.4], trend: "Noe forverring (+4.6) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [32.1, 34.6, 32.3, 33.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [36.5, 33.8, 29.0, 28.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [40.7, 31.0, 22.9, 31.2], trend: "Kraftig forverring (+8.3) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [20.5, 27.4, 35.8, 32.7], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Rogaland", dager: [24.8, 27.6, 30.0, 33.7], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [27.7, 29.7, 26.2, 31.5], trend: "Kraftig forverring (+5.3) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [25.2, 30.5, 31.5, 27.8], trend: "Noe bedring (-3.7) - roligere forhold" },
  { navn: "Østfold", dager: [21.4, 27.1, 30.4, 25.2], trend: "Markant bedring (-5.2) - lavtrykket har passert" },
  { navn: "Telemark", dager: [22.2, 25.8, 28.0, 25.1], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Buskerud", dager: [21.9, 23.4, 26.0, 24.8], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 148.6, iDag: 29.1, endringFraIGar: -4.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 142.7, iDag: 39.1, endringFraIGar: 6.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 134.1, iDag: 34.4, endringFraIGar: 4.6, plasseringEndring: 0 },
  { navn: "Vestland", total: 132.4, iDag: 33.4, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Troms", total: 127.9, iDag: 28.6, endringFraIGar: -0.4, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 125.8, iDag: 31.2, endringFraIGar: 8.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 116.4, iDag: 32.7, endringFraIGar: -3.1, plasseringEndring: 1 },
  { navn: "Rogaland", total: 116.1, iDag: 33.7, endringFraIGar: 3.7, plasseringEndring: 2 },
  { navn: "Innlandet", total: 115.1, iDag: 31.5, endringFraIGar: 5.3, plasseringEndring: 0 },
  { navn: "Agder", total: 115.0, iDag: 27.8, endringFraIGar: -3.7, plasseringEndring: -3 },
  { navn: "Østfold", total: 104.1, iDag: 25.2, endringFraIGar: -5.2, plasseringEndring: 0 },
  { navn: "Telemark", total: 101.1, iDag: 25.1, endringFraIGar: -2.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 96.1, iDag: 24.8, endringFraIGar: -1.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SNØHEIM", kommune: "DOVRE", fylke: "Innlandet", ei: 87.0, vindkast: 32.9, nedbor: 0, temp: -4.8, farevarsel: "oransje" },
  { navn: "RV15 SKJERDINGSDALEN", kommune: "STRYN", fylke: "Vestland", ei: 83.0, vindkast: 0, nedbor: 18.8, temp: -0.8, farevarsel: "oransje" },
  { navn: "ØRSTA - EITREFJELL", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 82.8, vindkast: 18.8, nedbor: 47.4, temp: -0.8, farevarsel: "oransje" },
  { navn: "GJEMNES - REINSFJELLET", kommune: "GJEMNES", fylke: "Møre og Romsdal", ei: 73.8, vindkast: 33.7, nedbor: 0, temp: -1.6, farevarsel: "oransje" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 72.7, vindkast: 27.8, nedbor: 0, temp: -5.3, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1020.7,
    tempMin: -3.3,
    dager: [543.8, 35.4, 26.4, 31.3, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 159 EI per dag. Toppdag Man med 543.8 EI. Mye nedbor med totalt 1020.7 mm."
  },
  {
    navn: "E6 STØDI BRU",
    kommune: "SALTDAL",
    ...
    precipTotal: 271.9,
    tempMin: -3.7,
    dager: [166.8, 48.1, 56.1, 37.2, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 77 EI per dag. Toppdag Man med 166.8 EI. Mye nedbor med totalt 271.9 mm."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -9.4,
    dager: [72.9, 81.5, 62.8, 70.1, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 107.7,
    tempMin: -1.3,
    dager: [62.8, 61.6, 76.7, 82.8, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 71 EI per dag. Toppdag Tor med 82.8 EI. Kraftige vindkast opp til 26.9 m/s. Mye nedbor med totalt 107.7 mm."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
    ...
    precipTotal: 0,
    tempMin: -4.1,
    dager: [69.7, 72.3, 62.7, 63.0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 67 EI per dag. Toppdag Tir med 72.3 EI. Kraftige vindkast opp til 38.0 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 148.6 poeng - 5.9 poeng foran Møre og Romsdal (142.7).",
