 ...
 *
 * Sist oppdatert: 06.05.2026 kl. 07:48
...
export const META = {
  ...
  datoOppdatert: "06.05.2026 kl. 07:48",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Trøndelag", dager: [42.9, 32.3, 28.7], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Nordland", dager: [33.3, 33.1, 28.8], trend: "Noe bedring (-4.3) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [33.7, 34.3, 27.0], trend: "Markant bedring (-7.3) - lavtrykket har passert" },
  { navn: "Finnmark", dager: [29.1, 29.8, 28.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [27.4, 29.4, 26.8], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Troms", dager: [28.0, 25.4, 26.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [23.8, 26.7, 27.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [21.3, 21.5, 24.3], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [19.3, 27.1, 20.7], trend: "Markant bedring (-6.4) - lavtrykket har passert" },
  { navn: "Rogaland", dager: [21.4, 22.4, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.4, 21.8, 23.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [19.0, 18.8, 22.4], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [18.4, 19.3, 22.4], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Trøndelag", total: 103.9, iDag: 28.7, endringFraIGar: -3.6, plasseringEndring: 0 },
  { navn: "Nordland", total: 95.2, iDag: 28.8, endringFraIGar: -4.3, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 95.0, iDag: 27.0, endringFraIGar: -7.3, plasseringEndring: -1 },
  { navn: "Finnmark", total: 87.8, iDag: 28.9, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 83.6, iDag: 26.8, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Troms", total: 80.1, iDag: 26.7, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 78.0, iDag: 27.5, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Agder", total: 67.1, iDag: 24.3, endringFraIGar: 2.8, plasseringEndring: 2 },
  { navn: "Oslo", total: 67.1, iDag: 20.7, endringFraIGar: -6.4, plasseringEndring: -1 },
  { navn: "Rogaland", total: 65.9, iDag: 22.1, endringFraIGar: -0.3, plasseringEndring: -1 },
  { navn: "Buskerud", total: 63.4, iDag: 23.2, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 60.2, iDag: 22.4, endringFraIGar: 3.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 60.1, iDag: 22.4, endringFraIGar: 3.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV74 LIFJELLET", kommune: "LIERNE", fylke: "Trøndelag", ei: 67.7, vindkast: 0, nedbor: 62.1, temp: -2.2, farevarsel: "oransje" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 56.9, vindkast: 27.3, nedbor: 0, temp: 0.5, farevarsel: "gul" },
  { navn: "HITRA - SANDSTAD II", kommune: "HITRA", fylke: "Trøndelag", ei: 54.2, vindkast: 12.6, nedbor: 11.1, temp: 1.5, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 52.8, vindkast: 14.1, nedbor: 0, temp: -11.8, farevarsel: "gul" },
  { navn: "NORDLI - SANDVIKA", kommune: "LIERNE", fylke: "Trøndelag", ei: 50.4, vindkast: 12.2, nedbor: 0.2, temp: -0.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3110.3,
    tempMin: -5.3,
    dager: [1597.7, 31.1, 28.8, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 553 EI per dag. Toppdag Man med 1597.7 EI. Mye nedbor med totalt 3110.3 mm. Bitende kulde ned til -5.3 grader C."
  },
  {
    navn: "FV74 LIFJELLET",
    kommune: "LIERNE",
    ...
    precipTotal: 111.1,
    tempMin: -2.2,
    dager: [55.0, 49.8, 67.7, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Ons med 67.7 EI. Mye nedbor med totalt 111.1 mm."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -11.8,
    dager: [61.9, 55.8, 52.8, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Man med 61.9 EI. Kraftige vindkast opp til 26.3 m/s. Bitende kulde ned til -11.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0.5,
    dager: [52.1, 54.9, 56.9, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 55 EI per dag. Toppdag Ons med 56.9 EI. Kraftige vindkast opp til 29.5 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.8,
    dager: [62.2, 52.5, 46.4, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Man med 62.2 EI. Kraftige vindkast opp til 26.7 m/s. Bitende kulde ned til -5.8 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Trøndelag leder sammenlagt med 103.9 poeng - 8.7 poeng foran Nordland (95.2).",
