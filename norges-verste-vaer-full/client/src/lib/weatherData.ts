 ...
 *
 * Sist oppdatert: 13.04.2026 kl. 18:06
...
export const META = {
  ...
  datoOppdatert: "13.04.2026 kl. 18:06",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [31.2], trend: "Kraftig forverring (+31.2) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [26.9], trend: "Kraftig forverring (+26.9) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [26.1], trend: "Kraftig forverring (+26.1) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [25.3], trend: "Kraftig forverring (+25.3) - okt vind og/eller nedbor" },
  ...
  { navn: "Nordland", dager: [24.8], trend: "Kraftig forverring (+24.8) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [22.8], trend: "Kraftig forverring (+22.8) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [22.5], trend: "Kraftig forverring (+22.5) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [22.2], trend: "Kraftig forverring (+22.2) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [22.1], trend: "Kraftig forverring (+22.1) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [21.8], trend: "Kraftig forverring (+21.8) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [21.0], trend: "Kraftig forverring (+21.0) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 31.2, iDag: 31.2, endringFraIGar: 31.2, plasseringEndring: 0 },
  { navn: "Innlandet", total: 26.9, iDag: 26.9, endringFraIGar: 26.9, plasseringEndring: 0 },
  { navn: "Telemark", total: 26.1, iDag: 26.1, endringFraIGar: 26.1, plasseringEndring: 0 },
  { navn: "Agder", total: 25.3, iDag: 25.3, endringFraIGar: 25.3, plasseringEndring: 0 },
  ...
  { navn: "Nordland", total: 24.8, iDag: 24.8, endringFraIGar: 24.8, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 22.8, iDag: 22.8, endringFraIGar: 22.8, plasseringEndring: 0 },
  { navn: "Vestland", total: 22.5, iDag: 22.5, endringFraIGar: 22.5, plasseringEndring: 0 },
  { navn: "Troms", total: 22.2, iDag: 22.2, endringFraIGar: 22.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 22.1, iDag: 22.1, endringFraIGar: 22.1, plasseringEndring: 0 },
  { navn: "Østfold", total: 21.8, iDag: 21.8, endringFraIGar: 21.8, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 21.0, iDag: 21.0, endringFraIGar: 21.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 77.3, vindkast: 36.7, nedbor: 0, temp: -2.8, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 66.2, vindkast: 27.4, nedbor: 0, temp: -3.7, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 62.7, vindkast: 20.5, nedbor: 0, temp: -7.3, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 61.4, vindkast: 26.1, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
  { navn: "MANNEN", kommune: "RAUMA", fylke: "Møre og Romsdal", ei: 61.2, vindkast: 25.4, nedbor: 0, temp: -2.9, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -2.8,
    dager: [77.3, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 77 EI per dag. Toppdag Man med 77.3 EI. Kraftige vindkast opp til 36.7 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [66.2, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Man med 66.2 EI. Kraftige vindkast opp til 27.4 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -7.3,
    dager: [62.7, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 63 EI per dag. Toppdag Man med 62.7 EI. Bitende kulde ned til -7.3 grader C."
  },
  {
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Man med 61.4 EI. Kraftige vindkast opp til 26.1 m/s. Bitende kulde ned til -5.2 grader C."
  },
  {
    navn: "MANNEN",
    kommune: "RAUMA",
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Man med 61.2 EI. Kraftige vindkast opp til 25.4 m/s."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 31.2 poeng - 4.3 poeng foran Innlandet (26.9).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
