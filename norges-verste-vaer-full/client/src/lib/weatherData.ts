 ...
 *
 * Sist oppdatert: 15.08.2026 kl. 17:10
...
export const META = {
  ...
  datoOppdatert: "15.08.2026 kl. 17:10",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Nordland", dager: [21.5, 24.6, 23.3, 21.7, 21.0, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [25.0, 25.0, 18.1, 16.3, 18.5, 19.6], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Vestland", dager: [26.9, 21.0, 17.1, 16.2, 18.3, 17.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.6, 24.8, 19.0, 18.2, 16.5, 18.5], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Innlandet", dager: [20.0, 19.5, 15.2, 13.2, 14.0, 13.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [19.0, 13.1, 12.4, 11.5, 12.9, 14.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.6, 13.4, 12.4, 11.2, 12.4, 14.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Nordland", total: 131.9, iDag: 19.8, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 122.5, iDag: 19.6, endringFraIGar: 1.1, plasseringEndring: 1 },
  ...
  { navn: "Vestland", total: 116.7, iDag: 17.2, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 116.6, iDag: 18.5, endringFraIGar: 2.0, plasseringEndring: 0 },
  ...
  { navn: "Innlandet", total: 95.4, iDag: 13.5, endringFraIGar: -0.5, plasseringEndring: -1 },
  { navn: "Telemark", total: 83.8, iDag: 14.9, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 82.1, iDag: 14.1, endringFraIGar: 1.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV848 FORNES", kommune: "NARVIK", fylke: "Nordland", ei: 64.9, vindkast: 0, nedbor: 1.2, temp: -39.2, farevarsel: "oransje" },
  ...
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 53.8, vindkast: 0, nedbor: 0, temp: -29.2, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.9,
    dager: [68.2, 63.6, 66.7, 64.1, 61.4, 62.1, 0],
  ...
  },
  {
    ...
    precipTotal: 0.4,
    tempMin: -39.8,
    dager: [74.9, 35.1, 65.1, 61.0, 57.7, 21.0, 0],
  ...
  },
  {
    ...
    precipTotal: 31.4,
    tempMin: 0,
    dager: [59.2, 47.8, 24.9, 40.6, 50.1, 46.6, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.0, 38.1, 44.5, 53.8, 46.0, 37.5, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 137.7 poeng - 5.8 poeng foran Nordland (131.9).",
