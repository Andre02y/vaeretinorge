 ...
 *
 * Sist oppdatert: 23.04.2026 kl. 18:25
...
export const META = {
  ...
  datoOppdatert: "23.04.2026 kl. 18:25",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.3, 36.3, 46.8, 44.8], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Troms", dager: [23.4, 31.2, 30.4, 32.8], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 29.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 27.4], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 18.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 24.9], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [25.2, 18.5, 18.1, 17.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [19.7, 18.2, 19.3, 20.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [19.0, 17.6, 19.3, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [25.0, 17.7, 16.4, 16.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 16.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 156.2, iDag: 44.8, endringFraIGar: -2.0, plasseringEndring: 0 },
  { navn: "Troms", total: 117.8, iDag: 32.8, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 106.1, iDag: 29.0, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 89.3, iDag: 27.4, endringFraIGar: 2.4, plasseringEndring: 2 },
  { navn: "Oslo", total: 86.3, iDag: 18.6, endringFraIGar: 0.5, plasseringEndring: -1 },
  { navn: "Innlandet", total: 85.7, iDag: 22.1, endringFraIGar: 0.4, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 80.8, iDag: 24.9, endringFraIGar: 3.9, plasseringEndring: 4 },
  { navn: "Agder", total: 79.6, iDag: 17.8, endringFraIGar: -0.3, plasseringEndring: -1 },
  { navn: "Vestland", total: 77.4, iDag: 20.2, endringFraIGar: 0.9, plasseringEndring: 1 },
  { navn: "Rogaland", total: 76.7, iDag: 20.8, endringFraIGar: 1.5, plasseringEndring: 2 },
  { navn: "Telemark", total: 75.5, iDag: 16.4, endringFraIGar: 0.0, plasseringEndring: -3 },
  { navn: "Buskerud", total: 74.3, iDag: 16.6, endringFraIGar: 0.0, plasseringEndring: -3 },
  { navn: "Østfold", total: 71.2, iDag: 16.1, endringFraIGar: 0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 AISAROAIVI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 82.0, vindkast: 0, nedbor: 54.7, temp: 1.2, farevarsel: "oransje" },
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 79.3, vindkast: 0, nedbor: 25.2, temp: 0.5, farevarsel: "oransje" },
  { navn: "MEHAMN LUFTHAVN", kommune: "GAMVIK", fylke: "Finnmark", ei: 71.3, vindkast: 24.8, nedbor: 2.7, temp: 1.6, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 70.8, vindkast: 32.8, nedbor: 0, temp: -1.3, farevarsel: "oransje" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 68.3, vindkast: 26.6, nedbor: 0, temp: -3.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -1.3,
    dager: [54.3, 85.8, 56.7, 70.8, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [40.4, 63.8, 70.8, 68.3, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Ons med 70.8 EI. Kraftige vindkast opp til 27.0 m/s."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
    ...
    precipTotal: 0,
    tempMin: -4.0,
    dager: [48.2, 74.4, 56.5, 61.2, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Tir med 74.4 EI. Kraftige vindkast opp til 29.6 m/s."
  },
  {
    navn: "FINNESVATNET",
    kommune: "VARDØ",
    ...
    precipTotal: 1.7,
    tempMin: -0.9,
    dager: [39.6, 54.0, 78.0, 66.4, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Ons med 78.0 EI. Kraftige vindkast opp til 26.3 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.8,
    dager: [53.6, 65.4, 56.0, 61.7, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 156.2 poeng - 38.4 poeng foran Troms (117.8).",
