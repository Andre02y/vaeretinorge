 ...
 *
 * Sist oppdatert: 14.04.2026 kl. 03:21
...
export const META = {
  ...
  datoOppdatert: "14.04.2026 kl. 03:21",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [24.9, 26.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [26.7, 23.7], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Nordland", dager: [24.3, 23.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [24.6, 21.8], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Troms", dager: [22.0, 23.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [25.1, 19.6], trend: "Markant bedring (-5.5) - lavtrykket har passert" },
  { navn: "Vestland", dager: [22.2, 21.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 19.7], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Telemark", dager: [22.8, 19.5], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Østfold", dager: [21.8, 20.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.4, 19.4], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Rogaland", dager: [21.8, 18.0], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [20.5, 18.2], trend: "Noe bedring (-2.3) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 51.0, iDag: 26.1, endringFraIGar: 1.2, plasseringEndring: 2 },
  { navn: "Innlandet", total: 50.4, iDag: 23.7, endringFraIGar: -3.0, plasseringEndring: -1 },
  { navn: "Nordland", total: 47.6, iDag: 23.3, endringFraIGar: -1.0, plasseringEndring: 2 },
  { navn: "Agder", total: 46.4, iDag: 21.8, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Troms", total: 45.1, iDag: 23.1, endringFraIGar: 1.1, plasseringEndring: 5 },
  { navn: "Oslo", total: 44.7, iDag: 19.6, endringFraIGar: -5.5, plasseringEndring: -4 },
  { navn: "Vestland", total: 44.1, iDag: 21.9, endringFraIGar: -0.3, plasseringEndring: 2 },
  { navn: "Buskerud", total: 42.9, iDag: 19.7, endringFraIGar: -3.5, plasseringEndring: -2 },
  { navn: "Telemark", total: 42.3, iDag: 19.5, endringFraIGar: -3.3, plasseringEndring: -2 },
  { navn: "Østfold", total: 41.9, iDag: 20.1, endringFraIGar: -1.7, plasseringEndring: 2 },
  { navn: "Trøndelag", total: 41.8, iDag: 19.4, endringFraIGar: -3.0, plasseringEndring: -3 },
  { navn: "Rogaland", total: 39.8, iDag: 18.0, endringFraIGar: -3.8, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 38.7, iDag: 18.2, endringFraIGar: -2.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 78.7, vindkast: 0, nedbor: 1.9, temp: -39.9, farevarsel: "oransje" },
  { navn: "E134 MIDTLÆGER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 76.0, vindkast: 0, nedbor: 34.5, temp: -0.6, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 70.8, vindkast: 28.4, nedbor: 0, temp: -2.2, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 66.8, vindkast: 21.9, nedbor: 0, temp: -2.8, farevarsel: "oransje" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 66.5, vindkast: 25.6, nedbor: 0, temp: -3.0, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 247.1,
    tempMin: 1.5,
    dager: [111.7, 62.9, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 87 EI per dag. Toppdag Man med 111.7 EI. Mye nedbor med totalt 247.1 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.8,
    dager: [74.4, 70.8, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 73 EI per dag. Toppdag Man med 74.4 EI. Kraftige vindkast opp til 36.7 m/s."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 42.9,
    tempMin: -0.6,
    dager: [60.2, 76.0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 68 EI per dag. Toppdag Tir med 76.0 EI. Mye nedbor med totalt 42.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 66.8, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Tir med 66.8 EI. Kraftige vindkast opp til 27.4 m/s."
  },
  {
    navn: "RV13 VIKAFJELL",
    kommune: "VIK",
    ...
    precipTotal: 2.0,
    tempMin: -39.9,
    dager: [50.7, 78.7, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Tir med 78.7 EI. Bitende kulde ned til -39.9 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 51.0 poeng, foran Innlandet (50.4).",
