 ...
 *
 * Sist oppdatert: 31.07.2026 kl. 10:38
...
export const META = {
  ...
  datoOppdatert: "31.07.2026 kl. 10:38",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Møre og Romsdal", dager: [27.6, 25.9, 17.5, 17.7, 21.6], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [25.0, 21.1, 18.7, 21.5, 21.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.2, 17.1, 15.9, 25.2, 27.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [18.6, 18.4, 23.0, 20.2, 21.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.4, 21.5, 14.8, 16.4, 19.7], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [21.9, 15.9, 16.0, 15.6, 16.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [19.5, 18.2, 16.7, 13.8, 17.4], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [15.0, 16.0, 21.4, 16.2, 14.1], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Finnmark", dager: [17.7, 14.2, 17.4, 17.8, 14.7], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Innlandet", dager: [16.9, 15.5, 13.7, 16.5, 17.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.4, 13.1, 13.5, 14.5, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.4, 12.3, 11.8, 15.6, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [12.3, 11.9, 12.4, 9.5, 14.2], trend: "Noe forverring (+4.7) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Møre og Romsdal", total: 110.3, iDag: 21.6, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 107.5, iDag: 21.2, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 104.5, iDag: 27.1, endringFraIGar: 1.9, plasseringEndring: 1 },
  { navn: "Nordland", total: 101.5, iDag: 21.3, endringFraIGar: 1.1, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 91.8, iDag: 19.7, endringFraIGar: 3.3, plasseringEndring: 0 },
  { navn: "Rogaland", total: 86.1, iDag: 16.7, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Agder", total: 85.6, iDag: 17.4, endringFraIGar: 3.6, plasseringEndring: 1 },
  { navn: "Troms", total: 82.7, iDag: 14.1, endringFraIGar: -2.1, plasseringEndring: -1 },
  { navn: "Finnmark", total: 81.8, iDag: 14.7, endringFraIGar: -3.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 80.4, iDag: 17.8, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 72.8, iDag: 16.3, endringFraIGar: 1.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 72.6, iDag: 17.5, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Østfold", total: 60.3, iDag: 14.2, endringFraIGar: 4.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 68.0, vindkast: 0, nedbor: 0, temp: -36.7, farevarsel: "oransje" },
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 64.6, vindkast: 0, nedbor: 0.1, temp: -33.4, farevarsel: "oransje" },
  ...
  { navn: "FLESBERG", kommune: "FLESBERG", fylke: "Buskerud", ei: 54.5, vindkast: 2.8, nedbor: 36.3, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 12.8,
    tempMin: -39.8,
    dager: [38.7, 56.4, 55.0, 69.2, 68.0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Tor med 69.2 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 41.1,
    tempMin: 0,
    dager: [57.3, 51.8, 45.7, 56.9, 52.5, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Møre og Romsdal leder sammenlagt med 110.3 poeng - 2.8 poeng foran Vestland (107.5).",
