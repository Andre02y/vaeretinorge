 ...
 *
 * Sist oppdatert: 13.04.2026 kl. 14:58
...
export const META = {
  ...
  datoOppdatert: "13.04.2026 kl. 14:58",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [31.3], trend: "Kraftig forverring (+31.3) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [26.9], trend: "Kraftig forverring (+26.9) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [26.0], trend: "Kraftig forverring (+26.0) - okt vind og/eller nedbor" },
  { navn: "Buskerud", dager: [25.3], trend: "Kraftig forverring (+25.3) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [25.2], trend: "Kraftig forverring (+25.2) - okt vind og/eller nedbor" },
  ...
  { navn: "Rogaland", dager: [22.4], trend: "Kraftig forverring (+22.4) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [21.9], trend: "Kraftig forverring (+21.9) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [21.3], trend: "Kraftig forverring (+21.3) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 31.3, iDag: 31.3, endringFraIGar: 31.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 26.9, iDag: 26.9, endringFraIGar: 26.9, plasseringEndring: 0 },
  { navn: "Telemark", total: 26.0, iDag: 26.0, endringFraIGar: 26.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 25.3, iDag: 25.3, endringFraIGar: 25.3, plasseringEndring: 0 },
  { navn: "Agder", total: 25.2, iDag: 25.2, endringFraIGar: 25.2, plasseringEndring: 0 },
  ...
  { navn: "Rogaland", total: 22.4, iDag: 22.4, endringFraIGar: 22.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 21.9, iDag: 21.9, endringFraIGar: 21.9, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 21.3, iDag: 21.3, endringFraIGar: 21.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 79.0, vindkast: 36.7, nedbor: 0, temp: -2.8, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 66.9, vindkast: 27.4, nedbor: 0, temp: -3.7, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 63.1, vindkast: 20.5, nedbor: 0, temp: -7.3, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 61.2, vindkast: 19.2, nedbor: 0, temp: -5.3, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 61.2, vindkast: 26.1, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -2.8,
    dager: [79.0, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 79 EI per dag. Toppdag Man med 79.0 EI. Kraftige vindkast opp til 36.7 m/s."
  },
  {
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 67 EI per dag. Toppdag Man med 66.9 EI. Kraftige vindkast opp til 27.4 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -7.3,
    dager: [63.1, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 63 EI per dag. Toppdag Man med 63.1 EI. Bitende kulde ned til -7.3 grader C."
  },
  {
    navn: "SPØRTEGGBU",
    kommune: "LUSTER",
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Man med 61.2 EI. Bitende kulde ned til -5.3 grader C."
  },
  {
    ...
    tempMin: -5.2,
    dager: [61.2, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Man med 61.2 EI. Kraftige vindkast opp til 26.1 m/s. Bitende kulde ned til -5.2 grader C."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 31.3 poeng - 4.4 poeng foran Innlandet (26.9).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
