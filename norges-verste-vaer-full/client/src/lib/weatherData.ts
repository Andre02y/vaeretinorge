 ...
 *
 * Sist oppdatert: 07.08.2026 kl. 17:43
...
export const META = {
  ...
  datoOppdatert: "07.08.2026 kl. 17:43",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [16.7, 16.4, 31.9, 33.7, 29.0], trend: "Noe bedring (-4.7) - roligere forhold" },
  { navn: "Finnmark", dager: [20.3, 29.6, 32.1, 23.3, 18.7], trend: "Noe bedring (-4.6) - roligere forhold" },
  { navn: "Nordland", dager: [22.1, 23.0, 19.0, 17.7, 21.3], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [24.2, 18.4, 16.3, 22.0, 20.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [21.8, 17.1, 18.5, 24.0, 19.2], trend: "Noe bedring (-4.8) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.7, 18.2, 16.1, 17.0, 22.7], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [16.8, 20.6, 20.4, 17.2, 16.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [15.4, 15.9, 20.3, 20.0, 17.9], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Buskerud", dager: [12.9, 13.8, 20.4, 21.1, 18.2], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Innlandet", dager: [16.9, 14.1, 18.0, 18.2, 18.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [12.7, 13.8, 22.2, 22.2, 14.3], trend: "Markant bedring (-7.9) - lavtrykket har passert" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 127.7, iDag: 29.0, endringFraIGar: -4.7, plasseringEndring: 1 },
  { navn: "Finnmark", total: 124.0, iDag: 18.7, endringFraIGar: -4.6, plasseringEndring: -1 },
  { navn: "Nordland", total: 103.1, iDag: 21.3, endringFraIGar: 3.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 101.2, iDag: 20.3, endringFraIGar: -1.7, plasseringEndring: 1 },
  { navn: "Vestland", total: 100.6, iDag: 19.2, endringFraIGar: -4.8, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 96.7, iDag: 22.7, endringFraIGar: 5.7, plasseringEndring: 1 },
  { navn: "Troms", total: 91.2, iDag: 16.2, endringFraIGar: -1.0, plasseringEndring: -1 },
  { navn: "Agder", total: 89.5, iDag: 17.9, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 86.4, iDag: 18.2, endringFraIGar: -2.9, plasseringEndring: 1 },
  { navn: "Innlandet", total: 85.7, iDag: 18.5, endringFraIGar: 0.3, plasseringEndring: 1 },
  { navn: "Telemark", total: 85.2, iDag: 14.3, endringFraIGar: -7.9, plasseringEndring: -2 },
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.1, 51.9, 60.6, 41.5, 30.2, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 38.5,
    tempMin: 0,
    dager: [54.5, 26.3, 46.5, 55.6, 48.4, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.8, 58.0, 62.1, 47.0, 31.9, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Oslo har overtatt forsteplassen i sammenlagt-ligaen med 127.7 poeng, foran Finnmark (124.0).",
