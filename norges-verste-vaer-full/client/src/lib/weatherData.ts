 ...
 *
 * Sist oppdatert: 01.05.2026 kl. 14:52
...
export const META = {
  ...
  datoOppdatert: "01.05.2026 kl. 14:52",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [42.6, 37.3, 30.2, 29.6, 27.5], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Nordland", dager: [34.8, 26.8, 32.3, 32.6, 31.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [34.7, 30.9, 31.4, 28.5, 29.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [27.9, 22.3, 24.3, 19.7, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [22.8, 20.1, 21.9, 18.6, 19.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [23.9, 21.1, 18.2, 15.8, 16.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [20.3, 18.8, 17.6, 17.3, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.3, 18.8, 18.1, 17.6, 17.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [20.2, 19.3, 17.3, 15.4, 16.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [18.8, 17.9, 17.1, 16.8, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [19.3, 17.9, 17.1, 15.7, 15.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [18.9, 18.3, 17.0, 15.1, 15.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.9, 17.8, 16.2, 15.8, 15.2], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 167.2, iDag: 27.5, endringFraIGar: -2.1, plasseringEndring: 0 },
  { navn: "Nordland", total: 158.4, iDag: 31.9, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Troms", total: 154.8, iDag: 29.3, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 113.2, iDag: 19.0, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 102.9, iDag: 19.5, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Innlandet", total: 95.9, iDag: 16.9, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 92.1, iDag: 18.1, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Oslo", total: 91.2, iDag: 17.4, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Agder", total: 88.7, iDag: 16.5, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 87.9, iDag: 17.3, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 85.2, iDag: 15.2, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Telemark", total: 84.3, iDag: 15.0, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 83.9, iDag: 15.2, endringFraIGar: -0.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 67.5, vindkast: 27.6, nedbor: 0, temp: 0.8, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 65.9, vindkast: 25.7, nedbor: 0, temp: 0.0, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 64.0, vindkast: 29.6, nedbor: 0, temp: 3.6, farevarsel: "oransje" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 62.8, vindkast: 29.2, nedbor: 0, temp: 4.4, farevarsel: "oransje" },
  { navn: "ROTVÆR", kommune: "LØDINGEN", fylke: "Nordland", ei: 61.8, vindkast: 25.5, nedbor: 0, temp: 6.6, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -5.7,
    dager: [47.2, 43.8, 54.4, 67.1, 65.9, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Tor med 67.1 EI. Kraftige vindkast opp til 27.6 m/s. Bitende kulde ned til -5.7 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.9,
    dager: [47.2, 39.3, 58.2, 56.7, 67.5, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Fre med 67.5 EI. Kraftige vindkast opp til 27.6 m/s. Bitende kulde ned til -5.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.1,
    dager: [44.4, 37.7, 59.0, 55.8, 62.8, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 52 EI per dag. Toppdag Fre med 62.8 EI. Kraftige vindkast opp til 29.2 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -9.0,
    dager: [46.6, 47.0, 51.6, 53.8, 56.5, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Fre med 56.5 EI. Bitende kulde ned til -9.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.8,
    dager: [50.6, 31.8, 56.1, 61.4, 49.2, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Tor med 61.4 EI. Kraftige vindkast opp til 27.6 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 167.2 poeng - 8.8 poeng foran Nordland (158.4).",
