 ...
 *
 * Sist oppdatert: 21.05.2026 kl. 14:02
...
export const META = {
  ...
  datoOppdatert: "21.05.2026 kl. 14:02",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [26.7, 22.2, 20.9, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [22.4, 21.7, 21.0, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.0, 19.1, 17.1, 29.2], trend: "Kraftig forverring (+12.1) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [21.3, 23.1, 18.0, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [21.1, 19.7, 18.4, 18.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.6, 19.7, 16.8, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [22.1, 19.8, 16.0, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [21.0, 17.0, 14.9, 20.6], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [19.6, 16.7, 15.4, 16.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [16.4, 14.7, 13.7, 19.4], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [17.4, 15.4, 14.1, 14.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.3, 12.1, 12.3, 18.3], trend: "Kraftig forverring (+6.0) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [17.9, 14.2, 12.7, 13.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 91.8, iDag: 22.0, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 87.1, iDag: 22.0, endringFraIGar: 1.0, plasseringEndring: 0 },
  { navn: "Oslo", total: 84.4, iDag: 29.2, endringFraIGar: 12.1, plasseringEndring: 4 },
  { navn: "Rogaland", total: 81.4, iDag: 19.0, endringFraIGar: 1.0, plasseringEndring: -1 },
  { navn: "Vestland", total: 78.1, iDag: 18.9, endringFraIGar: 0.5, plasseringEndring: -1 },
  { navn: "Troms", total: 74.8, iDag: 17.7, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Nordland", total: 74.2, iDag: 16.3, endringFraIGar: 0.3, plasseringEndring: -2 },
  { navn: "Telemark", total: 73.5, iDag: 20.6, endringFraIGar: 5.7, plasseringEndring: 0 },
  { navn: "Innlandet", total: 68.6, iDag: 16.9, endringFraIGar: 1.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 64.2, iDag: 19.4, endringFraIGar: 5.7, plasseringEndring: 2 },
  { navn: "Møre og Romsdal", total: 61.0, iDag: 14.1, endringFraIGar: 0.0, plasseringEndring: -1 },
  { navn: "Østfold", total: 59.0, iDag: 18.3, endringFraIGar: 6.0, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 57.9, iDag: 13.1, endringFraIGar: 0.4, plasseringEndring: -2 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 42.1, vindkast: 6.6, nedbor: 2.3, temp: 0, farevarsel: "gul" },
  { navn: "KRISTIANSAND - BRÅVANN", kommune: "KRISTIANSAND", fylke: "Agder", ei: 41.6, vindkast: 0, nedbor: 13.2, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0.5,
    dager: [57.8, 66.1, 63.0, 37.5, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.4,
    dager: [56.2, 57.1, 60.3, 35.7, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.3,
    dager: [50.6, 53.0, 43.0, 30.4, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -1.8,
    dager: [48.5, 50.0, 44.3, 33.3, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Tir med 50.0 EI."
  },
  {
    navn: "HONNEGRASNUTEN",
    kommune: "VINJE",
    ...
    precipTotal: 0,
    tempMin: 0.4,
    dager: [50.7, 48.7, 43.7, 32.8, 0, 0, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 91.8 poeng - 4.7 poeng foran Finnmark (87.1).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
