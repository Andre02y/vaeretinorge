 ...
 *
 * Sist oppdatert: 26.06.2026 kl. 18:55
...
export const META = {
  ...
  datoOppdatert: "26.06.2026 kl. 18:55",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.0, 24.8, 19.9, 21.5, 23.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [22.9, 21.2, 22.8, 20.1, 20.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [20.3, 21.2, 20.8, 18.8, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [23.4, 18.0, 18.2, 18.8, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [18.0, 18.7, 20.3, 16.7, 18.7], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Rogaland", dager: [14.2, 13.4, 15.0, 11.6, 11.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [12.4, 12.0, 14.0, 10.7, 11.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [13.6, 12.6, 11.5, 10.6, 9.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [11.9, 12.3, 12.8, 10.3, 9.7], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 122.4, iDag: 23.2, endringFraIGar: 1.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 107.4, iDag: 20.4, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 98.4, iDag: 17.3, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 95.4, iDag: 17.0, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Vestland", total: 92.4, iDag: 18.7, endringFraIGar: 2.0, plasseringEndring: 1 },
  ...
  { navn: "Rogaland", total: 65.3, iDag: 11.1, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 60.1, iDag: 11.0, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Agder", total: 57.3, iDag: 9.0, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 57.0, iDag: 9.7, endringFraIGar: -0.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 52.5, vindkast: 35.4, nedbor: 0, temp: 5.4, farevarsel: "gul" },
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 51.5, vindkast: 19.9, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 50.3, vindkast: 10.5, nedbor: 10.4, temp: 0, farevarsel: "gul" },
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 49.3, vindkast: 0, nedbor: 3.7, temp: -13.3, farevarsel: "gul" },
  { navn: "E10 BJØRNFJELL", kommune: "NARVIK", fylke: "Nordland", ei: 48.7, vindkast: 0, nedbor: 0.5, temp: -22.5, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 27.8,
    tempMin: 0,
    dager: [46.7, 42.6, 51.3, 46.8, 50.3, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 48 EI per dag. Toppdag Ons med 51.3 EI. Mye nedbor med totalt 27.8 mm."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -0.3,
    dager: [41.6, 40.6, 47.4, 41.7, 52.5, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Fre med 52.5 EI. Kraftige vindkast opp til 35.4 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.0, 37.5, 44.1, 43.1, 45.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 11.5,
    dager: [36.1, 38.9, 47.6, 46.0, 45.4, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 70.0,
    tempMin: 0,
    dager: [60.4, 38.5, 39.2, 35.5, 36.5, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Man med 60.4 EI. Mye nedbor med totalt 70.0 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 122.4 poeng - 15.0 poeng foran Møre og Romsdal (107.4).",
