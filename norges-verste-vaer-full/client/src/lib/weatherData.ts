 ...
 *
 * Sist oppdatert: 25.04.2026 kl. 17:32
...
export const META = {
  ...
  datoOppdatert: "25.04.2026 kl. 17:32",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 29.6, 32.0, 38.4], trend: "Kraftig forverring (+6.4) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 27.4, 28.0, 33.5], trend: "Kraftig forverring (+5.5) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 25.3, 28.2, 33.6], trend: "Kraftig forverring (+5.4) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 22.4, 21.5, 28.0], trend: "Kraftig forverring (+6.5) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [19.7, 18.2, 19.3, 20.2, 21.8, 27.9], trend: "Kraftig forverring (+6.1) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 18.6, 17.8, 18.9], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 16.7, 16.9, 19.2], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [25.0, 17.7, 16.4, 16.5, 15.9, 18.5], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 15.9, 15.7, 18.8], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Nordland", total: 177.1, iDag: 38.4, endringFraIGar: 6.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 150.8, iDag: 33.5, endringFraIGar: 5.5, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 143.0, iDag: 33.6, endringFraIGar: 5.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 135.5, iDag: 28.0, endringFraIGar: 6.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 127.1, iDag: 27.9, endringFraIGar: 6.1, plasseringEndring: 1 },
  { navn: "Oslo", total: 123.0, iDag: 18.9, endringFraIGar: 1.1, plasseringEndring: -1 },
  ...
  { navn: "Buskerud", total: 110.5, iDag: 19.2, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Telemark", total: 110.0, iDag: 18.5, endringFraIGar: 2.6, plasseringEndring: -1 },
  { navn: "Østfold", total: 105.5, iDag: 18.8, endringFraIGar: 3.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 66.8, vindkast: 28.5, nedbor: 0, temp: -2.1, farevarsel: "oransje" },
  { navn: "RØST LUFTHAVN", kommune: "RØST", fylke: "Nordland", ei: 65.9, vindkast: 18.9, nedbor: 5.4, temp: 1.7, farevarsel: "oransje" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 65.7, vindkast: 24.3, nedbor: 0, temp: -0.5, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 65.3, vindkast: 27.9, nedbor: 0, temp: -4.5, farevarsel: "oransje" },
  { navn: "SIRDAL - SMØLEHEIKNUDEN", kommune: "SIRDAL", fylke: "Agder", ei: 64.9, vindkast: 28.7, nedbor: 0, temp: 1.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.8,
    dager: [40.4, 63.8, 70.8, 69.7, 66.1, 41.1, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -4.7,
    dager: [54.3, 85.8, 56.7, 69.2, 48.7, 36.1, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.4,
    dager: [53.6, 65.4, 56.0, 60.9, 60.0, 49.6, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.6,
    dager: [48.2, 74.4, 56.5, 61.0, 52.0, 48.5, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 234.0 poeng - 44.5 poeng foran Troms (189.5).",
