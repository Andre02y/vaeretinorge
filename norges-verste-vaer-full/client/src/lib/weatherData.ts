 ...
 *
 * Sist oppdatert: 20.03.2026 kl. 13:33
...
export const META = {
  ...
  datoOppdatert: "20.03.2026 kl. 13:33",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.6, 33.8, 41.5, 42.4, 39.8], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Finnmark", dager: [31.1, 33.6, 37.6, 38.9, 37.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [28.1, 28.9, 33.1, 39.5, 36.2], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.5, 24.8, 25.9, 32.5, 28.7], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Oslo", dager: [34.0, 30.8, 25.5, 23.2, 19.3], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Innlandet", dager: [32.1, 28.8, 26.2, 22.9, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [24.5, 25.2, 29.2, 25.9, 26.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [29.9, 27.3, 25.1, 24.1, 23.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [33.5, 28.2, 24.4, 21.7, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [30.1, 29.7, 25.0, 19.9, 19.6], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Buskerud", dager: [28.6, 24.9, 21.7, 19.1, 19.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 187.1, iDag: 39.8, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Finnmark", total: 178.2, iDag: 37.0, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Troms", total: 165.8, iDag: 36.2, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 134.4, iDag: 28.7, endringFraIGar: -3.8, plasseringEndring: 4 },
  { navn: "Oslo", total: 132.8, iDag: 19.3, endringFraIGar: -3.9, plasseringEndring: -1 },
  { navn: "Innlandet", total: 132.0, iDag: 22.0, endringFraIGar: -0.9, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 131.0, iDag: 26.2, endringFraIGar: 0.3, plasseringEndring: 2 },
  { navn: "Vestland", total: 129.8, iDag: 23.4, endringFraIGar: -0.7, plasseringEndring: -1 },
  { navn: "Agder", total: 128.3, iDag: 20.5, endringFraIGar: -1.2, plasseringEndring: -3 },
  { navn: "Telemark", total: 124.3, iDag: 19.6, endringFraIGar: -0.3, plasseringEndring: 0 },
  ...
  { navn: "Buskerud", total: 113.6, iDag: 19.3, endringFraIGar: 0.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 509.4, vindkast: 0, nedbor: 936.0, temp: -0.3, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 85.3, vindkast: 37.7, nedbor: 0, temp: -3.4, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 73.0, vindkast: 28.3, nedbor: 0, temp: -3.3, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 72.7, vindkast: 32.3, nedbor: 0, temp: -0.3, farevarsel: "oransje" },
  { navn: "GLOMFJORD - SKIHYTTA", kommune: "MELØY", fylke: "Nordland", ei: 71.2, vindkast: 22.4, nedbor: 9.5, temp: 0.6, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 2201.9,
    tempMin: -1.8,
    dager: [33.8, 35.4, 32.8, 675.7, 509.4, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 257 EI per dag. Toppdag Tor med 675.7 EI. Mye nedbor med totalt 2201.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.4,
    dager: [53.3, 64.1, 79.2, 79.7, 85.3, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 72 EI per dag. Toppdag Fre med 85.3 EI. Kraftige vindkast opp til 38.4 m/s."
  },
  {
    navn: "KAPPFJELLET",
    kommune: "GRANE",
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [52.2, 61.9, 78.2, 68.5, 69.2, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 141.3,
    tempMin: -2.2,
    dager: [38.8, 59.0, 96.8, 68.1, 65.5, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Ons med 96.8 EI. Mye nedbor med totalt 141.3 mm."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -8.0,
    dager: [55.1, 71.9, 82.6, 62.8, 52.8, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 187.1 poeng - 8.9 poeng foran Finnmark (178.2).",
