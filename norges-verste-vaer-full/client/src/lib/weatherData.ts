 ...
 *
 * Sist oppdatert: 08.05.2026 kl. 09:14
...
export const META = {
  ...
  datoOppdatert: "08.05.2026 kl. 09:14",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.3, 33.1, 30.4, 29.3, 26.7], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Trøndelag", dager: [42.9, 32.3, 29.2, 24.6, 22.6], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [33.7, 34.3, 28.4, 24.4, 20.5], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Finnmark", dager: [29.1, 29.8, 28.5, 25.9, 24.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [28.0, 25.4, 25.0, 24.5, 24.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [27.4, 29.4, 26.8, 22.6, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [23.8, 26.7, 24.8, 22.3, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.3, 27.1, 19.8, 18.7, 19.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [21.3, 21.5, 20.6, 19.2, 19.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [21.4, 22.4, 21.0, 18.2, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.4, 21.8, 19.6, 19.1, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [18.4, 19.3, 19.9, 18.4, 18.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [19.0, 18.8, 18.7, 17.3, 18.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 152.8, iDag: 26.7, endringFraIGar: -2.6, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 151.6, iDag: 22.6, endringFraIGar: -2.0, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 141.3, iDag: 20.5, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Finnmark", total: 137.6, iDag: 24.3, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Troms", total: 127.3, iDag: 24.4, endringFraIGar: -0.1, plasseringEndring: 1 },
  { navn: "Vestland", total: 127.0, iDag: 20.8, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Innlandet", total: 119.2, iDag: 21.6, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Oslo", total: 104.0, iDag: 19.1, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Agder", total: 102.3, iDag: 19.7, endringFraIGar: 0.5, plasseringEndring: 1 },
  { navn: "Rogaland", total: 102.0, iDag: 19.0, endringFraIGar: 0.8, plasseringEndring: -1 },
  { navn: "Buskerud", total: 97.7, iDag: 18.8, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 94.4, iDag: 18.4, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 92.2, iDag: 18.4, endringFraIGar: 1.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 61.6, vindkast: 21.8, nedbor: 0, temp: -2.7, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 52.7, vindkast: 15.3, nedbor: 0, temp: -5.7, farevarsel: "gul" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 49.4, vindkast: 13.2, nedbor: 0, temp: -3.9, farevarsel: "gul" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 46.6, vindkast: 13.2, nedbor: 0, temp: -2.3, farevarsel: "gul" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 44.8, vindkast: 12.7, nedbor: 0, temp: -2.3, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3110.3,
    tempMin: -2.9,
    dager: [1597.7, 31.1, 25.5, 24.2, 26.3, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -10.8,
    dager: [61.9, 55.8, 48.8, 42.3, 52.7, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 121.4,
    tempMin: -1.9,
    dager: [55.0, 49.8, 81.7, 39.5, 27.6, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 22.3,
    tempMin: -0.9,
    dager: [54.5, 55.5, 45.9, 43.1, 41.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.2,
    dager: [62.2, 52.5, 45.5, 41.8, 37.7, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 152.8 poeng, foran Trøndelag (151.6).",
