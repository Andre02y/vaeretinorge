 ...
 *
 * Sist oppdatert: 29.07.2026 kl. 18:15
 * Periode sammenlagt: 27.07 - 29.07.2026 (3 dager)
...
export const META = {
  ...
  dagLabel: "Onsdag 29.07.2026",
  sammenlagtLabel: "27.07 - 29.07.2026 (3 dager)",
  datoOppdatert: "29.07.2026 kl. 18:15",
  rapportVersjon: "v2.2 (norsk tid, live uke, ryddig arkiv, fikset uke/arkiv-logikk)",
  dagLabels: ["Man 27", "Tir 28", "Ons 29"],
};

// ---- DAG-FOR-DAG EI PER FYLKE ----

export const FYLKER_DAG_FOR_DAG = [
  { navn: "Møre og Romsdal", dager: [27.6, 25.9, 17.5], trend: "Markant bedring (-8.4) - lavtrykket har passert" },
  { navn: "Vestland", dager: [25.0, 21.1, 17.1], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Nordland", dager: [18.6, 18.4, 23.8], trend: "Kraftig forverring (+5.4) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [19.4, 21.5, 15.0], trend: "Markant bedring (-6.5) - lavtrykket har passert" },
  { navn: "Agder", dager: [19.5, 18.2, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [15.0, 16.0, 22.5], trend: "Kraftig forverring (+6.5) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [21.9, 15.9, 15.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.2, 17.1, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [17.7, 14.2, 17.1], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [16.9, 15.5, 13.3], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Telemark", dager: [15.4, 13.1, 11.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.4, 12.3, 11.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [12.3, 11.9, 12.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Møre og Romsdal", total: 71.0, iDag: 17.5, endringFraIGar: -8.4, plasseringEndring: 0 },
  { navn: "Vestland", total: 63.2, iDag: 17.1, endringFraIGar: -4.0, plasseringEndring: 0 },
  { navn: "Nordland", total: 60.8, iDag: 23.8, endringFraIGar: 5.4, plasseringEndring: 3 },
  { navn: "Trøndelag", total: 55.9, iDag: 15.0, endringFraIGar: -6.5, plasseringEndring: -1 },
  { navn: "Agder", total: 54.7, iDag: 17.0, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Troms", total: 53.5, iDag: 22.5, endringFraIGar: 6.5, plasseringEndring: 4 },
  { navn: "Rogaland", total: 53.3, iDag: 15.5, endringFraIGar: -0.4, plasseringEndring: -3 },
  { navn: "Oslo", total: 52.2, iDag: 15.9, endringFraIGar: -1.2, plasseringEndring: -1 },
  { navn: "Finnmark", total: 49.0, iDag: 17.1, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Innlandet", total: 45.7, iDag: 13.3, endringFraIGar: -2.2, plasseringEndring: -2 },
  { navn: "Telemark", total: 40.4, iDag: 11.9, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 38.7, iDag: 11.0, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Østfold", total: 36.6, iDag: 12.4, endringFraIGar: 0.5, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER ONSDAG 29.07.2026 ----

export const STASJONER_PERIODE = [
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 59.7, vindkast: 26.8, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "YTRE HOLMEBUKT", kommune: "TROMSØ", fylke: "Troms", ei: 53.6, vindkast: 0, nedbor: 37.3, temp: 0, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 48.8, vindkast: 19.0, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "BJØRKÅSEN", kommune: "NARVIK", fylke: "Nordland", ei: 47.0, vindkast: 0, nedbor: 24.0, temp: 0, farevarsel: "gul" },
  { navn: "SVOLVÆR LH - TEISTHAUGAN", kommune: "VÅGAN", fylke: "Nordland", ei: 46.9, vindkast: 19.7, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 117.7,
    tempMin: 0,
    dager: [40.4, 86.2, 37.2, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 55 EI per dag. Toppdag Tir med 86.2 EI. Mye nedbor med totalt 117.7 mm."
  },
  {
    ...
    precipTotal: 0.7,
    tempMin: -38.9,
    dager: [58.9, 58.8, 45.0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Man med 58.9 EI. Bitende kulde ned til -38.9 grader C."
  },
  {
    ...
    precipTotal: 8.5,
    tempMin: 0,
    dager: [57.3, 51.8, 43.3, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Man med 57.3 EI."
  },
  {
    navn: "HOVLANDSDAL",
    kommune: "FJALER",
    ...
    precipTotal: 82.9,
    tempMin: 0,
    dager: [49.4, 60.2, 36.9, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 60.2 EI. Mye nedbor med totalt 82.9 mm."
  },
  {
    navn: "LAVIK",
    kommune: "HØYANGER",
    ...
    precipTotal: 82.1,
    tempMin: 0,
    dager: [50.6, 59.4, 36.0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 49 EI per dag. Toppdag Tir med 59.4 EI. Mye nedbor med totalt 82.1 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Møre og Romsdal leder sammenlagt med 71.0 poeng - 7.8 poeng foran Vestland (63.2).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-07-27",
  tilDato: "2026-07-29",
  periode: "27.07 - 29.07.2026 (3 dager)",
  dagerRegistrert: 3,
