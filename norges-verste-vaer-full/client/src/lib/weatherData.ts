 ...
 *
 * Sist oppdatert: 31.07.2026 kl. 13:16
...
export const META = {
  ...
  datoOppdatert: "31.07.2026 kl. 13:16",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Møre og Romsdal", dager: [27.6, 25.9, 17.5, 17.7, 22.1], trend: "Noe forverring (+4.4) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [25.0, 21.1, 18.7, 21.5, 21.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.2, 17.1, 15.9, 25.2, 29.0], trend: "Noe forverring (+3.8) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [18.6, 18.4, 23.0, 20.2, 22.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [19.4, 21.5, 14.8, 16.4, 20.0], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [21.9, 15.9, 16.0, 15.6, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [19.5, 18.2, 16.7, 13.8, 17.9], trend: "Noe forverring (+4.1) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [15.0, 16.0, 21.4, 16.2, 14.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [17.7, 14.2, 17.4, 17.8, 14.9], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Innlandet", dager: [16.9, 15.5, 13.7, 16.5, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [15.4, 13.1, 13.5, 14.5, 17.7], trend: "Noe forverring (+3.2) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [15.4, 12.3, 11.8, 15.6, 18.2], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [12.3, 11.9, 12.4, 9.5, 14.9], trend: "Kraftig forverring (+5.4) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Møre og Romsdal", total: 110.8, iDag: 22.1, endringFraIGar: 4.4, plasseringEndring: 0 },
  { navn: "Vestland", total: 108.1, iDag: 21.8, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 106.4, iDag: 29.0, endringFraIGar: 3.8, plasseringEndring: 1 },
  { navn: "Nordland", total: 102.4, iDag: 22.2, endringFraIGar: 2.0, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 92.1, iDag: 20.0, endringFraIGar: 3.6, plasseringEndring: 0 },
  { navn: "Rogaland", total: 86.4, iDag: 17.0, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Agder", total: 86.1, iDag: 17.9, endringFraIGar: 4.1, plasseringEndring: 1 },
  { navn: "Troms", total: 83.1, iDag: 14.5, endringFraIGar: -1.7, plasseringEndring: -1 },
  { navn: "Finnmark", total: 82.0, iDag: 14.9, endringFraIGar: -2.9, plasseringEndring: 0 },
  { navn: "Innlandet", total: 80.7, iDag: 18.1, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 74.2, iDag: 17.7, endringFraIGar: 3.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 73.3, iDag: 18.2, endringFraIGar: 2.6, plasseringEndring: 0 },
  { navn: "Østfold", total: 61.0, iDag: 14.9, endringFraIGar: 5.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 69.1, vindkast: 0, nedbor: 0, temp: -38.0, farevarsel: "oransje" },
  ...
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 56.1, vindkast: 0, nedbor: 0.6, temp: -24.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 12.8,
    tempMin: -39.8,
    dager: [38.7, 56.4, 55.0, 69.2, 69.1, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Møre og Romsdal leder sammenlagt med 110.8 poeng - 2.7 poeng foran Vestland (108.1).",
