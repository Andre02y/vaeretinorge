 ...
 *
 * Sist oppdatert: 06.04.2026 kl. 07:16
...
export const META = {
  ...
  datoOppdatert: "06.04.2026 kl. 07:16",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Trøndelag", dager: [33.2], trend: "Kraftig forverring (+33.2) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [33.2], trend: "Kraftig forverring (+33.2) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [32.1], trend: "Kraftig forverring (+32.1) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [32.1], trend: "Kraftig forverring (+32.1) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [30.8], trend: "Kraftig forverring (+30.8) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [28.2], trend: "Kraftig forverring (+28.2) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [26.8], trend: "Kraftig forverring (+26.8) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [26.6], trend: "Kraftig forverring (+26.6) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [26.5], trend: "Kraftig forverring (+26.5) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [23.4], trend: "Kraftig forverring (+23.4) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [23.0], trend: "Kraftig forverring (+23.0) - okt vind og/eller nedbor" },
  { navn: "Buskerud", dager: [22.3], trend: "Kraftig forverring (+22.3) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [20.5], trend: "Kraftig forverring (+20.5) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Trøndelag", total: 33.2, iDag: 33.2, endringFraIGar: 33.2, plasseringEndring: 0 },
  { navn: "Agder", total: 33.2, iDag: 33.2, endringFraIGar: 33.2, plasseringEndring: 0 },
  { navn: "Vestland", total: 32.1, iDag: 32.1, endringFraIGar: 32.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 32.1, iDag: 32.1, endringFraIGar: 32.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 30.8, iDag: 30.8, endringFraIGar: 30.8, plasseringEndring: 0 },
  { navn: "Finnmark", total: 28.2, iDag: 28.2, endringFraIGar: 28.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 26.8, iDag: 26.8, endringFraIGar: 26.8, plasseringEndring: 0 },
  { navn: "Troms", total: 26.6, iDag: 26.6, endringFraIGar: 26.6, plasseringEndring: 0 },
  { navn: "Nordland", total: 26.5, iDag: 26.5, endringFraIGar: 26.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 23.4, iDag: 23.4, endringFraIGar: 23.4, plasseringEndring: 0 },
  { navn: "Telemark", total: 23.0, iDag: 23.0, endringFraIGar: 23.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 22.3, iDag: 22.3, endringFraIGar: 22.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 20.5, iDag: 20.5, endringFraIGar: 20.5, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 101.1, vindkast: 38.9, nedbor: 0, temp: -5.8, farevarsel: "oransje" },
  { navn: "FV51 VALDRESFLYE", kommune: "ØYSTRE SLIDRE", fylke: "Innlandet", ei: 90.5, vindkast: 0, nedbor: 29.9, temp: -6.5, farevarsel: "oransje" },
  { navn: "TRYSIL - NORDRE KANKEN", kommune: "TRYSIL", fylke: "Innlandet", ei: 90.5, vindkast: 33.4, nedbor: 0, temp: -4.7, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 90.4, vindkast: 33.8, nedbor: 0, temp: -6.7, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 89.8, vindkast: 34.4, nedbor: 0, temp: -9.8, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -5.8,
    dager: [101.1, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 101 EI per dag. Toppdag Man med 101.1 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -5.8 grader C."
  },
  {
    navn: "FV51 VALDRESFLYE",
    ...
    precipTotal: 29.9,
    tempMin: -6.5,
    dager: [90.5, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 90 EI per dag. Toppdag Man med 90.5 EI. Mye nedbor med totalt 29.9 mm. Bitende kulde ned til -6.5 grader C."
  },
  {
    ...
    tempMin: -4.7,
    dager: [90.5, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 90 EI per dag. Toppdag Man med 90.5 EI. Kraftige vindkast opp til 33.4 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.7,
    dager: [90.4, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 90 EI per dag. Toppdag Man med 90.4 EI. Kraftige vindkast opp til 33.8 m/s. Bitende kulde ned til -6.7 grader C."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -9.8,
    dager: [89.8, 0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 90 EI per dag. Toppdag Man med 89.8 EI. Kraftige vindkast opp til 34.4 m/s. Bitende kulde ned til -9.8 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Trøndelag leder sammenlagt med 33.2 poeng - 0.0 poeng foran Agder (33.2).",
