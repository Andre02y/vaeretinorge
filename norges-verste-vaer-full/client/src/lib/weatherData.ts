 ...
 *
 * Sist oppdatert: 29.04.2026 kl. 15:19
...
export const META = {
  ...
  datoOppdatert: "29.04.2026 kl. 15:19",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [42.6, 37.3, 31.8], trend: "Markant bedring (-5.5) - lavtrykket har passert" },
  { navn: "Troms", dager: [34.7, 30.9, 30.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [34.8, 26.8, 30.9], trend: "Noe forverring (+4.1) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [27.9, 22.3, 24.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [22.8, 20.1, 21.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [23.9, 21.1, 18.6], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Vestland", dager: [20.3, 18.8, 17.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [20.2, 19.3, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.3, 18.8, 18.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [18.9, 18.3, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [19.3, 17.9, 17.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [18.8, 17.9, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.9, 17.8, 16.6], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 111.7, iDag: 31.8, endringFraIGar: -5.5, plasseringEndring: 0 },
  { navn: "Troms", total: 95.7, iDag: 30.1, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Nordland", total: 92.5, iDag: 30.9, endringFraIGar: 4.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 74.2, iDag: 24.0, endringFraIGar: 1.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 64.8, iDag: 21.9, endringFraIGar: 1.8, plasseringEndring: 1 },
  { navn: "Innlandet", total: 63.6, iDag: 18.6, endringFraIGar: -2.5, plasseringEndring: -1 },
  { navn: "Vestland", total: 57.0, iDag: 17.9, endringFraIGar: -0.9, plasseringEndring: 1 },
  { navn: "Agder", total: 57.0, iDag: 17.5, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Oslo", total: 56.4, iDag: 18.3, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Telemark", total: 54.5, iDag: 17.3, endringFraIGar: -1.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 54.3, iDag: 17.1, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Rogaland", total: 54.0, iDag: 17.3, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Buskerud", total: 53.3, iDag: 16.6, endringFraIGar: -1.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 55.6, vindkast: 21.0, nedbor: 0, temp: -0.9, farevarsel: "gul" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 54.3, vindkast: 22.7, nedbor: 0, temp: 3.7, farevarsel: "gul" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 53.8, vindkast: 18.5, nedbor: 0, temp: -4.7, farevarsel: "gul" },
  { navn: "VARDØ RADIO", kommune: "VARDØ", fylke: "Finnmark", ei: 53.8, vindkast: 14.0, nedbor: 0.9, temp: 1.0, farevarsel: "gul" },
  { navn: "GLOMFJORD - SKIHYTTA", kommune: "MELØY", fylke: "Nordland", ei: 53.1, vindkast: 14.3, nedbor: 1.5, temp: 0.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 2.4,
    tempMin: 0.6,
    dager: [63.5, 58.9, 47.3, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Man med 63.5 EI."
  },
  {
    navn: "E75 DOMEN",
    kommune: "VARDØ",
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 111.7 poeng - 16.0 poeng foran Troms (95.7).",
