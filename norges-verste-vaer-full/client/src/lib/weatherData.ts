 ...
 *
 * Sist oppdatert: 17.04.2026 kl. 09:18
...
export const META = {
  ...
  datoOppdatert: "17.04.2026 kl. 09:18",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [24.6, 34.2, 28.1, 23.3, 19.7], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.1, 27.5, 27.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.2, 23.4, 20.7], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Telemark", dager: [22.8, 27.6, 26.5, 19.6, 18.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.3, 23.1, 22.3, 21.8, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.1, 19.4, 18.4], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Troms", dager: [22.0, 20.6, 22.4, 22.1, 23.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 23.7, 23.8, 18.7, 18.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.7, 21.3, 17.4], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Østfold", dager: [21.8, 19.8, 21.5, 18.2, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [20.5, 19.6, 19.1, 19.1, 17.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 129.9, iDag: 19.7, endringFraIGar: -3.6, plasseringEndring: 0 },
  { navn: "Finnmark", total: 127.5, iDag: 27.7, endringFraIGar: 0.2, plasseringEndring: 1 },
  { navn: "Innlandet", total: 121.8, iDag: 20.7, endringFraIGar: -2.7, plasseringEndring: -1 },
  { navn: "Telemark", total: 114.8, iDag: 18.3, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Nordland", total: 113.6, iDag: 22.1, endringFraIGar: 0.3, plasseringEndring: 1 },
  { navn: "Oslo", total: 111.7, iDag: 18.4, endringFraIGar: -1.0, plasseringEndring: -1 },
  { navn: "Vestland", total: 111.6, iDag: 20.7, endringFraIGar: -1.1, plasseringEndring: 1 },
  { navn: "Rogaland", total: 110.4, iDag: 19.4, endringFraIGar: -4.8, plasseringEndring: -1 },
  { navn: "Troms", total: 110.3, iDag: 23.2, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Buskerud", total: 107.4, iDag: 18.0, endringFraIGar: -0.7, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 103.1, iDag: 17.4, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Østfold", total: 99.4, iDag: 18.1, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 96.2, iDag: 17.9, endringFraIGar: -1.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 59.5, vindkast: 15.3, nedbor: 0.4, temp: -0.5, farevarsel: "gul" },
  { navn: "GUOLAS", kommune: "KÅFJORD", fylke: "Troms", ei: 53.8, vindkast: 18.9, nedbor: 0, temp: -1.8, farevarsel: "gul" },
  { navn: "KLEVAVATNET", kommune: "AURLAND", fylke: "Vestland", ei: 51.9, vindkast: 12.5, nedbor: 0.7, temp: 1.8, farevarsel: "gul" },
  { navn: "HAUKELISETER TESTFELT", kommune: "VINJE", fylke: "Telemark", ei: 46.9, vindkast: 7.7, nedbor: 3.7, temp: 0.6, farevarsel: "gul" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 46.9, vindkast: 21.3, nedbor: 0, temp: -0.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 599.9,
    tempMin: 1.5,
    dager: [111.7, 222.6, 16.0, 14.3, 18.5, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [74.4, 75.5, 52.8, 71.9, 46.9, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 70.9, 66.5, 70.3, 37.2, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 2.7,
    tempMin: -0.4,
    dager: [48.9, 59.2, 60.8, 69.4, 51.9, 0, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 129.9 poeng - 2.4 poeng foran Finnmark (127.5).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
