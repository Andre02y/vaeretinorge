 ...
 *
 * Sist oppdatert: 19.04.2026 kl. 20:32
...
export const META = {
  ...
  datoOppdatert: "19.04.2026 kl. 20:32",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [24.6, 34.2, 28.1, 23.3, 21.2, 25.6, 24.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.1, 27.5, 27.0, 28.8, 25.4], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.1, 19.4, 18.1, 18.0, 38.7], trend: "Kraftig forverring (+20.7) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [22.8, 27.6, 26.5, 19.6, 18.1, 22.6, 29.9], trend: "Kraftig forverring (+7.3) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.2, 23.4, 20.0, 20.2, 24.6], trend: "Noe forverring (+4.4) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 23.7, 23.8, 18.7, 17.1, 19.8, 31.7], trend: "Kraftig forverring (+11.9) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [24.3, 23.1, 22.3, 21.8, 20.6, 23.6, 22.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [22.2, 24.5, 22.4, 21.8, 20.7, 21.8, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [21.8, 21.5, 23.5, 24.2, 19.6, 21.5, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [22.0, 20.6, 22.4, 22.1, 22.2, 23.2, 19.1], trend: "Noe bedring (-4.1) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.7, 21.3, 17.1, 18.5, 19.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [21.8, 19.8, 21.5, 18.2, 16.6, 14.0, 27.5], trend: "Kraftig forverring (+13.5) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [20.5, 19.6, 19.1, 19.1, 16.8, 16.8, 17.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 181.5, iDag: 24.5, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 181.0, iDag: 25.4, endringFraIGar: -3.4, plasseringEndring: 0 },
  { navn: "Oslo", total: 168.1, iDag: 38.7, endringFraIGar: 20.7, plasseringEndring: 6 },
  { navn: "Telemark", total: 167.1, iDag: 29.9, endringFraIGar: 7.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 165.9, iDag: 24.6, endringFraIGar: 4.4, plasseringEndring: -2 },
  { navn: "Buskerud", total: 158.0, iDag: 31.7, endringFraIGar: 11.9, plasseringEndring: 4 },
  { navn: "Nordland", total: 157.9, iDag: 22.2, endringFraIGar: -1.4, plasseringEndring: -2 },
  { navn: "Vestland", total: 155.5, iDag: 22.1, endringFraIGar: 0.3, plasseringEndring: -2 },
  { navn: "Rogaland", total: 152.6, iDag: 20.5, endringFraIGar: -1.0, plasseringEndring: -1 },
  { navn: "Troms", total: 151.6, iDag: 19.1, endringFraIGar: -4.1, plasseringEndring: -3 },
  { navn: "Trøndelag", total: 141.0, iDag: 19.7, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 139.4, iDag: 27.5, endringFraIGar: 13.5, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 129.4, iDag: 17.5, endringFraIGar: 0.7, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "FV51 VALDRESFLYE", kommune: "ØYSTRE SLIDRE", fylke: "Innlandet", ei: 111.3, vindkast: 0, nedbor: 130.6, temp: -0.3, farevarsel: "oransje" },
  { navn: "FV55 HERVAVATN", kommune: "LUSTER", fylke: "Vestland", ei: 68.7, vindkast: 0, nedbor: 15.7, temp: 0.2, farevarsel: "oransje" },
  { navn: "RV7 DYRANUT", kommune: "EIDFJORD", fylke: "Vestland", ei: 59.6, vindkast: 0, nedbor: 12.2, temp: -0.2, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 56.2, vindkast: 23.5, nedbor: 0, temp: -2.1, farevarsel: "gul" },
  { navn: "FLESBERG", kommune: "FLESBERG", fylke: "Buskerud", ei: 55.4, vindkast: 16.6, nedbor: 24.1, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 426.9,
    tempMin: -1.1,
    dager: [60.2, 231.3, 53.5, 71.3, 46.2, 39.9, 45.9],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [74.4, 75.5, 52.8, 71.9, 57.1, 59.9, 32.1],
    beskrivelse: "Ekstremt vaer hele uken med snitt 61 EI per dag. Toppdag Tir med 75.5 EI. Kraftige vindkast opp til 36.7 m/s."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 70.9, 66.5, 70.3, 45.2, 42.9, 37.7],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.3,
    dager: [62.1, 60.3, 53.4, 69.2, 39.9, 49.5, 56.2],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 181.5 poeng - 0.5 poeng foran Finnmark (181.0).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
