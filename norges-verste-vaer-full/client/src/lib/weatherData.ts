 ...
 *
 * Sist oppdatert: 25.06.2026 kl. 19:04
...
export const META = {
  ...
  datoOppdatert: "25.06.2026 kl. 19:04",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.0, 24.8, 19.9, 20.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [22.9, 21.2, 22.8, 20.3], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Finnmark", dager: [20.3, 21.2, 20.8, 18.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [23.4, 18.0, 18.2, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.5, 20.3, 17.4, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [18.0, 18.7, 20.3, 16.9], trend: "Noe bedring (-3.4) - roligere forhold" },
  ...
  { navn: "Rogaland", dager: [14.2, 13.4, 15.0, 11.7], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Buskerud", dager: [12.4, 12.0, 14.0, 10.8], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Agder", dager: [13.6, 12.6, 11.5, 10.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [11.9, 12.3, 12.8, 10.3], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Østfold", dager: [9.9, 11.9, 13.1, 8.1], trend: "Markant bedring (-5.0) - lavtrykket har passert" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 97.7, iDag: 20.0, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 87.2, iDag: 20.3, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Finnmark", total: 81.2, iDag: 18.9, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 78.8, iDag: 19.2, endringFraIGar: 1.0, plasseringEndring: 0 },
  { navn: "Troms", total: 74.5, iDag: 16.3, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 73.9, iDag: 16.9, endringFraIGar: -3.4, plasseringEndring: 0 },
  ...
  { navn: "Rogaland", total: 54.3, iDag: 11.7, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 49.2, iDag: 10.8, endringFraIGar: -3.2, plasseringEndring: 0 },
  { navn: "Agder", total: 48.4, iDag: 10.7, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Telemark", total: 47.3, iDag: 10.3, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 43.0, iDag: 8.1, endringFraIGar: -5.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 49.0, vindkast: 24.7, nedbor: 0, temp: 10.4, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 47.5, vindkast: 10.1, nedbor: 1.0, temp: 0, farevarsel: "gul" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 47.2, vindkast: 20.4, nedbor: 0, temp: 11.9, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 45.1, vindkast: 16.8, nedbor: 0, temp: 0, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 18.2,
    tempMin: 0,
    dager: [46.7, 42.6, 51.3, 47.5, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 6.9,
    dager: [68.7, 39.3, 21.9, 49.0, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.0, 37.5, 44.1, 44.1, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.3,
    dager: [41.6, 40.6, 47.4, 41.8, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 97.7 poeng - 10.5 poeng foran Møre og Romsdal (87.2).",
