 ...
 *
 * Sist oppdatert: 25.04.2026 kl. 14:36
...
export const META = {
  ...
  datoOppdatert: "25.04.2026 kl. 14:36",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.3, 36.3, 46.8, 47.9, 43.1, 31.6], trend: "Markant bedring (-11.5) - lavtrykket har passert" },
  { navn: "Troms", dager: [23.4, 31.2, 30.4, 33.8, 36.5, 33.7], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 29.6, 32.0, 37.7], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 27.4, 28.0, 32.8], trend: "Noe forverring (+4.8) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 25.3, 28.2, 33.3], trend: "Kraftig forverring (+5.1) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 22.4, 21.5, 27.7], trend: "Kraftig forverring (+6.2) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [19.7, 18.2, 19.3, 20.2, 21.8, 27.8], trend: "Kraftig forverring (+6.0) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 18.6, 17.8, 18.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [19.0, 17.6, 19.3, 20.8, 20.9, 25.0], trend: "Noe forverring (+4.1) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [25.2, 18.5, 18.1, 17.7, 17.3, 22.1], trend: "Noe forverring (+4.8) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 16.7, 16.9, 19.0], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [25.0, 17.7, 16.4, 16.5, 15.9, 18.3], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 15.9, 15.7, 18.3], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 234.0, iDag: 31.6, endringFraIGar: -11.5, plasseringEndring: 0 },
  { navn: "Troms", total: 189.0, iDag: 33.7, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Nordland", total: 176.4, iDag: 37.7, endringFraIGar: 5.7, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 150.1, iDag: 32.8, endringFraIGar: 4.8, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 142.7, iDag: 33.3, endringFraIGar: 5.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 135.2, iDag: 27.7, endringFraIGar: 6.2, plasseringEndring: 0 },
  { navn: "Vestland", total: 127.0, iDag: 27.8, endringFraIGar: 6.0, plasseringEndring: 1 },
  { navn: "Oslo", total: 122.7, iDag: 18.6, endringFraIGar: 0.8, plasseringEndring: -1 },
  { navn: "Rogaland", total: 122.6, iDag: 25.0, endringFraIGar: 4.1, plasseringEndring: 0 },
  { navn: "Agder", total: 118.9, iDag: 22.1, endringFraIGar: 4.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 110.3, iDag: 19.0, endringFraIGar: 2.1, plasseringEndring: 1 },
  { navn: "Telemark", total: 109.8, iDag: 18.3, endringFraIGar: 2.4, plasseringEndring: -1 },
  { navn: "Østfold", total: 105.0, iDag: 18.3, endringFraIGar: 2.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 68.3, vindkast: 28.5, nedbor: 0, temp: -2.1, farevarsel: "oransje" },
  { navn: "SIRDAL - SMØLEHEIKNUDEN", kommune: "SIRDAL", fylke: "Agder", ei: 66.3, vindkast: 28.7, nedbor: 0, temp: 1.4, farevarsel: "oransje" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 65.8, vindkast: 24.3, nedbor: 0, temp: -0.5, farevarsel: "oransje" },
  { navn: "RØST LUFTHAVN", kommune: "RØST", fylke: "Nordland", ei: 65.8, vindkast: 18.9, nedbor: 5.4, temp: 1.7, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 65.7, vindkast: 27.9, nedbor: 0, temp: -4.5, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.8,
    dager: [40.4, 63.8, 70.8, 69.7, 66.1, 40.5, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -4.7,
    dager: [54.3, 85.8, 56.7, 69.2, 48.7, 34.8, 0],
  ...
  },
  {
    ...
    precipTotal: 1.8,
    tempMin: -2.6,
    dager: [39.6, 54.0, 78.0, 68.6, 61.0, 44.6, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.4,
    dager: [53.6, 65.4, 56.0, 60.9, 60.0, 49.8, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.6,
    dager: [48.2, 74.4, 56.5, 61.0, 52.0, 47.9, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 234.0 poeng - 45.0 poeng foran Troms (189.0).",
