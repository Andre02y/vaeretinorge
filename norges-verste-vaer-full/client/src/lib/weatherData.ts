 ...
 *
 * Sist oppdatert: 01.05.2026 kl. 17:45
...
export const META = {
  ...
  datoOppdatert: "01.05.2026 kl. 17:45",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [42.6, 37.3, 30.2, 29.6, 27.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [34.8, 26.8, 32.3, 32.6, 32.0], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Møre og Romsdal", dager: [22.8, 20.1, 21.9, 18.6, 19.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [23.9, 21.1, 18.2, 15.8, 16.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [20.3, 18.8, 17.6, 17.3, 18.2], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Rogaland", dager: [18.8, 17.9, 17.1, 16.8, 17.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [19.3, 17.9, 17.1, 15.7, 15.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [18.9, 18.3, 17.0, 15.1, 15.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.9, 17.8, 16.2, 15.8, 14.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 167.5, iDag: 27.8, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Nordland", total: 158.5, iDag: 32.0, endringFraIGar: -0.6, plasseringEndring: 0 },
  ...
  { navn: "Møre og Romsdal", total: 103.1, iDag: 19.7, endringFraIGar: 1.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 95.8, iDag: 16.8, endringFraIGar: 1.0, plasseringEndring: 0 },
  { navn: "Vestland", total: 92.2, iDag: 18.2, endringFraIGar: 0.9, plasseringEndring: 0 },
  ...
  { navn: "Rogaland", total: 87.8, iDag: 17.2, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 85.4, iDag: 15.4, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 84.5, iDag: 15.2, endringFraIGar: 0.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 83.6, iDag: 14.9, endringFraIGar: -0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 68.9, vindkast: 29.9, nedbor: 0, temp: 0.8, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 64.1, vindkast: 25.7, nedbor: 0, temp: 0.0, farevarsel: "oransje" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 62.5, vindkast: 29.2, nedbor: 0, temp: 4.4, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 62.4, vindkast: 29.6, nedbor: 0, temp: 3.6, farevarsel: "oransje" },
  { navn: "ROTVÆR", kommune: "LØDINGEN", fylke: "Nordland", ei: 59.9, vindkast: 25.5, nedbor: 0, temp: 6.6, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -5.7,
    dager: [47.2, 43.8, 54.4, 67.1, 64.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.9,
    dager: [47.2, 39.3, 58.2, 56.7, 68.9, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Fre med 68.9 EI. Kraftige vindkast opp til 29.9 m/s. Bitende kulde ned til -5.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.1,
    dager: [44.4, 37.7, 59.0, 55.8, 62.5, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 52 EI per dag. Toppdag Fre med 62.5 EI. Kraftige vindkast opp til 29.2 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -9.0,
    dager: [46.6, 47.0, 51.6, 53.8, 56.7, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Fre med 56.7 EI. Bitende kulde ned til -9.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.8,
    dager: [50.6, 31.8, 56.1, 61.4, 50.3, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 167.5 poeng - 9.0 poeng foran Nordland (158.5).",
