 ...
 *
 * Sist oppdatert: 23.04.2026 kl. 07:22
 * Periode sammenlagt: 20.04 - 23.04.2026 (4 dager)
...
export const META = {
  ...
  dagLabel: "Torsdag 23.04.2026",
  sammenlagtLabel: "20.04 - 23.04.2026 (4 dager)",
  datoOppdatert: "23.04.2026 kl. 07:22",
  rapportVersjon: "v2.2 (norsk tid, live uke, ryddig arkiv, fikset uke/arkiv-logikk)",
  dagLabels: ["Man 20", "Tir 21", "Ons 22", "Tor 23"],
};

// ---- DAG-FOR-DAG EI PER FYLKE ----

export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.3, 36.3, 46.8, 38.3], trend: "Markant bedring (-8.5) - lavtrykket har passert" },
  { navn: "Troms", dager: [23.4, 31.2, 30.4, 27.8], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 25.3], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 24.5], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [25.2, 18.5, 18.1, 20.9], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 23.4], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [19.7, 18.2, 19.3, 21.6], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 20.0], trend: "Noe forverring (+3.4) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [25.0, 17.7, 16.4, 18.5], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [19.0, 17.6, 19.3, 21.4], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 18.4], trend: "Noe forverring (+3.2) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 149.7, iDag: 38.3, endringFraIGar: -8.5, plasseringEndring: 0 },
  { navn: "Troms", total: 112.8, iDag: 27.8, endringFraIGar: -2.6, plasseringEndring: 0 },
  { navn: "Nordland", total: 102.4, iDag: 25.3, endringFraIGar: -4.0, plasseringEndring: 0 },
  { navn: "Innlandet", total: 88.1, iDag: 24.5, endringFraIGar: 2.8, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 86.8, iDag: 24.9, endringFraIGar: -0.1, plasseringEndring: 1 },
  { navn: "Oslo", total: 86.7, iDag: 19.0, endringFraIGar: 0.9, plasseringEndring: -2 },
  { navn: "Agder", total: 82.7, iDag: 20.9, endringFraIGar: 2.8, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 79.3, iDag: 23.4, endringFraIGar: 2.4, plasseringEndring: 3 },
  { navn: "Vestland", total: 78.8, iDag: 21.6, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Buskerud", total: 77.7, iDag: 20.0, endringFraIGar: 3.4, plasseringEndring: -1 },
  { navn: "Telemark", total: 77.6, iDag: 18.5, endringFraIGar: 2.1, plasseringEndring: -3 },
  { navn: "Rogaland", total: 77.3, iDag: 21.4, endringFraIGar: 2.1, plasseringEndring: 0 },
  { navn: "Østfold", total: 73.5, iDag: 18.4, endringFraIGar: 3.2, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER TORSDAG 23.04.2026 ----

export const STASJONER_PERIODE = [
  { navn: "TRYSIL - NORDRE KANKEN", kommune: "TRYSIL", fylke: "Innlandet", ei: 64.2, vindkast: 28.2, nedbor: 0, temp: 0.2, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 62.7, vindkast: 24.4, nedbor: 0, temp: 0.1, farevarsel: "oransje" },
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 62.7, vindkast: 0, nedbor: 0.2, temp: 1.7, farevarsel: "oransje" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 62.5, vindkast: 22.7, nedbor: 0, temp: -1.6, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 61.6, vindkast: 23.2, nedbor: 0, temp: -4.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0.1,
    dager: [54.3, 85.8, 56.7, 62.7, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -1.6,
    dager: [40.4, 63.8, 70.8, 62.5, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Ons med 70.8 EI. Kraftige vindkast opp til 27.0 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [53.6, 65.4, 56.0, 54.9, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Tir med 65.4 EI. Kraftige vindkast opp til 28.3 m/s."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
    ...
    precipTotal: 0,
    tempMin: -4.5,
    dager: [48.2, 74.4, 56.5, 45.1, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 56 EI per dag. Toppdag Tir med 74.4 EI. Kraftige vindkast opp til 29.6 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [41.3, 67.1, 62.7, 45.6, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Tir med 67.1 EI. Kraftige vindkast opp til 29.5 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 149.7 poeng - 36.9 poeng foran Troms (112.8).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-04-20",
  tilDato: "2026-04-23",
  periode: "20.04 - 23.04.2026 (4 dager)",
  dagerRegistrert: 4,
  versteFylke: "Finnmark",
  versteFylkeScore: 149.7,
};
