 ...
 *
 * Sist oppdatert: 26.08.2026 kl. 02:33
...
export const META = {
  ...
  datoOppdatert: "26.08.2026 kl. 02:33",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [18.1, 23.0, 29.8], trend: "Kraftig forverring (+6.8) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [21.8, 21.9, 17.1], trend: "Noe bedring (-4.8) - roligere forhold" },
  { navn: "Troms", dager: [17.6, 20.2, 21.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [16.5, 14.2, 14.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [13.6, 13.7, 15.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [16.3, 15.7, 9.2], trend: "Markant bedring (-6.5) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [14.8, 13.0, 12.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [14.8, 12.1, 12.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [14.1, 12.8, 12.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [14.0, 11.5, 10.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [11.8, 11.3, 11.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [11.7, 10.9, 11.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [11.1, 9.8, 11.6], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 70.9, iDag: 29.8, endringFraIGar: 6.8, plasseringEndring: 1 },
  { navn: "Nordland", total: 60.8, iDag: 17.1, endringFraIGar: -4.8, plasseringEndring: -1 },
  { navn: "Troms", total: 59.0, iDag: 21.2, endringFraIGar: 1.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 44.9, iDag: 14.2, endringFraIGar: 0.0, plasseringEndring: 1 },
  { navn: "Agder", total: 42.3, iDag: 15.0, endringFraIGar: 1.3, plasseringEndring: 2 },
  { navn: "Oslo", total: 41.2, iDag: 9.2, endringFraIGar: -6.5, plasseringEndring: -2 },
  { navn: "Møre og Romsdal", total: 40.1, iDag: 12.3, endringFraIGar: -0.7, plasseringEndring: -1 },
  { navn: "Innlandet", total: 39.5, iDag: 12.6, endringFraIGar: 0.5, plasseringEndring: 1 },
  { navn: "Vestland", total: 39.1, iDag: 12.2, endringFraIGar: -0.6, plasseringEndring: -1 },
  { navn: "Rogaland", total: 36.4, iDag: 10.9, endringFraIGar: -0.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 34.3, iDag: 11.2, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 34.0, iDag: 11.4, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 32.5, iDag: 11.6, endringFraIGar: 1.8, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 77.5, vindkast: 0, nedbor: 0, temp: -46.8, farevarsel: "oransje" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 68.1, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "oransje" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 60.3, vindkast: 0, nedbor: 0, temp: -39.6, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 59.7, vindkast: 0, nedbor: 0, temp: -39.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -39.8,
    dager: [63.5, 63.7, 68.1, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Ons med 68.1 EI. Bitende kulde ned til -39.8 grader C."
  },
  {
    navn: "RV3 EBRU",
    kommune: "LØTEN",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -46.8,
    dager: [46.0, 27.8, 77.5, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Ons med 77.5 EI. Bitende kulde ned til -46.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 42.1, 58.2, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Ons med 58.2 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 70.9 poeng, foran Nordland (60.8).",
