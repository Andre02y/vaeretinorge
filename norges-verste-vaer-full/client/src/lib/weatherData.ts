 ...
 *
 * Sist oppdatert: 17.04.2026 kl. 20:42
...
export const META = {
  ...
  datoOppdatert: "17.04.2026 kl. 20:42",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Agder", dager: [24.6, 34.2, 28.1, 23.3, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.1, 27.5, 27.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.2, 23.4, 20.0], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Telemark", dager: [22.8, 27.6, 26.5, 19.6, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.3, 23.1, 22.3, 21.8, 20.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [22.2, 24.5, 22.4, 21.8, 20.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.1, 19.4, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [21.8, 21.5, 23.5, 24.2, 19.5], trend: "Noe bedring (-4.7) - roligere forhold" },
  { navn: "Troms", dager: [22.0, 20.6, 22.4, 22.1, 22.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 23.7, 23.8, 18.7, 17.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.7, 21.3, 17.0], trend: "Noe bedring (-4.3) - roligere forhold" },
  { navn: "Østfold", dager: [21.8, 19.8, 21.5, 18.2, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [20.5, 19.6, 19.1, 19.1, 17.0], trend: "Noe bedring (-2.1) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Agder", total: 132.2, iDag: 22.0, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 126.9, iDag: 27.1, endringFraIGar: -0.4, plasseringEndring: 1 },
  { navn: "Innlandet", total: 121.1, iDag: 20.0, endringFraIGar: -3.4, plasseringEndring: -1 },
  { navn: "Telemark", total: 114.6, iDag: 18.1, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Nordland", total: 112.2, iDag: 20.7, endringFraIGar: -1.1, plasseringEndring: 1 },
  { navn: "Vestland", total: 111.6, iDag: 20.7, endringFraIGar: -1.1, plasseringEndring: 2 },
  { navn: "Oslo", total: 111.4, iDag: 18.1, endringFraIGar: -1.3, plasseringEndring: -2 },
  { navn: "Rogaland", total: 110.5, iDag: 19.5, endringFraIGar: -4.7, plasseringEndring: -1 },
  { navn: "Troms", total: 109.2, iDag: 22.1, endringFraIGar: 0.0, plasseringEndring: 1 },
  { navn: "Buskerud", total: 106.5, iDag: 17.1, endringFraIGar: -1.6, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 102.7, iDag: 17.0, endringFraIGar: -4.3, plasseringEndring: 0 },
  { navn: "Østfold", total: 97.9, iDag: 16.6, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 95.3, iDag: 17.0, endringFraIGar: -2.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 54.8, vindkast: 24.7, nedbor: 0, temp: -0.7, farevarsel: "gul" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 47.5, vindkast: 16.0, nedbor: 0, temp: -0.5, farevarsel: "gul" },
  { navn: "HAUKELISETER TESTFELT", kommune: "VINJE", fylke: "Telemark", ei: 47.1, vindkast: 7.7, nedbor: 1.8, temp: 0.6, farevarsel: "gul" },
  { navn: "FOLGEFONNA SKISENTER", kommune: "ULLENSVANG", fylke: "Vestland", ei: 46.6, vindkast: 17.2, nedbor: 0, temp: 0.7, farevarsel: "gul" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 45.6, vindkast: 16.6, nedbor: 0, temp: -1.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 408.7,
    tempMin: -1.1,
    dager: [60.2, 231.3, 53.5, 71.3, 45.5, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 92 EI per dag. Toppdag Tir med 231.3 EI. Mye nedbor med totalt 408.7 mm."
  },
  {
    ...
    precipTotal: 599.9,
    tempMin: 2.5,
    dager: [111.7, 222.6, 16.0, 14.3, 13.7, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 76 EI per dag. Toppdag Tir med 222.6 EI. Mye nedbor med totalt 599.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [74.4, 75.5, 52.8, 71.9, 54.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [65.4, 70.9, 66.5, 70.3, 45.6, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Tir med 70.9 EI. Kraftige vindkast opp til 31.7 m/s."
  },
  {
    navn: "SPØRTEGGBU",
    kommune: "LUSTER",
    ...
    precipTotal: 0,
    tempMin: -5.3,
    dager: [60.8, 63.6, 56.0, 63.9, 43.8, 0, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 132.2 poeng - 5.3 poeng foran Finnmark (126.9).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
