 ...
 *
 * Sist oppdatert: 29.05.2026 kl. 03:59
...
export const META = {
  ...
  datoOppdatert: "29.05.2026 kl. 03:59",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.5, 26.9, 25.6, 26.8, 24.1], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Finnmark", dager: [25.2, 25.2, 27.3, 29.3, 25.8], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.4, 28.2, 28.3, 23.1, 17.7], trend: "Markant bedring (-5.4) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [23.8, 29.9, 25.8, 21.7, 16.2], trend: "Markant bedring (-5.5) - lavtrykket har passert" },
  { navn: "Troms", dager: [24.4, 20.0, 20.5, 23.0, 23.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [25.3, 25.3, 22.1, 18.1, 16.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [17.2, 21.6, 21.4, 18.5, 16.2], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Oslo", dager: [16.6, 17.4, 17.5, 17.5, 14.7], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Rogaland", dager: [15.1, 17.7, 18.6, 14.9, 16.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.9, 17.0, 16.9, 15.4, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [13.2, 14.9, 14.9, 14.1, 15.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.2, 14.3, 14.8, 14.2, 15.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [10.9, 13.5, 14.2, 13.5, 14.8], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 132.9, iDag: 24.1, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Finnmark", total: 132.8, iDag: 25.8, endringFraIGar: -3.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 119.7, iDag: 17.7, endringFraIGar: -5.4, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 117.4, iDag: 16.2, endringFraIGar: -5.5, plasseringEndring: 0 },
  { navn: "Troms", total: 111.6, iDag: 23.7, endringFraIGar: 0.7, plasseringEndring: 1 },
  { navn: "Vestland", total: 107.7, iDag: 16.9, endringFraIGar: -1.2, plasseringEndring: -1 },
  { navn: "Innlandet", total: 94.9, iDag: 16.2, endringFraIGar: -2.3, plasseringEndring: 0 },
  { navn: "Oslo", total: 83.7, iDag: 14.7, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Rogaland", total: 82.4, iDag: 16.1, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Agder", total: 80.8, iDag: 16.6, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 72.8, iDag: 15.7, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Telemark", total: 72.0, iDag: 15.5, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Østfold", total: 66.9, iDag: 14.8, endringFraIGar: 1.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 50.7, vindkast: 15.5, nedbor: 0, temp: -1.3, farevarsel: "gul" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 47.6, vindkast: 15.6, nedbor: 0, temp: 5.8, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 46.0, vindkast: 20.1, nedbor: 0, temp: 2.9, farevarsel: "gul" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 45.5, vindkast: 12.0, nedbor: 0, temp: -1.0, farevarsel: "gul" },
  { navn: "SISOVATNET", kommune: "SØRFOLD", fylke: "Nordland", ei: 44.2, vindkast: 4.8, nedbor: 0.1, temp: 0.9, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [62.3, 64.9, 67.3, 51.5, 46.0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 58 EI per dag. Toppdag Ons med 67.3 EI. Kraftige vindkast opp til 28.9 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [55.2, 56.1, 58.8, 47.2, 42.6, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 52 EI per dag. Toppdag Ons med 58.8 EI. Kraftige vindkast opp til 33.8 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0.1,
    dager: [46.7, 66.8, 60.0, 43.1, 31.0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [53.2, 68.2, 54.6, 36.4, 34.4, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 1.4,
    dager: [48.6, 62.1, 55.3, 43.7, 31.4, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 132.9 poeng - 0.1 poeng foran Finnmark (132.8).",
