 ...
 *
 * Sist oppdatert: 01.09.2026 kl. 15:46
...
export const META = {
  ...
  datoOppdatert: "01.09.2026 kl. 15:46",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [24.6, 16.2], trend: "Markant bedring (-8.4) - lavtrykket har passert" },
  { navn: "Nordland", dager: [18.7, 21.7], trend: "Noe forverring (+3.0) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [18.2, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [19.1, 17.1], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [17.6, 15.2], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Innlandet", dager: [17.1, 15.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [16.6, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [16.5, 14.5], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Vestland", dager: [15.8, 14.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [16.1, 12.5], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Buskerud", dager: [15.0, 12.8], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Rogaland", dager: [12.9, 12.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [12.3, 12.0], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 40.8, iDag: 16.2, endringFraIGar: -8.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 40.4, iDag: 21.7, endringFraIGar: 3.0, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 36.3, iDag: 18.1, endringFraIGar: -0.1, plasseringEndring: 1 },
  { navn: "Finnmark", total: 36.2, iDag: 17.1, endringFraIGar: -2.0, plasseringEndring: -2 },
  { navn: "Møre og Romsdal", total: 32.8, iDag: 15.2, endringFraIGar: -2.4, plasseringEndring: 0 },
  { navn: "Innlandet", total: 32.6, iDag: 15.5, endringFraIGar: -1.6, plasseringEndring: 0 },
  { navn: "Troms", total: 32.5, iDag: 15.9, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Agder", total: 31.0, iDag: 14.5, endringFraIGar: -2.0, plasseringEndring: 0 },
  { navn: "Vestland", total: 30.4, iDag: 14.6, endringFraIGar: -1.2, plasseringEndring: 1 },
  { navn: "Telemark", total: 28.6, iDag: 12.5, endringFraIGar: -3.6, plasseringEndring: -1 },
  { navn: "Buskerud", total: 27.8, iDag: 12.8, endringFraIGar: -2.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 25.3, iDag: 12.4, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 24.3, iDag: 12.0, endringFraIGar: -0.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 62.5, vindkast: 0, nedbor: 0, temp: -37.2, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "FV289 HURUM", kommune: "ASKER", fylke: "Buskerud", ei: 56.7, vindkast: 0, nedbor: 0, temp: -35.0, farevarsel: "gul" },
  { navn: "SANDNESSJØEN - ÅSEN", kommune: "ALSTAHAUG", fylke: "Nordland", ei: 52.0, vindkast: 0, nedbor: 34.1, temp: 0, farevarsel: "gul" },
  { navn: "SANDNESSJØEN - STAMNESØRA", kommune: "ALSTAHAUG", fylke: "Nordland", ei: 50.1, vindkast: 0, nedbor: 30.3, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -37.2,
    dager: [55.7, 62.5, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Tir med 62.5 EI. Bitende kulde ned til -37.2 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 13.2,
    dager: [79.6, 9.3, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Man med 79.6 EI. Kraftige vindkast opp til 79.1 m/s."
  },
  {
    ...
    precipTotal: 36.6,
    tempMin: 0,
    dager: [36.2, 52.0, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Tir med 52.0 EI. Mye nedbor med totalt 36.6 mm."
  },
  {
    ...
    precipTotal: 31.9,
    tempMin: 0,
    dager: [35.8, 50.1, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Tir med 50.1 EI. Mye nedbor med totalt 31.9 mm."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 40.8 poeng - 0.4 poeng foran Nordland (40.4).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
