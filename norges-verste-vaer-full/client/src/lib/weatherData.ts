 ...
 *
 * Sist oppdatert: 07.06.2026 kl. 13:01
...
export const META = {
  ...
  datoOppdatert: "07.06.2026 kl. 13:01",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Agder", dager: [19.4, 18.4, 21.7, 26.3, 23.7, 17.4, 14.4], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Telemark", dager: [20.8, 18.7, 18.5, 23.2, 22.7, 15.0, 13.0], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Buskerud", dager: [18.8, 17.7, 17.9, 23.0, 22.6, 15.3, 13.5], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Vestland", dager: [19.6, 18.1, 19.5, 19.3, 19.7, 16.3, 13.6], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Finnmark", dager: [20.5, 18.8, 19.9, 17.6, 16.6, 15.5, 16.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [19.0, 18.5, 17.7, 21.3, 19.4, 15.7, 12.9], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Østfold", dager: [17.7, 16.2, 14.9, 21.1, 22.4, 15.2, 12.7], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [17.6, 17.5, 17.3, 14.7, 16.7, 15.3, 15.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [18.8, 17.3, 15.9, 12.5, 13.9, 14.6, 13.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [13.8, 15.4, 12.7, 14.2, 15.5, 15.7, 16.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Agder", total: 141.3, iDag: 14.4, endringFraIGar: -3.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 131.9, iDag: 13.0, endringFraIGar: -2.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 128.8, iDag: 13.5, endringFraIGar: -1.8, plasseringEndring: 0 },
  ...
  { navn: "Vestland", total: 126.1, iDag: 13.6, endringFraIGar: -2.7, plasseringEndring: -1 },
  { navn: "Finnmark", total: 125.8, iDag: 16.9, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 124.5, iDag: 12.9, endringFraIGar: -2.8, plasseringEndring: -2 },
  { navn: "Østfold", total: 120.2, iDag: 12.7, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 114.3, iDag: 15.2, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Troms", total: 106.9, iDag: 13.9, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 103.4, iDag: 16.1, endringFraIGar: 0.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "GLOMFJORD - SKIHYTTA", kommune: "MELØY", fylke: "Nordland", ei: 71.6, vindkast: 10.7, nedbor: 86.9, temp: 9.2, farevarsel: "oransje" },
  { navn: "TUNNSJØ", kommune: "LIERNE", fylke: "Trøndelag", ei: 41.5, vindkast: 0, nedbor: 12.9, temp: 0, farevarsel: "gul" },
  { navn: "MYKEN", kommune: "RØDØY", fylke: "Nordland", ei: 41.1, vindkast: 15.9, nedbor: 0, temp: 10.8, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 2.9,
    dager: [28.2, 46.6, 66.5, 62.2, 47.2, 26.0, 27.4],
  ...
  },
  {
    ...
    precipTotal: 11.8,
    tempMin: 0,
    dager: [44.9, 42.9, 49.8, 47.5, 45.4, 43.7, 25.8],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [33.6, 37.6, 36.0, 40.3, 63.9, 52.2, 35.2],
  ...
  },
  {
    ...
    precipTotal: 44.1,
    tempMin: 0,
    dager: [41.2, 36.1, 39.8, 44.6, 47.4, 39.8, 37.3],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [33.4, 33.2, 56.9, 56.0, 41.3, 30.9, 28.8],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 193.2 poeng - 51.9 poeng foran Agder (141.3).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
