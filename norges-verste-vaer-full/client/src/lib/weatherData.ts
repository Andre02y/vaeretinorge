 ...
 *
 * Sist oppdatert: 27.04.2026 kl. 15:15
...
export const META = {
  ...
  datoOppdatert: "27.04.2026 kl. 15:15",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [42.2], trend: "Kraftig forverring (+42.2) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [35.4], trend: "Kraftig forverring (+35.4) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [34.2], trend: "Kraftig forverring (+34.2) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [28.3], trend: "Kraftig forverring (+28.3) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [25.8], trend: "Kraftig forverring (+25.8) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [24.6], trend: "Kraftig forverring (+24.6) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [21.0], trend: "Kraftig forverring (+21.0) - okt vind og/eller nedbor" },
  ...
  { navn: "Buskerud", dager: [19.6], trend: "Kraftig forverring (+19.6) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [19.5], trend: "Kraftig forverring (+19.5) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [19.2], trend: "Kraftig forverring (+19.2) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [18.8], trend: "Kraftig forverring (+18.8) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 42.2, iDag: 42.2, endringFraIGar: 42.2, plasseringEndring: 0 },
  { navn: "Nordland", total: 35.4, iDag: 35.4, endringFraIGar: 35.4, plasseringEndring: 0 },
  { navn: "Troms", total: 34.2, iDag: 34.2, endringFraIGar: 34.2, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 28.3, iDag: 28.3, endringFraIGar: 28.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 25.8, iDag: 25.8, endringFraIGar: 25.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 24.6, iDag: 24.6, endringFraIGar: 24.6, plasseringEndring: 0 },
  { navn: "Agder", total: 21.0, iDag: 21.0, endringFraIGar: 21.0, plasseringEndring: 0 },
  ...
  { navn: "Buskerud", total: 19.6, iDag: 19.6, endringFraIGar: 19.6, plasseringEndring: 0 },
  { navn: "Oslo", total: 19.5, iDag: 19.5, endringFraIGar: 19.5, plasseringEndring: 0 },
  { navn: "Telemark", total: 19.2, iDag: 19.2, endringFraIGar: 19.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 18.8, iDag: 18.8, endringFraIGar: 18.8, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "MEHAMN LUFTHAVN", kommune: "GAMVIK", fylke: "Finnmark", ei: 63.6, vindkast: 19.4, nedbor: 2.4, temp: 1.6, farevarsel: "oransje" },
  { navn: "HONNINGSVÅG LUFTHAVN", kommune: "NORDKAPP", fylke: "Finnmark", ei: 63.2, vindkast: 15.6, nedbor: 6.6, temp: 1.6, farevarsel: "oransje" },
  { navn: "E69 VEDBOTN", kommune: "NORDKAPP", fylke: "Finnmark", ei: 62.4, vindkast: 0, nedbor: 25.9, temp: 0.4, farevarsel: "oransje" },
  { navn: "FINNESVATNET", kommune: "VARDØ", fylke: "Finnmark", ei: 62.2, vindkast: 14.5, nedbor: 0.6, temp: -0.3, farevarsel: "oransje" },
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 61.5, vindkast: 0, nedbor: 35.4, temp: -1.9, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Man med 63.6 EI."
  },
  {
  ...
  },
  {
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Man med 62.4 EI. Mye nedbor med totalt 25.9 mm."
  },
  {
    navn: "FINNESVATNET",
    kommune: "VARDØ",
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Man med 62.2 EI."
  },
  {
    navn: "E69 NORDKAPP",
    kommune: "NORDKAPP",
    ...
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Man med 61.5 EI. Mye nedbor med totalt 35.4 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 42.2 poeng - 6.8 poeng foran Nordland (35.4).",
