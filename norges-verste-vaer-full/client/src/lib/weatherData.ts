 ...
 *
 * Sist oppdatert: 10.04.2026 kl. 09:14
...
export const META = {
  ...
  datoOppdatert: "10.04.2026 kl. 09:14",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 29.0], trend: "Markant bedring (-5.1) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 25.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.7], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 21.7], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 23.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.6], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 27.8], trend: "Noe forverring (+4.9) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 26.6], trend: "Noe forverring (+3.1) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.8], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 21.5], trend: "Noe forverring (+2.7) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 21.5], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 160.9, iDag: 29.0, endringFraIGar: -5.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 132.1, iDag: 25.9, endringFraIGar: 1.8, plasseringEndring: 1 },
  { navn: "Vestland", total: 130.8, iDag: 27.7, endringFraIGar: 2.8, plasseringEndring: 3 },
  { navn: "Troms", total: 128.7, iDag: 21.7, endringFraIGar: -3.4, plasseringEndring: -2 },
  { navn: "Nordland", total: 128.3, iDag: 23.8, endringFraIGar: -1.7, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 126.9, iDag: 23.6, endringFraIGar: 2.6, plasseringEndring: -1 },
  { navn: "Agder", total: 124.7, iDag: 27.8, endringFraIGar: 4.9, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 122.3, iDag: 22.8, endringFraIGar: 1.9, plasseringEndring: -1 },
  { navn: "Rogaland", total: 118.9, iDag: 26.6, endringFraIGar: 3.1, plasseringEndring: 0 },
  { navn: "Telemark", total: 103.2, iDag: 21.8, endringFraIGar: 2.5, plasseringEndring: 1 },
  { navn: "Buskerud", total: 101.9, iDag: 21.5, endringFraIGar: 2.7, plasseringEndring: 1 },
  { navn: "Oslo", total: 101.8, iDag: 19.9, endringFraIGar: 1.2, plasseringEndring: -2 },
  { navn: "Østfold", total: 100.6, iDag: 21.5, endringFraIGar: 3.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 98.8, vindkast: 48.4, nedbor: 0, temp: -1.4, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 90.4, vindkast: 38.5, nedbor: 0, temp: -3.5, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 78.6, vindkast: 29.7, nedbor: 0, temp: -3.9, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 75.5, vindkast: 28.7, nedbor: 0, temp: -3.5, farevarsel: "oransje" },
  { navn: "KLEVAVATNET", kommune: "AURLAND", fylke: "Vestland", ei: 74.9, vindkast: 23.0, nedbor: 2.1, temp: 0.5, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 98.8, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Fre med 98.8 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -5.8,
    dager: [80.1, 39.5, 44.2, 66.7, 90.4, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Fre med 90.4 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -5.8 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 141.9,
    tempMin: -3.2,
    dager: [77.7, 25.9, 44.8, 92.4, 57.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 73.1, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [59.4, 38.1, 71.3, 56.2, 70.9, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Ons med 71.3 EI. Kraftige vindkast opp til 37.1 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 160.9 poeng - 28.8 poeng foran Innlandet (132.1).",
