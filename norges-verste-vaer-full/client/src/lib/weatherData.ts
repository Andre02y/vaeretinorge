 ...
 *
 * Sist oppdatert: 15.04.2026 kl. 14:56
...
export const META = {
  ...
  datoOppdatert: "15.04.2026 kl. 14:56",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Telemark", dager: [22.8, 27.6, 28.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [26.7, 25.8, 25.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [25.1, 19.7, 29.4], trend: "Kraftig forverring (+9.7) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [24.9, 23.3, 24.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 23.7, 24.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.3, 23.1, 23.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [22.2, 24.5, 22.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [21.8, 21.5, 23.9], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [22.0, 20.6, 22.9], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [22.4, 21.3, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [21.8, 19.8, 22.4], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Telemark", total: 79.1, iDag: 28.7, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Innlandet", total: 78.2, iDag: 25.7, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Oslo", total: 74.2, iDag: 29.4, endringFraIGar: 9.7, plasseringEndring: 4 },
  { navn: "Finnmark", total: 72.7, iDag: 24.5, endringFraIGar: 1.2, plasseringEndring: -1 },
  { navn: "Buskerud", total: 71.4, iDag: 24.5, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Nordland", total: 70.6, iDag: 23.2, endringFraIGar: 0.1, plasseringEndring: -2 },
  { navn: "Vestland", total: 69.4, iDag: 22.7, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Rogaland", total: 67.2, iDag: 23.9, endringFraIGar: 2.4, plasseringEndring: 1 },
  { navn: "Troms", total: 65.5, iDag: 22.9, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 64.5, iDag: 20.8, endringFraIGar: -0.5, plasseringEndring: -2 },
  { navn: "Østfold", total: 64.0, iDag: 22.4, endringFraIGar: 2.6, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 66.2, vindkast: 23.3, nedbor: 0, temp: -3.4, farevarsel: "oransje" },
  { navn: "BØYLEFOSS", kommune: "FROLAND", fylke: "Agder", ei: 62.0, vindkast: 0, nedbor: 54.0, temp: 0, farevarsel: "oransje" },
  { navn: "KLEVAVATNET", kommune: "AURLAND", fylke: "Vestland", ei: 58.6, vindkast: 18.3, nedbor: 1.0, temp: 0.6, farevarsel: "gul" },
  { navn: "MØSSTRAND II", kommune: "VINJE", fylke: "Telemark", ei: 57.7, vindkast: 24.8, nedbor: 9.0, temp: -0.3, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 599.9,
    tempMin: 2.5,
    dager: [111.7, 222.6, 16.8, 0, 0, 0, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "AGDER LEDER!",
  beskrivelse: "Agder leder sammenlagt med 90.5 poeng - 11.4 poeng foran Telemark (79.1).",
  gammelLeder: "Agder",
  nyLeder: "Agder",
};
