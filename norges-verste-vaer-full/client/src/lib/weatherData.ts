 ...
 *
 * Sist oppdatert: 11.04.2026 kl. 14:32
...
export const META = {
  ...
  datoOppdatert: "11.04.2026 kl. 14:32",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 28.7, 23.9], trend: "Noe bedring (-4.8) - roligere forhold" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 30.8, 31.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 24.8, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.0, 24.3], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.0, 23.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.4, 23.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 20.6, 21.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.9, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 25.2, 26.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.7, 25.8], trend: "Noe forverring (+4.1) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 20.9, 20.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.8, 20.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 20.9, 20.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 184.5, iDag: 23.9, endringFraIGar: -4.8, plasseringEndring: 0 },
  { navn: "Agder", total: 159.6, iDag: 31.9, endringFraIGar: 1.1, plasseringEndring: 3 },
  { navn: "Innlandet", total: 155.9, iDag: 24.9, endringFraIGar: 0.1, plasseringEndring: -1 },
  { navn: "Vestland", total: 154.4, iDag: 24.3, endringFraIGar: -2.7, plasseringEndring: -1 },
  { navn: "Nordland", total: 152.2, iDag: 23.7, endringFraIGar: -0.3, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 150.2, iDag: 23.5, endringFraIGar: 0.1, plasseringEndring: 1 },
  { navn: "Troms", total: 148.7, iDag: 21.1, endringFraIGar: 0.5, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 144.0, iDag: 21.6, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Rogaland", total: 143.5, iDag: 26.0, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Telemark", total: 128.9, iDag: 25.8, endringFraIGar: 4.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 122.2, iDag: 20.9, endringFraIGar: 0.0, plasseringEndring: 1 },
  { navn: "Oslo", total: 121.7, iDag: 20.0, endringFraIGar: 0.2, plasseringEndring: -1 },
  { navn: "Østfold", total: 120.4, iDag: 20.4, endringFraIGar: -0.5, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 76.3, vindkast: 33.5, nedbor: 0, temp: -6.1, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 74.7, vindkast: 29.8, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 67.4, vindkast: 23.5, nedbor: 0.2, temp: -4.0, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 67.1, vindkast: 28.7, nedbor: 0, temp: -5.9, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 65.6, vindkast: 21.7, nedbor: 0, temp: -7.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.1,
    dager: [80.1, 39.5, 44.2, 66.7, 82.6, 76.3, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Fre med 82.6 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -6.1 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 88.2, 74.7, 0],
  ...
  },
  {
    ...
    precipTotal: 211.1,
    tempMin: -3.9,
    dager: [77.7, 25.9, 44.8, 92.4, 83.9, 48.7, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 211.1 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 71.8, 67.1, 0],
  ...
  },
  {
    ...
    precipTotal: 3.1,
    tempMin: -5.5,
    dager: [63.5, 42.4, 48.3, 72.8, 63.0, 67.4, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Tor med 72.8 EI. Kraftige vindkast opp til 29.9 m/s. Bitende kulde ned til -5.5 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 184.5 poeng - 24.9 poeng foran Agder (159.6).",
