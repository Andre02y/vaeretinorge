 ...
 *
 * Sist oppdatert: 06.08.2026 kl. 10:12
...
export const META = {
  ...
  datoOppdatert: "06.08.2026 kl. 10:12",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [20.3, 29.6, 32.1, 24.2], trend: "Markant bedring (-7.9) - lavtrykket har passert" },
  { navn: "Oslo", dager: [16.7, 16.4, 31.9, 20.5], trend: "Markant bedring (-11.4) - lavtrykket har passert" },
  { navn: "Nordland", dager: [22.1, 23.0, 19.0, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [21.8, 17.1, 18.5, 22.9], trend: "Noe forverring (+4.4) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [24.2, 18.4, 16.3, 20.9], trend: "Noe forverring (+4.6) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [16.8, 20.6, 20.4, 17.2], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.7, 18.2, 16.1, 15.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [15.4, 15.9, 20.3, 19.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [12.7, 13.8, 22.2, 18.8], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Innlandet", dager: [16.9, 14.1, 18.0, 16.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [12.9, 13.8, 20.4, 16.4], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Rogaland", dager: [15.9, 14.4, 15.5, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [11.1, 9.6, 21.0, 20.0], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 106.2, iDag: 24.2, endringFraIGar: -7.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 85.5, iDag: 20.5, endringFraIGar: -11.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 81.8, iDag: 17.7, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Vestland", total: 80.3, iDag: 22.9, endringFraIGar: 4.4, plasseringEndring: 2 },
  { navn: "Møre og Romsdal", total: 79.8, iDag: 20.9, endringFraIGar: 4.6, plasseringEndring: -1 },
  { navn: "Troms", total: 75.0, iDag: 17.2, endringFraIGar: -3.2, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 72.4, iDag: 15.4, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Agder", total: 71.2, iDag: 19.6, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 67.5, iDag: 18.8, endringFraIGar: -3.4, plasseringEndring: 1 },
  { navn: "Innlandet", total: 65.4, iDag: 16.4, endringFraIGar: -1.6, plasseringEndring: -1 },
  { navn: "Buskerud", total: 63.5, iDag: 16.4, endringFraIGar: -4.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 63.3, iDag: 17.5, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 61.7, iDag: 20.0, endringFraIGar: -1.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 68.9, vindkast: 0, nedbor: 16.9, temp: -38.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.8,
    dager: [44.3, 64.1, 65.8, 62.3, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.8, 58.0, 62.1, 52.9, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Ons med 62.1 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.1, 51.9, 60.6, 42.4, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [36.2, 54.3, 60.4, 46.3, 0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 106.2 poeng - 20.7 poeng foran Oslo (85.5).",
