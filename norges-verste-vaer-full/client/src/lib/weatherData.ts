 ...
 *
 * Sist oppdatert: 07.08.2026 kl. 04:00
...
export const META = {
  ...
  datoOppdatert: "07.08.2026 kl. 04:00",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [20.3, 29.6, 32.1, 23.3, 19.4], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Oslo", dager: [16.7, 16.4, 31.9, 33.7, 10.8], trend: "Markant bedring (-22.9) - lavtrykket har passert" },
  { navn: "Nordland", dager: [22.1, 23.0, 19.0, 17.7, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [24.2, 18.4, 16.3, 22.0, 16.6], trend: "Markant bedring (-5.4) - lavtrykket har passert" },
  { navn: "Vestland", dager: [21.8, 17.1, 18.5, 24.0, 16.1], trend: "Markant bedring (-7.9) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [22.7, 18.2, 16.1, 17.0, 19.8], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [16.8, 20.6, 20.4, 17.2, 16.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [15.4, 15.9, 20.3, 20.0, 16.7], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Innlandet", dager: [16.9, 14.1, 18.0, 18.2, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [12.7, 13.8, 22.2, 22.2, 10.2], trend: "Markant bedring (-12.0) - lavtrykket har passert" },
  { navn: "Rogaland", dager: [15.9, 14.4, 15.5, 18.3, 16.2], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Buskerud", dager: [12.9, 13.8, 20.4, 21.1, 11.4], trend: "Markant bedring (-9.7) - lavtrykket har passert" },
  { navn: "Østfold", dager: [11.1, 9.6, 21.0, 22.3, 9.3], trend: "Markant bedring (-13.0) - lavtrykket har passert" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 124.7, iDag: 19.4, endringFraIGar: -3.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 109.5, iDag: 10.8, endringFraIGar: -22.9, plasseringEndring: 0 },
  { navn: "Nordland", total: 101.0, iDag: 19.2, endringFraIGar: 1.5, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 97.5, iDag: 16.6, endringFraIGar: -5.4, plasseringEndring: 1 },
  { navn: "Vestland", total: 97.5, iDag: 16.1, endringFraIGar: -7.9, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 93.8, iDag: 19.8, endringFraIGar: 2.8, plasseringEndring: 1 },
  { navn: "Troms", total: 91.7, iDag: 16.7, endringFraIGar: -0.5, plasseringEndring: -1 },
  { navn: "Agder", total: 88.3, iDag: 16.7, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 84.5, iDag: 17.3, endringFraIGar: -0.9, plasseringEndring: 2 },
  { navn: "Telemark", total: 81.1, iDag: 10.2, endringFraIGar: -12.0, plasseringEndring: -1 },
  { navn: "Rogaland", total: 80.3, iDag: 16.2, endringFraIGar: -2.1, plasseringEndring: 1 },
  { navn: "Buskerud", total: 79.6, iDag: 11.4, endringFraIGar: -9.7, plasseringEndring: -2 },
  { navn: "Østfold", total: 73.3, iDag: 9.3, endringFraIGar: -13.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 66.0, vindkast: 0, nedbor: 0, temp: -39.7, farevarsel: "oransje" },
  { navn: "RV13 VIKAFJELL", kommune: "VIK", fylke: "Vestland", ei: 65.3, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "oransje" },
  { navn: "FV65 BYE", kommune: "ORKLAND", fylke: "Trøndelag", ei: 65.2, vindkast: 0, nedbor: 0, temp: -39.6, farevarsel: "oransje" },
  { navn: "E6 LANGFJORDBOTN", kommune: "ALTA", fylke: "Finnmark", ei: 61.1, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "oransje" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.9,
    dager: [44.3, 64.1, 65.8, 63.0, 61.1, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Ons med 65.8 EI. Bitende kulde ned til -39.9 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [31.8, 58.0, 62.1, 47.0, 37.3, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.1, 51.9, 60.6, 41.5, 27.4, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 124.7 poeng - 15.2 poeng foran Oslo (109.5).",
