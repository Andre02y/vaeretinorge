 ...
 *
 * Sist oppdatert: 21.03.2026 kl. 05:23
...
export const META = {
  ...
  datoOppdatert: "21.03.2026 kl. 05:23",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.6, 33.8, 41.5, 42.4, 41.3, 34.7], trend: "Markant bedring (-6.6) - lavtrykket har passert" },
  { navn: "Finnmark", dager: [31.1, 33.6, 37.6, 38.9, 37.4, 30.5], trend: "Markant bedring (-6.9) - lavtrykket har passert" },
  { navn: "Troms", dager: [28.1, 28.9, 33.1, 39.5, 35.9, 29.9], trend: "Markant bedring (-6.0) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [22.5, 24.8, 25.9, 32.5, 30.7, 24.9], trend: "Markant bedring (-5.8) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [32.1, 28.8, 26.2, 22.9, 21.3, 25.0], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [24.5, 25.2, 29.2, 25.9, 25.2, 25.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [34.0, 30.8, 25.5, 23.2, 19.4, 21.5], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [29.9, 27.3, 25.1, 24.1, 23.4, 22.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [33.5, 28.2, 24.4, 21.7, 20.3, 23.3], trend: "Noe forverring (+3.0) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [30.1, 29.7, 25.0, 19.9, 19.4, 21.9], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [28.9, 26.6, 26.6, 19.8, 20.3, 23.1], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [28.6, 26.8, 22.5, 19.1, 19.0, 20.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [28.6, 24.9, 21.7, 19.1, 19.0, 22.5], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 223.3, iDag: 34.7, endringFraIGar: -6.6, plasseringEndring: 0 },
  { navn: "Finnmark", total: 209.1, iDag: 30.5, endringFraIGar: -6.9, plasseringEndring: 0 },
  { navn: "Troms", total: 195.4, iDag: 29.9, endringFraIGar: -6.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 161.3, iDag: 24.9, endringFraIGar: -5.8, plasseringEndring: 0 },
  { navn: "Innlandet", total: 156.3, iDag: 25.0, endringFraIGar: 3.7, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 155.3, iDag: 25.3, endringFraIGar: 0.1, plasseringEndring: 1 },
  { navn: "Oslo", total: 154.4, iDag: 21.5, endringFraIGar: 2.1, plasseringEndring: -2 },
  { navn: "Vestland", total: 152.5, iDag: 22.7, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Agder", total: 151.4, iDag: 23.3, endringFraIGar: 3.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 146.0, iDag: 21.9, endringFraIGar: 2.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 145.3, iDag: 23.1, endringFraIGar: 2.8, plasseringEndring: 0 },
  { navn: "Rogaland", total: 136.4, iDag: 20.4, endringFraIGar: 1.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 135.8, iDag: 22.5, endringFraIGar: 3.5, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 223.6, vindkast: 0, nedbor: 360.0, temp: 1.2, farevarsel: "oransje" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 74.3, vindkast: 29.6, nedbor: 0, temp: 4.4, farevarsel: "oransje" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 73.8, vindkast: 33.5, nedbor: 0, temp: -2.2, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 67.5, vindkast: 30.5, nedbor: 0, temp: -0.9, farevarsel: "oransje" },
  { navn: "SJUFJELLET", kommune: "BALSFJORD", fylke: "Troms", ei: 67.3, vindkast: 31.2, nedbor: 0, temp: -1.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 3209.9,
    tempMin: -1.8,
    dager: [33.8, 35.4, 32.8, 675.7, 833.2, 223.6, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 306 EI per dag. Toppdag Fre med 833.2 EI. Mye nedbor med totalt 3209.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.4,
    dager: [53.3, 64.1, 79.2, 79.7, 85.5, 67.5, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 72 EI per dag. Toppdag Fre med 85.5 EI. Kraftige vindkast opp til 38.4 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -8.0,
    dager: [55.1, 71.9, 82.6, 62.8, 50.6, 73.8, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Ons med 82.6 EI. Kraftige vindkast opp til 41.5 m/s. Bitende kulde ned til -8.0 grader C."
  },
  {
    navn: "KAPPFJELLET",
    kommune: "GRANE",
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [52.2, 61.9, 78.2, 68.5, 68.5, 66.7, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 2.6,
    dager: [43.6, 51.2, 84.7, 70.4, 67.3, 74.3, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 223.3 poeng - 14.2 poeng foran Finnmark (209.1).",
