 ...
 *
 * Sist oppdatert: 02.05.2026 kl. 11:53
...
export const META = {
  ...
  datoOppdatert: "02.05.2026 kl. 11:53",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [34.8, 26.8, 32.3, 32.6, 32.2, 38.5], trend: "Kraftig forverring (+6.3) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [42.6, 37.3, 30.2, 29.6, 27.8, 25.8], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Troms", dager: [34.7, 30.9, 31.4, 28.5, 28.7, 31.3], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [27.9, 22.3, 24.3, 19.7, 19.0, 20.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [22.8, 20.1, 21.9, 18.6, 20.3, 23.6], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [23.9, 21.1, 18.2, 15.8, 16.7, 17.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [20.3, 18.8, 17.6, 17.3, 18.3, 20.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [19.3, 18.8, 18.1, 17.6, 17.3, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [20.2, 19.3, 17.3, 15.4, 16.4, 16.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [18.8, 17.9, 17.1, 16.8, 17.2, 15.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [19.3, 17.9, 17.1, 15.7, 16.0, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [18.9, 18.3, 17.0, 15.1, 15.6, 15.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [18.9, 17.8, 16.2, 15.8, 14.4, 15.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 197.2, iDag: 38.5, endringFraIGar: 6.3, plasseringEndring: 1 },
  { navn: "Finnmark", total: 193.3, iDag: 25.8, endringFraIGar: -2.0, plasseringEndring: -1 },
  { navn: "Troms", total: 185.5, iDag: 31.3, endringFraIGar: 2.6, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 133.8, iDag: 20.6, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 127.3, iDag: 23.6, endringFraIGar: 3.3, plasseringEndring: 0 },
  { navn: "Innlandet", total: 112.9, iDag: 17.2, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 112.3, iDag: 20.0, endringFraIGar: 1.7, plasseringEndring: 0 },
  { navn: "Oslo", total: 108.6, iDag: 17.5, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Agder", total: 105.0, iDag: 16.4, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 103.5, iDag: 15.7, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 101.6, iDag: 15.6, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Telemark", total: 100.1, iDag: 15.2, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 98.4, iDag: 15.3, endringFraIGar: 0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 86.8, vindkast: 52.9, nedbor: 0, temp: -0.7, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 73.2, vindkast: 40.0, nedbor: 0, temp: 2.1, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 68.3, vindkast: 36.3, nedbor: 0, temp: -1.7, farevarsel: "oransje" },
  { navn: "ROTVÆR", kommune: "LØDINGEN", fylke: "Nordland", ei: 66.4, vindkast: 32.4, nedbor: 0, temp: 6.1, farevarsel: "oransje" },
  { navn: "E6 STØDI BRU", kommune: "SALTDAL", fylke: "Nordland", ei: 64.7, vindkast: 0, nedbor: 9.6, temp: 1.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -5.9,
    dager: [47.2, 39.3, 58.2, 56.7, 65.9, 86.8, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Lør med 86.8 EI. Kraftige vindkast opp til 52.9 m/s. Bitende kulde ned til -5.9 grader C."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
    ...
    precipTotal: 0,
    tempMin: -5.7,
    dager: [47.2, 43.8, 54.4, 67.1, 61.5, 68.3, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 57 EI per dag. Toppdag Lør med 68.3 EI. Kraftige vindkast opp til 36.3 m/s. Bitende kulde ned til -5.7 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.1,
    dager: [44.4, 37.7, 59.0, 55.8, 59.3, 62.4, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 53 EI per dag. Toppdag Lør med 62.4 EI. Kraftige vindkast opp til 34.6 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -2.8,
    dager: [50.6, 31.8, 56.1, 61.4, 49.2, 62.6, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 52 EI per dag. Toppdag Lør med 62.6 EI. Kraftige vindkast opp til 35.4 m/s."
  },
  {
    navn: "ÅNSTADBLÅHEIA",
    kommune: "SORTLAND",
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [39.1, 33.9, 52.8, 52.8, 58.2, 73.2, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 52 EI per dag. Toppdag Lør med 73.2 EI. Kraftige vindkast opp til 40.0 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 197.2 poeng, foran Finnmark (193.3).",
