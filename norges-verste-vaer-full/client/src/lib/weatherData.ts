 ...
 *
 * Sist oppdatert: 18.07.2026 kl. 12:08
...
export const META = {
  ...
  datoOppdatert: "18.07.2026 kl. 12:08",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [20.8, 24.0, 26.0, 24.0, 23.3, 23.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [19.2, 26.2, 20.7, 23.7, 23.2, 22.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.6, 21.9, 20.6, 24.5, 21.6, 22.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [15.3, 14.9, 14.7, 14.6, 15.9, 32.5], trend: "Kraftig forverring (+16.6) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [13.5, 12.7, 12.4, 12.4, 15.4, 17.6], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [12.9, 12.7, 12.6, 12.2, 13.0, 15.9], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [8.9, 7.8, 7.7, 7.2, 9.3, 22.1], trend: "Kraftig forverring (+12.8) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [10.3, 9.7, 8.7, 8.7, 10.2, 14.3], trend: "Noe forverring (+4.1) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [9.2, 7.7, 6.8, 6.5, 8.0, 20.0], trend: "Kraftig forverring (+12.0) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [9.0, 7.8, 7.3, 7.2, 8.1, 17.7], trend: "Kraftig forverring (+9.6) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [8.7, 8.9, 8.0, 7.3, 10.6, 13.1], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [7.5, 7.3, 7.0, 6.4, 7.1, 11.9], trend: "Noe forverring (+4.8) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [7.1, 6.7, 6.0, 5.6, 6.2, 11.6], trend: "Kraftig forverring (+5.4) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 141.2, iDag: 23.1, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Finnmark", total: 135.9, iDag: 22.9, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Troms", total: 132.0, iDag: 22.8, endringFraIGar: 1.2, plasseringEndring: 0 },
  { navn: "Oslo", total: 107.9, iDag: 32.5, endringFraIGar: 16.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 84.0, iDag: 17.6, endringFraIGar: 2.2, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 79.3, iDag: 15.9, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 63.0, iDag: 22.1, endringFraIGar: 12.8, plasseringEndring: 2 },
  { navn: "Vestland", total: 61.9, iDag: 14.3, endringFraIGar: 4.1, plasseringEndring: -1 },
  { navn: "Innlandet", total: 58.2, iDag: 20.0, endringFraIGar: 12.0, plasseringEndring: 2 },
  { navn: "Telemark", total: 57.1, iDag: 17.7, endringFraIGar: 9.6, plasseringEndring: 0 },
  { navn: "Rogaland", total: 56.6, iDag: 13.1, endringFraIGar: 2.5, plasseringEndring: -3 },
  { navn: "Agder", total: 47.2, iDag: 11.9, endringFraIGar: 4.8, plasseringEndring: 0 },
  { navn: "Østfold", total: 43.2, iDag: 11.6, endringFraIGar: 5.4, plasseringEndring: 0 },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [58.2, 64.5, 63.7, 63.9, 60.6, 39.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 5.7,
    dager: [48.3, 58.7, 42.6, 56.9, 51.3, 45.9, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 2.7,
    dager: [54.0, 48.5, 50.7, 59.2, 48.1, 41.1, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 5.9,
    dager: [46.5, 47.8, 52.3, 59.2, 52.1, 39.8, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [43.2, 59.0, 43.1, 54.6, 52.8, 44.8, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 141.2 poeng - 5.3 poeng foran Finnmark (135.9).",
