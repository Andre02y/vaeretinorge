 ...
 *
 * Sist oppdatert: 25.07.2026 kl. 17:55
...
export const META = {
  ...
  datoOppdatert: "25.07.2026 kl. 17:55",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [19.7, 28.1, 23.5, 21.2, 26.1, 20.2], trend: "Markant bedring (-5.9) - lavtrykket har passert" },
  { navn: "Finnmark", dager: [20.9, 22.8, 21.6, 21.8, 22.5, 18.8], trend: "Noe bedring (-3.7) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [14.4, 17.0, 19.9, 17.7, 21.7, 20.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [17.8, 19.5, 20.3, 18.6, 18.6, 15.5], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Trøndelag", dager: [14.1, 17.9, 20.1, 17.0, 19.4, 17.0], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Oslo", dager: [17.8, 16.2, 16.4, 16.6, 16.3, 18.9], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [12.2, 13.3, 16.0, 13.8, 19.7, 23.3], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [12.9, 13.8, 18.1, 13.9, 17.1, 19.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [12.7, 11.6, 15.3, 13.8, 13.7, 16.6], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [12.1, 12.3, 11.5, 12.7, 14.6, 17.0], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [12.0, 11.0, 10.9, 11.8, 12.3, 14.7], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [13.1, 11.2, 11.3, 11.1, 11.9, 13.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [13.0, 11.2, 12.7, 9.7, 10.1, 11.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 138.8, iDag: 20.2, endringFraIGar: -5.9, plasseringEndring: 0 },
  { navn: "Finnmark", total: 128.4, iDag: 18.8, endringFraIGar: -3.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 110.7, iDag: 20.0, endringFraIGar: -1.7, plasseringEndring: 1 },
  { navn: "Troms", total: 110.3, iDag: 15.5, endringFraIGar: -3.1, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 105.5, iDag: 17.0, endringFraIGar: -2.4, plasseringEndring: 0 },
  { navn: "Oslo", total: 102.2, iDag: 18.9, endringFraIGar: 2.6, plasseringEndring: 0 },
  { navn: "Vestland", total: 98.3, iDag: 23.3, endringFraIGar: 3.6, plasseringEndring: 1 },
  { navn: "Rogaland", total: 94.9, iDag: 19.1, endringFraIGar: 2.0, plasseringEndring: -1 },
  { navn: "Innlandet", total: 83.7, iDag: 16.6, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Agder", total: 80.2, iDag: 17.0, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 72.7, iDag: 14.7, endringFraIGar: 2.4, plasseringEndring: 1 },
  { navn: "Telemark", total: 72.2, iDag: 13.6, endringFraIGar: 1.7, plasseringEndring: -1 },
  { navn: "Østfold", total: 67.8, iDag: 11.1, endringFraIGar: 1.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 66.8, vindkast: 0, nedbor: 5.2, temp: -32.8, farevarsel: "oransje" },
  { navn: "HOVLANDSDAL", kommune: "FJALER", fylke: "Vestland", ei: 59.2, vindkast: 0, nedbor: 48.5, temp: 0, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 57.1, vindkast: 26.3, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "BREKKE I SOGN", kommune: "GULEN", fylke: "Vestland", ei: 54.5, vindkast: 0, nedbor: 39.0, temp: 0, farevarsel: "gul" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 53.8, vindkast: 25.3, nedbor: 0, temp: 11.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 149.5,
    tempMin: 0,
    dager: [36.0, 56.2, 37.5, 35.2, 71.7, 48.2, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Fre med 71.7 EI. Mye nedbor med totalt 149.5 mm."
  },
  {
    navn: "LEIRFJORD",
    kommune: "LEIRFJORD",
  ...
  },
  {
    ...
    precipTotal: 111.0,
    tempMin: 0,
    dager: [36.5, 71.7, 38.0, 35.8, 43.5, 40.2, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 44 EI per dag. Toppdag Tir med 71.7 EI. Mye nedbor med totalt 111.0 mm."
  },
  {
    ...
    precipTotal: 79.3,
    tempMin: 0,
    dager: [36.0, 61.1, 37.0, 35.6, 41.0, 38.9, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Tir med 61.1 EI. Mye nedbor med totalt 79.3 mm."
  },
  {
    navn: "KRÅKENES",
    kommune: "KINN",
    ...
    precipTotal: 0,
    tempMin: 10.9,
    dager: [32.1, 37.9, 33.3, 36.3, 55.6, 53.8, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Fre med 55.6 EI. Kraftige vindkast opp til 25.3 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 138.8 poeng - 10.4 poeng foran Finnmark (128.4).",
