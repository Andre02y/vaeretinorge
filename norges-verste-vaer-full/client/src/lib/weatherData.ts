 ...
 *
 * Sist oppdatert: 12.04.2026 kl. 07:16
 * Periode sammenlagt: 06.04 - 12.04.2026 (7 dager)
...
export const META = {
  ...
  dagLabel: "Søndag 12.04.2026",
  sammenlagtLabel: "06.04 - 12.04.2026 (7 dager)",
  datoOppdatert: "12.04.2026 kl. 07:16",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 28.7, 23.6, 27.4], trend: "Noe forverring (+3.8) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 30.8, 31.4, 35.1], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 24.8, 24.8, 27.7], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.0, 24.8, 26.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.0, 23.6, 26.9], trend: "Noe forverring (+3.3) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.4, 23.9, 27.6], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 20.6, 20.5, 24.2], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 25.2, 25.4, 29.3], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.9, 21.0, 23.3], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.7, 26.0, 22.8], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 20.9, 20.5, 22.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 20.9, 19.7, 22.4], trend: "Noe forverring (+2.7) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.8, 19.8, 20.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 211.6, iDag: 27.4, endringFraIGar: 3.8, plasseringEndring: 0 },
  { navn: "Agder", total: 194.2, iDag: 35.1, endringFraIGar: 3.7, plasseringEndring: 0 },
  { navn: "Innlandet", total: 183.5, iDag: 27.7, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Vestland", total: 181.3, iDag: 26.4, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Nordland", total: 179.0, iDag: 26.9, endringFraIGar: 3.3, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 178.2, iDag: 27.6, endringFraIGar: 3.7, plasseringEndring: 0 },
  { navn: "Troms", total: 172.3, iDag: 24.2, endringFraIGar: 3.7, plasseringEndring: 0 },
  { navn: "Rogaland", total: 172.2, iDag: 29.3, endringFraIGar: 3.9, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 166.7, iDag: 23.3, endringFraIGar: 2.3, plasseringEndring: -1 },
  { navn: "Telemark", total: 151.9, iDag: 22.8, endringFraIGar: -3.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 144.0, iDag: 22.2, endringFraIGar: 1.7, plasseringEndring: 0 },
  { navn: "Østfold", total: 142.1, iDag: 22.4, endringFraIGar: 2.7, plasseringEndring: 1 },
  { navn: "Oslo", total: 142.0, iDag: 20.5, endringFraIGar: 0.7, plasseringEndring: -1 },
...
// ---- TOPP 5 STASJONER SØNDAG 12.04.2026 ----

export const STASJONER_PERIODE = [
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 97.6, vindkast: 37.2, nedbor: 0, temp: -5.7, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 88.6, vindkast: 40.1, nedbor: 0, temp: -5.4, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 85.2, vindkast: 42.0, nedbor: 0, temp: -4.5, farevarsel: "oransje" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 83.6, vindkast: 32.1, nedbor: 0, temp: -4.5, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 82.0, vindkast: 40.1, nedbor: 0, temp: -3.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.1,
    dager: [80.1, 39.5, 44.2, 66.7, 82.6, 89.0, 85.2],
    beskrivelse: "Ekstremt vaer hele uken med snitt 70 EI per dag. Toppdag Lør med 89.0 EI. Kraftige vindkast opp til 42.0 m/s. Bitende kulde ned til -6.1 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 88.2, 83.2, 82.0],
    beskrivelse: "Ekstremt vaer hele uken med snitt 68 EI per dag. Toppdag Fre med 88.2 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 259.4,
    tempMin: -3.9,
    dager: [77.7, 25.9, 44.8, 92.4, 83.9, 67.6, 68.2],
    beskrivelse: "Ekstremt vaer hele uken med snitt 66 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 259.4 mm."
  },
  {
    navn: "SPØRTEGGBU",
    kommune: "LUSTER",
    ...
    precipTotal: 0,
    tempMin: -7.4,
    dager: [64.6, 41.8, 45.2, 61.0, 74.4, 68.0, 97.6],
    beskrivelse: "Ekstremt vaer hele uken med snitt 65 EI per dag. Toppdag Søn med 97.6 EI. Kraftige vindkast opp til 37.2 m/s. Bitende kulde ned til -7.4 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 71.8, 68.0, 88.6],
    beskrivelse: "Ekstremt vaer hele uken med snitt 64 EI per dag. Toppdag Søn med 88.6 EI. Kraftige vindkast opp til 40.1 m/s. Bitende kulde ned til -7.5 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 211.6 poeng - 17.4 poeng foran Agder (194.2).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-04-06",
  tilDato: "2026-04-12",
  periode: "06.04 - 12.04.2026 (7 dager)",
  dagerRegistrert: 7,
  versteFylke: "Finnmark",
  versteFylkeScore: 211.6,
};
