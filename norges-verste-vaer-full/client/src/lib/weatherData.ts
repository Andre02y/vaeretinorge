 ...
 *
 * Sist oppdatert: 22.08.2026 kl. 23:11
...
export const META = {
  ...
  datoOppdatert: "22.08.2026 kl. 23:11",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [21.7, 25.3, 23.4, 28.9, 27.3, 29.8], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Finnmark", dager: [21.1, 23.7, 22.1, 20.0, 16.7, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [18.8, 19.1, 16.6, 20.4, 25.1, 19.3], trend: "Markant bedring (-5.8) - lavtrykket har passert" },
  { navn: "Nordland", dager: [22.4, 22.4, 19.2, 17.4, 17.2, 16.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [20.8, 20.0, 17.6, 21.3, 16.7, 16.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 16.1, 15.8, 16.3, 18.4, 21.0], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [20.1, 23.7, 17.7, 14.3, 13.0, 14.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [17.3, 14.8, 14.0, 14.6, 20.0, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.7, 16.4, 14.7, 18.4, 16.5, 17.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.6, 15.7, 16.1, 16.2, 15.3, 14.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 14.4, 12.9, 12.5, 16.0, 17.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 13.9, 13.7, 14.1, 14.9, 13.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [14.4, 13.6, 11.3, 14.0, 12.3, 12.5], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 156.4, iDag: 29.8, endringFraIGar: 2.5, plasseringEndring: 0 },
  { navn: "Finnmark", total: 120.6, iDag: 17.0, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 119.3, iDag: 19.3, endringFraIGar: -5.8, plasseringEndring: 0 },
  { navn: "Nordland", total: 114.7, iDag: 16.1, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 113.1, iDag: 16.7, endringFraIGar: 0.0, plasseringEndring: 0 },
  { navn: "Innlandet", total: 104.2, iDag: 21.0, endringFraIGar: 2.6, plasseringEndring: 1 },
  { navn: "Troms", total: 103.5, iDag: 14.7, endringFraIGar: 1.7, plasseringEndring: -1 },
  { navn: "Vestland", total: 99.7, iDag: 19.0, endringFraIGar: -1.0, plasseringEndring: 1 },
  { navn: "Buskerud", total: 99.5, iDag: 17.8, endringFraIGar: 1.3, plasseringEndring: -1 },
  { navn: "Agder", total: 92.7, iDag: 14.8, endringFraIGar: -0.5, plasseringEndring: 0 },
  { navn: "Rogaland", total: 90.9, iDag: 17.9, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Telemark", total: 83.6, iDag: 13.7, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 78.1, iDag: 12.5, endringFraIGar: 0.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 67.1, vindkast: 0, nedbor: 0, temp: -42.1, farevarsel: "oransje" },
  { navn: "RV3 EBRU", kommune: "LØTEN", fylke: "Innlandet", ei: 63.8, vindkast: 0, nedbor: 110.7, temp: 11.5, farevarsel: "oransje" },
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -45.9,
    dager: [73.4, 75.4, 16.3, 15.8, 28.1, 67.1, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 46 EI per dag. Toppdag Tir med 75.4 EI. Bitende kulde ned til -45.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.2,
    dager: [24.9, 63.7, 65.1, 67.0, 16.7, 22.8, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Tor med 67.0 EI. Bitende kulde ned til -39.2 grader C."
  },
  {
    navn: "ERESFJORD",
    kommune: "MOLDE",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 43.9, 37.6, 38.4, 45.8, 39.4, 0],
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 156.4 poeng - 35.8 poeng foran Finnmark (120.6).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
