 ...
 *
 * Sist oppdatert: 23.04.2026 kl. 20:54
...
export const META = {
  ...
  datoOppdatert: "23.04.2026 kl. 20:54",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.3, 36.3, 46.8, 46.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [23.4, 31.2, 30.4, 33.1], trend: "Noe forverring (+2.7) - ustabilt vaer fortsetter" },
  { navn: "Nordland", dager: [20.5, 27.3, 29.3, 29.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [17.6, 19.3, 25.0, 27.5], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [30.2, 19.4, 18.1, 18.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [22.3, 19.6, 21.7, 22.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.7, 21.0, 25.0], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [25.2, 18.5, 18.1, 17.7], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Buskerud", dager: [23.5, 17.6, 16.6, 16.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [23.6, 16.3, 15.2, 15.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 157.9, iDag: 46.5, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Troms", total: 118.1, iDag: 33.1, endringFraIGar: 2.7, plasseringEndring: 0 },
  { navn: "Nordland", total: 106.6, iDag: 29.5, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 89.4, iDag: 27.5, endringFraIGar: 2.5, plasseringEndring: 2 },
  { navn: "Oslo", total: 86.3, iDag: 18.6, endringFraIGar: 0.5, plasseringEndring: -1 },
  { navn: "Innlandet", total: 86.0, iDag: 22.4, endringFraIGar: 0.7, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 80.9, iDag: 25.0, endringFraIGar: 4.0, plasseringEndring: 4 },
  { navn: "Agder", total: 79.5, iDag: 17.7, endringFraIGar: -0.4, plasseringEndring: -1 },
  ...
  { navn: "Buskerud", total: 74.2, iDag: 16.5, endringFraIGar: -0.1, plasseringEndring: -3 },
  { navn: "Østfold", total: 71.0, iDag: 15.9, endringFraIGar: 0.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 AISAROAIVI", kommune: "HAMMERFEST", fylke: "Finnmark", ei: 96.9, vindkast: 0, nedbor: 81.7, temp: 0.7, farevarsel: "oransje" },
  { navn: "E69 NORDKAPP", kommune: "NORDKAPP", fylke: "Finnmark", ei: 83.5, vindkast: 0, nedbor: 32.6, temp: -0.1, farevarsel: "oransje" },
  { navn: "MEHAMN LUFTHAVN", kommune: "GAMVIK", fylke: "Finnmark", ei: 72.3, vindkast: 24.8, nedbor: 2.8, temp: 1.6, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 70.4, vindkast: 32.8, nedbor: 0, temp: -1.3, farevarsel: "oransje" },
  { navn: "REINHAUGEN", kommune: "NESSEBY", fylke: "Finnmark", ei: 69.2, vindkast: 26.6, nedbor: 0, temp: -3.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -1.3,
    dager: [54.3, 85.8, 56.7, 70.4, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [40.4, 63.8, 70.8, 69.2, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -4.0,
    dager: [48.2, 74.4, 56.5, 61.6, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 1.7,
    tempMin: -0.9,
    dager: [39.6, 54.0, 78.0, 67.4, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 36.0,
    tempMin: -1.9,
    dager: [44.3, 59.5, 50.0, 83.5, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Tor med 83.5 EI. Mye nedbor med totalt 36.0 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 157.9 poeng - 39.8 poeng foran Troms (118.1).",
