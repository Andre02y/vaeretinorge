 ...
 *
 * Sist oppdatert: 19.08.2026 kl. 11:22
...
export const META = {
  ...
  datoOppdatert: "19.08.2026 kl. 11:22",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [21.7, 25.3, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [21.1, 23.7, 22.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [22.4, 22.4, 19.0], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Troms", dager: [20.1, 23.7, 18.2], trend: "Markant bedring (-5.5) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [20.8, 20.0, 18.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [18.8, 19.1, 17.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 16.1, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.7, 16.4, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.6, 15.7, 16.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [17.3, 14.8, 14.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 14.4, 13.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 13.9, 14.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [14.4, 13.6, 12.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 71.9, iDag: 24.9, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Finnmark", total: 66.8, iDag: 22.0, endringFraIGar: -1.7, plasseringEndring: 0 },
  { navn: "Nordland", total: 63.8, iDag: 19.0, endringFraIGar: -3.4, plasseringEndring: 0 },
  { navn: "Troms", total: 62.0, iDag: 18.2, endringFraIGar: -5.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 58.9, iDag: 18.1, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 55.1, iDag: 17.2, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Innlandet", total: 49.3, iDag: 16.6, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 49.1, iDag: 17.0, endringFraIGar: 0.6, plasseringEndring: 1 },
  { navn: "Agder", total: 47.2, iDag: 16.9, endringFraIGar: 1.2, plasseringEndring: 2 },
  { navn: "Vestland", total: 46.5, iDag: 14.4, endringFraIGar: -0.4, plasseringEndring: -2 },
  { navn: "Rogaland", total: 44.7, iDag: 13.1, endringFraIGar: -1.3, plasseringEndring: -1 },
  { navn: "Telemark", total: 41.6, iDag: 14.4, endringFraIGar: 0.5, plasseringEndring: 1 },
  { navn: "Østfold", total: 40.1, iDag: 12.1, endringFraIGar: -1.5, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 63.4, vindkast: 0, nedbor: 0, temp: -38.7, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 58.8, vindkast: 0, nedbor: 0, temp: -38.8, farevarsel: "gul" },
  { navn: "FV65 ØVRE RINDAL", kommune: "RINDAL", fylke: "Trøndelag", ei: 49.0, vindkast: 0, nedbor: 0, temp: -26.5, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 43.2, vindkast: 16.2, nedbor: 0, temp: 6.7, farevarsel: "gul" },
  { navn: "KIRKENES LUFTHAVN - HØYDE 212", kommune: "SØR-VARANGER", fylke: "Finnmark", ei: 42.3, vindkast: 12.7, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -38.8,
    dager: [48.5, 58.4, 58.8, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 55 EI per dag. Toppdag Ons med 58.8 EI. Bitende kulde ned til -38.8 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -38.7,
    dager: [24.9, 63.7, 63.4, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Tir med 63.7 EI. Bitende kulde ned til -38.7 grader C."
  },
  {
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 71.9 poeng - 5.1 poeng foran Finnmark (66.8).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
