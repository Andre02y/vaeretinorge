 ...
 *
 * Sist oppdatert: 27.03.2026 kl. 13:37
...
export const META = {
  ...
  datoOppdatert: "27.03.2026 kl. 13:37",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [46.8, 39.3, 33.4, 31.6, 32.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [37.0, 32.9, 29.8, 35.6, 39.9], trend: "Noe forverring (+4.3) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [35.7, 35.1, 32.8, 38.6, 31.1], trend: "Markant bedring (-7.5) - lavtrykket har passert" },
  { navn: "Troms", dager: [36.5, 33.8, 29.0, 30.1, 37.9], trend: "Kraftig forverring (+7.8) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [32.1, 34.6, 32.3, 32.1, 28.5], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Trøndelag", dager: [40.7, 31.0, 22.9, 33.1, 30.1], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Rogaland", dager: [24.8, 27.6, 30.0, 31.7, 26.3], trend: "Markant bedring (-5.4) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [27.7, 29.7, 26.2, 30.6, 25.4], trend: "Markant bedring (-5.2) - lavtrykket har passert" },
  { navn: "Agder", dager: [25.2, 30.5, 31.5, 26.7, 24.5], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Østfold", dager: [21.4, 27.1, 30.4, 24.3, 21.9], trend: "Noe bedring (-2.4) - roligere forhold" },
  { navn: "Oslo", dager: [20.5, 27.4, 35.8, 21.2, 19.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [22.2, 25.8, 28.0, 21.4, 20.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [21.9, 23.4, 26.0, 21.2, 21.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 184.0, iDag: 32.9, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 175.2, iDag: 39.9, endringFraIGar: 4.3, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 173.3, iDag: 31.1, endringFraIGar: -7.5, plasseringEndring: -1 },
  { navn: "Troms", total: 167.3, iDag: 37.9, endringFraIGar: 7.8, plasseringEndring: 1 },
  { navn: "Vestland", total: 159.6, iDag: 28.5, endringFraIGar: -3.6, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 157.8, iDag: 30.1, endringFraIGar: -3.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 140.4, iDag: 26.3, endringFraIGar: -5.4, plasseringEndring: 1 },
  { navn: "Innlandet", total: 139.6, iDag: 25.4, endringFraIGar: -5.2, plasseringEndring: -1 },
  { navn: "Agder", total: 138.4, iDag: 24.5, endringFraIGar: -2.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 125.1, iDag: 21.9, endringFraIGar: -2.4, plasseringEndring: 1 },
  { navn: "Oslo", total: 124.8, iDag: 19.9, endringFraIGar: -1.3, plasseringEndring: -1 },
  { navn: "Telemark", total: 118.1, iDag: 20.7, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 113.9, iDag: 21.4, endringFraIGar: 0.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E75 KOMAGVÆR", kommune: "VARDØ", fylke: "Finnmark", ei: 117.0, vindkast: 0, nedbor: 122.0, temp: -0.0, farevarsel: "oransje" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 73.3, vindkast: 36.3, nedbor: 0, temp: -4.3, farevarsel: "oransje" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 68.6, vindkast: 34.0, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "FV86 ANDSVATNET", kommune: "SØRREISA", fylke: "Troms", ei: 68.1, vindkast: 0, nedbor: 50.5, temp: -0.1, farevarsel: "oransje" },
  { navn: "E75 DOMEN", kommune: "VARDØ", fylke: "Finnmark", ei: 67.6, vindkast: 0, nedbor: 21.0, temp: -0.2, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1020.7,
    tempMin: -3.7,
    dager: [543.8, 35.4, 26.4, 32.9, 31.9, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 272.7,
    tempMin: -6.0,
    dager: [166.8, 48.1, 56.1, 38.7, 40.6, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 70 EI per dag. Toppdag Man med 166.8 EI. Mye nedbor med totalt 272.7 mm. Bitende kulde ned til -6.0 grader C."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
    ...
    precipTotal: 0,
    tempMin: -4.3,
    dager: [69.7, 72.3, 62.7, 61.0, 73.3, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 68 EI per dag. Toppdag Fre med 73.3 EI. Kraftige vindkast opp til 38.0 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -9.9,
    dager: [72.9, 81.5, 62.8, 67.2, 53.8, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 68 EI per dag. Toppdag Tir med 81.5 EI. Kraftige vindkast opp til 43.3 m/s. Bitende kulde ned til -9.9 grader C."
  },
  {
    ...
    precipTotal: 108.2,
    tempMin: -2.1,
    dager: [62.8, 61.6, 76.7, 76.3, 49.6, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Ons med 76.7 EI. Kraftige vindkast opp til 26.9 m/s. Mye nedbor med totalt 108.2 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 184.0 poeng - 8.8 poeng foran Finnmark (175.2).",
