 ...
 *
 * Sist oppdatert: 05.07.2026 kl. 20:58
...
export const META = {
  ...
  datoOppdatert: "05.07.2026 kl. 20:58",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [18.6, 27.6, 27.6, 22.5, 17.4, 18.0, 18.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [21.4, 27.7, 24.9, 17.5, 17.3, 18.6, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [19.3, 18.9, 13.2, 15.8, 19.7, 20.5, 25.6], trend: "Kraftig forverring (+5.1) - okt vind og/eller nedbor" },
  ...
  { navn: "Innlandet", dager: [11.7, 12.8, 13.3, 17.5, 19.3, 15.5, 19.5], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [10.6, 11.0, 10.7, 19.1, 23.3, 13.9, 18.7], trend: "Noe forverring (+4.8) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [10.2, 11.1, 11.2, 21.6, 19.1, 12.5, 18.4], trend: "Kraftig forverring (+5.9) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Finnmark", total: 150.3, iDag: 18.6, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Nordland", total: 146.2, iDag: 18.8, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 133.0, iDag: 25.6, endringFraIGar: 5.1, plasseringEndring: 1 },
  ...
  { navn: "Innlandet", total: 109.6, iDag: 19.5, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 107.3, iDag: 18.7, endringFraIGar: 4.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 104.1, iDag: 18.4, endringFraIGar: 5.9, plasseringEndring: 1 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 55.1, vindkast: 23.4, nedbor: 0, temp: 3.9, farevarsel: "gul" },
  { navn: "RV15 STRYNEFJELL-KVITENOVA", kommune: "STRYN", fylke: "Vestland", ei: 53.4, vindkast: 0, nedbor: 3.0, temp: 0.3, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 52.3, vindkast: 13.0, nedbor: 4.5, temp: 0, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 20.5,
    tempMin: 0,
    dager: [55.0, 45.1, 42.2, 45.7, 50.9, 47.0, 52.3],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [32.2, 57.2, 59.0, 47.3, 38.0, 41.0, 40.0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 67.3, 64.6, 38.5, 34.5, 37.7, 31.1],
  ...
  },
  {
    ...
    precipTotal: 22.7,
    tempMin: -26.9,
    dager: [47.5, 44.7, 39.7, 40.3, 29.5, 60.0, 35.4],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 42 EI per dag. Toppdag Lør med 60.0 EI. Mye nedbor med totalt 22.7 mm. Bitende kulde ned til -26.9 grader C."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 164.5 poeng - 14.2 poeng foran Finnmark (150.3).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
