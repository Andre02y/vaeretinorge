 ...
 *
 * Sist oppdatert: 12.04.2026 kl. 20:32
...
export const META = {
  ...
  datoOppdatert: "12.04.2026 kl. 20:32",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 28.7, 23.6, 25.7], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 30.8, 31.4, 33.9], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 24.8, 24.8, 28.3], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.0, 24.8, 26.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.0, 23.6, 26.0], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.4, 23.9, 26.3], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 25.2, 25.4, 28.1], trend: "Noe forverring (+2.7) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 20.6, 20.5, 21.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.9, 21.0, 22.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.7, 26.0, 25.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 20.9, 20.5, 23.0], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.8, 19.8, 21.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 20.9, 19.7, 20.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 209.9, iDag: 25.7, endringFraIGar: 2.1, plasseringEndring: 0 },
  { navn: "Agder", total: 193.0, iDag: 33.9, endringFraIGar: 2.5, plasseringEndring: 0 },
  { navn: "Innlandet", total: 184.1, iDag: 28.3, endringFraIGar: 3.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 181.0, iDag: 26.1, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Nordland", total: 178.1, iDag: 26.0, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 176.9, iDag: 26.3, endringFraIGar: 2.4, plasseringEndring: 0 },
  { navn: "Rogaland", total: 171.0, iDag: 28.1, endringFraIGar: 2.7, plasseringEndring: 2 },
  { navn: "Troms", total: 169.6, iDag: 21.5, endringFraIGar: 1.0, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 166.2, iDag: 22.8, endringFraIGar: 1.8, plasseringEndring: -1 },
  { navn: "Telemark", total: 154.7, iDag: 25.6, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 144.8, iDag: 23.0, endringFraIGar: 2.5, plasseringEndring: 0 },
  { navn: "Oslo", total: 142.9, iDag: 21.4, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Østfold", total: 140.1, iDag: 20.4, endringFraIGar: 0.7, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 85.7, vindkast: 37.2, nedbor: 0, temp: -5.8, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 85.7, vindkast: 40.1, nedbor: 0, temp: -3.3, farevarsel: "oransje" },
  { navn: "FV450 VØYLEN", kommune: "TOKKE", fylke: "Telemark", ei: 82.6, vindkast: 0, nedbor: 78.6, temp: -0.3, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 79.5, vindkast: 42.0, nedbor: 0, temp: -4.4, farevarsel: "oransje" },
  { navn: "FV55 HERVAVATN", kommune: "LUSTER", fylke: "Vestland", ei: 78.5, vindkast: 0, nedbor: 49.1, temp: -3.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 88.2, 83.2, 85.7],
    beskrivelse: "Ekstremt vaer hele uken med snitt 69 EI per dag. Toppdag Fre med 88.2 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.1,
    dager: [80.1, 39.5, 44.2, 66.7, 82.6, 89.0, 79.5],
    beskrivelse: "Ekstremt vaer hele uken med snitt 69 EI per dag. Toppdag Lør med 89.0 EI. Kraftige vindkast opp til 42.0 m/s. Bitende kulde ned til -6.1 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 273.0,
    tempMin: -3.9,
    dager: [77.7, 25.9, 44.8, 92.4, 83.9, 67.6, 64.4],
    beskrivelse: "Ekstremt vaer hele uken med snitt 65 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 273.0 mm."
  },
  {
    navn: "SPØRTEGGBU",
    kommune: "LUSTER",
    ...
    precipTotal: 0,
    tempMin: -7.4,
    dager: [64.6, 41.8, 45.2, 61.0, 74.4, 68.0, 85.7],
    beskrivelse: "Ekstremt vaer hele uken med snitt 63 EI per dag. Toppdag Søn med 85.7 EI. Kraftige vindkast opp til 37.2 m/s. Bitende kulde ned til -7.4 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 71.8, 68.0, 76.3],
    beskrivelse: "Ekstremt vaer hele uken med snitt 63 EI per dag. Toppdag Man med 81.3 EI. Kraftige vindkast opp til 40.1 m/s. Bitende kulde ned til -7.5 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 209.9 poeng - 16.9 poeng foran Agder (193.0).",
