 ...
 *
 * Sist oppdatert: 22.05.2026 kl. 04:03
...
export const META = {
  ...
  datoOppdatert: "22.05.2026 kl. 04:03",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [22.4, 21.7, 21.0, 23.3, 21.0], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Agder", dager: [26.7, 22.2, 20.9, 21.3, 15.6], trend: "Markant bedring (-5.7) - lavtrykket har passert" },
  { navn: "Oslo", dager: [19.0, 19.1, 17.1, 29.0, 12.3], trend: "Markant bedring (-16.7) - lavtrykket har passert" },
  { navn: "Vestland", dager: [21.1, 19.7, 18.4, 19.3, 16.2], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Rogaland", dager: [21.3, 23.1, 18.0, 18.4, 13.2], trend: "Markant bedring (-5.2) - lavtrykket har passert" },
  { navn: "Troms", dager: [20.6, 19.7, 16.8, 17.9, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [22.1, 19.8, 16.0, 15.8, 18.1], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Telemark", dager: [21.0, 17.0, 14.9, 20.9, 15.2], trend: "Markant bedring (-5.7) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [19.6, 16.7, 15.4, 17.1, 15.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [16.4, 14.7, 13.7, 19.7, 14.6], trend: "Markant bedring (-5.1) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [17.4, 15.4, 14.1, 15.9, 15.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [17.9, 14.2, 12.7, 13.6, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.3, 12.1, 12.3, 18.6, 14.1], trend: "Noe bedring (-4.5) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 109.4, iDag: 21.0, endringFraIGar: -2.3, plasseringEndring: 1 },
  { navn: "Agder", total: 106.7, iDag: 15.6, endringFraIGar: -5.7, plasseringEndring: -1 },
  { navn: "Oslo", total: 96.5, iDag: 12.3, endringFraIGar: -16.7, plasseringEndring: 0 },
  { navn: "Vestland", total: 94.7, iDag: 16.2, endringFraIGar: -3.1, plasseringEndring: 1 },
  { navn: "Rogaland", total: 94.0, iDag: 13.2, endringFraIGar: -5.2, plasseringEndring: -1 },
  { navn: "Troms", total: 93.8, iDag: 18.8, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Nordland", total: 91.8, iDag: 18.1, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Telemark", total: 89.0, iDag: 15.2, endringFraIGar: -5.7, plasseringEndring: -1 },
  { navn: "Innlandet", total: 84.5, iDag: 15.7, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 79.1, iDag: 14.6, endringFraIGar: -5.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 78.4, iDag: 15.6, endringFraIGar: -0.3, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 73.5, iDag: 15.1, endringFraIGar: 1.5, plasseringEndring: 1 },
  { navn: "Østfold", total: 73.4, iDag: 14.1, endringFraIGar: -4.5, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 67.4, vindkast: 0, nedbor: 0, temp: -39.6, farevarsel: "oransje" },
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 45.0, vindkast: 14.6, nedbor: 0, temp: 4.2, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 42.4, vindkast: 11.3, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 40.4, vindkast: 15.3, nedbor: 0, temp: 8.0, farevarsel: "gul" },
  { navn: "HONNEGRASNUTEN", kommune: "VINJE", fylke: "Telemark", ei: 35.9, vindkast: 12.2, nedbor: 0, temp: 2.6, farevarsel: "ingen" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0.5,
    dager: [57.8, 66.1, 63.0, 35.9, 29.8, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Tir med 66.1 EI. Kraftige vindkast opp til 33.0 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.4,
    dager: [56.2, 57.1, 60.3, 36.9, 26.4, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0.4,
    dager: [50.7, 48.7, 43.7, 34.3, 35.9, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Man med 50.7 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.2, 46.6, 45.8, 37.1, 33.0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 42 EI per dag. Toppdag Man med 48.2 EI."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -1.8,
    dager: [48.5, 50.0, 44.3, 31.7, 28.0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 40 EI per dag. Toppdag Tir med 50.0 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 109.4 poeng, foran Agder (106.7).",
  gammelLeder: "Agder",
  nyLeder: "Finnmark",
};
