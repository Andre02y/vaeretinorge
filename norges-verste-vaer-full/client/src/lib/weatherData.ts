 ...
 *
 * Sist oppdatert: 26.07.2026 kl. 12:27
...
export const META = {
  ...
  datoOppdatert: "26.07.2026 kl. 12:27",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [20.9, 22.8, 21.6, 21.8, 22.5, 18.3, 18.3], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Trøndelag", dager: [14.1, 17.9, 20.1, 17.0, 19.4, 17.3, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [12.9, 13.8, 18.1, 13.9, 17.1, 21.8, 22.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [12.1, 12.3, 11.5, 12.7, 14.6, 19.3, 22.2], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [12.7, 11.6, 15.3, 13.8, 13.7, 17.8, 19.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.1, 11.2, 11.3, 11.1, 11.9, 18.1, 20.4], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [12.0, 11.0, 10.9, 11.8, 12.3, 18.3, 20.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [13.0, 11.2, 12.7, 9.7, 10.1, 13.0, 16.9], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Finnmark", total: 146.2, iDag: 18.3, endringFraIGar: 0.0, plasseringEndring: 0 },
  ...
  { navn: "Trøndelag", total: 124.8, iDag: 19.0, endringFraIGar: 1.7, plasseringEndring: -1 },
  { navn: "Rogaland", total: 119.9, iDag: 22.3, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Agder", total: 104.7, iDag: 22.2, endringFraIGar: 2.9, plasseringEndring: 1 },
  { navn: "Innlandet", total: 104.5, iDag: 19.6, endringFraIGar: 1.8, plasseringEndring: -1 },
  { navn: "Telemark", total: 97.1, iDag: 20.4, endringFraIGar: 2.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 96.5, iDag: 20.2, endringFraIGar: 1.9, plasseringEndring: 0 },
  { navn: "Østfold", total: 86.6, iDag: 16.9, endringFraIGar: 3.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 77.5, vindkast: 0, nedbor: 1.3, temp: -39.8, farevarsel: "oransje" },
  ...
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 61.3, vindkast: 13.6, nedbor: 15.4, temp: 0, farevarsel: "oransje" },
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 10.9,
    dager: [32.1, 37.9, 33.3, 36.3, 55.6, 58.3, 57.0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [32.1, 35.1, 36.6, 36.2, 51.5, 57.4, 52.7],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 158.1 poeng - 11.9 poeng foran Finnmark (146.2).",
