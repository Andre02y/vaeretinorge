 ...
 *
 * Sist oppdatert: 29.03.2026 kl. 03:15
 * Periode sammenlagt: 23.03 - 29.03.2026 (7 dager)
...
export const META = {
  ...
  sammenlagtLabel: "23.03 - 29.03.2026 (7 dager)",
  datoOppdatert: "29.03.2026 kl. 03:15",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [46.8, 39.3, 33.4, 31.6, 34.1, 31.2, 29.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [37.0, 32.9, 29.8, 35.6, 38.4, 36.3, 29.6], trend: "Markant bedring (-6.7) - lavtrykket har passert" },
  { navn: "Møre og Romsdal", dager: [35.7, 35.1, 32.8, 38.6, 29.1, 28.7, 28.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [36.5, 33.8, 29.0, 30.1, 36.3, 31.2, 27.7], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Vestland", dager: [32.1, 34.6, 32.3, 32.1, 29.5, 31.5, 24.4], trend: "Markant bedring (-7.1) - lavtrykket har passert" },
  { navn: "Trøndelag", dager: [40.7, 31.0, 22.9, 33.1, 28.8, 23.7, 26.6], trend: "Noe forverring (+2.9) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [25.2, 30.5, 31.5, 26.7, 29.8, 30.3, 25.7], trend: "Noe bedring (-4.6) - roligere forhold" },
  { navn: "Innlandet", dager: [27.7, 29.7, 26.2, 30.6, 28.8, 28.7, 27.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [24.8, 27.6, 30.0, 31.7, 28.0, 27.1, 23.1], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Oslo", dager: [20.5, 27.4, 35.8, 21.2, 30.9, 33.6, 22.8], trend: "Markant bedring (-10.8) - lavtrykket har passert" },
  { navn: "Østfold", dager: [21.4, 27.1, 30.4, 24.3, 23.8, 24.8, 21.5], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Telemark", dager: [22.2, 25.8, 28.0, 21.4, 25.0, 26.6, 23.3], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Buskerud", dager: [21.9, 23.4, 26.0, 21.2, 26.3, 25.7, 23.6], trend: "Noe bedring (-2.1) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 245.7, iDag: 29.3, endringFraIGar: -1.9, plasseringEndring: 0 },
  { navn: "Finnmark", total: 239.6, iDag: 29.6, endringFraIGar: -6.7, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 228.5, iDag: 28.5, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Troms", total: 224.6, iDag: 27.7, endringFraIGar: -3.5, plasseringEndring: 0 },
  { navn: "Vestland", total: 216.5, iDag: 24.4, endringFraIGar: -7.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 206.8, iDag: 26.6, endringFraIGar: 2.9, plasseringEndring: 0 },
  { navn: "Agder", total: 199.7, iDag: 25.7, endringFraIGar: -4.6, plasseringEndring: 0 },
  { navn: "Innlandet", total: 199.4, iDag: 27.7, endringFraIGar: -1.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 192.3, iDag: 23.1, endringFraIGar: -4.0, plasseringEndring: 1 },
  { navn: "Oslo", total: 192.2, iDag: 22.8, endringFraIGar: -10.8, plasseringEndring: -1 },
  { navn: "Østfold", total: 173.3, iDag: 21.5, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 172.3, iDag: 23.3, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 168.1, iDag: 23.6, endringFraIGar: -2.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 67.0, vindkast: 27.9, nedbor: 0, temp: -9.6, farevarsel: "oransje" },
  { navn: "ONA II", kommune: "ÅLESUND", fylke: "Møre og Romsdal", ei: 63.7, vindkast: 23.6, nedbor: 0, temp: 3.8, farevarsel: "oransje" },
  { navn: "ROALDSHORNET", kommune: "STRANDA", fylke: "Møre og Romsdal", ei: 63.4, vindkast: 22.5, nedbor: 0, temp: -3.4, farevarsel: "oransje" },
  { navn: "JUVFLYE - KLIMAPARK 2469", kommune: "LOM", fylke: "Innlandet", ei: 60.9, vindkast: 18.5, nedbor: 0, temp: -9.3, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 59.7, vindkast: 16.6, nedbor: 0, temp: -8.2, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1020.7,
    tempMin: -5.3,
    dager: [543.8, 35.4, 26.4, 32.9, 32.6, 31.0, 30.5],
    beskrivelse: "Ekstremt vaer hele uken med snitt 105 EI per dag. Toppdag Man med 543.8 EI. Mye nedbor med totalt 1020.7 mm. Bitende kulde ned til -5.3 grader C."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -9.9,
    dager: [72.9, 81.5, 62.8, 67.2, 55.9, 56.1, 67.0],
    beskrivelse: "Ekstremt vaer hele uken med snitt 66 EI per dag. Toppdag Tir med 81.5 EI. Kraftige vindkast opp til 43.3 m/s. Bitende kulde ned til -9.9 grader C."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
    ...
    precipTotal: 0,
    tempMin: -4.3,
    dager: [69.7, 72.3, 62.7, 61.0, 68.9, 59.7, 56.8],
    beskrivelse: "Ekstremt vaer hele uken med snitt 64 EI per dag. Toppdag Tir med 72.3 EI. Kraftige vindkast opp til 38.0 m/s."
  },
  {
    navn: "KRÅKENES",
    kommune: "KINN",
    ...
    precipTotal: 0,
    tempMin: 4.2,
    dager: [66.0, 86.9, 62.5, 46.8, 63.7, 60.5, 56.1],
    beskrivelse: "Ekstremt vaer hele uken med snitt 63 EI per dag. Toppdag Tir med 86.9 EI. Kraftige vindkast opp til 40.0 m/s."
  },
  {
    ...
    precipTotal: 104.1,
    tempMin: -2.1,
    dager: [62.8, 61.6, 76.7, 76.3, 45.2, 62.4, 37.3],
    beskrivelse: "Ekstremt vaer hele uken med snitt 60 EI per dag. Toppdag Ons med 76.7 EI. Kraftige vindkast opp til 26.9 m/s. Mye nedbor med totalt 104.1 mm."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 245.7 poeng - 6.1 poeng foran Finnmark (239.6).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-03-23",
  tilDato: "2026-03-29",
  periode: "23.03 - 29.03.2026 (7 dager)",
  dagerRegistrert: 7,
