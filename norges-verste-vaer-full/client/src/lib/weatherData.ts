 ...
 *
 * Sist oppdatert: 23.08.2026 kl. 20:12
...
export const META = {
  ...
  datoOppdatert: "23.08.2026 kl. 20:12",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [21.7, 25.3, 23.4, 28.9, 27.3, 29.8, 27.5], trend: "Noe bedring (-2.3) - roligere forhold" },
  ...
  { navn: "Nordland", dager: [22.4, 22.4, 19.2, 17.4, 17.2, 16.1, 17.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [20.8, 20.0, 17.6, 21.3, 16.7, 16.7, 17.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [16.6, 16.1, 15.8, 16.3, 18.4, 21.0, 18.8], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Troms", dager: [20.1, 23.7, 17.7, 14.3, 13.0, 14.7, 15.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [15.7, 16.4, 14.7, 18.4, 16.5, 17.8, 16.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [17.3, 14.8, 14.0, 14.6, 20.0, 19.0, 15.6], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Agder", dager: [14.6, 15.7, 16.1, 16.2, 15.3, 14.8, 14.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [17.2, 14.4, 12.9, 12.5, 16.0, 17.9, 16.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.3, 13.9, 13.7, 14.1, 14.9, 13.7, 16.3], trend: "Noe forverring (+2.6) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [14.4, 13.6, 11.3, 14.0, 12.3, 12.5, 11.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 183.9, iDag: 27.5, endringFraIGar: -2.3, plasseringEndring: 0 },
  ...
  { navn: "Nordland", total: 131.7, iDag: 17.0, endringFraIGar: 0.9, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 130.4, iDag: 17.3, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Innlandet", total: 123.0, iDag: 18.8, endringFraIGar: -2.2, plasseringEndring: 0 },
  { navn: "Troms", total: 118.9, iDag: 15.4, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Buskerud", total: 116.2, iDag: 16.7, endringFraIGar: -1.1, plasseringEndring: 1 },
  { navn: "Vestland", total: 115.3, iDag: 15.6, endringFraIGar: -3.4, plasseringEndring: -1 },
  { navn: "Agder", total: 107.4, iDag: 14.7, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 107.0, iDag: 16.1, endringFraIGar: -1.8, plasseringEndring: 0 },
  { navn: "Telemark", total: 99.9, iDag: 16.3, endringFraIGar: 2.6, plasseringEndring: 0 },
  { navn: "Østfold", total: 89.4, iDag: 11.3, endringFraIGar: -1.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RV3 EBRU", kommune: "LØTEN", fylke: "Innlandet", ei: 128.9, vindkast: 0, nedbor: 247.7, temp: 15.0, farevarsel: "oransje" },
  { navn: "FV450 HUNNEDALEN", kommune: "SIRDAL", fylke: "Agder", ei: 64.1, vindkast: 0, nedbor: 0, temp: -36.3, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.2, vindkast: 0, nedbor: 0, temp: -39.2, farevarsel: "gul" },
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 47.7, vindkast: 0, nedbor: 0, temp: -22.8, farevarsel: "gul" },
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 45.2, vindkast: 0, nedbor: 0, temp: -17.1, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -39.9,
    dager: [48.5, 58.4, 59.4, 59.4, 58.9, 59.9, 59.2],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -39.2,
    dager: [24.9, 63.7, 65.1, 67.0, 16.7, 22.8, 64.1],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -45.9,
    dager: [73.4, 75.4, 16.3, 15.8, 28.1, 67.1, 47.7],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 46 EI per dag. Toppdag Tir med 75.4 EI. Bitende kulde ned til -45.9 grader C."
  },
  {
    navn: "ERESFJORD",
    kommune: "MOLDE",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 43.9, 37.6, 38.4, 45.8, 39.4, 37.4],
    beskrivelse: "Varierende forhold hele uken med snitt 40 EI per dag. Toppdag Fre med 45.8 EI."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 183.9 poeng - 45.4 poeng foran Finnmark (138.5).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
