 ...
 *
 * Sist oppdatert: 03.07.2026 kl. 15:31
...
export const META = {
  ...
  datoOppdatert: "03.07.2026 kl. 15:31",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Oslo", dager: [15.4, 15.7, 15.8, 33.2, 33.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [21.4, 27.7, 24.9, 17.5, 15.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [14.2, 24.3, 24.3, 18.7, 14.9], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [19.3, 18.9, 13.2, 15.8, 19.4], trend: "Noe forverring (+3.6) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [16.7, 16.3, 13.1, 16.7, 22.4], trend: "Kraftig forverring (+5.7) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [15.7, 19.4, 14.6, 13.9, 15.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [10.4, 11.4, 11.2, 21.6, 23.9], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [10.6, 11.0, 10.7, 19.1, 26.0], trend: "Kraftig forverring (+6.9) - okt vind og/eller nedbor" },
  ...
  { navn: "Innlandet", dager: [11.7, 12.8, 13.3, 17.5, 19.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [9.8, 10.1, 10.5, 16.8, 20.0], trend: "Noe forverring (+3.2) - ustabilt vaer fortsetter" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Oslo", total: 113.7, iDag: 33.6, endringFraIGar: 0.4, plasseringEndring: 2 },
  { navn: "Nordland", total: 107.3, iDag: 15.8, endringFraIGar: -1.7, plasseringEndring: -1 },
  { navn: "Troms", total: 96.4, iDag: 14.9, endringFraIGar: -3.8, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 86.6, iDag: 19.4, endringFraIGar: 3.6, plasseringEndring: 0 },
  { navn: "Vestland", total: 85.2, iDag: 22.4, endringFraIGar: 5.7, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 79.4, iDag: 15.8, endringFraIGar: 1.9, plasseringEndring: -1 },
  { navn: "Telemark", total: 78.5, iDag: 23.9, endringFraIGar: 2.3, plasseringEndring: 1 },
  { navn: "Rogaland", total: 77.4, iDag: 26.0, endringFraIGar: 6.9, plasseringEndring: 3 },
  ...
  { navn: "Innlandet", total: 74.7, iDag: 19.4, endringFraIGar: 1.9, plasseringEndring: -4 },
  { navn: "Østfold", total: 67.2, iDag: 20.0, endringFraIGar: 3.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "LINDESNES FYR", kommune: "LINDESNES", fylke: "Agder", ei: 57.6, vindkast: 28.2, nedbor: 12.1, temp: 14.0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 18.1,
    tempMin: 0,
    dager: [55.0, 45.1, 42.2, 45.7, 52.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [32.2, 57.2, 59.0, 47.3, 39.2, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 113.8 poeng - 0.1 poeng foran Oslo (113.7).",
