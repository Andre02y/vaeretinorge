 ...
 *
 * Sist oppdatert: 16.08.2026 kl. 14:15
...
export const META = {
  ...
  datoOppdatert: "16.08.2026 kl. 14:15",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [24.9, 24.9, 27.2, 22.3, 20.1, 18.6, 16.6], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Nordland", dager: [21.5, 24.6, 23.3, 21.7, 21.0, 19.3, 18.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [25.0, 25.0, 18.1, 16.3, 18.5, 19.8, 20.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [28.3, 17.1, 16.4, 15.9, 22.3, 21.7, 17.6], trend: "Noe bedring (-4.1) - roligere forhold" },
  { navn: "Trøndelag", dager: [19.6, 24.8, 19.0, 18.2, 16.5, 19.2, 19.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [26.9, 21.0, 17.1, 16.2, 18.3, 17.6, 17.1], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Agder", dager: [22.8, 16.7, 14.7, 12.8, 13.1, 16.6, 14.4], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Innlandet", dager: [20.0, 19.5, 15.2, 13.2, 14.0, 14.2, 14.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [19.0, 13.1, 12.4, 11.5, 12.9, 15.3, 12.4], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Buskerud", dager: [18.6, 13.4, 12.4, 11.2, 12.4, 14.3, 13.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [16.4, 11.3, 11.3, 10.9, 9.4, 9.5, 10.4], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 154.6, iDag: 16.6, endringFraIGar: -2.0, plasseringEndring: 0 },
  { navn: "Nordland", total: 149.9, iDag: 18.5, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 143.0, iDag: 20.3, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Oslo", total: 139.3, iDag: 17.6, endringFraIGar: -4.1, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 136.6, iDag: 19.3, endringFraIGar: 0.1, plasseringEndring: 1 },
  { navn: "Vestland", total: 134.2, iDag: 17.1, endringFraIGar: -0.5, plasseringEndring: 1 },
  ...
  { navn: "Agder", total: 111.1, iDag: 14.4, endringFraIGar: -2.2, plasseringEndring: 0 },
  { navn: "Innlandet", total: 110.6, iDag: 14.5, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 96.6, iDag: 12.4, endringFraIGar: -2.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 95.4, iDag: 13.1, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Østfold", total: 79.2, iDag: 10.4, endringFraIGar: 0.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 LANGFJORDBOTN", kommune: "ALTA", fylke: "Finnmark", ei: 62.1, vindkast: 0, nedbor: 0, temp: -39.8, farevarsel: "oransje" },
  { navn: "RINGVASSØYA - STRANDMO", kommune: "KARLSØY", fylke: "Troms", ei: 61.6, vindkast: 0, nedbor: 0, temp: -38.6, farevarsel: "oransje" },
  { navn: "FV848 FORNES", kommune: "NARVIK", fylke: "Nordland", ei: 61.1, vindkast: 0, nedbor: 0.1, temp: -39.1, farevarsel: "oransje" },
  { navn: "FV42 HADDELANDSHEIA", kommune: "KVINESDAL", fylke: "Agder", ei: 59.9, vindkast: 0, nedbor: 0, temp: -39.9, farevarsel: "gul" },
  { navn: "BIRTAVARRE - HOLMEN", kommune: "KÅFJORD", fylke: "Troms", ei: 56.6, vindkast: 2.4, nedbor: 0, temp: 9.3, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0.1,
    tempMin: -39.9,
    dager: [68.2, 63.6, 66.7, 64.1, 61.4, 62.2, 62.1],
  ...
  },
  {
    ...
    precipTotal: 0.4,
    tempMin: -39.8,
    dager: [74.9, 35.1, 65.1, 61.0, 57.7, 28.9, 18.4],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [57.0, 48.9, 34.5, 37.1, 42.4, 43.4, 45.0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.2,
    dager: [59.3, 46.2, 39.9, 41.6, 42.0, 35.4, 41.0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 154.6 poeng - 4.7 poeng foran Nordland (149.9).",
