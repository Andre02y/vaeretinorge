 ...
 *
 * Sist oppdatert: 25.06.2026 kl. 21:44
...
export const META = {
  ...
  datoOppdatert: "25.06.2026 kl. 21:44",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.0, 24.8, 19.9, 21.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [22.9, 21.2, 22.8, 20.1], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Finnmark", dager: [20.3, 21.2, 20.8, 18.8], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Trøndelag", dager: [23.4, 18.0, 18.2, 18.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.5, 20.3, 17.4, 16.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [18.0, 18.7, 20.3, 16.7], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Oslo", dager: [16.2, 16.1, 17.6, 15.4], trend: "Noe bedring (-2.2) - roligere forhold" },
  { navn: "Innlandet", dager: [15.3, 14.5, 17.1, 13.1], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Rogaland", dager: [14.2, 13.4, 15.0, 11.6], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Buskerud", dager: [12.4, 12.0, 14.0, 10.7], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Agder", dager: [13.6, 12.6, 11.5, 10.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [11.9, 12.3, 12.8, 10.3], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Østfold", dager: [9.9, 11.9, 13.1, 8.0], trend: "Markant bedring (-5.1) - lavtrykket har passert" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 99.2, iDag: 21.5, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 87.0, iDag: 20.1, endringFraIGar: -2.7, plasseringEndring: 0 },
  { navn: "Finnmark", total: 81.1, iDag: 18.8, endringFraIGar: -2.0, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 78.4, iDag: 18.8, endringFraIGar: 0.6, plasseringEndring: 0 },
  { navn: "Troms", total: 74.5, iDag: 16.3, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 73.7, iDag: 16.7, endringFraIGar: -3.6, plasseringEndring: 0 },
  { navn: "Oslo", total: 65.3, iDag: 15.4, endringFraIGar: -2.2, plasseringEndring: 0 },
  { navn: "Innlandet", total: 60.0, iDag: 13.1, endringFraIGar: -4.0, plasseringEndring: 0 },
  { navn: "Rogaland", total: 54.2, iDag: 11.6, endringFraIGar: -3.4, plasseringEndring: 0 },
  { navn: "Buskerud", total: 49.1, iDag: 10.7, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Agder", total: 48.3, iDag: 10.6, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Telemark", total: 47.3, iDag: 10.3, endringFraIGar: -2.5, plasseringEndring: 0 },
  { navn: "Østfold", total: 42.9, iDag: 8.0, endringFraIGar: -5.1, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 48.9, vindkast: 24.7, nedbor: 0, temp: 10.4, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 46.8, vindkast: 10.1, nedbor: 0.2, temp: 0, farevarsel: "gul" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 46.0, vindkast: 20.4, nedbor: 0, temp: 11.9, farevarsel: "gul" },
  { navn: "LIAFOSS", kommune: "NÆRØYSUND", fylke: "Trøndelag", ei: 44.5, vindkast: 0, nedbor: 19.0, temp: 0, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 44.1, vindkast: 16.8, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 17.4,
    tempMin: 0,
    dager: [46.7, 42.6, 51.3, 46.8, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Ons med 51.3 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 6.9,
    dager: [68.7, 39.3, 21.9, 48.9, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 45 EI per dag. Toppdag Man med 68.7 EI. Kraftige vindkast opp til 35.5 m/s."
  },
  {
    navn: "BJERKA - VALLA",
    kommune: "HEMNES",
    ...
    precipTotal: 67.0,
    tempMin: 0,
    dager: [60.4, 38.5, 39.2, 35.5, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Man med 60.4 EI. Mye nedbor med totalt 67.0 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.0, 37.5, 44.1, 43.1, 0, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.3,
    dager: [41.6, 40.6, 47.4, 41.7, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 43 EI per dag. Toppdag Ons med 47.4 EI."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 99.2 poeng - 12.2 poeng foran Møre og Romsdal (87.0).",
