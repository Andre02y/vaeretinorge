 ...
 *
 * Sist oppdatert: 29.05.2026 kl. 08:44
...
export const META = {
  ...
  datoOppdatert: "29.05.2026 kl. 08:44",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.5, 26.9, 25.6, 26.8, 25.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [25.2, 25.2, 27.3, 29.3, 25.7], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.4, 28.2, 28.3, 23.1, 19.1], trend: "Noe bedring (-4.0) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [23.8, 29.9, 25.8, 21.7, 17.1], trend: "Noe bedring (-4.6) - roligere forhold" },
  { navn: "Troms", dager: [24.4, 20.0, 20.5, 23.0, 24.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [25.3, 25.3, 22.1, 18.1, 16.0], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Innlandet", dager: [17.2, 21.6, 21.4, 18.5, 15.3], trend: "Noe bedring (-3.2) - roligere forhold" },
  { navn: "Oslo", dager: [16.6, 17.4, 17.5, 17.5, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [15.1, 17.7, 18.6, 14.9, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [14.9, 17.0, 16.9, 15.4, 14.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [13.2, 14.9, 14.9, 14.1, 14.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.2, 14.3, 14.8, 14.2, 14.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [10.9, 13.5, 14.2, 13.5, 13.1], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 134.1, iDag: 25.3, endringFraIGar: -1.5, plasseringEndring: 0 },
  { navn: "Finnmark", total: 132.7, iDag: 25.7, endringFraIGar: -3.6, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 121.1, iDag: 19.1, endringFraIGar: -4.0, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 118.3, iDag: 17.1, endringFraIGar: -4.6, plasseringEndring: 0 },
  { navn: "Troms", total: 112.0, iDag: 24.1, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Vestland", total: 106.8, iDag: 16.0, endringFraIGar: -2.1, plasseringEndring: -1 },
  { navn: "Innlandet", total: 94.0, iDag: 15.3, endringFraIGar: -3.2, plasseringEndring: 0 },
  { navn: "Oslo", total: 86.7, iDag: 17.7, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 81.4, iDag: 15.1, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Agder", total: 78.8, iDag: 14.6, endringFraIGar: -0.8, plasseringEndring: 0 },
  { navn: "Buskerud", total: 71.5, iDag: 14.4, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Telemark", total: 70.6, iDag: 14.1, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Østfold", total: 65.2, iDag: 13.1, endringFraIGar: -0.4, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "TROLLEDALSEGGA", kommune: "STAD", fylke: "Vestland", ei: 48.9, vindkast: 17.6, nedbor: 0, temp: 5.2, farevarsel: "gul" },
  { navn: "ØRSTA-VOLDA LH - HELGEHORNET", kommune: "ØRSTA", fylke: "Møre og Romsdal", ei: 48.6, vindkast: 15.9, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "SISOVATNET", kommune: "SØRFOLD", fylke: "Nordland", ei: 47.7, vindkast: 5.4, nedbor: 8.8, temp: 1.9, farevarsel: "gul" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 45.9, vindkast: 15.5, nedbor: 0, temp: -0.7, farevarsel: "gul" },
  { navn: "BJØRKÅSEN", kommune: "NARVIK", fylke: "Nordland", ei: 43.4, vindkast: 0, nedbor: 16.7, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [62.3, 64.9, 67.3, 51.5, 41.6, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [55.2, 56.1, 58.8, 47.2, 41.2, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0.1,
    dager: [46.7, 66.8, 60.0, 43.1, 33.8, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [53.2, 68.2, 54.6, 36.4, 33.5, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 1.4,
    dager: [48.6, 62.1, 55.3, 43.7, 27.9, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 134.1 poeng - 1.4 poeng foran Finnmark (132.7).",
