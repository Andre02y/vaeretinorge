 ...
 *
 * Sist oppdatert: 18.07.2026 kl. 20:43
...
export const META = {
  ...
  datoOppdatert: "18.07.2026 kl. 20:43",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [20.8, 24.0, 26.0, 24.0, 23.3, 23.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Finnmark", dager: [19.2, 26.2, 20.7, 23.7, 23.2, 24.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.6, 21.9, 20.6, 24.5, 21.6, 23.8], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Oslo", dager: [15.3, 14.9, 14.7, 14.6, 15.9, 36.0], trend: "Kraftig forverring (+20.1) - okt vind og/eller nedbor" },
  { navn: "Møre og Romsdal", dager: [13.5, 12.7, 12.4, 12.4, 15.4, 18.2], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [12.9, 12.7, 12.6, 12.2, 13.0, 17.0], trend: "Noe forverring (+4.0) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [8.9, 7.8, 7.7, 7.2, 9.3, 23.5], trend: "Kraftig forverring (+14.2) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [10.3, 9.7, 8.7, 8.7, 10.2, 14.0], trend: "Noe forverring (+3.8) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [9.2, 7.7, 6.8, 6.5, 8.0, 21.2], trend: "Kraftig forverring (+13.2) - okt vind og/eller nedbor" },
  { navn: "Telemark", dager: [9.0, 7.8, 7.3, 7.2, 8.1, 18.3], trend: "Kraftig forverring (+10.2) - okt vind og/eller nedbor" },
  { navn: "Rogaland", dager: [8.7, 8.9, 8.0, 7.3, 10.6, 13.0], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [7.5, 7.3, 7.0, 6.4, 7.1, 12.9], trend: "Kraftig forverring (+5.8) - okt vind og/eller nedbor" },
  { navn: "Østfold", dager: [7.1, 6.7, 6.0, 5.6, 6.2, 16.1], trend: "Kraftig forverring (+9.9) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 141.9, iDag: 23.8, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Finnmark", total: 137.5, iDag: 24.5, endringFraIGar: 1.3, plasseringEndring: 0 },
  { navn: "Troms", total: 133.0, iDag: 23.8, endringFraIGar: 2.2, plasseringEndring: 0 },
  { navn: "Oslo", total: 111.4, iDag: 36.0, endringFraIGar: 20.1, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 84.6, iDag: 18.2, endringFraIGar: 2.8, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 80.4, iDag: 17.0, endringFraIGar: 4.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 64.4, iDag: 23.5, endringFraIGar: 14.2, plasseringEndring: 2 },
  { navn: "Vestland", total: 61.6, iDag: 14.0, endringFraIGar: 3.8, plasseringEndring: -1 },
  { navn: "Innlandet", total: 59.4, iDag: 21.2, endringFraIGar: 13.2, plasseringEndring: 2 },
  { navn: "Telemark", total: 57.7, iDag: 18.3, endringFraIGar: 10.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 56.5, iDag: 13.0, endringFraIGar: 2.4, plasseringEndring: -3 },
  { navn: "Agder", total: 48.2, iDag: 12.9, endringFraIGar: 5.8, plasseringEndring: 0 },
  { navn: "Østfold", total: 47.7, iDag: 16.1, endringFraIGar: 9.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "FAGERSTRAND", kommune: "NESODDEN", fylke: "Buskerud", ei: 54.4, vindkast: 0, nedbor: 38.7, temp: 0, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [58.2, 64.5, 63.7, 63.9, 60.6, 40.2, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 5.7,
    dager: [48.3, 58.7, 42.6, 56.9, 51.3, 49.9, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 2.7,
    dager: [54.0, 48.5, 50.7, 59.2, 48.1, 44.2, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 5.9,
    dager: [46.5, 47.8, 52.3, 59.2, 52.1, 45.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [43.2, 59.0, 43.1, 54.6, 52.8, 50.3, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Tir med 59.0 EI. Kraftige vindkast opp til 26.8 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 141.9 poeng - 4.4 poeng foran Finnmark (137.5).",
