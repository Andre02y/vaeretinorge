 ...
 *
 * Sist oppdatert: 30.05.2026 kl. 12:43
...
export const META = {
  ...
  datoOppdatert: "30.05.2026 kl. 12:43",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.5, 26.9, 25.6, 26.8, 25.7, 24.2], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Troms", dager: [24.4, 20.0, 20.5, 23.0, 24.4, 23.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [23.8, 29.9, 25.8, 21.7, 16.9, 15.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [25.3, 25.3, 22.1, 18.1, 16.0, 17.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [17.2, 21.6, 21.4, 18.5, 14.5, 13.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [16.6, 17.4, 17.5, 17.5, 17.5, 16.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [15.1, 17.7, 18.6, 14.9, 15.3, 17.5], trend: "Noe forverring (+2.2) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [14.9, 17.0, 16.9, 15.4, 14.5, 15.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [13.2, 14.3, 14.8, 14.2, 14.0, 14.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [13.2, 14.9, 14.9, 14.1, 13.5, 13.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [10.9, 13.5, 14.2, 13.5, 13.4, 10.5], trend: "Noe bedring (-2.9) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 158.7, iDag: 24.2, endringFraIGar: -1.5, plasseringEndring: 0 },
  ...
  { navn: "Troms", total: 136.0, iDag: 23.7, endringFraIGar: -0.7, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 133.2, iDag: 15.1, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Vestland", total: 124.4, iDag: 17.6, endringFraIGar: 1.6, plasseringEndring: 0 },
  { navn: "Innlandet", total: 106.8, iDag: 13.6, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Oslo", total: 103.1, iDag: 16.6, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Rogaland", total: 99.1, iDag: 17.5, endringFraIGar: 2.2, plasseringEndring: 0 },
  { navn: "Agder", total: 94.0, iDag: 15.3, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Telemark", total: 85.2, iDag: 14.7, endringFraIGar: 0.7, plasseringEndring: 1 },
  { navn: "Buskerud", total: 84.0, iDag: 13.4, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Østfold", total: 76.0, iDag: 10.5, endringFraIGar: -2.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 52.3, vindkast: 0, nedbor: 0, temp: -25.2, farevarsel: "gul" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 46.3, vindkast: 19.6, nedbor: 0, temp: 0.7, farevarsel: "gul" },
  { navn: "NORDNESFJELLET - JETTANII", kommune: "KÅFJORD", fylke: "Troms", ei: 44.5, vindkast: 10.8, nedbor: 2.1, temp: 1.2, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 43.8, vindkast: 9.5, nedbor: 2.5, temp: 0, farevarsel: "gul" },
  { navn: "MYKEN", kommune: "RØDØY", fylke: "Nordland", ei: 43.6, vindkast: 15.7, nedbor: 4.1, temp: 7.7, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [62.3, 64.9, 67.3, 51.5, 39.6, 29.9, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [53.2, 68.2, 54.6, 36.4, 37.9, 32.2, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.0,
    dager: [55.2, 56.1, 58.8, 47.2, 37.1, 27.8, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 1.0,
    dager: [55.7, 63.5, 53.8, 36.4, 33.2, 32.9, 0],
  ...
  },
  {
    ...
    precipTotal: 33.9,
    tempMin: 0,
    dager: [61.9, 62.1, 48.6, 29.4, 28.1, 43.8, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 158.7 poeng - 0.4 poeng foran Finnmark (158.3).",
