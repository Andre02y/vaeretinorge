 ...
 *
 * Sist oppdatert: 05.07.2026 kl. 18:00
...
export const META = {
  ...
  datoOppdatert: "05.07.2026 kl. 18:00",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [18.6, 27.6, 27.6, 22.5, 17.4, 18.0, 18.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [21.4, 27.7, 24.9, 17.5, 17.3, 18.6, 17.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [19.3, 18.9, 13.2, 15.8, 19.7, 20.5, 25.4], trend: "Noe forverring (+4.9) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [16.7, 16.3, 13.1, 16.7, 21.7, 19.8, 22.3], trend: "Noe forverring (+2.5) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [14.2, 24.3, 24.3, 18.7, 14.9, 14.8, 14.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [15.7, 19.4, 14.6, 13.9, 16.8, 17.0, 23.1], trend: "Kraftig forverring (+6.1) - okt vind og/eller nedbor" },
  { navn: "Innlandet", dager: [11.7, 12.8, 13.3, 17.5, 19.3, 15.5, 19.4], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Rogaland", dager: [10.6, 11.0, 10.7, 19.1, 23.3, 13.9, 18.9], trend: "Noe forverring (+5.0) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [10.2, 11.1, 11.2, 21.6, 19.1, 12.5, 18.5], trend: "Kraftig forverring (+6.0) - okt vind og/eller nedbor" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Finnmark", total: 150.1, iDag: 18.4, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Nordland", total: 145.1, iDag: 17.7, endringFraIGar: -0.9, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 132.8, iDag: 25.4, endringFraIGar: 4.9, plasseringEndring: 1 },
  { navn: "Vestland", total: 126.6, iDag: 22.3, endringFraIGar: 2.5, plasseringEndring: 1 },
  { navn: "Troms", total: 126.0, iDag: 14.8, endringFraIGar: 0.0, plasseringEndring: -2 },
  { navn: "Trøndelag", total: 120.5, iDag: 23.1, endringFraIGar: 6.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 109.5, iDag: 19.4, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Rogaland", total: 107.5, iDag: 18.9, endringFraIGar: 5.0, plasseringEndring: 0 },
  { navn: "Buskerud", total: 104.2, iDag: 18.5, endringFraIGar: 6.0, plasseringEndring: 1 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 55.0, vindkast: 23.4, nedbor: 0, temp: 3.9, farevarsel: "gul" },
  { navn: "RV15 STRYNEFJELL-KVITENOVA", kommune: "STRYN", fylke: "Vestland", ei: 53.8, vindkast: 0, nedbor: 3.0, temp: 0.3, farevarsel: "gul" },
  { navn: "SKARDSBØFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 52.6, vindkast: 13.0, nedbor: 5.0, temp: 0, farevarsel: "gul" },
  { navn: "JUVVASSHØE", kommune: "LOM", fylke: "Innlandet", ei: 51.3, vindkast: 19.8, nedbor: 0, temp: 1.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [35.9, 67.3, 64.6, 38.5, 34.5, 37.7, 30.5],
  ...
  },
  {
    ...
    precipTotal: 22.7,
    tempMin: -26.9,
    dager: [47.5, 44.7, 39.7, 40.3, 29.5, 60.0, 38.0],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 43 EI per dag. Toppdag Lør med 60.0 EI. Mye nedbor med totalt 22.7 mm. Bitende kulde ned til -26.9 grader C."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 164.5 poeng - 14.4 poeng foran Finnmark (150.1).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
