 ...
 *
 * Sist oppdatert: 28.03.2026 kl. 02:06
...
export const META = {
  ...
  datoOppdatert: "28.03.2026 kl. 02:06",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [46.8, 39.3, 33.4, 31.6, 34.1, 30.3], trend: "Noe bedring (-3.8) - roligere forhold" },
  { navn: "Finnmark", dager: [37.0, 32.9, 29.8, 35.6, 38.4, 33.0], trend: "Markant bedring (-5.4) - lavtrykket har passert" },
  { navn: "Troms", dager: [36.5, 33.8, 29.0, 30.1, 36.3, 33.4], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [35.7, 35.1, 32.8, 38.6, 29.1, 26.8], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Vestland", dager: [32.1, 34.6, 32.3, 32.1, 29.5, 28.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [40.7, 31.0, 22.9, 33.1, 28.8, 23.7], trend: "Markant bedring (-5.1) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [27.7, 29.7, 26.2, 30.6, 28.8, 27.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [25.2, 30.5, 31.5, 26.7, 29.8, 23.3], trend: "Markant bedring (-6.5) - lavtrykket har passert" },
  { navn: "Oslo", dager: [20.5, 27.4, 35.8, 21.2, 30.9, 28.4], trend: "Noe bedring (-2.5) - roligere forhold" },
  { navn: "Rogaland", dager: [24.8, 27.6, 30.0, 31.7, 28.0, 21.6], trend: "Markant bedring (-6.4) - lavtrykket har passert" },
  { navn: "Østfold", dager: [21.4, 27.1, 30.4, 24.3, 23.8, 25.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [22.2, 25.8, 28.0, 21.4, 25.0, 21.5], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Buskerud", dager: [21.9, 23.4, 26.0, 21.2, 26.3, 23.4], trend: "Noe bedring (-2.9) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 215.5, iDag: 30.3, endringFraIGar: -3.8, plasseringEndring: 0 },
  { navn: "Finnmark", total: 206.7, iDag: 33.0, endringFraIGar: -5.4, plasseringEndring: 0 },
  { navn: "Troms", total: 199.1, iDag: 33.4, endringFraIGar: -2.9, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 198.1, iDag: 26.8, endringFraIGar: -2.3, plasseringEndring: -1 },
  { navn: "Vestland", total: 188.8, iDag: 28.2, endringFraIGar: -1.3, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 180.2, iDag: 23.7, endringFraIGar: -5.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 170.5, iDag: 27.5, endringFraIGar: -1.3, plasseringEndring: 1 },
  { navn: "Agder", total: 167.0, iDag: 23.3, endringFraIGar: -6.5, plasseringEndring: -1 },
  { navn: "Oslo", total: 164.2, iDag: 28.4, endringFraIGar: -2.5, plasseringEndring: 1 },
  { navn: "Rogaland", total: 163.7, iDag: 21.6, endringFraIGar: -6.4, plasseringEndring: -1 },
  { navn: "Østfold", total: 152.8, iDag: 25.8, endringFraIGar: 2.0, plasseringEndring: 0 },
  { navn: "Telemark", total: 143.9, iDag: 21.5, endringFraIGar: -3.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 142.2, iDag: 23.4, endringFraIGar: -2.9, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 65.5, vindkast: 23.3, nedbor: 0, temp: -4.5, farevarsel: "oransje" },
  { navn: "FAKKEN", kommune: "KARLSØY", fylke: "Troms", ei: 63.7, vindkast: 19.2, nedbor: 0, temp: -1.9, farevarsel: "oransje" },
  { navn: "KRÅKENES", kommune: "KINN", fylke: "Vestland", ei: 61.2, vindkast: 28.5, nedbor: 0, temp: 5.2, farevarsel: "oransje" },
  { navn: "ANDØYA", kommune: "ANDØY", fylke: "Nordland", ei: 59.4, vindkast: 13.9, nedbor: 0.1, temp: 1.7, farevarsel: "gul" },
  { navn: "ROALDSHORNET", kommune: "STRANDA", fylke: "Møre og Romsdal", ei: 59.0, vindkast: 19.6, nedbor: 0, temp: -3.8, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 1020.7,
    tempMin: -3.3,
    dager: [543.8, 35.4, 26.4, 32.9, 32.6, 34.0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 118 EI per dag. Toppdag Man med 543.8 EI. Mye nedbor med totalt 1020.7 mm."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -9.9,
    dager: [72.9, 81.5, 62.8, 67.2, 55.9, 53.9, 0],
  ...
  },
  {
    ...
    precipTotal: 272.7,
    tempMin: -5.0,
    dager: [166.8, 48.1, 56.1, 38.7, 42.5, 37.5, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Man med 166.8 EI. Mye nedbor med totalt 272.7 mm."
  },
  {
    navn: "TROLLEDALSEGGA",
    kommune: "STAD",
    ...
    precipTotal: 0,
    tempMin: -4.3,
    dager: [69.7, 72.3, 62.7, 61.0, 68.9, 53.8, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Tir med 72.3 EI. Kraftige vindkast opp til 38.0 m/s."
  },
  {
    navn: "KRÅKENES",
    kommune: "KINN",
    ...
    precipTotal: 0,
    tempMin: 4.2,
    dager: [66.0, 86.9, 62.5, 46.8, 63.7, 61.2, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 215.5 poeng - 8.8 poeng foran Finnmark (206.7).",
