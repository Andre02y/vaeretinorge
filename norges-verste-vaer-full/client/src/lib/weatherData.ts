 ...
 *
 * Sist oppdatert: 27.06.2026 kl. 15:05
...
export const META = {
  ...
  datoOppdatert: "27.06.2026 kl. 15:05",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [33.0, 24.8, 19.9, 21.5, 22.8, 25.6], trend: "Noe forverring (+2.8) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [22.9, 21.2, 22.8, 20.1, 21.4, 18.4], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Finnmark", dager: [20.3, 21.2, 20.8, 18.8, 17.3, 21.0], trend: "Noe forverring (+3.7) - ustabilt vaer fortsetter" },
  { navn: "Troms", dager: [20.5, 20.3, 17.4, 16.3, 17.3, 22.4], trend: "Kraftig forverring (+5.1) - okt vind og/eller nedbor" },
  { navn: "Trøndelag", dager: [23.4, 18.0, 18.2, 18.8, 17.6, 15.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [18.0, 18.7, 20.3, 16.7, 18.9, 14.8], trend: "Noe bedring (-4.1) - roligere forhold" },
  { navn: "Oslo", dager: [16.2, 16.1, 17.6, 15.4, 15.1, 15.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [15.3, 14.5, 17.1, 13.1, 14.3, 13.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [14.2, 13.4, 15.0, 11.6, 12.8, 11.4], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Agder", dager: [13.6, 12.6, 11.5, 10.6, 9.1, 9.3], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 147.6, iDag: 25.6, endringFraIGar: 2.8, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 126.8, iDag: 18.4, endringFraIGar: -3.0, plasseringEndring: 0 },
  { navn: "Finnmark", total: 119.4, iDag: 21.0, endringFraIGar: 3.7, plasseringEndring: 0 },
  { navn: "Troms", total: 114.2, iDag: 22.4, endringFraIGar: 5.1, plasseringEndring: 2 },
  { navn: "Trøndelag", total: 111.9, iDag: 15.9, endringFraIGar: -1.7, plasseringEndring: -1 },
  { navn: "Vestland", total: 107.4, iDag: 14.8, endringFraIGar: -4.1, plasseringEndring: -1 },
  { navn: "Oslo", total: 96.2, iDag: 15.8, endringFraIGar: 0.7, plasseringEndring: 0 },
  { navn: "Innlandet", total: 87.5, iDag: 13.2, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Rogaland", total: 78.4, iDag: 11.4, endringFraIGar: -1.4, plasseringEndring: 0 },
  ...
  { navn: "Agder", total: 66.7, iDag: 9.3, endringFraIGar: 0.2, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "E10 BJØRNFJELL", kommune: "NARVIK", fylke: "Nordland", ei: 57.8, vindkast: 0, nedbor: 3.6, temp: -22.9, farevarsel: "gul" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 55.1, vindkast: 26.9, nedbor: 0, temp: 7.1, farevarsel: "gul" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 54.2, vindkast: 22.6, nedbor: 0, temp: 4.0, farevarsel: "gul" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 52.5, vindkast: 21.8, nedbor: 0, temp: 0, farevarsel: "gul" },
  { navn: "LAKSELV LH - NJEAIDDAN", kommune: "PORSANGER", fylke: "Finnmark", ei: 50.5, vindkast: 21.6, nedbor: 0, temp: 0, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 38.6,
    tempMin: 0,
    dager: [46.7, 42.6, 51.3, 46.8, 52.4, 43.3, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -0.3,
    dager: [41.6, 40.6, 47.4, 41.7, 50.5, 28.7, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 6.9,
    dager: [68.7, 39.3, 21.9, 48.9, 33.4, 32.9, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [47.0, 37.5, 44.1, 43.1, 42.9, 30.4, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 147.6 poeng - 20.8 poeng foran Møre og Romsdal (126.8).",
