 ...
 *
 * Sist oppdatert: 21.04.2026 kl. 18:04
 * Periode sammenlagt: 20.04 - 21.04.2026 (2 dager)
...
export const META = {
  ...
  dagLabel: "Tirsdag 21.04.2026",
  sammenlagtLabel: "20.04 - 21.04.2026 (2 dager)",
  datoOppdatert: "21.04.2026 kl. 18:04",
  rapportVersjon: "v2.2 (norsk tid, live uke, ryddig arkiv, fikset uke/arkiv-logikk)",
  dagLabels: ["Man 20", "Tir 21"],
};

// ---- DAG-FOR-DAG EI PER FYLKE ----

export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.3, 35.9], trend: "Kraftig forverring (+7.6) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [23.4, 30.6], trend: "Kraftig forverring (+7.2) - okt vind og/eller nedbor" },
  { navn: "Oslo", dager: [30.2, 19.4], trend: "Markant bedring (-10.8) - lavtrykket har passert" },
  { navn: "Nordland", dager: [20.5, 26.4], trend: "Kraftig forverring (+5.9) - okt vind og/eller nedbor" },
  { navn: "Agder", dager: [25.2, 18.7], trend: "Markant bedring (-6.5) - lavtrykket har passert" },
  { navn: "Telemark", dager: [25.0, 17.9], trend: "Markant bedring (-7.1) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [22.3, 19.6], trend: "Noe bedring (-2.7) - roligere forhold" },
  { navn: "Buskerud", dager: [23.5, 17.9], trend: "Markant bedring (-5.6) - lavtrykket har passert" },
  { navn: "Østfold", dager: [23.6, 16.9], trend: "Markant bedring (-6.7) - lavtrykket har passert" },
  { navn: "Vestland", dager: [19.7, 18.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [17.6, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [19.0, 17.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [17.2, 17.6], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 64.2, iDag: 35.9, endringFraIGar: 7.6, plasseringEndring: 1 },
  { navn: "Troms", total: 54.0, iDag: 30.6, endringFraIGar: 7.2, plasseringEndring: 5 },
  { navn: "Oslo", total: 49.6, iDag: 19.4, endringFraIGar: -10.8, plasseringEndring: -2 },
  { navn: "Nordland", total: 46.9, iDag: 26.4, endringFraIGar: 5.9, plasseringEndring: 5 },
  { navn: "Agder", total: 43.9, iDag: 18.7, endringFraIGar: -6.5, plasseringEndring: -2 },
  { navn: "Telemark", total: 42.9, iDag: 17.9, endringFraIGar: -7.1, plasseringEndring: -2 },
  { navn: "Innlandet", total: 41.9, iDag: 19.6, endringFraIGar: -2.7, plasseringEndring: 1 },
  { navn: "Buskerud", total: 41.4, iDag: 17.9, endringFraIGar: -5.6, plasseringEndring: -2 },
  { navn: "Østfold", total: 40.5, iDag: 16.9, endringFraIGar: -6.7, plasseringEndring: -4 },
  { navn: "Vestland", total: 38.0, iDag: 18.3, endringFraIGar: -1.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 36.8, iDag: 19.2, endringFraIGar: 1.6, plasseringEndring: 1 },
  { navn: "Rogaland", total: 36.5, iDag: 17.5, endringFraIGar: -1.5, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 34.8, iDag: 17.6, endringFraIGar: 0.4, plasseringEndring: 0 },
...
// ---- TOPP 5 STASJONER TIRSDAG 21.04.2026 ----

export const STASJONER_PERIODE = [
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 87.9, vindkast: 40.9, nedbor: 0, temp: 3.1, farevarsel: "oransje" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 75.8, vindkast: 33.2, nedbor: 0, temp: 3.9, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 74.0, vindkast: 29.0, nedbor: 0, temp: -0.5, farevarsel: "oransje" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 66.4, vindkast: 28.9, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "ARNØYA - TROLLTINDEN", kommune: "SKJERVØY", fylke: "Troms", ei: 65.3, vindkast: 28.3, nedbor: 0, temp: -1.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 3.1,
    dager: [54.3, 87.9, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 71 EI per dag. Toppdag Tir med 87.9 EI. Kraftige vindkast opp til 40.9 m/s."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
    ...
    precipTotal: 0,
    tempMin: -0.5,
    dager: [48.2, 74.0, 0, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 61 EI per dag. Toppdag Tir med 74.0 EI. Kraftige vindkast opp til 29.0 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 3.9,
    dager: [43.4, 75.8, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Tir med 75.8 EI. Kraftige vindkast opp til 33.2 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.7,
    dager: [53.6, 65.3, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 59 EI per dag. Toppdag Tir med 65.3 EI. Kraftige vindkast opp til 28.3 m/s."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [41.3, 66.4, 0, 0, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Tir med 66.4 EI. Kraftige vindkast opp til 28.9 m/s."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark har overtatt forsteplassen i sammenlagt-ligaen med 64.2 poeng, foran Troms (54.0).",
  gammelLeder: "Oslo",
  nyLeder: "Finnmark",
};
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-04-20",
  tilDato: "2026-04-21",
  periode: "20.04 - 21.04.2026 (2 dager)",
  dagerRegistrert: 2,
  versteFylke: "Finnmark",
  versteFylkeScore: 64.2,
};
