 ...
 *
 * Sist oppdatert: 15.07.2026 kl. 12:42
...
export const META = {
  ...
  datoOppdatert: "15.07.2026 kl. 12:42",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Finnmark", dager: [19.2, 26.2, 21.6], trend: "Noe bedring (-4.6) - roligere forhold" },
  { navn: "Troms", dager: [20.6, 21.9, 19.1], trend: "Noe bedring (-2.8) - roligere forhold" },
  { navn: "Oslo", dager: [15.3, 14.9, 14.5], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Vestland", dager: [10.3, 9.7, 9.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [8.7, 8.9, 8.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [8.9, 7.8, 8.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [9.2, 7.7, 7.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [9.0, 7.8, 7.4], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [7.5, 7.3, 6.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [7.1, 6.7, 6.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Finnmark", total: 67.0, iDag: 21.6, endringFraIGar: -4.6, plasseringEndring: -1 },
  { navn: "Troms", total: 61.6, iDag: 19.1, endringFraIGar: -2.8, plasseringEndring: 0 },
  { navn: "Oslo", total: 44.7, iDag: 14.5, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 39.2, iDag: 13.6, endringFraIGar: 0.9, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 38.9, iDag: 12.7, endringFraIGar: 0.0, plasseringEndring: -1 },
  { navn: "Vestland", total: 29.5, iDag: 9.5, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 26.4, iDag: 8.8, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 24.9, iDag: 8.2, endringFraIGar: 0.4, plasseringEndring: 2 },
  { navn: "Innlandet", total: 24.6, iDag: 7.7, endringFraIGar: 0.0, plasseringEndring: -1 },
  { navn: "Telemark", total: 24.2, iDag: 7.4, endringFraIGar: -0.4, plasseringEndring: -1 },
  { navn: "Agder", total: 21.7, iDag: 6.9, endringFraIGar: -0.4, plasseringEndring: 0 },
  { navn: "Østfold", total: 20.7, iDag: 6.9, endringFraIGar: 0.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SANDHORNØYA - VÅTVIKFJELLET", kommune: "GILDESKÅL", fylke: "Nordland", ei: 62.7, vindkast: 28.3, nedbor: 0, temp: 7.4, farevarsel: "oransje" },
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 58.7, vindkast: 23.2, nedbor: 0, temp: 0, farevarsel: "gul" },
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [58.2, 64.5, 58.7, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Tir med 64.5 EI. Kraftige vindkast opp til 29.2 m/s."
  },
  {
    navn: "E10 BJØRNFJELL",
    kommune: "NARVIK",
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 71.0 poeng, foran Finnmark (67.0).",
