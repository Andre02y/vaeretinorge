 ...
 *
 * Sist oppdatert: 13.09.2026 kl. 03:43
...
export const META = {
  ...
  datoOppdatert: "13.09.2026 kl. 03:43",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [33.7, 27.4, 26.4, 28.6, 19.5, 29.2, 15.3], trend: "Markant bedring (-13.9) - lavtrykket har passert" },
  { navn: "Finnmark", dager: [28.2, 29.9, 29.5, 25.7, 20.0, 19.5, 25.5], trend: "Kraftig forverring (+6.0) - okt vind og/eller nedbor" },
  { navn: "Nordland", dager: [23.5, 23.6, 21.6, 20.7, 20.7, 21.4, 25.9], trend: "Noe forverring (+4.5) - ustabilt vaer fortsetter" },
  { navn: "Møre og Romsdal", dager: [22.1, 20.2, 26.2, 19.9, 20.7, 20.9, 23.3], trend: "Noe forverring (+2.4) - ustabilt vaer fortsetter" },
  { navn: "Vestland", dager: [25.7, 24.2, 23.3, 18.8, 20.6, 21.1, 18.2], trend: "Noe bedring (-2.9) - roligere forhold" },
  { navn: "Troms", dager: [23.1, 21.6, 22.3, 21.2, 17.7, 17.7, 21.6], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Trøndelag", dager: [19.7, 20.6, 21.6, 19.0, 19.5, 18.2, 21.7], trend: "Noe forverring (+3.5) - ustabilt vaer fortsetter" },
  { navn: "Agder", dager: [21.9, 22.4, 21.0, 17.4, 21.6, 22.1, 13.7], trend: "Markant bedring (-8.4) - lavtrykket har passert" },
  { navn: "Rogaland", dager: [21.2, 22.4, 21.5, 16.6, 20.3, 19.6, 13.9], trend: "Markant bedring (-5.7) - lavtrykket har passert" },
  { navn: "Innlandet", dager: [20.0, 19.5, 20.1, 19.1, 18.4, 18.7, 18.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [21.8, 18.7, 18.3, 17.5, 19.6, 19.6, 13.3], trend: "Markant bedring (-6.3) - lavtrykket har passert" },
  { navn: "Buskerud", dager: [21.5, 16.1, 17.6, 18.2, 16.7, 19.6, 13.6], trend: "Markant bedring (-6.0) - lavtrykket har passert" },
  { navn: "Østfold", dager: [22.5, 19.0, 15.1, 18.1, 16.6, 14.8, 11.8], trend: "Noe bedring (-3.0) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 180.1, iDag: 15.3, endringFraIGar: -13.9, plasseringEndring: 0 },
  { navn: "Finnmark", total: 178.3, iDag: 25.5, endringFraIGar: 6.0, plasseringEndring: 0 },
  { navn: "Nordland", total: 157.4, iDag: 25.9, endringFraIGar: 4.5, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 153.3, iDag: 23.3, endringFraIGar: 2.4, plasseringEndring: 1 },
  { navn: "Vestland", total: 151.9, iDag: 18.2, endringFraIGar: -2.9, plasseringEndring: -2 },
  { navn: "Troms", total: 145.2, iDag: 21.6, endringFraIGar: 3.9, plasseringEndring: 1 },
  { navn: "Trøndelag", total: 140.3, iDag: 21.7, endringFraIGar: 3.5, plasseringEndring: 2 },
  { navn: "Agder", total: 140.1, iDag: 13.7, endringFraIGar: -8.4, plasseringEndring: -2 },
  { navn: "Rogaland", total: 135.5, iDag: 13.9, endringFraIGar: -5.7, plasseringEndring: -1 },
  { navn: "Innlandet", total: 133.8, iDag: 18.0, endringFraIGar: -0.7, plasseringEndring: 0 },
  { navn: "Telemark", total: 128.8, iDag: 13.3, endringFraIGar: -6.3, plasseringEndring: 0 },
  { navn: "Buskerud", total: 123.3, iDag: 13.6, endringFraIGar: -6.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 117.9, iDag: 11.8, endringFraIGar: -3.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "SØMNA - KVALØYFJELLET", kommune: "SØMNA", fylke: "Nordland", ei: 75.4, vindkast: 35.1, nedbor: 0, temp: 8.9, farevarsel: "oransje" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 67.8, vindkast: 24.8, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "GJEMNES - REINSFJELLET", kommune: "GJEMNES", fylke: "Møre og Romsdal", ei: 66.6, vindkast: 30.9, nedbor: 0, temp: 2.7, farevarsel: "oransje" },
  { navn: "SOGNDAL LH - STOREHAUGFJELLET", kommune: "SOGNDAL", fylke: "Vestland", ei: 63.0, vindkast: 22.2, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "KRISTIANSUND LH - KVERNBERGET 200MOH", kommune: "KRISTIANSUND", fylke: "Møre og Romsdal", ei: 61.0, vindkast: 26.4, nedbor: 0, temp: 0, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 27.9,
    tempMin: -39.9,
    dager: [43.1, 73.3, 43.6, 52.4, 59.8, 58.4, 28.9],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 51 EI per dag. Toppdag Tir med 73.3 EI. Mye nedbor med totalt 27.9 mm. Bitende kulde ned til -39.9 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [54.1, 50.2, 44.8, 43.9, 46.5, 48.0, 67.8],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 51 EI per dag. Toppdag Søn med 67.8 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [51.1, 50.7, 59.2, 52.8, 34.6, 38.7, 56.8],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 49 EI per dag. Toppdag Ons med 59.2 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 2.9,
    dager: [48.8, 39.3, 54.1, 55.3, 39.7, 35.2, 59.8],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 47 EI per dag. Toppdag Søn med 59.8 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.7, 43.2, 54.8, 54.5, 40.8, 42.8, 44.0],
    beskrivelse: "Jevnt darlig vaer hele uken med snitt 47 EI per dag. Toppdag Ons med 54.8 EI. Kraftige vindkast opp til 25.2 m/s."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 180.1 poeng - 1.8 poeng foran Finnmark (178.3).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
