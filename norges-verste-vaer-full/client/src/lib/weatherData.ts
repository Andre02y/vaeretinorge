 ...
 *
 * Sist oppdatert: 19.09.2026 kl. 09:37
...
export const META = {
  ...
  datoOppdatert: "19.09.2026 kl. 09:37",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Oslo", dager: [17.2, 30.6, 30.5, 26.3, 30.0, 25.2], trend: "Noe bedring (-4.8) - roligere forhold" },
  { navn: "Finnmark", dager: [28.5, 23.6, 26.9, 24.1, 25.8, 22.5], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Vestland", dager: [17.7, 24.8, 25.0, 20.7, 26.2, 25.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Nordland", dager: [24.9, 21.0, 23.5, 24.0, 21.0, 19.0], trend: "Noe bedring (-2.0) - roligere forhold" },
  { navn: "Agder", dager: [16.4, 24.7, 25.2, 19.7, 24.9, 21.6], trend: "Noe bedring (-3.3) - roligere forhold" },
  { navn: "Troms", dager: [25.9, 20.8, 18.4, 25.2, 20.9, 20.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [16.9, 21.7, 25.3, 19.9, 25.3, 21.7], trend: "Noe bedring (-3.6) - roligere forhold" },
  { navn: "Møre og Romsdal", dager: [18.5, 21.9, 25.2, 20.1, 19.9, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [17.5, 23.4, 21.9, 18.7, 19.3, 19.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [18.0, 17.5, 21.3, 19.5, 17.7, 19.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [14.7, 20.5, 19.6, 17.1, 19.7, 17.1], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Telemark", dager: [14.1, 19.5, 21.3, 15.4, 21.3, 16.9], trend: "Noe bedring (-4.4) - roligere forhold" },
  { navn: "Østfold", dager: [12.5, 18.8, 18.7, 15.3, 19.2, 14.9], trend: "Noe bedring (-4.3) - roligere forhold" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Oslo", total: 159.8, iDag: 25.2, endringFraIGar: -4.8, plasseringEndring: 0 },
  { navn: "Finnmark", total: 151.4, iDag: 22.5, endringFraIGar: -3.3, plasseringEndring: 0 },
  { navn: "Vestland", total: 140.0, iDag: 25.6, endringFraIGar: -0.6, plasseringEndring: 1 },
  { navn: "Nordland", total: 133.4, iDag: 19.0, endringFraIGar: -2.0, plasseringEndring: -1 },
  { navn: "Agder", total: 132.5, iDag: 21.6, endringFraIGar: -3.3, plasseringEndring: 1 },
  { navn: "Troms", total: 132.0, iDag: 20.8, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Rogaland", total: 130.8, iDag: 21.7, endringFraIGar: -3.6, plasseringEndring: 0 },
  { navn: "Møre og Romsdal", total: 127.2, iDag: 21.6, endringFraIGar: 1.7, plasseringEndring: 0 },
  { navn: "Innlandet", total: 120.3, iDag: 19.5, endringFraIGar: 0.2, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 113.2, iDag: 19.2, endringFraIGar: 1.5, plasseringEndring: 0 },
  { navn: "Buskerud", total: 108.7, iDag: 17.1, endringFraIGar: -2.6, plasseringEndring: 1 },
  { navn: "Telemark", total: 108.5, iDag: 16.9, endringFraIGar: -4.4, plasseringEndring: -1 },
  { navn: "Østfold", total: 99.4, iDag: 14.9, endringFraIGar: -4.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  ...
  { navn: "FV614 GRYTADALEN", kommune: "BREMANGER", fylke: "Vestland", ei: 63.1, vindkast: 0, nedbor: 12.6, temp: -30.0, farevarsel: "oransje" },
  ...
  { navn: "FV65 BYE", kommune: "ORKLAND", fylke: "Trøndelag", ei: 61.2, vindkast: 0, nedbor: 0.7, temp: -39.7, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 100.7,
    tempMin: -31.0,
    dager: [17.5, 55.8, 58.0, 58.4, 73.7, 63.1, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 54 EI per dag. Toppdag Fre med 73.7 EI. Mye nedbor med totalt 100.7 mm. Bitende kulde ned til -31.0 grader C."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 61.6,
    tempMin: 0,
    dager: [38.8, 52.1, 47.4, 45.8, 51.2, 53.1, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 48 EI per dag. Toppdag Lør med 53.1 EI. Mye nedbor med totalt 61.6 mm."
  },
  {
    navn: "BREKKE I SOGN",
    kommune: "GULEN",
  ...
  },
  {
    ...
    precipTotal: 44.9,
    tempMin: -32.3,
    dager: [40.5, 49.0, 65.5, 62.5, 46.7, 16.9, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 47 EI per dag. Toppdag Ons med 65.5 EI. Mye nedbor med totalt 44.9 mm. Bitende kulde ned til -32.3 grader C."
  },
];
...
export const TRONSKIFTE = {
  aktiv: false,
  tittel: "OSLO LEDER!",
  beskrivelse: "Oslo leder sammenlagt med 159.8 poeng - 8.4 poeng foran Finnmark (151.4).",
  gammelLeder: "Oslo",
  nyLeder: "Oslo",
};
