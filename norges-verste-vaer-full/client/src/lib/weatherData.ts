 ...
 *
 * Sist oppdatert: 11.04.2026 kl. 17:24
...
export const META = {
  ...
  datoOppdatert: "11.04.2026 kl. 17:24",
...
export const FYLKER_DAG_FOR_DAG = [
  ...
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 30.8, 32.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 24.8, 24.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.0, 24.4], trend: "Noe bedring (-2.6) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.0, 23.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.4, 23.9], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 20.6, 20.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 25.2, 26.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.9, 21.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.7, 25.8], trend: "Noe forverring (+4.1) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 20.9, 20.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.8, 19.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 20.9, 19.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  ...
  { navn: "Agder", total: 160.2, iDag: 32.5, endringFraIGar: 1.7, plasseringEndring: 3 },
  { navn: "Innlandet", total: 155.9, iDag: 24.9, endringFraIGar: 0.1, plasseringEndring: -1 },
  { navn: "Vestland", total: 154.5, iDag: 24.4, endringFraIGar: -2.6, plasseringEndring: -1 },
  { navn: "Nordland", total: 152.2, iDag: 23.7, endringFraIGar: -0.3, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 150.6, iDag: 23.9, endringFraIGar: 0.5, plasseringEndring: 1 },
  { navn: "Troms", total: 148.3, iDag: 20.7, endringFraIGar: 0.1, plasseringEndring: -1 },
  { navn: "Rogaland", total: 143.8, iDag: 26.3, endringFraIGar: 1.1, plasseringEndring: 1 },
  { navn: "Møre og Romsdal", total: 143.7, iDag: 21.3, endringFraIGar: -1.6, plasseringEndring: -1 },
  { navn: "Telemark", total: 128.9, iDag: 25.8, endringFraIGar: 4.1, plasseringEndring: 0 },
  { navn: "Buskerud", total: 122.0, iDag: 20.7, endringFraIGar: -0.2, plasseringEndring: 1 },
  { navn: "Oslo", total: 121.5, iDag: 19.8, endringFraIGar: 0.0, plasseringEndring: -1 },
  { navn: "Østfold", total: 119.9, iDag: 19.9, endringFraIGar: -1.0, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 81.2, vindkast: 35.3, nedbor: 0, temp: -6.1, farevarsel: "oransje" },
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 76.1, vindkast: 29.8, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 70.2, vindkast: 26.5, nedbor: 0.2, temp: -4.0, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 67.4, vindkast: 28.7, nedbor: 0, temp: -5.9, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 66.3, vindkast: 21.7, nedbor: 0, temp: -7.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.1,
    dager: [80.1, 39.5, 44.2, 66.7, 82.6, 81.2, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Fre med 82.6 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -6.1 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 88.2, 76.1, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 65 EI per dag. Toppdag Fre med 88.2 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 213.7,
    tempMin: -3.9,
    dager: [77.7, 25.9, 44.8, 92.4, 83.9, 50.4, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 63 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 213.7 mm."
  },
  {
  ...
  },
  {
    ...
    precipTotal: 3.1,
    tempMin: -5.5,
    dager: [63.5, 42.4, 48.3, 72.8, 63.0, 70.2, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 184.2 poeng - 24.0 poeng foran Agder (160.2).",
