 ...
 *
 * Sist oppdatert: 20.03.2026 kl. 16:34
...
export const META = {
  ...
  datoOppdatert: "20.03.2026 kl. 16:34",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [29.6, 33.8, 41.5, 42.4, 40.1], trend: "Noe bedring (-2.3) - roligere forhold" },
  { navn: "Finnmark", dager: [31.1, 33.6, 37.6, 38.9, 37.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [28.1, 28.9, 33.1, 39.5, 36.0], trend: "Noe bedring (-3.5) - roligere forhold" },
  { navn: "Trøndelag", dager: [22.5, 24.8, 25.9, 32.5, 29.4], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Oslo", dager: [34.0, 30.8, 25.5, 23.2, 19.3], trend: "Noe bedring (-3.9) - roligere forhold" },
  { navn: "Innlandet", dager: [32.1, 28.8, 26.2, 22.9, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [24.5, 25.2, 29.2, 25.9, 26.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [29.9, 27.3, 25.1, 24.1, 23.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [33.5, 28.2, 24.4, 21.7, 20.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [30.1, 29.7, 25.0, 19.9, 19.5], trend: "Stabilt - lite endring fra i gar" },
  ...
  { navn: "Buskerud", dager: [28.6, 24.9, 21.7, 19.1, 18.9], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 187.4, iDag: 40.1, endringFraIGar: -2.3, plasseringEndring: 0 },
  { navn: "Finnmark", total: 179.0, iDag: 37.8, endringFraIGar: -1.1, plasseringEndring: 0 },
  { navn: "Troms", total: 165.6, iDag: 36.0, endringFraIGar: -3.5, plasseringEndring: 0 },
  { navn: "Trøndelag", total: 135.1, iDag: 29.4, endringFraIGar: -3.1, plasseringEndring: 4 },
  { navn: "Oslo", total: 132.8, iDag: 19.3, endringFraIGar: -3.9, plasseringEndring: -1 },
  { navn: "Innlandet", total: 131.6, iDag: 21.6, endringFraIGar: -1.3, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 130.8, iDag: 26.0, endringFraIGar: 0.1, plasseringEndring: 2 },
  { navn: "Vestland", total: 129.9, iDag: 23.5, endringFraIGar: -0.6, plasseringEndring: -1 },
  { navn: "Agder", total: 128.1, iDag: 20.3, endringFraIGar: -1.4, plasseringEndring: -3 },
  { navn: "Telemark", total: 124.2, iDag: 19.5, endringFraIGar: -0.4, plasseringEndring: 0 },
  ...
  { navn: "Buskerud", total: 113.2, iDag: 18.9, endringFraIGar: -0.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FV705 LANGSVOLA", kommune: "TYDAL", fylke: "Trøndelag", ei: 617.2, vindkast: 0, nedbor: 1152.0, temp: 0.5, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 85.5, vindkast: 37.7, nedbor: 0, temp: -3.4, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 73.6, vindkast: 28.3, nedbor: 0, temp: -3.3, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 72.1, vindkast: 32.3, nedbor: 0, temp: -0.3, farevarsel: "oransje" },
  { navn: "HASVIK - SLUSKFJELLET", kommune: "HASVIK", fylke: "Finnmark", ei: 71.0, vindkast: 30.6, nedbor: 0, temp: -0.1, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 2417.9,
    tempMin: -1.8,
    dager: [33.8, 35.4, 32.8, 675.7, 617.2, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 279 EI per dag. Toppdag Tor med 675.7 EI. Mye nedbor med totalt 2417.9 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.4,
    dager: [53.3, 64.1, 79.2, 79.7, 85.5, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 143.2,
    tempMin: -2.2,
    dager: [38.8, 59.0, 96.8, 68.1, 68.3, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 66 EI per dag. Toppdag Ons med 96.8 EI. Mye nedbor med totalt 143.2 mm."
  },
  {
    navn: "KAPPFJELLET",
    kommune: "GRANE",
    ...
    precipTotal: 0,
    tempMin: -3.5,
    dager: [52.2, 61.9, 78.2, 68.5, 69.9, 0, 0],
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: -8.0,
    dager: [55.1, 71.9, 82.6, 62.8, 51.0, 0, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 187.4 poeng - 8.4 poeng foran Finnmark (179.0).",
