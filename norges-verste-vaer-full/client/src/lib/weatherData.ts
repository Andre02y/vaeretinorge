 ...
 *
 * Sist oppdatert: 11.04.2026 kl. 11:31
...
export const META = {
  ...
  datoOppdatert: "11.04.2026 kl. 11:31",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Finnmark", dager: [28.8, 29.6, 39.4, 34.1, 28.7, 24.2], trend: "Noe bedring (-4.5) - roligere forhold" },
  { navn: "Agder", dager: [32.3, 20.8, 20.9, 22.9, 30.8, 31.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [34.6, 24.1, 23.4, 24.1, 24.8, 24.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [31.7, 22.9, 23.6, 24.9, 27.0, 24.0], trend: "Noe bedring (-3.0) - roligere forhold" },
  { navn: "Nordland", dager: [24.6, 24.2, 30.2, 25.5, 24.0, 23.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Trøndelag", dager: [34.0, 25.6, 22.7, 21.0, 23.4, 23.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [24.5, 25.6, 31.8, 25.1, 20.6, 21.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [32.6, 24.7, 21.3, 20.9, 22.9, 21.7], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [27.2, 20.4, 21.2, 23.5, 25.2, 25.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [23.8, 19.2, 19.1, 19.3, 21.7, 25.6], trend: "Noe forverring (+3.9) - ustabilt vaer fortsetter" },
  { navn: "Buskerud", dager: [23.2, 19.3, 19.1, 18.8, 20.9, 21.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Oslo", dager: [24.7, 19.4, 19.1, 18.7, 19.8, 20.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [24.2, 18.6, 18.5, 17.8, 20.9, 20.6], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Finnmark", total: 184.8, iDag: 24.2, endringFraIGar: -4.5, plasseringEndring: 0 },
  { navn: "Agder", total: 159.0, iDag: 31.3, endringFraIGar: 0.5, plasseringEndring: 3 },
  { navn: "Innlandet", total: 155.7, iDag: 24.7, endringFraIGar: -0.1, plasseringEndring: -1 },
  { navn: "Vestland", total: 154.1, iDag: 24.0, endringFraIGar: -3.0, plasseringEndring: -1 },
  { navn: "Nordland", total: 152.2, iDag: 23.7, endringFraIGar: -0.3, plasseringEndring: -1 },
  { navn: "Trøndelag", total: 149.8, iDag: 23.1, endringFraIGar: -0.3, plasseringEndring: 1 },
  { navn: "Troms", total: 149.2, iDag: 21.6, endringFraIGar: 1.0, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 144.1, iDag: 21.7, endringFraIGar: -1.2, plasseringEndring: 0 },
  { navn: "Rogaland", total: 142.6, iDag: 25.1, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Telemark", total: 128.7, iDag: 25.6, endringFraIGar: 3.9, plasseringEndring: 0 },
  { navn: "Buskerud", total: 122.4, iDag: 21.1, endringFraIGar: 0.2, plasseringEndring: 1 },
  { navn: "Oslo", total: 121.7, iDag: 20.0, endringFraIGar: 0.2, plasseringEndring: -1 },
  { navn: "Østfold", total: 120.6, iDag: 20.6, endringFraIGar: -0.3, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "FOLGEFONNA SKISENTER TOPP", kommune: "ULLENSVANG", fylke: "Vestland", ei: 71.1, vindkast: 27.1, nedbor: 0, temp: -5.2, farevarsel: "oransje" },
  { navn: "RØLDALSFJELLET - ELVERSHEI", kommune: "ULLENSVANG", fylke: "Vestland", ei: 69.3, vindkast: 27.3, nedbor: 0, temp: -6.1, farevarsel: "oransje" },
  { navn: "MIDTSTOVA", kommune: "ULVIK", fylke: "Vestland", ei: 66.1, vindkast: 22.2, nedbor: 0.2, temp: -4.0, farevarsel: "oransje" },
  { navn: "TROLLHEIMEN - STORHORNET", kommune: "OPPDAL", fylke: "Trøndelag", ei: 65.6, vindkast: 28.7, nedbor: 0, temp: -5.9, farevarsel: "oransje" },
  { navn: "SPØRTEGGBU", kommune: "LUSTER", fylke: "Vestland", ei: 64.6, vindkast: 21.3, nedbor: 0, temp: -7.4, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 0,
    tempMin: -6.0,
    dager: [53.1, 37.6, 51.1, 82.8, 88.2, 71.1, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Fre med 88.2 EI. Kraftige vindkast opp til 48.4 m/s. Bitende kulde ned til -6.0 grader C."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -6.1,
    dager: [80.1, 39.5, 44.2, 66.7, 82.6, 69.3, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 64 EI per dag. Toppdag Fre med 82.6 EI. Kraftige vindkast opp til 38.9 m/s. Bitende kulde ned til -6.1 grader C."
  },
  {
    navn: "E134 MIDTLÆGER",
    kommune: "ULLENSVANG",
    ...
    precipTotal: 210.7,
    tempMin: -3.9,
    dager: [77.7, 25.9, 44.8, 92.4, 83.9, 48.0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 62 EI per dag. Toppdag Tor med 92.4 EI. Mye nedbor med totalt 210.7 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -7.5,
    dager: [81.3, 52.3, 38.2, 51.3, 71.8, 65.6, 0],
  ...
  },
  {
    ...
    precipTotal: 3.1,
    tempMin: -5.5,
    dager: [63.5, 42.4, 48.3, 72.8, 63.0, 66.1, 0],
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Finnmark leder sammenlagt med 184.8 poeng - 25.8 poeng foran Agder (159.0).",
