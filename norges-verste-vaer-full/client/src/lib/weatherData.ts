 ...
 *
 * Sist oppdatert: 16.07.2026 kl. 09:53
...
export const META = {
  ...
  datoOppdatert: "16.07.2026 kl. 09:53",
...
export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [20.8, 24.0, 26.0, 22.9], trend: "Noe bedring (-3.1) - roligere forhold" },
  { navn: "Finnmark", dager: [19.2, 26.2, 20.7, 21.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Troms", dager: [20.6, 21.9, 20.6, 22.9], trend: "Noe forverring (+2.3) - ustabilt vaer fortsetter" },
  ...
  { navn: "Trøndelag", dager: [12.9, 12.7, 12.6, 12.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Vestland", dager: [10.3, 9.7, 8.7, 9.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [8.7, 8.9, 8.0, 7.8], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [8.9, 7.8, 7.7, 8.1], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [9.0, 7.8, 7.3, 7.2], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Innlandet", dager: [9.2, 7.7, 6.8, 7.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [7.5, 7.3, 7.0, 6.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Østfold", dager: [7.1, 6.7, 6.0, 5.8], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 93.7, iDag: 22.9, endringFraIGar: -3.1, plasseringEndring: 0 },
  { navn: "Finnmark", total: 87.1, iDag: 21.0, endringFraIGar: 0.3, plasseringEndring: 0 },
  { navn: "Troms", total: 86.0, iDag: 22.9, endringFraIGar: 2.3, plasseringEndring: 0 },
  ...
  { navn: "Trøndelag", total: 50.7, iDag: 12.5, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Vestland", total: 38.2, iDag: 9.5, endringFraIGar: 0.8, plasseringEndring: 0 },
  { navn: "Rogaland", total: 33.4, iDag: 7.8, endringFraIGar: -0.2, plasseringEndring: 0 },
  { navn: "Buskerud", total: 32.5, iDag: 8.1, endringFraIGar: 0.4, plasseringEndring: 0 },
  { navn: "Telemark", total: 31.3, iDag: 7.2, endringFraIGar: -0.1, plasseringEndring: 0 },
  { navn: "Innlandet", total: 31.0, iDag: 7.3, endringFraIGar: 0.5, plasseringEndring: 0 },
  { navn: "Agder", total: 27.8, iDag: 6.0, endringFraIGar: -1.0, plasseringEndring: 0 },
  { navn: "Østfold", total: 25.6, iDag: 5.8, endringFraIGar: -0.2, plasseringEndring: 0 },
...
export const STASJONER_PERIODE = [
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 65.1, vindkast: 31.0, nedbor: 0, temp: 8.3, farevarsel: "oransje" },
  { navn: "KVANNTOKOLLEN", kommune: "EVENES", fylke: "Nordland", ei: 64.6, vindkast: 26.1, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "TROMSØ LH - STORKJØLEN", kommune: "TROMSØ", fylke: "Troms", ei: 61.6, vindkast: 21.4, nedbor: 0, temp: 0, farevarsel: "oransje" },
  { navn: "ANDØYA - TROLLTINDEN", kommune: "ANDØY", fylke: "Nordland", ei: 54.7, vindkast: 26.8, nedbor: 0, temp: 9.0, farevarsel: "gul" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 54.4, vindkast: 21.6, nedbor: 0, temp: 5.9, farevarsel: "gul" },
];
...
export const STASJONER_UKE = [
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 4.1,
    dager: [54.0, 48.5, 50.7, 54.4, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 52 EI per dag. Toppdag Tor med 54.4 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [50.8, 50.4, 39.3, 61.6, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 51 EI per dag. Toppdag Tor med 61.6 EI."
  },
  {
    ...
    precipTotal: 0,
    tempMin: 7.1,
    dager: [46.5, 47.8, 52.3, 54.7, 0, 0, 0],
    beskrivelse: "Jevnt darlig vaer sa langt denne uka med snitt 50 EI per dag. Toppdag Tor med 54.7 EI. Kraftige vindkast opp til 26.8 m/s."
  },
  {
    navn: "ÅNSTADBLÅHEIA",
    kommune: "SORTLAND",
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland leder sammenlagt med 93.7 poeng - 6.6 poeng foran Finnmark (87.1).",
