 ...
 *
 * Sist oppdatert: 01.04.2026 kl. 23:33
 * Periode sammenlagt: 30.03 - 01.04.2026 (3 dager)
...
export const META = {
  ...
  sammenlagtLabel: "30.03 - 01.04.2026 (3 dager)",
  datoOppdatert: "01.04.2026 kl. 23:33",
  rapportVersjon: "v2.2 (norsk tid, live uke, ryddig arkiv, fikset uke/arkiv-logikk)",
  dagLabels: ["Man 30", "Tir 31", "Ons 01"],
};

// ---- DAG-FOR-DAG EI PER FYLKE ----

export const FYLKER_DAG_FOR_DAG = [
  { navn: "Nordland", dager: [30.4, 31.1, 44.3], trend: "Kraftig forverring (+13.2) - okt vind og/eller nedbor" },
  { navn: "Finnmark", dager: [32.4, 31.2, 38.1], trend: "Kraftig forverring (+6.9) - okt vind og/eller nedbor" },
  { navn: "Troms", dager: [27.6, 28.6, 39.0], trend: "Kraftig forverring (+10.4) - okt vind og/eller nedbor" },
  { navn: "Vestland", dager: [31.4, 28.2, 28.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Møre og Romsdal", dager: [25.2, 27.3, 31.6], trend: "Noe forverring (+4.3) - ustabilt vaer fortsetter" },
  { navn: "Innlandet", dager: [29.0, 25.5, 23.6], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Rogaland", dager: [29.5, 24.6, 23.3], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Agder", dager: [32.3, 23.7, 20.3], trend: "Noe bedring (-3.4) - roligere forhold" },
  { navn: "Oslo", dager: [35.4, 21.5, 19.4], trend: "Noe bedring (-2.1) - roligere forhold" },
  { navn: "Trøndelag", dager: [21.9, 23.9, 26.0], trend: "Noe forverring (+2.1) - ustabilt vaer fortsetter" },
  { navn: "Østfold", dager: [27.7, 22.4, 20.5], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Buskerud", dager: [27.1, 20.8, 19.0], trend: "Stabilt - lite endring fra i gar" },
  { navn: "Telemark", dager: [26.9, 20.4, 19.0], trend: "Stabilt - lite endring fra i gar" },
...
export const FYLKER_SAMMENLAGT = [
  { navn: "Nordland", total: 105.8, iDag: 44.3, endringFraIGar: 13.2, plasseringEndring: 1 },
  { navn: "Finnmark", total: 101.7, iDag: 38.1, endringFraIGar: 6.9, plasseringEndring: -1 },
  { navn: "Troms", total: 95.2, iDag: 39.0, endringFraIGar: 10.4, plasseringEndring: 2 },
  { navn: "Vestland", total: 87.6, iDag: 28.0, endringFraIGar: -0.2, plasseringEndring: -1 },
  { navn: "Møre og Romsdal", total: 84.1, iDag: 31.6, endringFraIGar: 4.3, plasseringEndring: 4 },
  { navn: "Innlandet", total: 78.1, iDag: 23.6, endringFraIGar: -1.9, plasseringEndring: 1 },
  { navn: "Rogaland", total: 77.4, iDag: 23.3, endringFraIGar: -1.3, plasseringEndring: 1 },
  { navn: "Agder", total: 76.3, iDag: 20.3, endringFraIGar: -3.4, plasseringEndring: -2 },
  { navn: "Oslo", total: 76.3, iDag: 19.4, endringFraIGar: -2.1, plasseringEndring: -5 },
  { navn: "Trøndelag", total: 71.8, iDag: 26.0, endringFraIGar: 2.1, plasseringEndring: 3 },
  { navn: "Østfold", total: 70.6, iDag: 20.5, endringFraIGar: -1.9, plasseringEndring: -1 },
  { navn: "Buskerud", total: 66.9, iDag: 19.0, endringFraIGar: -1.8, plasseringEndring: -1 },
  { navn: "Telemark", total: 66.3, iDag: 19.0, endringFraIGar: -1.4, plasseringEndring: -1 },
...
export const STASJONER_PERIODE = [
  { navn: "E6 STØDI BRU", kommune: "SALTDAL", fylke: "Nordland", ei: 110.6, vindkast: 0, nedbor: 133.1, temp: -1.3, farevarsel: "oransje" },
  { navn: "E6 ØSE", kommune: "GRATANGEN", fylke: "Troms", ei: 104.6, vindkast: 0, nedbor: 100.7, temp: 1.7, farevarsel: "oransje" },
  { navn: "NARVIK - FAGERNESFJELLET", kommune: "NARVIK", fylke: "Nordland", ei: 97.1, vindkast: 46.9, nedbor: 0, temp: -2.0, farevarsel: "oransje" },
  { navn: "ÅNSTADBLÅHEIA", kommune: "SORTLAND", fylke: "Nordland", ei: 83.7, vindkast: 39.0, nedbor: 0, temp: 0.7, farevarsel: "oransje" },
  { navn: "KISTEFJELL", kommune: "SENJA", fylke: "Troms", ei: 83.2, vindkast: 35.8, nedbor: 0, temp: -2.5, farevarsel: "oransje" },
];
...
export const STASJONER_UKE = [
  {
    ...
    precipTotal: 154.8,
    tempMin: -2.0,
    dager: [46.2, 53.0, 110.6, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 70 EI per dag. Toppdag Ons med 110.6 EI. Mye nedbor med totalt 154.8 mm."
  },
  {
    ...
    precipTotal: 0,
    tempMin: -3.2,
    dager: [55.0, 56.6, 97.1, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 70 EI per dag. Toppdag Ons med 97.1 EI. Kraftige vindkast opp til 46.9 m/s."
  },
  {
    navn: "KISTEFJELL",
    kommune: "SENJA",
  ...
  },
  {
    ...
    precipTotal: 0,
    tempMin: 0,
    dager: [48.4, 50.5, 81.5, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Ons med 81.5 EI. Kraftige vindkast opp til 37.9 m/s."
  },
  {
    navn: "JUVVASSHØE",
    kommune: "LOM",
    ...
    precipTotal: 0,
    tempMin: -8.5,
    dager: [48.1, 55.8, 76.4, 0, 0, 0, 0],
    beskrivelse: "Ekstremt vaer sa langt denne uka med snitt 60 EI per dag. Toppdag Ons med 76.4 EI. Kraftige vindkast opp til 36.4 m/s. Bitende kulde ned til -8.5 grader C."
  },
];
...
export const TRONSKIFTE = {
  ...
  beskrivelse: "Nordland har overtatt forsteplassen i sammenlagt-ligaen med 105.8 poeng, foran Finnmark (101.7).",
...
export const AKTUELL_UKE = {
  ...
  fraDato: "2026-03-30",
  tilDato: "2026-04-01",
  periode: "30.03 - 01.04.2026 (3 dager)",
  dagerRegistrert: 3,
  versteFylke: "Nordland",
  versteFylkeScore: 105.8,
};
